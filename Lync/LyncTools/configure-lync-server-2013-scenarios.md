...
> [!NOTE]  
> Para obter detalhes sobre como usar o Windows PowerShell e o Shell de gerenciamento do Lync Server, consulte o blog do Lync Server 2013 Windows PowerShell em <A href="https://go.microsoft.com/fwlink/?linkid=203150">https://go.microsoft.com/fwlink/?LinkId=203150</A> .
...
Talvez seja necessário configurar a política de verificação de versão do cliente se você tiver alterado as configurações de valores padrão. Para obter detalhes, consulte "Configurando as versões de cliente com suporte" em <https://technet.microsoft.com/library/gg412832(v=ocs.15).aspx> . A ferramenta de desempenho e stress do Lync Server 2013 usa as seguintes versões de agente de usuário por padrão ao se comunicar com o Lync Server 2013:
