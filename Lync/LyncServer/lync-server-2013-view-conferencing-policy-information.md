...
5.  Em **Editar Filtro de Arquivo**, marque a caixa de seleção **Mostrar Detalhes…**.
    ...
    **Editar política de conferência \<policy\> -** Abre exibindo as configurações da política selecionada. Para obter detalhes sobre como definir as configurações, consulte [create or Modify a Conferencing Policy in Lync Server 2013](lync-server-2013-create-or-modify-a-conferencing-policy.md).
