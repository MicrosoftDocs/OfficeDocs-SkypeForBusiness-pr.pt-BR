...
# <a name="pstn-connectivity-cmdlets-in-lync-server-2013"></a>Cmdlets de conectividade PSTN no Lync Server 2013
...
O Enterprise Voice fornece configurações que permitem chamadas de e para a rede telefônica pública comutada (PSTN) sem recusar a qualidade do serviço (QoS). Você pode definir essas configurações por meio de cmdlets disponíveis no Shell de gerenciamento do Lync Server.

<div>

## <a name="pstn-connectivity-cmdlets"></a>Cmdlets de conectividade PSTN

Use os cmdlets a seguir para configurar vários aspectos da conectividade PSTN.

**[Cmdlets de gateways PSTN no Lync Server 2013](lync-server-2013-pstn-gateways-cmdlets.md)**
...
**[Cmdlets de roteamento estático no Lync Server 2013](lync-server-2013-static-routing-cmdlets.md)**
...
**[Cmdlets de configuração de entroncamento no Lync Server 2013](lync-server-2013-trunking-configuration-cmdlets.md)**
