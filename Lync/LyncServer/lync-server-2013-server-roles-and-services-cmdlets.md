...
Muitos componentes do Microsoft Lync Server 2013 são executados como funções de servidor ou como serviços. O Lync Server 2013 acompanha vários cmdlets que permitem gerenciar essas funções de servidor e serviços.

<div>

## <a name="server-roles-and-services-cmdlets"></a>Cmdlets de serviços e funções de servidor

Muitas (mas não todas) as tarefas de gerenciamento que se aplicam a servidores e funções de serviço podem ser realizadas no painel de controle do Lync Server. Por exemplo, você pode gerenciar as configurações do servidor de arquivamento, mas não as configurações do servidor do catálogo de endereços usando o painel de controle do Lync Server. No entanto, todas essas tarefas podem ser executadas usando cmdlets do Shell de gerenciamento do Lync Server ou de dentro de um script; o uso de um script permite automatizar determinadas tarefas. A seguir está uma lista de cmdlets relacionados diretamente ao gerenciamento de serviços e funções de servidor:

**[Cmdlets do servidor de catálogo de endereços no Lync Server 2013](lync-server-2013-address-book-server-cmdlets.md)**
...
**[Cmdlets de banco de dados e servidor de gerenciamento no Lync Server 2013](lync-server-2013-database-and-management-server-cmdlets.md)**
...
**[Cmdlets de registradores e diretor no Lync Server 2013](lync-server-2013-registrar-and-director-cmdlets.md)**
...
**[Solucionando problemas de cmdlets de serviços e funções de servidor no Lync Server 2013](lync-server-2013-troubleshooting-server-roles-and-services-cmdlets.md)**
