...
# <a name="server-roles-and-services-cmdlets-in-lync-server-2013"></a>Cmdlets de serviços e funções de servidor no Lync Server 2013
...
Muitos componentes do Microsoft Lync Server 2013 são executados como funções de servidor ou como serviços. O Lync Server 2013 vem com vários cmdlets que permitem que você gerencie essas funções e serviços de servidor.

<div>

## <a name="server-roles-and-services-cmdlets"></a>Cmdlets de serviços e funções de servidor

Muitos (mas não todas) das tarefas de gerenciamento que se aplicam a servidores e funções de serviço podem ser executados no painel de controle do Lync Server. Por exemplo, você pode gerenciar as configurações do servidor de arquivamento, mas não do catálogo de endereços, usando o painel de controle do Lync Server. No entanto, todas essas tarefas podem ser executadas usando cmdlets do Shell de gerenciamento do Lync Server ou de dentro de um script; usar um script permite automatizar determinadas tarefas. Veja a seguir uma lista de cmdlets relacionados diretamente ao gerenciamento de funções e serviços do servidor:

**[Cmdlets do servidor do catálogo de endereços no Lync Server 2013](lync-server-2013-address-book-server-cmdlets.md)**
...
**[Cmdlets de arquivamento e monitoramento no Lync Server 2013](lync-server-2013-archiving-and-monitoring-cmdlets.md)**
...
**[Cmdlets do servidor de gerenciamento e banco de dados no Lync Server 2013](lync-server-2013-database-and-management-server-cmdlets.md)**
...
**[Cmdlets do servidor de borda no Lync Server 2013](lync-server-2013-edge-server-cmdlets.md)**
...
**[Outros cmdlets de função de servidor no Lync Server 2013](lync-server-2013-other-server-role-cmdlets.md)**
...
**[Cmdlets de registrador e diretor no Lync Server 2013](lync-server-2013-registrar-and-director-cmdlets.md)**
...
**[Cmdlets de serviços no Lync Server 2013](lync-server-2013-services-cmdlets.md)**
...
<!-- end list -->
  ...
  - <span></span>  
    [Parar-CsWindowsService](https://technet.microsoft.com/en-us/library/Gg398426(v=OCS.15))

**[Solução de problemas de cmdlets de serviços e funções de servidor no Lync Server 2013](lync-server-2013-troubleshooting-server-roles-and-services-cmdlets.md)**
...
**[Cmdlets de serviços e servidor Web no Lync Server 2013](lync-server-2013-web-server-and-services-cmdlets.md)**
