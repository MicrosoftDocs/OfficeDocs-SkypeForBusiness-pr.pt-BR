...
# <a name="security-checks-in-lync-server-2013"></a>Verificações de segurança no Lync Server 2013
...
Realize auditorias regulares de segurança, como regras de firewall, direitos do usuário, associação a um grupo, direitos de representante e assim por diante.
