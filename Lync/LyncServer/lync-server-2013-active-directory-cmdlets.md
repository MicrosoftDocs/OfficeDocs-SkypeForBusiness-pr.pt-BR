...
---
# <a name="active-directory-cmdlets-in-lync-server-2013"></a>Cmdlets do Active Directory no Lync Server 2013
...
## <a name="active-directory-cmdlets"></a>Cmdlets do Active Directory

Veja a seguir uma lista de cmdlets relacionados diretamente ao gerenciamento de configurações do Active Directory do Lync Server 2013:
