...
# <a name="set-csclientpolicy-for-address-book-management-in-lync-server-2013"></a>Set-CsClientPolicy para gerenciamento de catálogo de endereços no Lync Server 2013
