...
# <a name="associate-subnets-with-network-sites-for-e9-1-1-in-lync-server-2013"></a>Associar sub-redes a sites de rede para E9-1-1 no Lync Server 2013
...
Todas as sub-redes da rede que você deseja habilitar para E9-1-1 devem estar associadas a um site de rede específico. Isso ocorre porque as informações de sub-rede são usadas para determinar o site de rede no qual se encontra um ponto de extremidade.
