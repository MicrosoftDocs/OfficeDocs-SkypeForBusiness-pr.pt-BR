...
description: 'Lync Server 2013: cmdlets de registro em log centralizado.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48544337"
---
# <a name="centralized-logging-cmdlets-in-lync-server-2013"></a>Cmdlets de registro centralizado no Lync Server 2013
...
Os cmdlets de registro centralizado fornecem uma maneira de os administradores gerenciarem e configurar os recursos de registro em log centralizados introduzidos no Microsoft Lync Server 2013. O registro centralizado em log permite que os administradores ative ou desativem o acompanhamento de eventos em diversos computadores ao mesmo tempo.

<div>

## <a name="centralized-logging-cmdlets"></a>Cmdlets de registro centralizado em log

Os cmdlets de registro centralizado permitem que você gerencie o serviço de registro em log centralizado introduzido no Lync Server 2013:
