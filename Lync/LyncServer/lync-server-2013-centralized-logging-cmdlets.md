...
# <a name="centralized-logging-cmdlets-in-lync-server-2013"></a>Cmdlets de log centralizado no Lync Server 2013
...
Os cmdlets de log centralizado fornecem uma maneira para os administradores gerenciarem e configurarem os recursos de registro centralizado apresentados no Microsoft Lync Server 2013. O registro em log centralizado permite que os administradores habilitem ou desabilitem simultaneamente o rastreamento de eventos em vários computadores.

<div>

## <a name="centralized-logging-cmdlets"></a>Cmdlets de log centralizado

Os cmdlets de log centralizados permitem que você gerencie o serviço de log centralizado apresentado no Lync Server 2013:

**Cmdlets de log centralizado**
...
<!-- end list -->
  ...
  - [Parar-CsClsLogging](https://technet.microsoft.com/en-us/library/JJ619180(v=OCS.15))
