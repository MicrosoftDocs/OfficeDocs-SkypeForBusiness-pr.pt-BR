...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Excluir uma regra de política de versão de cliente existente no Lync Server 2013](lync-server-2013-delete-an-existing-client-version-policy-rule.md)
