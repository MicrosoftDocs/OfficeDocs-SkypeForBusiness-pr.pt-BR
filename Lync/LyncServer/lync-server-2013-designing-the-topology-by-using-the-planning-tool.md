...
# <a name="designing-the-topology-for-lync-server-2013-by-using-the-planning-tool"></a>Criando a topologia do Lync Server 2013 usando a ferramenta de planejamento
...
_**Tópico da última modificação:** 2013-03-04_

O Microsoft Lync Server 2013, ferramenta de planejamento é uma ferramenta de planejamento orientada por assistente que faz perguntas sobre a topologia do Lync Server 2013 que você está criando. A ferramenta de planejamento usa as informações fornecidas, combinadas com práticas preferenciais de design e capacidade de topologia, para apresentar uma topologia recomendada com base nas respostas fornecidas. Você pode baixar a ferramenta de planejamento no centro de download da[http://go.microsoft.com/fwlink/?LinkID=282725](http://go.microsoft.com/fwlink/?linkid=282725)Microsoft ().

Por fim, o objetivo da ferramenta de planejamento é facilitar a complexidade potencial de criar uma topologia completa do Lync Server 2013. A ferramenta também fornece referências contextuais à documentação de planejamento e implantação dentro da ferramenta, contanto que uma conexão com a Internet esteja disponível para se conectar ao site Microsoft TechNet.
...
Os tópicos a seguir introduzem e detalham a ferramenta de planejamento.
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Navegar pela ferramenta de planejamento no Lync Server 2013](lync-server-2013-navigating-the-planning-tool.md)
