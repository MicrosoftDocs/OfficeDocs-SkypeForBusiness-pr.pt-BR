...
description: Migração de usuário.
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
f1.keywords:
...
ms.locfileid: "48579557"
---
# <a name="user-migration"></a><span data-ttu-id="e0ccf-103">Migração de usuários</span><span class="sxs-lookup"><span data-stu-id="e0ccf-103">User migration</span></span>
