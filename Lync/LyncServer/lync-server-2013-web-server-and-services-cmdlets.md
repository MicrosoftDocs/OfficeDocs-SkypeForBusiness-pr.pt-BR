...
Muitos dos componentes do Microsoft Lync Server 2013 são baseados na Web: esses componentes usam serviços Web ou páginas da Web para realizar suas tarefas. Os cmdlets de servidor Web e serviços Web permitem que você faça coisas como definir configurações de servidor Web e gerenciar URLs simples. As URLs simples facilitam a participação dos usuários em reuniões e conferências, além de facilitar o logon dos administradores no painel de controle do Lync Server 2013.

<div>

## <a name="web-server-and-web-services-cmdlets"></a>Cmdlets de Servidores e Serviços da Web
