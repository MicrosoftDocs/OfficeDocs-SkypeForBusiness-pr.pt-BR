...
## <a name="to-open-best-practices-analyzer-as-administrator-to-check-for-updates"></a>Para abrir o Analisador de Práticas Recomendadas como Administrador para verificar a existência de atualizações

1.  Em um computador no qual o Best Practices Analyzer está instalado, clique em **Iniciar**, aponte para **Microsoft Lync Server 2013**, clique com o botão direito em **analisador de práticas recomendadas**e clique em **Executar como administrador**.
