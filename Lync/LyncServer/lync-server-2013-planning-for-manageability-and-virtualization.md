...
# <a name="planning-for-manageability-and-virtualization-in-lync-server-2013"></a>Planejamento de capacidade de gerenciamento e virtualização no Lync Server 2013
...
Esta seção inclui tópicos sobre o planejamento para o gerenciamento simples da sua implantação do Lync Server 2013.
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Executando o Lync Server 2013 em servidores virtuais](lync-server-2013-running-lync-server-on-virtual-servers.md)
