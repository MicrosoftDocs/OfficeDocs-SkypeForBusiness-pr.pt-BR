...
O Microsoft Lync Server 2013 permite que os usuários ingressem em conferências de duas maneiras diferentes: usando um aplicativo de conferência como o Lync 2013 ou discando usando um telefone. Os usuários de discagem não podem fazer coisas como exibir slides ou mensagens de chat do Exchange, mas podem participar de forma completa na parte de áudio de uma conferência.
...
**[Cmdlets da webconferência no Lync Server 2013](lync-server-2013-web-conferencing-cmdlets.md)**
