...
É possível usar os tópicos nesta seção para garantir que sua rede está pronta para o Lync Server.

<div>

## <a name="in-this-section"></a>Nesta seção

  - [Requisitos de infraestrutura de rede para o Lync Server 2013](lync-server-2013-network-infrastructure-requirements.md)
  ...
  - [Requisitos de DNS (sistema de nomes de domínio) para o Lync Server 2013](lync-server-2013-domain-name-system-dns-requirements.md)
