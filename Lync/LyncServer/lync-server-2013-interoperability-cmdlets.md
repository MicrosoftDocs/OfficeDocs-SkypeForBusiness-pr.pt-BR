...
---
# <a name="interoperability-cmdlets-in-lync-server-2013"></a>Cmdlets de interoperabilidade no Lync Server 2013
...
Os cmdlets de interoperabilidade são usados para configurar a autenticação de servidor para servidor e a autorização entre o Microsoft Lync Server 2013 e outros produtos de servidor, como o Microsoft Exchange Server 2013. Autorização e autenticação de servidor a servidor permite que estes servidores troquem e compartilhem dados perfeitamente.

<div>

## <a name="interoperability-cmdlets"></a>Cmdlets de interoperabilidade

Veja a seguir uma lista de cmdlets relacionados diretamente à configuração e ao gerenciamento da interoperabilidade entre o Microsoft Lync Server 2013 e outros produtos de servidor:
