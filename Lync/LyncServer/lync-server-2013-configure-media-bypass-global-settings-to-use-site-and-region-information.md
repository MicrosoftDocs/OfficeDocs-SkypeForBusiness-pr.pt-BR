...
## <a name="see-also"></a><span data-ttu-id="62c30-138">Confira Também</span><span class="sxs-lookup"><span data-stu-id="62c30-138">See Also</span></span>


[<span data-ttu-id="62c30-139">Associar sub-redes a sites de rede para bypass de mídia no Lync Server 2013</span><span class="sxs-lookup"><span data-stu-id="62c30-139">Associate subnets with network sites for media bypass in Lync Server 2013</span></span>](lync-server-2013-associate-subnets-with-network-sites-for-media-bypass.md)  
