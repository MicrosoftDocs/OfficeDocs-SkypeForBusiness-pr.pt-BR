...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Relatório de tendências de local no Lync Server 2013](lync-server-2013-location-trend-report.md)     Fornece informações de tendência de qualidade de chamada para locais de rede.
