...
26. Especifique como tratar chamadas após a reprodução da mensagem (se uma mensagem estiver configurada):
      ...
      - Para encaminhar a chamada para outro número de telefone, clique em **Encaminhar para número de telefone** e digite o número de telefone. O formato do número de telefone é \<number\> @ \<domainName\> (por exemplo, + 14255550121@contoso.com). O nome do domínio é usado para direcionar o chamador para o destino correto.
