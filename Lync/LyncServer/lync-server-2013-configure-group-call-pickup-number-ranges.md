...
---
# <a name="configure-group-call-pickup-number-ranges-in-lync-server-2013"></a>Configurar intervalos de números de recebimento de chamadas em grupo no Lync Server 2013
