...
description: 'Lync Server 2013: cmdlets de bypass de mídia.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48556407"
---
# <a name="media-bypass-cmdlets-in-lync-server-2013"></a>Cmdlets de bypass de mídia no Lync Server 2013
...
## <a name="media-bypass-cmdlets"></a>Cmdlets de desvio de mídia
