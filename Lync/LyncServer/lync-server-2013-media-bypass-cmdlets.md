...
# <a name="media-bypass-cmdlets-in-lync-server-2013"></a>Cmdlets bypass de mídia no Lync Server 2013
...
## <a name="media-bypass-cmdlets"></a>Cmdlets de bypass de mídia
