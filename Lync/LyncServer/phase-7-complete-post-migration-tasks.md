...
description: 'Fase 7: concluir tarefas de migração.'
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
f1.keywords:
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Migrar reuniões existentes e conteúdo de reunião](migrate-existing-meetings-and-meeting-content.md)
