...
---
# <a name="lync-phone-edition-configuration-settings-in-lync-server-2013"></a>Definições de configuração do Lync Phone Edition no Lync Server 2013
...
As definições de configuração executando o Lync Phone Edition se aplicam globalmente ou você pode criar novos conjuntos de definições que se aplicam a um site específico. Os conjuntos incluem segurança de SIP, configurações de trava do dispositivo, entre outros.

<div>

## <a name="in-this-section"></a>Nesta seção

  - [Exibir as informações de configuração do Lync Phone Edition no Lync Server 2013](lync-server-2013-view-lync-phone-edition-configuration-settings-information.md)
