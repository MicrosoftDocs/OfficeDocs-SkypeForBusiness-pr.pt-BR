...
description: 'Lync Server 2013: Resumo de certificado-borda consolidada em escala, balanceamento de carga de DNS com endereços IP públicos.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48572267"
---
# <a name="certificate-summary---scaled-consolidated-edge-dns-load-balancing-with-public-ip-addresses-in-lync-server-2013"></a>Resumo de certificado-borda consolidada em escala, balanceamento de carga de DNS com endereços IP públicos no Lync Server 2013
...
## <a name="scaled-consolidated-edge-using-dns-load-balancing-with-public-ip-addresses"></a>Borda Consolidada Dimensionada usando Balanceamento de Carga DNS com Endereços IP Públicos
...
<td><p>O certificado deve ser um CA público e deve ter um EKU do servidor e um EKU do cliente se a conectividade de IM público com a AOL for implantada. Além disso, para servidores de borda em escala, a chave privada do certificado deve ser exportável e o certificado e a chave privada copiados para cada servidor de borda. O certificado é atribuído a interfaces de Borda externas para:</p>
<ul>
<li><p>Borda de acesso</p></li>
<li><p>Borda de conferência</p></li>
<li><p>Borda A/V</p></li>
</ul>
<p>Observe que SANs são automaticamente adicionados ao certificado com base em suas definições no Construtor de Topologias. Você adiciona entradas SAN conforme o necessário para domínios SIP e outras entradas que precise suportar. O nome de entidade é replicado no SAN e deve estar presente para a operação correta.</p></td>
</tr>
<tr class="even">
