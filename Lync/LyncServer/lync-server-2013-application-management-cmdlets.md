...
description: 'Lync Server 2013: cmdlets de gerenciamento de aplicativos.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48568887"
---
# <a name="application-management-cmdlets-in-lync-server-2013"></a>Cmdlets de gerenciamento de aplicativos no Lync Server 2013
...
O Microsoft Lync Server 2013 fornece cmdlets que permitem gerenciar aplicativos do Lync Server e aplicativos de terceiros confiáveis.

<div>

## <a name="application-management-cmdlets"></a>Cmdlets de gerenciamento de aplicativos

Use os cmdlets nessas categorias para gerenciar aplicativos.

**[Cmdlets de pontos de extremidade de aplicativo no Lync Server 2013](lync-server-2013-application-endpoints-cmdlets.md)**
...
**[Cmdlets de serviços e servidor de aplicativos no Lync Server 2013](lync-server-2013-application-server-and-services-cmdlets.md)**
...
**[Cmdlets de aplicativos confiáveis no Lync Server 2013](lync-server-2013-trusted-applications-cmdlets.md)**
