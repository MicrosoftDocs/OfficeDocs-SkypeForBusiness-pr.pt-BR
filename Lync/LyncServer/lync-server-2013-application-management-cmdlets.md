...
Use os cmdlets dessas categorias para gerenciar aplicativos.

**[Cmdlets de pontos de extremidade do aplicativo no Lync Server 2013](lync-server-2013-application-endpoints-cmdlets.md)**
