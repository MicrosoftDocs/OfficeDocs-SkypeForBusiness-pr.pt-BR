...
Os tópicos desta seção descrevem como usar o painel de controle do Lync Server 2013 para configurar a conferência discada para usar seu ambiente do Lync Server 2013.

<div>

## <a name="in-this-section"></a>Nesta seção

  - [Habilitar ou desabilitar a conferência discada para reuniões no Lync Server 2013](lync-server-2013-enable-or-disable-dial-in-conferencing-for-meetings.md)

  - [Números de acesso de conferência discada no Lync Server 2013](lync-server-2013-dial-in-conferencing-access-numbers.md)
