...
---
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a>Testar servidor de chat persistente com uma transação sintética
...
Para testar o servidor de chat persistente para envio e recebimento de mensagens em uma sala de chat entre dois usuários
