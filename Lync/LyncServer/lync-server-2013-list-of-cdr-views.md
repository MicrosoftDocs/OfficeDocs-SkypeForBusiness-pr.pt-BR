...
---
# <a name="list-of-cdr-views-in-lync-server-2013"></a>Lista de exibições de CDR no Lync Server 2013
...
As exibições oferecem uma forma fácil de acessar informações sobre os cenários mais comuns usados para retornar dados do banco de dados CDR. É recomendável que você use modos de exibição para criar relatórios personalizados, em vez de usar as tabelas de banco de dados CDR reais; Isso ocorre porque as exibições do banco de dados são mais prováveis de manter a compatibilidade com versões anteriores do Lync Server.
...
<tr class="odd">
<td><p><a href="lync-server-2013-conferences-view.md">Exibição de conferências no Lync Server 2013</a></p></td>
...
<tr class="odd">
<td><p><a href="lync-server-2013-filetransfers-view.md">Modo de transferência de filetransfers no Lync Server 2013</a></p></td>
...
<tr class="odd">
<td><p><a href="lync-server-2013-media-view.md">Exibição de mídia no Lync Server 2013</a></p></td>
...
<tr class="odd">
<td><p><a href="lync-server-2013-registration-view.md">Exibição de registro no Lync Server 2013</a></p></td>
...
<tr class="odd">
<td><p><a href="lync-server-2013-user-view.md">Exibição de usuário no Lync Server 2013</a></p></td>
