...
9.  Clique em host que oferece **este serviço**e digite o nome de domínio totalmente qualificado (FQDN) do pool de borda do lync Server 2013 que fornece acesso ao seu sistema do lync Server 2013 para clientes externos confiáveis.
    ...
    > [!NOTE]
    > O domínio também deve ser configurado como um domínio autoritativo, aceito em suas configurações do Exchange Online. Para obter detalhes, consulte criar domínios aceitos em <A href="http://go.microsoft.com/fwlink/p/?linkid=229762">http://go.microsoft.com/fwlink/p/?linkId=229762</A>.
