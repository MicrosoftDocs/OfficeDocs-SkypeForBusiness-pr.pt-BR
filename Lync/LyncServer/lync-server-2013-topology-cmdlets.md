...
# <a name="topology-cmdlets-jn-lync-server-2013"></a>Cmdlets de topologia JN Lync Server 2013
...
Muitos dos cmdlets de topologia incluídos no Microsoft Lync Server 2013 foram projetados para serem usados com o construtor de topologias e configurações; por isso, há uma série de cmdlets de topologia que os administradores raramente farão chamadas diretamente. No entanto, haverá ocasiões em que os administradores deverão usar esses cmdlets; por exemplo, após a criação de novas contas Kerberos, você deve executar o cmdlet [Enable-CsTopology](https://technet.microsoft.com/en-us/library/Gg398398(v=OCS.15)) para fazer com que as alterações entrem em vigor. Além disso, os administradores provavelmente executarão cmdlets como [Test-CsTopology](https://technet.microsoft.com/en-us/library/Gg398127(v=OCS.15)) e [Test-CsComputer](https://technet.microsoft.com/en-us/library/Gg398162(v=OCS.15)) para ajudar a garantir que o Lync Server 2013 foi instalado corretamente e está funcionando conforme esperado.

<div>

## <a name="topology-cmdlets"></a>Cmdlets de topologia

Veja a seguir uma lista de cmdlets relacionados ao gerenciamento direto da topologia do Lync Server:
