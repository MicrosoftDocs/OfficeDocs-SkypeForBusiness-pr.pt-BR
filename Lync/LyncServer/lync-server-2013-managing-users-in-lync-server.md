...
# <a name="managing-users-in-lync-server-2013"></a>Gerenciando usuários no Lync Server 2013
...
Você pode usar o painel de controle do Lync Server 2013 e o Shell de gerenciamento do Lync Server 2013 para gerenciar contas de usuário no Lync Server 2013. Os procedimentos nesta seção orientam você sobre como visualizar informações de conta e configurar definições para contas de usuário.
