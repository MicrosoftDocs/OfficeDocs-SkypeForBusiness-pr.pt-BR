...
# <a name="new-call-management-features-in-lync-server-2013"></a>Novos recursos de gerenciamento de chamadas no Lync Server 2013
...
As seções a seguir descrevem as alterações nos recursos de gerenciamento de chamadas no Lync Server 2013.
  ...
  - [Novo recurso de recebimento de chamada em grupo no Lync Server 2013](lync-server-2013-new-group-call-pickup-feature.md)
