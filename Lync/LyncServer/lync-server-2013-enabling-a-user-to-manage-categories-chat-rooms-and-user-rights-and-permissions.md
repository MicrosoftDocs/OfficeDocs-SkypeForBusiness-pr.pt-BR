...
---
# <a name="enabling-a-user-to-manage-categories-chat-rooms-and-user-rights-and-permissions-in-lync-server-2013"></a>Habilitando um usuário para gerenciar categorias, salas de chat e direitos e permissões de usuário no Lync Server 2013
...
Os membros da função **CsPersistentChatAdministrator** (administradores de chat persistente) podem conceder direitos e permissões do gerente de sala de chat a outros usuários e a eles mesmos.
