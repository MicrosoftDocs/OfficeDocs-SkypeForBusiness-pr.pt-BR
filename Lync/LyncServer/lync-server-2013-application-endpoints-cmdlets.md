...
description: 'Lync Server 2013: cmdlets de pontos de extremidade de aplicativo.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48568917"
---
# <a name="application-endpoints-cmdlets-in-lync-server-2013"></a>Cmdlets de pontos de extremidade de aplicativo no Lync Server 2013
...
Os pontos de extremidade do aplicativo são objetos de contato nos serviços de domínio do Active Directory. Você pode usar cmdlets no Shell de gerenciamento do Lync Server para gerenciar esses contatos para o Microsoft Lync Server 2013.

<div>

## <a name="application-endpoints-cmdlets"></a>Cmdlets de pontos de extremidade de aplicativo
