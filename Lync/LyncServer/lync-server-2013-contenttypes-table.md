...
A tabela ContentTypes é uma tabela de suporte que armazena uma lista dos tipos de conteúdo usados nas sessões ponto a ponto e nas sessões de conferência. Cada registro da tabela representa um tipo de conteúdo.
