...
O modo de exibição MCUs armazena informações sobre o MCUs que participaram de sessões de conferência. Este modo de exibição foi introduzido no Microsoft Lync Server 2013.
