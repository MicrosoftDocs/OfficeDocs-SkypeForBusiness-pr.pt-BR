...
# <a name="testing-user-connection-to-exchange-um-voicemail-in-lync-server-2013"></a>Testando a conexão do usuário com o correio de voz do Exchange no Lync Server 2013
...
O cmdlet **Test-CsExUMVoiceMail** permite que os administradores verifiquem se um usuário pode acessar e usar o serviço de mensagens unificadas do Microsoft Exchange Server 2013. Para fazer isso, o cmdlet se conecta ao serviço de Unificação de mensagens e deixa uma caixa postal na caixa de correio especificada. Pode ser uma caixa postal fornecida pelo sistema ou pode ser um personalizada. WAV que você mesmo gravou.
...
Se o usuário especificado não conseguir se conectar ao correio de voz, o resultado será mostrado como uma **falha**, e informações adicionais serão gravadas nas propriedades de erro e diagnóstico:
