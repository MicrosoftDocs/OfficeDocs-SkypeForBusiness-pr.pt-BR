...
Para obter detalhes, consulte [Hosted Exchange Contact Object Management in Lync Server 2013](lync-server-2013-hosted-exchange-contact-object-management.md) na documentação de planejamento.
...
> [!IMPORTANT]  
> Para que os objetos de contato do Lync Server 2013 possam ser habilitados para UM do Exchange hospedado, uma política de correio de voz hospedada que se aplica a eles deve ser implantada. Para obter detalhes, consulte <A href="lync-server-2013-hosted-voice-mail-policies.md">Hosted voice mail Policies in Lync Server 2013</A>.
...
## <a name="to-create-aa-or-sa-contact-objects-for-hosted-exchange-um"></a>Para criar objetos de contato no AA ou SA para a UM do Exchange hospedado
...
2.  Execute o cmdlet New-CsExUmContact para criar objetos de contato obrigatórios para a sua implantação. Por exemplo, para criar um objeto de contato no AA e um no SA, execute:
    ...
    Estes exemplos definem os seguintes parâmetros:
      ...
      - **RegistrarPool** especifica o nome de domínio totalmente qualificado (FQDN) do pool em que o serviço do Registrador Avançado está sendo executado.
        ...
        > [!NOTE]  
        > Os objetos de contato de UM do Exchange não podem ser movidos para pools que fazem parte de implantações do Lync Server 2013 antes do Lync Server 2013.
