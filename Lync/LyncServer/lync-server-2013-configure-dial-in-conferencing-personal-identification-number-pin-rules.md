...
---
# <a name="configure-dial-in-conferencing-personal-identification-number-pin-rules-in-lync-server-2013"></a>Configurar regras de PIN (número de identificação pessoal) de conferência discada no Lync Server 2013
...
Lync Server 2013 os usuários que têm credenciais do AD DS (serviços de domínio Active Directory) em sua organização podem participar de conferências discadas como usuários autenticados usando um PIN (número de identificação pessoal). A política de PIN define as regras de funcionamento dos PINs de conferências de discagem.
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Excluir as configurações de PIN de conferência discada para um site ou grupo de usuários no Lync Server 2013](lync-server-2013-delete-dial-in-conferencing-pin-settings-for-a-site-or-group-of-users.md)
