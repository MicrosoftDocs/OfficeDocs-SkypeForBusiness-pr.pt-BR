...
description: Adicione o site de filial do aplicativo de filial persistente do Lync Server 2010 à sua topologia.
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48572047"
---
# <a name="add-lync-server-2010-survivable-branch-appliance-branch-site-to-your-topology"></a>Adicionar site de filial de dispositivo de filial persistente do Lync Server 2010 à sua topologia
...
Aplicativos de ramificação persistentes do Microsoft Lync Server 2010 (SBA) podem ser associados a um pool de front-ends do Microsoft Lync Server 2013 como um registrador de backup. Consulte a seção migração, [conectar um aparelho de filial persistente](connect-a-survivable-branch-appliance.md), para obter procedimentos detalhados sobre como conectar o Microsoft lync Server 2010 SBA a um pool de front-ends do Microsoft lync Server 2013.
