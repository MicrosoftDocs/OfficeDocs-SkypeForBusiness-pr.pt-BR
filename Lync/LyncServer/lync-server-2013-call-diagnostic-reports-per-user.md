...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [O relatório de atividades do usuário no Lync Server 2013](lync-server-2013-user-activity-report.md)   fornece informações sobre atividades ponto a ponto e conferência para cada um dos seus usuários.
