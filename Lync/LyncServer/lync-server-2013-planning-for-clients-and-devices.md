...
# <a name="planning-for-clients-and-devices-in-lync-server-2013"></a>Planejamento para clientes e dispositivos no Lync Server 2013
...
_**Tópico da última modificação:** 2012-06-04_

Os tópicos desta seção descrevem como planejar os clientes e dispositivos do Lync Server 2013 em sua organização.
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Planejando dispositivos no Lync Server 2013](lync-server-2013-planning-for-devices.md)
