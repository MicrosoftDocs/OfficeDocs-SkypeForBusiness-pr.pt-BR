...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Implantando o plug-in do Lync VDI no Lync Server 2013](lync-server-2013-deploying-the-lync-vdi-plug-in.md)

  - [Implantando o Lync Web App no Lync Server 2013](lync-server-2013-deploying-lync-web-app.md)
