...
# <a name="persistent-chat-compliance-in-lync-server-2013"></a>Conformidade de Chat Persistente no Lync Server 2013
...
Para criar uma nova configuração de conformidade de chat persistente
...
Para obter configuração de conformidade de chat persistente

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

Para definir a configuração de conformidade de chat persistente
...
Para remover a configuração de conformidade de chat persistente
