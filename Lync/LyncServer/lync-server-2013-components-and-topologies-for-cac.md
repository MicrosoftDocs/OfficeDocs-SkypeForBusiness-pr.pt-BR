...
description: 'Lync Server 2013: componentes e topologias para CAC.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48576907"
---
# <a name="components-and-topologies-for-cac-in-lync-server-2013"></a>Componentes e topologias para CAC no Lync Server 2013
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Controle de admissão de chamadas em uma rede MPLS com o Lync Server 2013](lync-server-2013-call-admission-control-on-an-mpls-network.md)
