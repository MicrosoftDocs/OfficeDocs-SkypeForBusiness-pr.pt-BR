...
---
# <a name="trunking-configuration-cmdlets-in-lync-server-2013"></a>Cmdlets de configuração de tronco no Lync Server 2013
...
## <a name="trunking-configuration-cmdlets"></a>Cmdlets de configuração de tronco
