...
---
# <a name="voice-application-cmdlets-in-lync-server-2013"></a>Cmdlets de aplicativo de voz no Lync Server 2013
...
Os aplicativos de voz são executados no serviço de Aplicativo do Servidor Front-End. Esses aplicativos ajudam você a gerenciar chamadas telefônicas de entrada e saída, permitindo que você disquem em chamadas, lidar com números não atribuídos, coordenada com a Unificação de mensagens (UM) do Exchange e executar o aplicativo grupo de resposta.

<div>

## <a name="voice-application-cmdlets"></a>Cmdlets de aplicativos de voz

A seguir é apresentada uma lista dos cmdlets que lidam com os aplicativos de voz:

**[Cmdlets do aplicativo de estacionamento de chamada no Lync Server 2013](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Cmdlets de UM do Exchange no Lync Server 2013](lync-server-2013-exchange-um-cmdlets.md)**
...
**[Cmdlets do aplicativo grupo de resposta no Lync Server 2013](lync-server-2013-response-group-application-cmdlets.md)**
...
**[Cmdlets de número não atribuído no Lync Server 2013](lync-server-2013-unassigned-number-cmdlets.md)**
