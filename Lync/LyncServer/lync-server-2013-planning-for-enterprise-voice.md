...
Para decisões de planejamento que pertencem à implantação de uma determinada funcionalidade ou componente de voz ou componente da empresa, consulte os tópicos desta seção.
  ...
  - [Orientações de implantação para Enterprise Voice no Lync Server 2013](lync-server-2013-deployment-guidelines-for-enterprise-voice.md)

  - [Visão geral do processo de implantação para Enterprise Voice no Lync Server 2013](lync-server-2013-deployment-process-overview-for-enterprise-voice.md)
