...
# <a name="replication-cmdlets-in-lync-server-2013"></a>Cmdlets de replicação no Lync Server 2013
...
Os cmdlets de replicação fornecem uma maneira de você monitorar e gerenciar a replicação do Lync Server. Você pode usar esses cmdlets para definir configurações de replicação; para monitorar o progresso da replicação; e forçar manualmente a replicação em um servidor.

<div>

## <a name="replication-cmdlets"></a>Cmdlets de replicação

Veja a seguir uma lista de cmdlets relacionados diretamente ao gerenciamento de replicação:
