...
# <a name="technical-requirements-for-group-call-pickup-in-lync-server-2013"></a>Requisitos técnicos para a coleta de chamadas em grupo no Lync Server 2013
...
O recebimento de chamadas em grupo tem os mesmos requisitos de hardware, software e porta que o aplicativo de estacionamento de chamadas. A retirada de chamadas em grupo não usa arquivos de áudio.
