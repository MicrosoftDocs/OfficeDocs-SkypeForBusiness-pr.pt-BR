...
# <a name="administrative-tools-infrastructure-requirements-in-lync-server-2013"></a>Requisitos de infraestrutura de ferramentas administrativas no Lync Server 2013
