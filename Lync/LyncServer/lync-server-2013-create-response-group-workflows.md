...
Use a ferramenta de configuração de grupo de resposta para criar fluxos de trabalho. Você pode acessar a ferramenta de configuração do grupo de resposta na página grupo de resposta do painel de controle do Lync Server.
