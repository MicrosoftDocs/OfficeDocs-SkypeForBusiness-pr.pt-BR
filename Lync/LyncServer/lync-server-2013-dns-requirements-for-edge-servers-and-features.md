...
---
# <a name="dns-requirements-for-edge-servers-and-features-in-lync-server-2013"></a>Requisitos de DNS para servidores de borda e recursos no Lync Server 2013
...
Servidores de borda do Lync Server 2013, pools de borda e proxies reversos têm requisitos específicos para registros DNS (sistema de nomes de domínio). No Lync Server 2013 quando IPv4 e IPv6 estiverem em uso, você deverá planejar os registros de host A e AAAA.

Os tópicos listados abaixo definem o uso de registros DNS para seu planejamento de implantação:
