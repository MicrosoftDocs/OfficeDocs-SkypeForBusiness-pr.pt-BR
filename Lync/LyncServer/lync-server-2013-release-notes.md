...
Para contornar esse problema, exclua as pastas que contêm os componentes Web e o .NET Framework da verificação antivírus. Para obter detalhes, consulte o artigo 312592 da base de dados de conhecimento da Microsoft, "PRB: reinicializações aleatórias do aplicativo com o erro" o [http://go.microsoft.com/fwlink/p/?linkid=3052\&kbid=312592](http://go.microsoft.com/fwlink/p/?linkid=3052%26kbid=312592)aplicativo está reiniciando "no ASP.net" em.
