...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Habilitar ou desabilitar notificações por push para Windows phones no Lync Server 2013](lync-server-2013-enabling-or-disabling-push-notifications-for-windows-phones.md)

  - [Exibindo informações sobre configurações de notificação por push no Lync Server 2013](lync-server-2013-viewing-information-about-push-notification-settings.md)
