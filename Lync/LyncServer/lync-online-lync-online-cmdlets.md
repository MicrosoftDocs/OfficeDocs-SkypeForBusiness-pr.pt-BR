...
description: 'Lync Online: cmdlets do Lync Online.'
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
f1.keywords:
...
ms.locfileid: "48569527"
---
# <a name="lync-online-cmdlets"></a>Cmdlets do Lync Online
...
Esta página lista todos os cmdlets do Windows PowerShell disponíveis para administradores de locatários do Microsoft Lync Online.

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>Cmdlets disponíveis somente para administradores do Lync Online

Os cmdlets a seguir podem ser usados apenas com o Lync Online:
...
Para obter informações sobre como configurar o computador para usar o Windows PowerShell para gerenciar com o Lync Online, consulte o tópico da ajuda [usando o Windows PowerShell para gerenciar o Lync Online](https://technet.microsoft.com/library/Dn362831(v=OCS.15)).

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Outros cmdlets disponíveis para administradores do Lync Online

Esses cmdlets podem ser usados com o Lync Online ou com a versão local do Lync Server 2013:
