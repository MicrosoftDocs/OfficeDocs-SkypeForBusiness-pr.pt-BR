...
Para obter informações sobre como configurar seu computador para usar o Windows PowerShell para gerenciar com o Lync Online, consulte o tópico da ajuda [usando o Windows PowerShell para gerenciar o Lync Online](https://technet.microsoft.com/en-us/library/Dn362831(v=OCS.15)).

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Outros cmdlets disponíveis para os administradores do Lync Online
