...
Os cmdlets de serviços e função de servidor que acompanham o Microsoft Lync Server 2013 permitem que você retorne informações sobre os vários componentes que foram instalados como parte da sua implantação do Lync Server 2013. Além disso, esses cmdlets facilitam a interrupção e o início de seus serviços do Lync Server.
