...
# <a name="request-certificates-in-advance-optional-for-lync-server-2013"></a><span data-ttu-id="a19ab-102">Solicitar certificados com antecedência (opcional) para o Lync Server 2013</span><span class="sxs-lookup"><span data-stu-id="a19ab-102">Request certificates in advance (optional) for Lync Server 2013</span></span>
