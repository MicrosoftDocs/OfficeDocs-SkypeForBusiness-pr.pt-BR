...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Esquema de banco de dados de registro de detalhes de chamadas (CDR) no Lync Server 2013](lync-server-2013-call-detail-recording-cdr-database-schema.md)

  - [Esquema de banco de dados de QoE (qualidade da experiência) no Lync Server 2013](lync-server-2013-quality-of-experience-qoe-database-schema.md)

  - [Esquema de banco de dados de chat persistente no Lync Server 2013](lync-server-2013-persistent-chat-database-schema.md)
