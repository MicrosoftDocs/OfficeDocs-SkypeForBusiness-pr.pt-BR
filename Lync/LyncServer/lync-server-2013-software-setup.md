...
---
# <a name="software-setup-for-lync-server-2013"></a>Configuração de software para o Lync Server 2013
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Solicitar certificados com antecedência (opcional) para o Lync Server 2013](lync-server-2013-request-certificates-in-advance-optional.md)

  - [Configurar o IIS para Lync Server 2013](lync-server-2013-configure-iis.md)

  - [Instalando o Windows PowerShell 3,0 para Lync Server 2013](lync-server-2013-installing-windows-powershell-3-0.md)
