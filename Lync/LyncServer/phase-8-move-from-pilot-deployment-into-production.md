...
# <a name="phase-8-move-from-pilot-deployment-into-production"></a>Fase 8: mover da implantação piloto para produção
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Mover usuários restantes para Lync Server 2013](move-remaining-users-to-lync-server-2013_1.md)

  - [Configurar o gateway do XMPP no Lync Server 2013](configure-xmpp-gateway-on-lync-server-2013_1.md)
