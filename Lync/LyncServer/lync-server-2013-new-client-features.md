...
# <a name="new-client-features-in-lync-server-2013"></a>Novos recursos de cliente no Lync Server 2013
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [O que há de novo para dispositivos no Lync Server 2013](lync-server-2013-what-s-new-for-devices.md)
