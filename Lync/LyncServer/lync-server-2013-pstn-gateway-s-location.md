...
Chamadas roteadas por meio de gateways PSTN e PBXs podem exigir restrições de roteamento Location-Based dependendo do local desses sistemas. Location-Based roteamento pode ser habilitado na granularidade por tronco.

Location-Based roteamento introduz o seguinte conjunto de regras quando habilitado em um tronco:

  - Quando Location-Based roteamento é habilitado em uma base por tronco, as regras definidas nesse tronco serão aplicadas apenas às chamadas encaminhadas através desse tronco.
