...
# <a name="backup-and-high-availability-cmdlets-in-lync-server-2013"></a>Cmdlets de backup e alta disponibilidade no Lync Server 2013
...
Os cmdlets de backup e de alta disponibilidade permitem que os administradores gerenciem os recursos de backup, restauração e alta disponibilidade do pool introduzidos no Microsoft Lync Server 2013.

<div>

## <a name="backup-and-high-availability-cmdlets"></a>Cmdlets de backup e alta disponibilidade

Veja a seguir uma lista de cmdlets relacionados diretamente ao backup e à configuração da disponibilidade da sua topologia do Lync Server:
