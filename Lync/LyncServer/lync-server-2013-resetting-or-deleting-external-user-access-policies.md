...
description: 'Lync Server 2013: Redefinindo ou excluindo políticas de acesso de usuário externo.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48577817"
---
# <a name="resetting-or-deleting-external-user-access-policies-in-lync-server-2013"></a>Redefinindo ou excluindo políticas de acesso de usuário externo no Lync Server 2013
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Excluir uma política de site ou de usuário para acesso de usuário externo no Lync Server 2013](lync-server-2013-delete-a-site-or-user-policy-for-external-user-access.md)
