...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dn720922(v=OCS.15)
ms:contentKeyID: 62240143
ms.date: 05/19/2016
...
We recommend conducting this validation daily by using the Painel de Controle do Lync Server, starting with developing a robust set of test cases against the current set of normalization rules that were published in the Lync Server global settings. These test cases should be run daily to highlight any unwanted changes that were made and committed to the dial plan.

Painel de Controle do Lync Server also helps you visualize, test, change, archive, and share configuration information about voice routing and in changing Enterprise Voice number normalization rules, dial plans, voice policy, and routes. It has additional features for doing the following:
  ...
  - More information about voice routing tests can be found at [Testar roteamento de voz no Lync Server 2013](lync-server-2013-test-voice-routing.md)
