...
Trabalhando com um [parceiro da Microsoft](https://partnercenter.microsoft.com/en-us/pcv/search), você pode se conectar a uma variedade de aplicativos do Office 365 incluindo Skype para Business Online na nuvem para sua rede e voz em tempo real e recursos de comunicação de vídeo para Skype para negócios exigem rede serviços devem ser configurados especificamente para oferecer suporte a essas cargas de trabalho do Office 365 em tempo real. Isso inclui uma rede que tenha a largura de banda suficiente para executar o volume de tráfego necessário e ser capaz de suportar o Quality of Service (QoS) para proporcionar uma experiência de classe de negócios para seus usuários.
...
Skype para áudio de negócios deve ser implantado no EF (Expedited Forwarding - DSCP 46) Skype para vídeo de negócios e a fila devem ser implantado no AF41 (Assured Forwarding - DSCP 34) fila. Isso é verdadeiro mesmo para tráfego de ponto a ponto e conferências, independentemente se o sistema telefônico no Office 365 ou outros recursos de telefonia estão sendo implantados.
...
Em uma sessão de mídia em tempo real, os dispositivos de mídia que são usados por todos os participantes, como headsets e webcams tem um grande impacto na qualidade de vídeo e áudio geral. Dispositivos de qualidade inferior ou dispositivos com drivers de dispositivo incorreto causarão qualidade geral som inferior para qualidade de imagem de áudio e mais baixa para vídeo. Certificado para dispositivos ou boa qualidade dispositivos, por outro lado, ajudar com cancelamento de eco, a filtragem de ruído, a resolução de vídeo e reduzir a latência.
