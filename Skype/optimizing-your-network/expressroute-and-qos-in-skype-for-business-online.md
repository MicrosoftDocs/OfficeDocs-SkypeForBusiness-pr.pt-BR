...
> [!NOTE]
> Uma nova versão da Calculadora de largura de banda está disponível: [Skype para os negócios, Calculadora de largura de banda](https://go.microsoft.com/fwlink/?LinkId=715766). Contudo, as instruções neste documento usam o Lync 2010 e 2013 Calculadora de largura de banda. 
...
- Os switches de rede e roteadores também devem usar fontes de alimentação ininterruptas (UPS) para continuar em funcionamento durante uma falta de energia.
    ...
    Elas têm um conexões Wi-Fi que seus escritórios de LAN, portanto, é altamente recomendável que usarem um certificado Skype para parceiro de infra-estrutura de negócios Wi-Fi do [Skype para soluções de negócios](https://go.microsoft.com/fwlink/?LinkId=690281).
...
Para atribuição baseada em ACL de rede, as marcas de prioridade DSCP são implementadas em um roteador de fluxo contrário e baseiam-se à porta de origem UDP. Os intervalos de porta recomendada para cada aplicativo são listados na seção 2.6.1.1 de [Planejamento de rede, monitoramento e solução de problemas com o Lync Server](https://go.microsoft.com/fwlink/?LinkId=690286). É importante que você coordene isso com a implementação de QoS e design geral do Dewey lei LLC e estar ciente diferentes políticas de QoS e o potencial de marcação incompatibilidades de pacotes.
...
Para implementar o QoS em toda sua empresa, rede, os pontos de extremidade ou roteadores deve marcar cada pacote com o indicador de prioridade de camada 3 apropriado (ou seja, DSCP). Ao longo do caminho de rede inteira, cada opção e o roteador devem ter a opção de QoS ativada. O QoS marcações nos pacotes de voz ou vídeo passem por esse comutador ou roteador poderia ser tendo o mesmo somente um comutador de rede ou roteador, que não tem o QoS ativado, retirado. Desativa efetivamente QoS em todos os comutadores downstream e roteadores que diminui o valor de ter ExpressRoute.
...
> [!TIP]
>  Para obter detalhes específicos sobre a configuração de QoS, consulte 2,6 seção [Planejamento de rede, monitoramento e solução de problemas com o Lync Server]( https://go.microsoft.com/fwlink/?LinkId=760669). Você também pode ver a [planejar os requisitos de rede de Skype para negócios 2015](https://go.microsoft.com/fwlink/?LinkId=690287) para planejamento de requisitos de rede mais.
 ...
 **Largura de banda agregada por site por classe de tráfego de QoS - ('' Sites planilha - colunas A e ML através de MR)**
...
|**Site**|**Largura de banda de pico de SIP/IM**|**Largura de banda de conferência de áudio de pico**|**Largura de banda de conferência de vídeo de pico**|**Largura de banda de pico para compartilhamento de WAN**|**Largura de banda de pico de WAN para chamadas PSTN**|**Total de ExpressRoute<br/>tráfego por classe de site<br/>(ou seja, total<br/># dos sites de tempo)**|
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
 ...
 **Padrão IEEE 802.11 e / mapeamento de multimídia (WMM Wi-Fi) para 802.1 P**
...
É importante observar que há uma incompatibilidade na codificação para IEEE 802.1p e WMM prioridade. O 802.1p o PCP valor para voz é de 5, no entanto, o mapeamento padrão equivalência WMM, PCP 5 é convertido no Access categoria 2, a categoria de acesso WMM para vídeo (AC_VI). Se possível você deve substituir esse mapeamento para que 5 PCP converte para Access categoria 1 ou simplesmente evitar usar voz e vídeo na mesma rede Wi-Fi, até que o Wi-Fi Alliance corrige esse problema. Para obter informações adicionais sobre Wi-Fi, consulte [Wi-Fi itens de catálogo]( https://go.microsoft.com/fwlink/?LinkId=690322).
...
Oferecendo consistentemente voz em tempo real do nível de negócios e serviços de vídeos requer uma infraestrutura de rede de ponta a ponta que é capaz de fornecer a QoS. Que incluiria LAN e os serviços WAN. A Microsoft fornece ferramentas como o [Lync 2010 e 2013 Calculadora de largura de banda](https://go.microsoft.com/fwlink/?LinkID=690282) para estimar a capacidade de rede que você irá precisar para os vários serviços. Além disso, há parceiros no programa de ferramentas de profissionais de TI [Skype para soluções de negócios: ferramentas de profissionais de TI](https://go.microsoft.com/fwlink/?LinkID=690307) que oferecem ferramentas previamente avaliar a infraestrutura de rede e suporte a monitoramento, relatórios e solução de problemas. Sem uma infra-estrutura de rede corretamente dimensionada e configurado, você correrá o risco de ter um Skype ExpressRoute da implantação de negócios que não atenda às expectativas do seu usuário de qualidade e consistência.
