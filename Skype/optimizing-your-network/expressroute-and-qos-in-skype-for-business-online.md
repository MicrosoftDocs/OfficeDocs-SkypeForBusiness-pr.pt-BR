...
> [!NOTE]
> Há uma nova versão da calculadora de largura de banda disponível em [Skype for Business, Calculadora de largura de banda](http://go.microsoft.com/fwlink/?LinkId=715766). No entanto, as orientações deste documento usam a Calculadora de largura de banda para Lync 2010 e 2013. 
...
- [Preços do ExpressRoute](http://go.microsoft.com/fwlink/?LinkId=690284)
    
- [Documentação do ExpressRoute](http://go.microsoft.com/fwlink/?LinkId=690285)
...
|Assistentes jurídicos  <br/> |4:00  <br/> |125  <br/> |30  <br/> |15%  <br/> |
...
- Os switches de rede e roteadores também devem usar fontes de alimentação ininterruptas (UPS) para continuar em funcionamento durante uma falta de energia.
    ...
    Eles têm conexões Wi-Fi com os escritórios na LAN, portanto, é altamente recomendável usar um parceiro de infraestrutura de Wi-Fi certificado do Skype for Business das [Soluções do Skype for Business](http://go.microsoft.com/fwlink/?LinkId=690281)
    
    > [!TIP]
    > Recomentamos pontos de acesso sem fio 802.11n e 802.11ac. 
...
> [!TIP]
> Qualquer tráfego enviado pela classe de serviço de voz que ultrapasse a quantidade fornecida pelo provedor de serviços será descartado imediatamente, o que afetará diretamente a qualidade de voz. 
...
> [!TIP]
> Para ver detalhes específicos sobre a configuração de QoS, consulte a Seção 2.6 [Planejamento de Rede, Monitoramento e Solução de Problemas do Lync Server]( http://go.microsoft.com/fwlink/?LinkId=760669). Você também pode consultar [Planejar os requisitos de rede para o Skype for Business 2015](http://go.microsoft.com/fwlink/?LinkId=690287) para ver mais requisitos do planejamento de rede.
...
|**Pessoal**|**Mensagens Instantâneas/Presença**|**Áudio P2P**|**Vídeo P2P**|**Áudio da conferência**|**Vídeo da conferência**|**Compartilhamento da área de trabalho**|**Áudio da conferência discada**|**Lync 2010 RTV_Type**|**Usuários remotos**|**Lync 2013 áudio estéreo**|**Lync 2013 qualidade de vídeo**|**Lync 2013 comportamento dos usuários para janela de vídeo P2P**|**Lync 2013 Uso de Multi-view**|
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
> [!TIP]
> A planilha completa também inclui o número máximo de sessões simultâneas para cada aplicativo, mas excluímos essas colunas para economizar espaço. 
...
|Escritórios regionais  <br/> |3:45  <br/> |3  <br/> |Executivos/Parceiros  <br/> |60  <br/> |Associados/Assistentes jurídicos  <br/> |225  <br/> |Administradores de TI  <br/> |60  <br/> |
...
|Filiais pequenas  <br/> |36  <br/> |50  <br/> |Executivos/Parceiros  <br/> |6  <br/> |Associados/Assistentes jurídicos  <br/> |2,5  <br/> |Administradores de TI  <br/> |1  <br/> |
   
 **Largura de banda necessária por aplicativo por local, em Kbps (Planilha "Locais": Colunas A e BQ até LF)**
  
|**Site**|**Largura de banda de pico de SIP/IM**|**Largura de banda de pico para áudio de par entre sites**|**Largura de banda de pico para vídeo de par entre sites**|**Largura de banda de pico para audioconferências**|**Largura de banda de pico para videoconferências**|**Largura de banda de pico para compartilhamento de WAN**|**Largura de banda de pico de WAN para chamadas PSTN**|
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|Sede  <br/> |1070  <br/> |525,30  <br/> |560,00  <br/> |739,50  <br/> |2640,00  <br/> |4224,00  <br/> |2688,30  <br/> |
|Escritórios regionais  <br/> |3:45  <br/> |185,40  <br/> |560,00  <br/> |255,00  <br/> |1320,00  <br/> |1536,00  <br/> |896,10  <br/> |
...
> [!TIP]
> Novamente, embora a classe de serviço EF ofereça a melhor garantia de desempenho, se você exceder a largura de banda definida os pacotes adicionais serão descartados imediatamente. 
  
 **Largura de banda agregada por local por classe de tráfego de QoS (Planilha "Locais": Colunas A e ML até MR) **
...
|**Site**|**Largura de banda de pico de SIP/IM**|**Largura de banda de pico para audioconferências**|**Largura de banda de pico para videoconferências**|**Largura de banda de pico para compartilhamento de WAN**|**Largura de banda de pico de WAN para chamadas PSTN**|**Total de tráfego ExpressRoute por classe de site (ou seja, tempo total # de sites)**|
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|**Sede** <br/> |1.070  <br/> |739,50  <br/> |2640,00  <br/> |4224,00  <br/> |2688,30  <br/> |11361,80  <br/> |
|**Escritórios regionais** <br/> |3:45  <br/> |255,00  <br/> |1320,00  <br/> |1536,00  <br/> |896,10  <br/> |8704,20  <br/> |
...
> [!TIP]
> Testes de estresse são altamente recomendáveis ao realizar uma pré-avaliação da rede. 
 ...
 ** Mapeamento de IEEE 802.11e/Wi-Fi multimídia (WMM) para 802.1P**
...
É importante observar que há uma incompatibilidade entre a codificação de prioridade do IEEE 802.1p e WMM. No 802.1p, o valor de PCP para voz é 5. No entanto, no mapeamento de equivalência padrão para WMM, o PCP 5 é traduzido para Categoria de acesso 2, a categoria de acesso de WMM para vídeo (AC_VI). Se possível, você deve substituir esse mapeamento para que o PCP 5 seja convertido em Categoria de acesso 1, ou simplesmente evitar usar voz e vídeo na mesma rede Wi-Fi até que o Wi-Fi Alliance resolva esse problema. Para obter informações adicionais sobre Wi-Fi, consulte [Itens do catálogo Wi-Fi]( http://go.microsoft.com/fwlink/?LinkId=690322)
...
Oferecer serviços de voz e vídeo em tempo real com nível empresarial de forma consistente exige uma infraestrutura de rede completa capaz de fornecer QoS. Isso inclui serviços de LAN e WAN. A Microsoft fornece ferramentas como a [Calculadora de largura de banda do Lync 2010 e 2013](http://go.microsoft.com/fwlink/?LinkID=690282) para estimar a capacidade de rede necessária para os vários serviços. Além disso, há os parceiros do programa IT Pro Tools[Soluções do Skype for Business: IT Pro Tools](http://go.microsoft.com/fwlink/?LinkID=690307), que oferecem ferramentas para pré-avaliar a infraestrutura de rede, monitoramento de suporte, geração de relatórios e solução de problemas. Sem uma infraestrutura de rede corretamente dimensionada e configurada, você corre o risco de ter uma implantação do Skype for Business ExpressRoute que não atende às expectativas do usuário em relação a qualidade e consistência.
