...
O novo painel de controle do Office 365 **relatórios** mostra a visão geral de atividade entre os produtos do Office 365 em sua organização. Ele permite analisado relatórios de nível de produto individual para proporcionar mais granular insight sobre as atividades dentro de cada produto. Por exemplo, você pode usar o relatório do **Skype para a atividade do organizador de conferência de negócios** para ver quanto a seus usuários são organizem conferências que utilizam o IM, áudio/vídeo, compartilhamento de aplicativo, Web, de terceiros confiáveis dial-in/out - 3rd e dial-in/out - Microsoft. 
...
Nesse relatório, juntamente com o outro Skype para relatórios de negócios, oferece detalhes sobre a atividade de conferências organizada em toda a organização. Esses detalhes são muito úteis quando você estiver investigando, planejamento e fazendo outras decisões de negócios para sua organização. 
...
***
![Número 1](../images/sfbcallout1.png)<br/>No relatório **Atividade dos organizadores de conferências do Skype for Business**, é possível ver as tendências dos últimos sete, 30, 90 ou 180 dias.
...
*    **Excluído** indica que a licença do usuário foi removida.<br/><br/>
     **Observação:**  Atividade de um usuário excluído ainda será exibida em um relatório, desde que ele foi licenciado em algum momento durante o período de tempo selecionado. A coluna **Deleted** ajuda você a Observe que o usuário pode não estar mais ativo, mas contribuíram para os dados no relatório.<br/> <br/>
