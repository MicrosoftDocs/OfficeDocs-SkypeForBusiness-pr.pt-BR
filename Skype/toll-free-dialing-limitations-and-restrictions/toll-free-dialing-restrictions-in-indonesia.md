...
---
# <a name="toll-free-dialing-restrictions-in-indonesia"></a>Restrições de discagem gratuita da Indonésia
...
|Discagem format(s)  <br/> | 001 803 XXXX DE CCC <br/>  007 803 XXXX DE CCC <br/> |
...
|Disponibilidade de rede móvel  <br/> |Parcial. Veja os comentários.  <br/> |
|Comentários, restrições e problemas de acesso  <br/> |Dois formatos de número são fornecidos para cobertura maior. O formato de número XXXX CCC de 007 803 do formato é acessível a partir da rede PT Telkom, incluindo Telkomsel e XL móvel. O formato de número 001 803 XXXX de CCC é acessível a partir da rede Indosat. Para dispositivos móveis: matriz celular (prefixo 0855, 0858, 0815 e 0816) somente.  <br/> |
