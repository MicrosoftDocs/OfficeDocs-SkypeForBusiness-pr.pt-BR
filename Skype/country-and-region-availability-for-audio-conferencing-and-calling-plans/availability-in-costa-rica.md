...
---
# <a name="availability-in-costa-rica"></a>Disponibilidade na Costa Rica

[Encontre outro país ou região](country-and-region-availability-for-audio-conferencing-and-calling-plans.md), ou aprender mais sobre disponibilidade país e região para conferência de áudio e chamar plans.for audioconferências e chamar planos.

Aqui estão os serviços do Office 365 para Skype para Teams da Microsoft e de negócios disponíveis para Costa Rica.
...
|Números de telefone são automaticamente atribuídos para conferência de áudio?  <br/> |Números de telefone não são vinculados a uma cidade ou local específico.  <br/> Se desejar que os números de telefone dedicados, consulte [Getting números de telefone de serviço para Skype para equipes da Microsoft e de negócios](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Quais letras maiusculas ou principais cidades você consegue números tarifados para?  <br/> |Números de telefone não são vinculados a uma cidade ou local específico.  <br/> |
|Números tarifados estão disponíveis?  <br/> |Sim  <br/> |
|Números para ligações gratuitas estão disponíveis?  <br/> |Não  <br/> |
