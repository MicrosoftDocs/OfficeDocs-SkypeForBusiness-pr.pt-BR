...
|Números de telefone são automaticamente atribuídos para conferência de áudio?  <br/> |Sim, para Bruxelas. Se desejar que os números de telefone dedicados, consulte [Getting números de telefone de serviço para Skype para equipes da Microsoft e de negócios](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
|Recurso de discagem usando a chamada Me de recurso  <br/> |Disponível  <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Planos de chamada estão disponíveis para comprar?  <br/> |Sim  <br/> |
|Minutos disponíveis para planos de chamada  <br/> |1200 minutos de chamadas domésticas ou 600 minutos de chamadas internacionais (o limite que for atingido primeiro).  <br/> |
|Pode fazer chamadas de saída para?  <br/> | Para 196 países, incluindo [esses](users-can-make-outbound-calls-to-these-countries-and-regions.md).  <br/> |
   
## <a name="toll-and-toll-free-numbers-for-services"></a>Chamada Tarifada e números de discagem gratuita para os serviços

|**Recurso**|**Detalhes**|
|:-----|:-----|
|Quais letras maiusculas ou principais cidades você consegue números tarifados para?  <br/> | Bruges <br/>  Bruxelas <br/>  Charleroi <br/>  Ghent <br/>  Liège <br/>  Namur <br/> |
|Números tarifados estão disponíveis?  <br/> |Sim  <br/> |
|Números para ligações gratuitas estão disponíveis?  <br/> |Sim  <br/> |
   
 Se você deseja obter Chamada Tarifada e números de telefone gratuitos de conferência de áudio, atendedor automático e filas de chamada, consulte [Getting números de telefone de serviço para Skype para equipes da Microsoft e de negócios](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).
