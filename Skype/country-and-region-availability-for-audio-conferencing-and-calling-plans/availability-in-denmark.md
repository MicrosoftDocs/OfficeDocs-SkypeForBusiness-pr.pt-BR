...
Aqui estão os serviços do Office 365 para Skype para Teams da Microsoft e de negócios disponíveis para Dinamarca.
...
|Números de telefone são automaticamente atribuídos para conferência de áudio?  <br/> |Sim, para Copenhague. Se desejar que os números de telefone dedicados, consulte [Getting números de telefone de serviço para Skype para equipes da Microsoft e de negócios](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Quais letras maiusculas ou principais cidades você consegue números tarifados para?  <br/> |Copenhague  <br/> |
