...
---
# <a name="availability-in-georgia"></a>Disponibilidade em Geórgia
...
Aqui estão os serviços do Office 365 para Skype para Teams da Microsoft e de negócios disponíveis para Geórgia.
  
## <a name="audio-conferencing"></a>Audioconferência

|**Recurso**|**Detalhes**|
|:-----|:-----|
|Conferência de áudio está disponível para compra?  <br/> |Não  <br/> |
|Números de telefone são automaticamente atribuídos para conferência de áudio?  <br/> |Sim, para Tbilisi. Se desejar que os números de telefone dedicados, consulte [Getting números de telefone de serviço para Skype para equipes da Microsoft e de negócios](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Quais letras maiusculas ou principais cidades você consegue números tarifados para?  <br/> |Tbilisi  <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Comunicações créditos estão disponíveis?  <br/> |Não  <br/> |
