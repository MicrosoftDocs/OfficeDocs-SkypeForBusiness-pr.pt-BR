...
Cada Servidor front-end executando a Atualização Cumulativa 2 (CU2) do Skype for Business Server 2015 ou posterior suporta até 375 participantes para compartilhamento de tela usando RDP (embora apenas 250 por reunião). Essa capacidade não muda após a CU3, quando o VbSS é introduzido e usado.
...
- Se alguém que usa uma versão mais antiga do cliente do Skype for Business ingressar em sua sessão, por exemplo, qualquer pessoa que use qualquer versão de cliente do Windows que seja inferior a 16.0.6330.1000, Dispositivos de Sistema do Skype for Business Room ou Skype for Business Mobile Apps. 
...
> [!NOTE]
> Não há suporte para bloquear ou tentar bloquear a transição do VbSS para o RDP no Skype for Business compartilhamento de tela. 
...
- Você pode atribuir uma política de usuário que não permita o VbSS a quaisquer usuários que não devem usar o VbSS executando esse cmdlet no Console de Gerenciamento do Skype for Business (substitua [PolicyName] pela política pela que você está fazendo isso):
...
> [!NOTE]
> Em uma reunião multipartidária do Skype for Business, todos os pontos de extremidade do cliente respeitarão a configuração de política para o organizador da reunião. 
  
### <a name="how-to-enable-users-to-use-vbss"></a>Como permitir que os usuários usem o VbSS

- Você pode atribuir uma política de usuário específica que permita o VbSS a todos os usuários que precisem usar o VbSS executando esse cmdlet no Console de Gerenciamento do Skype for Business (substitua [PolicyName] pela política pela que você está fazendo isso):
...
> [!NOTE]
> Em uma reunião multi-party do Skype for Business, todos os pontos de extremidade do cliente respeitarão a configuração de política para o organizador da reunião. 
  
## <a name="see-also"></a>Confira também

[Atualização cumulativa do Skype for Business Server 2015 KB3061064](https://www.microsoft.com/download/details.aspx?id=47690)
