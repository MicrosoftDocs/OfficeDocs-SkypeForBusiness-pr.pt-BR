...
O Relatório de Resumo de Conferências não apenas informa quantas conferências foram realizadas durante um determinado período de tempo (por hora, diariamente, semanalmente, mensalmente), mas também informa o número total de pessoas que participaram dessas conferências e o número total de organizadores exclusivos da conferência.
...
Os valores totais da maioria das métricas usadas no Relatório de Resumo de Conferências podem ser encontrados na parte inferior do relatório; role para baixo para ver valores como o número total de conferências realizadas durante o período de tempo especificado e o número total de pessoas que participaram dessas conferências. Uma métrica que não é totalada na parte inferior do relatório é Total de organizadores exclusivos da conferência. Por que não? Aqui está um motivo. Suponha que você está analisando dados de um mês. No dia 1, você tinha 34 organizadores de conferência exclusivos; no dia 2, você tinha 27 organizadores de conferência exclusivos. Isso significa que você tinha 61 organizadores de conferência exclusivos nesses dois dias? Não necessariamente. Afinal, todas as 27 pessoas que organizaram conferências no dia 2 podem estar entre as 34 pessoas que organizaram conferências no dia 1. Por exemplo, neste relatório simples, observe que Ken Myer e Pilar Ackerman agendam conferências em 7/7/2015 e em 02/07/2015:
