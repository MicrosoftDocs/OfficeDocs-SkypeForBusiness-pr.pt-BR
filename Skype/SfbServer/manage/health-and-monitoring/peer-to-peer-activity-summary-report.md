...
- Algum dos meus usuários está realmente aproveitando os recursos de transferência de arquivos e compartilhamento de aplicativos do Skype for Business Server?
...
O Relatório de Resumo de Atividade Ponto a Ponto é acessado a partir da página inicial de Relatórios de Monitoramento. Abra o Relatório de Mensagens [IM](im-report.md) Ponto a Ponto no Skype for Business Server clicando em uma das seguintes métricas:
