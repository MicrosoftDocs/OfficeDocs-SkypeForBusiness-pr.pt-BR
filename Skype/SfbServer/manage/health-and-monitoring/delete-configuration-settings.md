...
---
# <a name="delete-an-existing-collection-of-cdr-configuration-settings-in-skype-for-business-server"></a>Excluir uma coleção existente de configurações de CDR no Skype for Business Server
...
Você pode remover as configurações de CDR usando o Painel de Controle do Skype for Business Server ou o cmdlet [Remove-CsCdrConfiguration.](/powershell/module/skype/remove-cscdrconfiguration?view=skype-ps)
  
### <a name="to-remove-cdr-configuration-settings-with-skype-for-business-server-control-panel"></a>Para remover as configurações de CDR com o Painel de Controle do Skype for Business Server
...
3. Clique **em Editar** e, em seguida, clique em **Excluir**.
