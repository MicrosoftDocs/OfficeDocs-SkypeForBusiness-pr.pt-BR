...
---
# <a name="monitor-for-server-memory-capacity-limits-in-skype-for-business-server-2015"></a>Monitorar os limites de capacidade da memória do servidor no Skype for Business Server 2015
 
**Resumo:** Saiba como para o monitoramento de limites de capacidade de memória do servidor no Skype para Business Server 2015.
...
Dois contadores de desempenho de mobilidade podem ajudá-lo a determinar seu uso atual e ajudar no planejamento de capacidade para o Skype para Business Server 2015 Mobility Service (Mcx), bem como para monitorar o uso de memória para UCWA. Para UCWA, a categoria do contador é **LS:WEB - UCWA**. Para o Serviço de mobilidade (Mcx), os contadores estão sob a categoria **LS:WEB - Mobile Communication Service**. Os contadores para monitoramento são:
