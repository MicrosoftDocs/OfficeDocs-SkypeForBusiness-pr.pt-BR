---
title: Relatórios de diagnóstico de chamada (por usuário) no Skype for Business Server
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
manager: serdars
...
description: 'Resumo: Saiba mais sobre os relatórios de diagnóstico de chamada por usuário usados no Skype for Business Server.'
ms.openlocfilehash: 2361d25b69d92682336e7e2d5320a32974d62b80
ms.sourcegitcommit: ab47ff88f51a96aaf8bc99a6303e114d41ca5c2f
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 05/20/2019
ms.locfileid: "34289354"
---
# <a name="call-diagnostic-reports-per-user-in-skype-for-business-server"></a>Relatórios de diagnóstico de chamada (por usuário) no Skype for Business Server
  
Os Relatórios de Diagnóstico de Chamada oferecem informações por usuário sobre falhas em sessões ponto a ponto e de conferência. No momento, há apenas um relatório, o **relatório de atividade do usuário**.
