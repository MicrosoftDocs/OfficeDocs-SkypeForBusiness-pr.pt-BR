...
No Relatório de Distribuição de Falhas, você pode clicar em qualquer uma das seguintes métricas para exibir o Relatório de Lista de Falhas [em Skype for Business Server](failure-list-report.md):
