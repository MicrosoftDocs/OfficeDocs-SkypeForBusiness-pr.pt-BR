...
- Chamadas Ponto a Ponto de UC (como uma chamada do Skype for Business para o Skype for Business)
...
O Relatório de resumo de qualidade de mídia é acessado a partir da página inicial dos Relatórios de Monitoramento. Você pode detalhar o [Relatório de Lista de Chamadas no Skype for Business Server](call-list-report-0.md) clicando em uma das seguintes métricas:
