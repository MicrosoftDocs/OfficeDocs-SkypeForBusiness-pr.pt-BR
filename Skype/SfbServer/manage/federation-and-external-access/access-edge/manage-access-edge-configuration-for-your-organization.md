...
**Exibindo informações de configuração de Borda de Acesso usando Windows PowerShell cmdlets**
  ...
  - As informações de configuração de Borda de Acesso podem ser exibidas usando Windows PowerShell e o cmdlet **Get-CsAccessEdgeConfiguration**. Esse cmdlet pode ser executado no Shell de Gerenciamento Skype for Business Server ou em uma sessão remota de Windows PowerShell. 
