...
- Implantando Skype for Business Server em sua organização (conhecidos como serviços *locais)* e configurando Skype for Business de usuário em sua organização.
...
1. Em um Servidor front-end, inicie o shell de gerenciamento Skype for Business Server: clique em **Iniciar,** clique em Todos os **Programas,** clique Skype for Business Server **e** clique em Skype for Business Server Shell **de Gerenciamento.**
