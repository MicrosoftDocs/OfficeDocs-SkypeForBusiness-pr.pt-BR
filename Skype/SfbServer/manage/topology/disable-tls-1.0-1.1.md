...
A Microsoft produziu um white paper no TLS disponível [aqui e também](https://cloudblogs.microsoft.com/microsoftsecure/2017/06/20/tls-1-2-support-at-microsoft/) recomendamos a leitura em segundo plano disponível [neste blog Exchange.](https://blogs.technet.microsoft.com/exchange/2018/01/26/exchange-server-tls-guidance-part-1-getting-ready-for-tls-1-2/)
...
- Atualização in-loco Skype for Business Server 2015, com CU9 6.0.9319.548 (maio de 2019) ou superior no Windows Server 2008 R2, 2012 (com KB [3140245](https://support.microsoft.com/help/3140245/update-to-enable-tls-1-1-and-tls-1-2-as-a-default-secure-protocols-in) ou atualização de sobressução) ou 2012 R2.
...
- Skype for Business 2016 Clique para Executar Exigir as Atualizações de abril de [2018](/officeupdates/release-notes-office365-proplus): 
    ...
    - Semi-Annual e Canal Adiado, 16084312242\.\.\. ou superior
...
- Skype Web App 2015 CU6 HF2 ou superior (vem com o Server)
...
Infelizmente, Windows Fabric 1.0 **não dá suporte ao TLS 1.2.  No entanto, atualizaremos o Lync Server 2013 para trabalhar com o TLS 1.2**. Isso estará chegando na próxima Atualização Cumulativa do Lync Server 2013.  Estamos fornecendo suporte ao TLS 1.2 para habilitar cenários de co-existência, migração, federação e híbridos.
...
Skype for Business Online é capaz de TLS 1.2 hoje, portanto, não é esperado impacto para Híbrido/Federação com Online.

PIC (Conectividade de IM Pública) para Skype Consumidor: não esperamos desabilitar o TLS 1.0/1.1 para afetar Skype [Conectividade;](../../deploy/deploy-skype-connectivity.md) Os Gateways PIC da Microsoft já são TLS 1.2 capazes.
...
5. Atualize o Driver ODBC 11 para SQL Server incluir suporte para TLS 1.2 (KB [3135244](https://support.microsoft.com/help/3135244/tls-1-2-support-for-microsoft-sql-server)).
...
Antes de prosseguir com as próximas etapas, certifique-se de ter concluído todos os *pré-requisitos* e atualizados Skype for Business Servidores.
