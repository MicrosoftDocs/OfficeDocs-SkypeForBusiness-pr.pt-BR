...
1. Abra o Painel de Controle do Servidor do Skype for Busines.
...
Depois de configurar o tronco, continue configurando o bypass de mídia escolhendo entre opções globais de bypass de mídia, conforme descrito em [Deploy media bypass in Skype for Business Server](../../deploy/deploy-enterprise-voice/deploy-media-bypass.md).