...
## <a name="view-the-status-of-services-running-on-a-skype-for-business-server"></a>Exibir o status dos serviços executados em um Skype para Business server
