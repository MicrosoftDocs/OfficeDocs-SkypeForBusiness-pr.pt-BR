...
**Resumo:** Use os procedimentos a seguir para gerenciar Skype para autenticação e segurança do servidor de negócios.
  
Use os procedimentos a seguir para gerenciar Skype para autenticação e segurança do servidor de negócios.
...
- [Gerenciar definições de configuração do serviço Web no Skype para Business Server](web-service-configuration-settings.md)
    
- [Gerenciar configurações de PIN no Skype para Business Server](pin-settings.md)
