...
---
# <a name="create-a-new-pin-policy-in-skype-for-business-server-2015"></a>Criar uma nova política de PIN no Skype for Business Server 2015
 
**Resumo:** Crie uma nova política PIN no Skype para Business Server 2015.
