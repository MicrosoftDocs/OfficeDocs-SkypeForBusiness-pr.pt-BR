---
title: Atribuir um certificado de autenticação de servidor para servidor para Skype for Business Server
ms.reviewer: ''
ms.author: serdars
author: SerdarSoysal
manager: serdars
