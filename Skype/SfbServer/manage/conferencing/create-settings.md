...
---
# <a name="create-meeting-configuration-settings-in-skype-for-business-server-2015"></a>Criar definições de configuração de reunião no Skype for Business Server 2015
 
**Resumo:** Saiba como criar configurações de reunião no Skype para Business Server 2015.
