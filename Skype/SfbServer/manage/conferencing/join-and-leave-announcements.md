...
---
# <a name="manage-conference-join-and-leave-announcements-in-skype-for-business-server"></a>Gerenciar comunicados de saída e ingressar em conferência no Skype for Business Server
 
**Resumo:** Saiba como gerenciar comunicados de saída e ingressar em conferência no Skype for Business Server.
...
Este cmdlet recupera informações sobre se os participantes precisam registrar seus nomes ao ingressar em uma conferência e como o Skype for Business Server responde quando os participantes in unem ou saem de uma conferência discada.
...
Para obter mais informações, incluindo sintaxe e uma lista completa de parâmetros, consulte [Set-CsDialInConferencingConfiguration](https://docs.microsoft.com/powershell/module/skype/set-csdialinconferencingconfiguration?view=skype-ps).
