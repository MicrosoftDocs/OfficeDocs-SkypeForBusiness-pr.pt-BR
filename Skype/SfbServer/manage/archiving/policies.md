...
**Resumo:** Saiba como gerenciar políticas de usuário para arquivamento do Skype for Business Server.
...
As políticas de arquivamento podem ser definidas no nível global, de site ou de usuário.
...
Você também pode configurar políticas de arquivamento usando os cmdlets do Windows PowerShell listados na tabela a seguir. Para obter detalhes sobre sintaxe, incluindo todos os parâmetros disponíveis, consulte [Skype for Business Server Management Shell](../management-shell.md).
