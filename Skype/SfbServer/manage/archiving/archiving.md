...
Essas opções podem ser definidas no nível global, do site ou do pool. Para obter mais informações, consulte [Gerenciar opções de](options.md)arquivamento em Skype for Business Server .
...
Essas políticas podem ser definidas no nível global, do site ou do usuário. Para obter mais informações, consulte [Gerenciar políticas de](policies.md)arquivamento em Skype for Business Server .
