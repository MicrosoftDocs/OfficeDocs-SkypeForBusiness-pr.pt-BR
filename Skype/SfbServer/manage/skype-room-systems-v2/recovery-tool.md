...
5. Instale quaisquer atualizações adicionais disponíveis do Windows Update.
...
3. Execute o comando Powershell.exe `-file "<path to RecoveryTool.ps1>" -ExecutionPolicy Unrestricted`.
