...
|**RelativeOneWayGapDuration** <br/> |flutuação  <br/> ||Duração total de intervalos unidirecionais. Uma transmissão "intersvante" é uma transmissão em que os fluxos de dados são imprevisiveis em oposição a um fluxo contínuo; as lacunas indicam atrasos entre essas falhas. Esta medida avalia o fluxo de dados entre o cliente e o servidor.  <br/> |
