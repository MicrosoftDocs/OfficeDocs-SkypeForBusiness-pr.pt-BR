...
|**CallerUserAgent** <br/> |bit  <br/> |Externo  <br/> |Agente do usuário do chamador. Referenciado na [tabela UserAgent](useragent.md).  <br/> |
|**CallPriority** <br/> |smallint  <br/> ||A prioridade dessa chamada.  <br/> |
|**ClassifiedPoorCall** <br/> |bit  <br/> ||Essa coluna foi preterida e não é usada no Skype for Business Server. Em vez disso, essas informações são relatadas em uma base de linha por mídia. Consulte a tabela [MediaLine para](medialine-0.md) obter mais informações. <br/> |
