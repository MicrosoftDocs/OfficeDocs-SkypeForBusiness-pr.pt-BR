...
|**BurstDensity** <br/> |decimal(9,4)  <br/> | <br/> |Densidade média de perda de pacote durante os estouros de perdas durante a chamada.  <br/> |
...
|**AudioPayloadDescription** <br/> |int  <br/> |Externo  <br/> |O Codec de áudio usado para a chamada, referenciado na Tabela PayloadDescription.  <br/> |
|**AudioSampleRate** <br/> |int  <br/> | <br/> |Taxa de amostragem para o fluxo de áudio.  <br/> |
|**RoundTrip** <br/> |int  <br/> | <br/> |Tempo de ida e volta de estatísticas RTCP. Para uma qualidade aceitável, deve ser inferior a 100 ms.  <br/> |
...
|**OverallMinNetworkMOS** <br/> |decimal(3,2)  <br/> | <br/> |A MOS de rede de banda larga mínima para a chamada.  <br/> |
|**SendListenMOS** <br/> |decimal(3,2)  <br/> | <br/> |A pontuação média prevista de MOS de escuta de banda larga para áudio enviado, incluindo nível de fala, nível de ruído e características do dispositivo de captura.  <br/> |
|**SendListenMOSMin** <br/> |decimal(3,2)  <br/> | <br/> |O SendListenMOS mínimo para a chamada.  <br/> |
...
|**ConcealRatioMax** <br/> |flutuação  <br/> ||Taxa máxima de pacotes ocultados pela correção.  <br/> Esta coluna foi introduzida no Microsoft Lync Server 2013.  <br/> |
|**ConcealRatiosD** <br/> |flutuação  <br/> ||Desvio padrão da proporção de pacotes ocultados pela correção.  <br/> Esta coluna foi introduzida no Microsoft Lync Server 2013.  <br/> |
|**HealerPacketDropRatio** <br/> |flutuação  <br/> ||Taxa de pacotes descartados pela cura em comparação com o número total de pacotes recebidos.  <br/> Esta coluna foi introduzida no Microsoft Lync Server 2013.  <br/> |
...
|**MaxCompressedSamples** <br/> |flutuação  <br/> ||Número máximo de pacotes de áudio que foram compactados pelo healer.  <br/> Esta coluna foi introduzida no Microsoft Lync Server 2013.  <br/> |
...
|**AudioPostFECPLR** <br/> |flutuação  <br/> ||Taxa de perda de pacote após a aplicação da correção de erro posterior.  <br/> Esta coluna foi introduzida no Microsoft Lync Server 2013.  <br/> |
