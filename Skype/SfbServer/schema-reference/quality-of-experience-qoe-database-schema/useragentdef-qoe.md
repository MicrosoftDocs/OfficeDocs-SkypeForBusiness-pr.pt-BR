...
A tabela UserAgentDef mapeia identificadores de agente do usuário para os nomes descritivos do agente. Os agentes do usuário são clientes de software usados para se conectar ao Skype for Business Server.
