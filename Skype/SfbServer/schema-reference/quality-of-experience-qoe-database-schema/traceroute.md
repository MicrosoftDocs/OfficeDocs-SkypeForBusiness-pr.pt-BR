...
|**IPAddressKey** <br/> |int  <br/> |Externo  <br/> |Identificador exclusivo do endereço IP. As informações de endereço IP são armazenadas na [tabela IPAddress](ipaddress.md).  <br/> |
