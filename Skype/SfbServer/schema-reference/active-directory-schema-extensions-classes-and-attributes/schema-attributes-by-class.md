...
|msRTCSIP-Domain  <br/> |msRTCSIP-padrão  <br/> msRTCSIP-DomainData  <br/> msRTCSIP-DomainName  <br/> |
...
|**Classe**|**Pode conter esta classe**|
|:-----|:-----|
|serviceConnectionPoint  <br/> |msRTCSIP-servidor  <br/> msRTCSIP-PoolService  <br/> msRTCSIP-MCU  <br/> msRTCSIP-MCUFactoryService  <br/> msRTCSIP-WebComponents  <br/> msRTCSIP-WebComponentsService  <br/> msRTCSIP-ApplicationServerService  <br/> msRTCSIP-Service  <br/> objetos msRTCSIP-ConnectionPoint  <br/> msRTCSIP-MediationServer  <br/> msRTCSIP-ApplicationServer  <br/> |
