...
---
# <a name="schema-classes-and-descriptions-in-skype-for-business-server"></a>Classes e descrições de esquema no Skype for Business Server
...
|:-----|:-----|:-----|
|Mail-Recipient  <br/> |Destinatário de email da Unificação de Mensagens (UM) do Exchange.  <br/> |Essa classe auxiliar é compartilhada com a UM do Exchange.  <br/> |
|msRTCSIP-ApplicationContacts  <br/> |Esta classe é um contêiner para vários contatos de aplicativo e não contém atributos próprios.  <br/> |Novidade no Microsoft Office Communications Server 2007 R2.  <br/> |
...
|msRTCSIP-ApplicationServerService  <br/> |Essa classe fornece uma associação de um pool específico para seu serviço de aplicativo.  <br/> |Novo no Communications Server 2007 R2.  <br/> |
|msRTCSIP-ApplicationServerSettings  <br/> |Essa classe auxiliar de msRTCSIP-ApplicationServer contém atributos que representam configurações para instâncias do serviço de aplicativo.  <br/> |Novo no Communications Server 2007 R2.  <br/> |
...
|msRTCSIP-ConnectionPoint  <br/> |Ponto de controle de serviço genérico (SCP) para especificar o computador como um servidor executando o Skype for Business Server.  <br/> |Novo no Lync 2010.  <br/> |
|msRTCSIP-DefaultCWABank  <br/> |Essa classe auxiliar contém as configurações para um banco do Skype for Business Web App.  <br/> |Novo no Communications Server 2007 R2.  <br/> |
...
|msRTCSIP-EnterpriseMCUSettings  <br/> |Esta classe auxiliar de msRTCSIP-MCU contém atributos que representam configurações de servidores de conferência.  <br/> |Novidade no Microsoft Office Communications Server 2007.  <br/> |
...
|msRTCSIP-GlobalContainer  <br/> |Essa classe contém todas as configurações que se aplicam em uma implantação do Skype for Business Server.  <br/> |-  <br/> |
...
|msRTCSIP-LocationContactMapping  <br/> |Essa classe é criada pelo aplicativo Atendente de Conferência e contém atributos usados para categorizar números de telefone de conferência por região.  <br/> |Novo no Communications Server 2007 R2.  <br/> |
...
|msRTCSIP-MonitoringServer  <br/> |Essa classe contém atributos que representam configurações para um único Monitoring Server.  <br/> |Novo no Communications Server 2007 R2.  <br/> |
...
|msRTCSIP-Pools  <br/> |Essa classe contém vários pools do Skype for Business Server e não tem atributos em si.  <br/> |-  <br/> |
...
|msRTCSIP-Server  <br/> |Essa classe representa um único servidor executando o Skype for Business Server.  <br/> |-  <br/> |
...
|msRTCSIP-TrustedService  <br/> |Esta classe é um contêiner que representa um serviço confiável que é roteável usando um URI de operador usuário de encaminhamento global (GRUU). Uma instância dessa classe é criada quando um novo servidor confiável pelo Skype for Business Server é ativado. O servidor confiáve deve ser associado a um domínio Active Directory.  <br/> |Novo no Communications Server 2007.  <br/> |
