...
---
# <a name="list-of-cdr-tables-in-skype-for-business-server-2015"></a>Lista de tabelas de CDR no Skype for Business Server 2015
...
|[Tabela Roles](roles.md) <br/> |Armazena a lista de funções de conferência possíveis (por exemplo, participantes e apresentadores).  <br/> |
...
|[Tabela Devices no Skype for Business Server 2015](devices.md) <br/> |Armazena uma lista de dispositivos, incluindo a versão de hardware, fabricante e endereço MAC.  <br/> |
|[Tabela Dialogs in Skype for Business Server 2015](dialogs.md) <br/> |Armazena informações sobre o ID de Diálogo para cada sessão no banco de dados.  <br/> |
...
|[Tabela Manufacturers no Skype for Business Server 2015](manufacturers.md) <br/> |Armazena uma lista de fabricantes de dispositivos (telefone de mesa).  <br/> |
...
|[Tabela Servers](servers.md) <br/> |Armazena o nome de servidores envolvidos em chamadas.  <br/> |
...
|[Tabela UserAgentDef](useragentdef.md) <br/> |Mapeia identificadores de agente do usuário para os nomes descritivos do agente.  <br/> |
|[Tabela Users](users.md) <br/> |Armazena o os URIs de usuários que tenham participado em sessões gravadas ou arquivadas neste banco de dados.  <br/> |
...
|**Table**|**Descrição**|
|:-----|:-----|
|[Tabela Conferences no Skype for Business Server 2015](conferences.md) <br/> |Armazena informações sobre todas as conferências que foram arquivadas ou que tiveram seus detalhes gravados, incluindo ConferenceUI e hora de início e término.  <br/> |
|[Tabela ConferenceSessionDetails no Skype for Business Server 2015](conferencesessiondetails-0.md) <br/> |Armazena informações sobre todas as sessões de conferência baseada em SIP, incluindo hora de início e término, ID de usuário, código de resposta e ID de diagnóstico para cada sessão.  <br/> |
|[Tabela FocusJoinsAndLeaves no Skype for Business Server 2015](focusjoinsandleaves.md) <br/> |Armazena informações sobre junções e saídas de conferência, incluindo a função e a versão do cliente dos usuários.  <br/> |
...
|**Table**|**Descrição**|
|:-----|:-----|
|[Tabela VoipDetails](voipdetails-0.md) <br/> |Armazena, para cada chamada VoIP/PSTN de duas partes, informações sobre a chamada, tais como ID de telefone do telefone VoIP, gateway usado e qual parte desconectou. Refere-se à [tabela SessionDetails para horários](sessiondetails.md) de início/término de chamada e código de resposta. <br/> |
   
> [!NOTE]
> Se uma parte em uma chamada é um usuário VoIP ou se um Servidor de Mediação esteve envolvido na chamada, um registro será criado nesta tabela. Informações sobre chamadas VoIP/VoIP não envolvendo um telefone PSTN (rede telefônica pública comutado) são capturadas na tabela [SessionDetails](sessiondetails.md). 
  
## <a name="table-for-e9-1-1-call-auditing"></a>Tabela para Auditoria de Chamada E9-1-1

|**Table**|**Descrição**|
|:-----|:-----|
|[Tabela Locais no Skype for Business Server 2015](locations.md) <br/> |Armazena, para cada chamada de emergência, tal como uma chamada Enhanced 9-1-1 (E9-1-1), informações locais sobre a chamada. Refere-se à [tabela SessionDetails para horários](sessiondetails.md) de início/término de chamada e código de resposta. <br/> |
...
|**Table**|**Descrição**|
|:-----|:-----|
|[Tabela application in Skype for Business Server 2015](application.md) <br/> |Armazena informações sobre vários processos no Skype for Business Server 2015 que estão envolvidos no roteamento e conexões.  <br/> |
