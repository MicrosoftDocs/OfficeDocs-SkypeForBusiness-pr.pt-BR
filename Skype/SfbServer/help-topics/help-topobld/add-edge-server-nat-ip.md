...
---
# <a name="add-edge-server-nat-ip"></a><span data-ttu-id="f53d2-105">Adicionar IP NAT de Servidor de Borda</span><span class="sxs-lookup"><span data-stu-id="f53d2-105">Add Edge Server NAT IP</span></span>
