...
Para obter detalhes sobre as configurações para o pool do servidor de mediação ou servidor de mediação, consulte [Deploy um servidor de mediação no construtor de topologia no Skype para Business Server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) na documentação de implantação.
