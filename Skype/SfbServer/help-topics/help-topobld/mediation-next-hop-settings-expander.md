...
Para obter detalhes sobre as configurações do pool do Servidor de Mediação ou servidor de mediação, consulte [Deploy a Mediation Server in Topology Builder in Skype for Business Server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) na documentação implantação.
