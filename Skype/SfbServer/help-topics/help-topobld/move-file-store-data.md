...
1. Desligue os serviços do Skype for Business Server 2015 que usam o repositório de arquivos que você planeja remover.
...
1. Faça logon em um computador como membro do grupo RTCUniversersalServerAdmins ou CsServerAdministrator em que o Skype for Business Server 2015, ferramentas administrativas, sejam instaladas.
...
6. Inicie o construtor de topologias: clique em **Iniciar**, em **todos os programas**, clique em **Skype for Business Server 2015**e, em seguida, clique em **Skype for Business Server 2015Topology Builder**.
