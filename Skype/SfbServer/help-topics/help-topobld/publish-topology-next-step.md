...
Para revisar as Próximas Etapas sugeridas para completar sua topologia, clique no link **Clique aqui para abrir a lista de tarefas**. O arquivo de texto aberto clicando nesse link indicará os servidores para os quais será necessário executar a configuração local, e quaisquer etapas adicionais que precisam ser executadas para completar sua implantação. Para cada uma das tarefas listadas, consulte a seção apropriada na documentação Implantação. Para obter detalhes, consulte [Deploying Lync Server 2013 Preview](https://technet.microsoft.com/library/b76795a4-4e71-4c70-a5c0-d1197fa8028c.aspx) e consulte a seção relacionada para cada função de servidor anotada na lista de tarefas.
