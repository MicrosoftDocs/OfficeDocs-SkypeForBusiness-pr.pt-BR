...
---
# <a name="add-persistent-chat-compliance-sql-server-store"></a>Adicionar Repositório de Servidor SQL de Conformidade de Bate-papo Persistente
 
Você configura os repositórios de conformidade do SQL Server que fornecerão bancos de dados para o servidor de chat persistente ou o recurso de conformidade do servidor de chat persistente.
...
Selecione na lista **espelhamento do SQL Server Store** um SQL Server e uma instância opcional para atuar como o espelho do SQL Server para o SQL Server de conformidade de chat persistente.
...
Clique em **novo** para definir uma nova testemunha do SQL Server, opcionalmente, uma instância para a testemunha de espelhamento do SQL Server de conformidade de chat persistente.
