...
Clique **em Novo** para definir uma nova SQL Server testemunha opcionalmente uma instância para a testemunha de conformidade do Chat Persistente SQL Server espelhamento.
