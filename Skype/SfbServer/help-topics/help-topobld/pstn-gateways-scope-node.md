...
O nó de **Gateways PSTN** lista os gateways PSTN (rede telefônica pública comutada) da sua topologia. Você pode realizar a seguinte ação:
  
- **Novo Gateway IP/PSTN**. Iniciar o assistente **Definir Novo Gateway IP/PSTN** usado para adicionar um novo gateway PSTN à topologia.
