...
---
# <a name="add-edge-server-nat-ip-2010"></a><span data-ttu-id="2ab95-104">Adicionar IP NAT de Servidor de Borda 2010</span><span class="sxs-lookup"><span data-stu-id="2ab95-104">Add Edge Server NAT IP 2010</span></span>
 
<span data-ttu-id="2ab95-p102">Se o endereço IP deste pool de Borda for convertido por uma NAT (conversão de endereços de rede), será necessário especificar o endereço IP público a ser convertido. Esse endereço deve ser o endereço IP externo do serviço de Borda A/V.</span><span class="sxs-lookup"><span data-stu-id="2ab95-p102">If the public IP address of this Edge pool is translated by a network address translation (NAT), you must specify the public IP address to be translated. This should be the external IP address of the A/V Edge service.</span></span>
  
<span data-ttu-id="2ab95-107">Para alterar o uso de conversão NAT pelo pool de Borda, clique com o botão direito no nome do pool de Bordar e clique em  **Editar Propriedades**.</span><span class="sxs-lookup"><span data-stu-id="2ab95-107">To change whether the Edge pool uses NAT translation, right-click the name of the Edge pool and click **Edit Properties**.</span></span>
