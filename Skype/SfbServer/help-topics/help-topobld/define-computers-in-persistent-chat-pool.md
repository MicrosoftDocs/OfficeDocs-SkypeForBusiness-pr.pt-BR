...
Você define os computadores que serão parte de um pool de Servidores de Chat Persistente digitando o FQDN (nome de domínio totalmente qualificado) no **FQDN do computador**. Esse precisa ser o nome do computador definido nos registros (A ou AAAA) do host DNS (sistema de nome de domínio).
