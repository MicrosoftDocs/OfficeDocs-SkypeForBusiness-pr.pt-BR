...
Você pode **definir o monitoramento do SQL Server Store** configurando as seguintes propriedades:
  
- **Monitorando a loja do SQL Server**: selecione um FQDN (nome de domínio totalmente qualificado) do SQL Server (e, opcionalmente, uma instância nomeada do SQL Server) na lista.
