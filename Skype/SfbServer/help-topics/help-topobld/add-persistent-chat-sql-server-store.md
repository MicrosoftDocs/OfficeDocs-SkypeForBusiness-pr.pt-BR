...
Marque a **caixa de seleção Habilitar SQL Server** armazenamento de espelhamento para configurar um banco de dados SQL Server e uma instância opcional que fornecerá um banco de dados espelhado para os dados do Chat Persistente.
...
Clique **em Novo** para definir uma nova SQL Server testemunha opcionalmente uma instância para a testemunha de espelhamento SQL Server chat persistente.
