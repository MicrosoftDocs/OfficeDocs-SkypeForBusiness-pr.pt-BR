...
- **Habilitar controle de admissão de chamadas** Selecione esta configuração para habilitar o CAC. Desmarque essa configuração para desabilitar o CAC para toda sua rede. Para habilitar o CAC, você deve ter configurado sua rede para CAC. Para obter detalhes, consulte [implantar o controle de admissão de chamadas no Skype for Business Server 2015](../../deploy/deploy-enterprise-voice/deploy-call-admission-control.md) na documentação de implantação.
