...
description: Você pode criar novas funções de servidor no nó Lync Server 2010 do Construtor de Topologias clicando com o botão direito do mouse no Lync Server 2010, selecione Novo e selecione a função de servidor a ser criado.
