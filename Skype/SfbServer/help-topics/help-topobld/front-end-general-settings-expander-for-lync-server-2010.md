...
- **Armazenamento de** arquivos: você seleciona o FQDN do servidor e o compartilhamento (  `\\<FQDN of server>\<share name>`no formato ) que atuará como o local do armazenamento de arquivos para os arquivos compartilhados que o Lync Server 2013 cria e usa para replicação, diretórios de conferência e outras finalidades. Selecione o Repositório de arquivo na lista ou crie um novo Repositório de arquivo clicando em **Novo**
