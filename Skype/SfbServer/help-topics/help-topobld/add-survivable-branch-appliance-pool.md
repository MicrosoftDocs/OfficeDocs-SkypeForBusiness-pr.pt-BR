...
ms.locfileid: "41820593"
---
# <a name="add-survivable-branch-appliance-pool"></a><span data-ttu-id="c7822-104">Adicionar Pool de Aparelho de Escritório Persistente</span><span class="sxs-lookup"><span data-stu-id="c7822-104">Add Survivable Branch Appliance Pool</span></span>
 
<span data-ttu-id="c7822-105">Para **definir o FQDN do aparelho de ramificação sobreviventes**, digite o FQDN (nome de domínio totalmente qualificado) (conforme definido no sistema de nomes de domínio (DNS)) do aparelho de ramificação sobreviventes ou do servidor de ramificação sobreviventes na caixa de texto **FQDN** .</span><span class="sxs-lookup"><span data-stu-id="c7822-105">To **Define the Survivable Branch Appliance FQDN**, type the fully qualified domain name (FQDN) (as defined in Domain Name System (DNS)) of the Survivable Branch Appliance or Survivable Branch Server in the **FQDN** text box.</span></span> <span data-ttu-id="c7822-106">Clique em **Avançar** para continuar.</span><span class="sxs-lookup"><span data-stu-id="c7822-106">Click **Next** to continue.</span></span>
  
> [!NOTE]
> <span data-ttu-id="c7822-107">A menos que seja declarado de outra forma, a definição de um aparelho de ramificação sobreviventes ou um servidor de ramificação sobreviventes é o mesmo procedimento.</span><span class="sxs-lookup"><span data-stu-id="c7822-107">Unless it is stated otherwise, defining a Survivable Branch Appliance or a Survivable Branch Server is the same procedure.</span></span> 
