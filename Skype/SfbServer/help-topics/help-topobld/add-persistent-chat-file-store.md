...
> [!IMPORTANT]
> O compartilhamento de arquivos do Skype for Business Server não pode ser localizado no servidor front-end Enterprise Edition, mas pode estar localizado em um servidor Standard Edition. 
...
> [!IMPORTANT]
> Quando você adiciona um servidor de chat persistente ou um pool de servidores de chat persistente à sua topologia, o construtor de topologias deve ser capaz de configurar o repositório de arquivos e configurar DACLs (listas de controle de acesso discricional) no compartilhamento de arquivos a ser usado para o repositório de arquivos. Isso exige que, quando executar o Construtor de Topologias para publicar a nova topologia, você esteja conectado com uma conta que tenha permissões de controle total (ler/escrever/modificar) para o compartilhamento de arquivos. 
