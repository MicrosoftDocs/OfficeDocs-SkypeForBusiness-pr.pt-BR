...
ms.locfileid: "30887719"
---
# <a name="mediation-service-setting-expander"></a>Expansor de Configuração de Serviço de Mediação
 
Use esta página para definir as portas de escuta para este servidor de mediação e definir suas associações com gateways PSTN (rede) telefônica pública comutada. 
