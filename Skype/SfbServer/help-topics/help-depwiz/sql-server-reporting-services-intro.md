...
Todos os pools em um site e os pools de múltiplos sites centrais podem usar o mesmo Servidor de Monitoramento, se o uso não exceder a capacidade do Servidor de Monitoramento. Para obter detalhes sobre como projetar uma topologia para dar suporte ao monitoramento, consulte Associate a monitoring store with [a Front End pool in Skype for Business Server 2015](../../deploy/deploy-monitoring/associate-a-monitoring-store.md) na documentação implantação.
