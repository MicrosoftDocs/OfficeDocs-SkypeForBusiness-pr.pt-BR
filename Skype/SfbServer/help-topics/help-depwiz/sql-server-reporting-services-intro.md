...
Todos os pools em um site e os pools de vários sites centrais podem usar o mesmo Monitoring Server, se o uso não exceder a capacidade do Monitoring Server. Para obter detalhes sobre como projetar uma topologia para dar suporte ao monitoramento, consulte [associar um repositório de monitoramento com um pool de Front-End no Skype para Business Server 2015](../../deploy/deploy-monitoring/associate-a-monitoring-store.md) na documentação de implantação.
