...
- **CsViewOnlyAdministrator:** Os membros podem exibir a implantação e a configuração das informações do servidor. Essa associação permite que um membro monitore a saúde dos servidores que executam Skype for Business Server 2015.
