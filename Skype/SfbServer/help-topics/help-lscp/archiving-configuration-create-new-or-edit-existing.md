...
- **Integração com o Microsoft Exchange** Selecione essa opção se tiver usuários que estão no Exchange 2013. Com essa opção, o Exchange 2013 é usado para armazenar dados para esses usuários, se suas caixas de correio foram colocadas em In-Place Espera. Se todos os seus usuários estão armazenados no Exchange 2013, você não precisa configurar bancos de dados separados do SQL Server para armazenamento de dados de arquivamento.
