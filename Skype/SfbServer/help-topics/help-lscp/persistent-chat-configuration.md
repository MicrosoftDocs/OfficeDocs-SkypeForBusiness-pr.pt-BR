...
Os gerentes de sala de Chat Persistente, que têm a capacidade de gerenciar uma ou mais salas de chat, podem usar o cliente para iniciar um aplicativo Web de gerenciamento de sala para criar e gerenciar salas (ou os clientes podem criar soluções personalizadas e fluxos de trabalho a serem invocados). Chat persistente
  
Os administradores de Chat Persistente também podem usar o painel de controle ou Windows PowerShell cmdlets para criar e gerenciar salas.
