...
> [!NOTE]
> Para recuperar todos os usuários habilitados para o Enterprise Voice, não digite nada na caixa Pesquisar. Você também pode encontrar todos os usuários cujos nomes para exibição ou endereços SIP começam com uma determinada cadeia de caracteres. Por exemplo, para localizar todos os usuários cujo endereço SIP começa com ken, digite sip: ken. Isso retornará usuários como sip:kenmyer@fabrikam.com, sip:kenkwok.fabrikam.com e sip:kenmallit@fabrikam.com. 
