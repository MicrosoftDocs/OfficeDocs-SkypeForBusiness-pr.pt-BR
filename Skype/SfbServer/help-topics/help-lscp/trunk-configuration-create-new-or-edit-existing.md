...
ms.locfileid: "23244955"
---
# <a name="trunk-configuration-create-new-or-edit-existing"></a>Configuração do tronco: Criar nova ou editar existente
...
- [Criar ou modificar uma regra de conversão para apresentação da ID chamada no Skype for Business Server 2015](../../deploy/deploy-enterprise-voice/called-id-presentation-rules.md)
