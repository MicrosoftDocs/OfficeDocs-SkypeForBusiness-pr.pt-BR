...
Se você não vir a extensão para um tipo de arquivo que você deseja selecionar listada em **extensões de tipo de arquivo**, digite a extensão na caixa de texto em **Adicionar novas extensões de arquivo à lista**e, em seguida, clique em **Adicionar**. 
