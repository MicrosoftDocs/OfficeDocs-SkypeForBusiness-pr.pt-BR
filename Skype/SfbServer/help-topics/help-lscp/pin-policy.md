...
ms.locfileid: "34291036"
---
# <a name="pin-policy"></a>Política de PIN

O que você deseja fazer? Clique no link da tarefa que você deseja executar.

 **Trabalhar com política de PIN para telefones IP** Esta política de PIN (número de identificação pessoal) dá suporte à autenticação para usuários que se conectam ao Skype for Business Server usando um telefone IP.
...
- [Excluir uma política de PIN no Skype for Business Server 2015](../../manage/authentication/delete-a-pin-policy.md)
  ...
  **Trabalhar com a política de fixação para conferência discada** Essa política de PIN permite que os usuários que têm credenciais de serviços de domínio Active Directory em sua organização ingressem em conferências discadas como usuários autenticados, inserindo um PIN.
