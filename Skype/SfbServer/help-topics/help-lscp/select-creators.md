...
[Usando categorias para administrar o servidor de chat persistente](/previous-versions/office/lync-server-2013/using-categories-to-administer-persistent-chat-server)

[Movendo uma sala de chat para outra categoria](/previous-versions/office/lync-server-2013/lync-server-2013-moving-a-chat-room-from-one-category-to-another)

[Criando ou editando uma nova sala](/previous-versions/office/lync-server-2013/lync-server-2013-creating-or-editing-a-new-room)