...
---
# <a name="voice-routing-status-of-commit-changes-for-voice-routing-configuration"></a>Roteamento de voz: Status das Alterações de Compromisso para Configuração do Roteamento de Voz
 
Se as alterações não forem concluídas, examine as mensagens nessa caixa de diálogo, altere sua configuração de roteamento de voz e tente novamente.
