...
1. [Regras de conversão no Skype for Business Server 2015](../../plan-your-deployment/enterprise-voice-solution/translation-rules.md)
...
3. [Criar ou modificar uma regra de conversão para apresentação chamada de ID no Skype for Business Server 2015](../../deploy/deploy-enterprise-voice/called-id-presentation-rules.md)