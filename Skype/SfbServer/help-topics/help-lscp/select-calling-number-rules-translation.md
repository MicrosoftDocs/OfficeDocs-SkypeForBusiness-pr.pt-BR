...
3. [Criar ou modificar uma regra de conversão para apresentação de ID chamada no Skype for Business Server 2015](../../deploy/deploy-enterprise-voice/called-id-presentation-rules.md)
