---
title: Ferramenta de planejamento de Federação do Lync Server
ms.reviewer: ''
...
ms.locfileid: "60744372"
---
# <a name="lync-server-federation-planning-tool"></a>Ferramenta de planejamento de Federação do Lync Server
...
- [Planejamento da federação XMPP (extensible messaging and presence protocol) no Lync Server 2013](/previous-versions/office/lync-server-2013/lync-server-2013-planning-for-extensible-messaging-and-presence-protocol-xmpp-federation)
