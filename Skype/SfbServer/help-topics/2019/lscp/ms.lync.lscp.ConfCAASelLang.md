...
ms.locfileid: "23250162"
---
# <a name="select-languages"></a>Selecionar Idiomas

Selecione os idiomas que você deseja usar para o número de acesso de conferência discada. Para obter detalhes, consulte [criar ou modificar um número de acesso da conferência discada](https://technet.microsoft.com/library/06f55c28-57f8-4d4e-8313-9740846796d9.aspx).
