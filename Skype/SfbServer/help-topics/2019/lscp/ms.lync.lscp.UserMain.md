...
- **Ação** Clique em **ação**e selecione a ação que você deseja executar para os usuários selecionados nos resultados da pesquisa. As ações a seguir estão disponíveis:
  ...
  - **Exibir o status do pino** Abre a caixa de diálogo [usuários: Exibir status do pino](ms.lync.lscp.UserViewPin.md) , que exibe os dados do PIN para o usuário selecionado.
  ...
  - **Mover os usuários selecionados para o pool** Abre a caixa de diálogo [mover usuário](ms.lync.lscp.UserMove.md) , na qual você pode selecionar um pool para o qual mover o usuário selecionado.

  - **Mover todos os usuários para o pool** Abre a caixa de diálogo [mover usuário](ms.lync.lscp.UserMove.md) , na qual você pode selecionar um pool para o qual moverá todos os usuários selecionados.
