...
- **Agente de usuário** Você pode selecionar um tipo de cliente na lista. A tabela a seguir define códigos de agente de usuário. Esta lista inclui tipos de cliente herdados, alguns dos quais não são mais suportados.
