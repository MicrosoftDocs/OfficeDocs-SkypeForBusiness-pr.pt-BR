...
Use a caixa de diálogo **selecionar prefixo do hiperlink** para selecionar os tipos de hiperlinks que você deseja bloquear, enviar uma mensagem de aviso ou permitir selecionando (para bloquear ou enviar uma mensagem de aviso) ou desmarcando (permitir) as caixas de seleção das extensões Categorias em prefixos de **hiperlink**. Clique na seta para expandir uma categoria e exibir todos os prefixos de hiperlink para essa categoria. Se você quiser selecionar todos os prefixos de hiperlink para uma categoria, selecione o nome da categoria. 
