...
- Habilitar ou desabilitar configurações de versão de cliente existentes.

> [!NOTE]
> Como os usuários anônimos não são associados a um site, eles são afetados somente por políticas no nível global.
