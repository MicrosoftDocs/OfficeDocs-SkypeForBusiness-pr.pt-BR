...
Use as políticas de Arquivamento para habilitar e desabilitar o arquivamento para usuários que estão no Skype for Business Server. Em cada política de Arquivamento, você pode habilitar ou desabilitar o arquivamento para uma ou ambas as seguintes:
  
- Comunicações internas
    
- Comunicações externas (comunicações que incluem pelo menos um usuário fora da rede interna)
    
As políticas de arquivamento incluem a política global e, opcionalmente, uma ou mais políticas de Arquivamento de site e usuário:
...
> [!NOTE]
> As políticas de arquivamento se aplicam somente aos usuários que estão no Skype for Business Server. Se você usar a integração com o Exchange para armazenar dados de arquivamento no Microsoft Exchange, as políticas do Exchange controlarão o arquivamento de usuários que estão no Exchange. Para habilitar o arquivamento para esses usuários, a caixa de correio do usuário deve ser colocada In-Place Espera. 
...
- **Novo** Você pode adicionar uma ou mais de cada uma das seguintes políticas de Arquivamento opcionais:
