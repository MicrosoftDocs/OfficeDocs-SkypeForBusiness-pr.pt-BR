...
> [!NOTE]
> As políticas de arquivamento aplicam-se somente aos usuários hospedados no Skype for Business Server. Se você usa a integração do Exchange para armazenar dados de arquivamento no Microsoft Exchange, o Exchange Policies controla o arquivamento para usuários hospedados no Exchange. Para habilitar o arquivamento para esses usuários, a caixa de correio do usuário deve ser colocada no bloqueio in-loco. 
