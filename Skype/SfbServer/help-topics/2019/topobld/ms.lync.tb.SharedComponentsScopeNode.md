...
Clique com o botão direito do mouse em **Componentes Compartilhados** na árvore de hierarquia do Construtor de Topologias para criar novos componentes compartilhados ou acessar as opções de nível de Topologia.
  
![Nó de Escopo de Componentes Compartilhados](../../../media/Shared_Components_Scope_Node.jpg)
  
Selecione **Novo** para criar um novo repositório de arquivos, um novo Gateway IP/PSTN, um novo Servidor do Office Web Apps, um novo repositório do SQL Server ou um novo Tronco.
  
> [!NOTE]
> Consulte os tópicos da Ajuda para cada uma dessas opções. 
