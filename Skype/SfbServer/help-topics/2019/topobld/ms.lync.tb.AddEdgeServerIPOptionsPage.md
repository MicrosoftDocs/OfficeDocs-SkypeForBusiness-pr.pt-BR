...
O Skype for Business Server permite configurar endereços IPv4 e IPv6 para cada interface para o Servidor de Borda e o pool de Borda. Para fazer isso, faça o seguinte:
