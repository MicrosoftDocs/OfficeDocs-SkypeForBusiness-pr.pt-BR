...
Para obter detalhes sobre as configurações para o pool do Servidor de Mediação ou Servidor de Mediação, consulte [Deploy a Mediation Server in Topology Builder in Skype for Business Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) na documentação implantação.
