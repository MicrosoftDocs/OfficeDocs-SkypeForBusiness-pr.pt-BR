...
ms.locfileid: "60742328"
---
# <a name="av-mcu-settings-expander"></a>Expansor de Configurações AV MCU
 
Para editar as propriedades de um pool do Servidor de Conferência A/V que você já definiu, faça o seguinte:
  
## <a name="general-settings"></a>Configurações Gerais

Para atualizar o FQDN (nome de domínio totalmente qualificado) do pool do Servidor de Conferência A/V, digite o nome do pool como ele é definido no Dns (Sistema de Nomes de Domínio). Você deve ter um registro de hospedeiro (A) DNS correspondente com o nome do pool de Servidor de Conferência A/V.
