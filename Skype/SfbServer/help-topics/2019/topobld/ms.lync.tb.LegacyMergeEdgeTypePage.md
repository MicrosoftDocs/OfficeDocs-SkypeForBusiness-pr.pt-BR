...
description: Para um Servidor de Borda Único ou servidor de Borda consolidada balanceada por carga, clique em Próximo para especificar informações de configuração. Para uma Borda Expandida, a configuração de cada servidor deve ser alterada para uma configuração de Borda consolidada antes de ser mesclada.
