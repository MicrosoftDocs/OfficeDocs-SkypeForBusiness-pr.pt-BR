...
---
# <a name="associate-av-mcu-with-front-end"></a><span data-ttu-id="c0cf0-104">Associar AV MCU com Front-End</span><span class="sxs-lookup"><span data-stu-id="c0cf0-104">Associate AV MCU With Front End</span></span>
 
<span data-ttu-id="c0cf0-105">Todos os pools de Front End do Enterprise Edition com a conferência habilitado devem ter um A / o serviço de conferência V colocado, ou deve usar uma stand-alone A / pool de conferência V.</span><span class="sxs-lookup"><span data-stu-id="c0cf0-105">All Enterprise Edition Front End pools with Conferencing enabled must have an A/V Conferencing service collocated, or must use a stand-alone A/V Conferencing pool.</span></span> <span data-ttu-id="c0cf0-106">Qualquer existente Enterprise Edition pools Front-End que possuírem um A / conferência V colocado de serviço podem ser selecionada para usar este nova stand-alone A / pool de conferência de V em vez disso.</span><span class="sxs-lookup"><span data-stu-id="c0cf0-106">Any existing Enterprise Edition Front End pools that currently have an A/V Conferencing service collocated may be selected to use this new stand-alone A/V Conferencing pool instead.</span></span>
