...
ms.locfileid: "41793659"
---
# <a name="file-stores-scope-node"></a>Nó de Escopo de Repositórios de Arquivos
 
O nó de **Repositórios de Arquivos** lista os Repositórios de Arquivos em sua topologia. Você pode executar a seguinte ação:
  
- **Novo Repositório de Arquivos**. Inicia a página **Definir Novo Repositório de Arquivos**, usada para adicionar um novo Repositório de Arquivos à topologia.
