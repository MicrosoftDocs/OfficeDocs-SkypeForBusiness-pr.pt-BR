...
- **Monitorando o SQL Server store**: selecione um nome de domínio totalmente qualificado do SQL Server (FQDN) (e, opcionalmente, uma instância nomeada do SQL Server) na lista.
