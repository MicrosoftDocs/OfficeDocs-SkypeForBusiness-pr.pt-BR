...
ms.locfileid: "30875725"
---
# <a name="skype-for-business-server-create-new-expander"></a>Skype para Business Server criar novo expansor
 
Você pode criar novas funções de servidor no construtor de topologia clicando **Skype para Business Server**, selecionando **novo**e, em seguida, selecionando a função de servidor a ser criada.
