...
Além das opções para o servidor que executa o Monitoramento descrito anteriormente neste tópico, você tem opções gerais do nó Monitoramento que também estão disponíveis de outros nós na árvore do console. Isso inclui as seguintes opções:
