...
Para obter detalhes sobre SQL Server suporte, consulte o [Software de banco de dados e suporte a clusters](http://technet.microsoft.com/library/e05d0032-bbea-4e61-987d-d07b1c045fd5.aspx) na documentação de suporte. Para obter detalhes sobre como configurar o SQL Server para o banco de dados de back-end, consulte [Configurar o SQL Server para o Lync Server 2010](http://technet.microsoft.com/library/375e5cc4-e436-46dc-9b02-5063f35cdcc1.aspx) na documentação de implantação.
