...
Selecione um servidor do Office Web Apps para sua implantação se você tiver escolhido conferência como uma de suas opções de recurso para a configuração do Skype for Business Server.
