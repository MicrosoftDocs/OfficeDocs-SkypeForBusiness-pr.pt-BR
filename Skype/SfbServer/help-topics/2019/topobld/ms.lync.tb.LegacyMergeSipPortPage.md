...
Se sua implantação herdada estiver configurada para entrada automática do Cliente, selecione Descoberta automática da configuração da porta SIP para cada **pool** e clique em **Próximo** para continuar.
