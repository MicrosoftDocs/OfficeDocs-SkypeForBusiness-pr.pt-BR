...
O nó **SQL armazena** lista os bancos de dados do SQL Server em sua topologia. É possível executar a seguinte ação:
  
- **Novo SQL Store**. Inicia o assistente **Definir novo repositório SQL** , que você usa para adicionar um novo banco de dados do SQL Server à topologia.
