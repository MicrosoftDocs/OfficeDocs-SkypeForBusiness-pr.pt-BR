...
2. Na  caixa de diálogo Instalar  Bancos de Dados, na página Criar Banco de Dados, selecione o FQDN (nome de domínio totalmente qualificado) do armazenamento do SQL Server onde os novos bancos de dados devem ser criados.
