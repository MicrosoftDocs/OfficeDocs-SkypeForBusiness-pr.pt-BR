...
> [!NOTE]
> Os botões **Remover** ou **Desmarcar Tudo** funcionam somente em entradas SAN adicionadas nessa página. Os botões não afetarão as entradas SAN que já estão no certificado.
