...
Para preparar um domínio para servidores de host executando Skype para Business Server ou Skype para usuários Business Server, você deve concluir **etapa 5: Preparar domínio atual**, conforme descrito no tópico [Usando o Setup para executar a preparação do domínio](http://technet.microsoft.com/library/95dab800-1f2c-4506-b36c-99986643b149.aspx). Para completar a etapa, é necessário estar conectado como membro do grupo Administradores de Domínio no domínio que você está preparando ou como membro do grupo Administradores de Empresa da floresta a qual o domínio pertence. Para preparar o domínio:
