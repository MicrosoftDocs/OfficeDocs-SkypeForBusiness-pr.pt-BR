...
Para especificar as credenciais para o SQL Server Reporting Services (SSRS) a fim de acessar o banco de dados de Monitoramento, faça o seguinte:
...
Para obter detalhes sobre como implantar os relatórios do Reporting Services para o servidor que está executando o Monitoramento, consulte [Install Monitoring Reports in Skype for Business Server](../../../deploy/deploy-monitoring/install-monitoring-reports.md).
