...
Todos os pools em um site e os pools de múltiplos sites centrais podem usar o mesmo Servidor de Monitoramento, se o uso não exceder a capacidade do Servidor de Monitoramento. Para obter detalhes sobre como projetar uma topologia para dar suporte ao monitoramento, consulte [Associate a monitoring store](../../../deploy/deploy-monitoring/associate-a-monitoring-store.md) with a Front End pool in Skype for Business Server na documentação implantação.
