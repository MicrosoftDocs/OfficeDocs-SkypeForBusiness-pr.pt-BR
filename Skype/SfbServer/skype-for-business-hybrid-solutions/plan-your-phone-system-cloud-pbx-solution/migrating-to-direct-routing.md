...
Para obter mais informações, consulte [migração e interoperabilidade orientações para as organizações que usam equipes em conjunto com o Skype para negócios](https://docs.microsoft.com/en-us/MicrosoftTeams/migration-interop-guidance-for-teams-with-skype).
...
- [Configurar Planos de Chamadas](../../../SfbOnline/what-are-calling-plans-in-office-365/set-up-calling-plans.md)
