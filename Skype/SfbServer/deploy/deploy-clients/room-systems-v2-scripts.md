...
---
# <a name="skype-room-systems-v2-scripts"></a>Skype sala sistemas v2 Scripts
 
Copie cada uma das seções deste artigo em um arquivo de texto chamado no título da seção. Esses arquivos são usados na implantação de sistemas de sala Skype v2: 
* [CreateSrsMedia.ps1](#createsrsmediaps1) é usado para criar uma imagem de software para o dispositivo do console de um script do Powershell.  
* [SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) é um Powershell usará o script usado para configurar Skype para contas de negócios e Exchange os dispositivos.  
* [SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) é usado quando a configuração do gerenciamento de sistemas de sala Skype v2 usando OMS.
