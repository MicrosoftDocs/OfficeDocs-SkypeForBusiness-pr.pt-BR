...
Para obter informações sobre a OCT, consulte [usar a OCT para personalizar o Office 2013](https://technet.microsoft.com/library/cc179132.aspx). Observe que essas informações também se aplica ao Office 2016.
