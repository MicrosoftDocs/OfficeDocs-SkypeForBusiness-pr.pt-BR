...
Para configurar um KMS, consulte [ativação do KMS do Office 2013](https://technet.microsoft.com/en-us/library/ee624357.aspx) e [GVLKs para ativação KMS and Active Directory do Office 2013](https://technet.microsoft.com/en-us/library/dn385360.aspx)
