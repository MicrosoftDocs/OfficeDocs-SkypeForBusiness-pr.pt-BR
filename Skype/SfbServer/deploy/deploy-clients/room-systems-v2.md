...
description: Leia este tópico para saber mais sobre os sistemas de sala Skype v2 e como ele se integra com o Exchange e Skype para Business Server 2015.
...
---
# <a name="deploy-skype-room-systems-v2"></a>Implantar o Skype Room Systems versão 2
...
A melhor maneira de configurar as contas de usuário é configurá-los usando o Windows PowerShell remoto. [A Microsoft fornece scripts](https://go.microsoft.com/fwlink/?linkid=870105) que ajudarão a criar novas contas de usuário ou validar contas existentes de recurso, você ter para ajudá-lo a transformá-los em contas de usuário de v2 Skype sala sistemas compatíveis.
  
Se você preferir usar a interface do usuário do Office 365 sobre cmdlets do Windows PowerShell, algumas etapas podem ser realizadas manualmente. Consulte o [tópico Criando uma conta de dispositivo usando o Office 365](https://technet.microsoft.com/en-us/itpro/surface-hub/create-a-device-account-using-office-365).
