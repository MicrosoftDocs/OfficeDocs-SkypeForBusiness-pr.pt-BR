...
- Criando Skype para contas de negócios e do Exchange e atribuindo a elas nos dispositivos de console (consulte [Configurar contas para salas de equipes da Microsoft](room-systems-v2-configure-accounts.md))
...
- (Opcional) Configurando o pacote de gerenciamento do Microsoft Operations para seus sistemas (consulte [gerenciamento de salas de equipes Microsoft implantar com o Windows Azure Monitor](azure-monitor.md))
...
-   [Definir configurações de conta local e alimentação](../../manage/skype-room-systems-v2/room-systems-v2-operations.md#configuring-group-policy-for-microsoft-teams-rooms).
...
Cada dispositivo Microsoft equipes salas requer uma conta de recurso dedicado e exclusivo que deve ser habilitada para ambos os Skype para Exchange e de negócios. Essa conta deve ter uma caixa de correio de sala hospedada no Exchange e ser habilitada como uma sala de reunião no Skype para implantação de negócios. No lado do Exchange, o processamento de calendário deve ser configurado para que o dispositivo pode aceitar automaticamente solicitações de reunião recebidas. Para obter mais informações sobre como criar essas contas, consulte [Configurar contas para salas de equipes da Microsoft](room-systems-v2-configure-accounts.md). 
...
Para obter mais informações sobre como usar o arquivo de configuração XML, consulte [Gerenciar configurações de console um Microsoft equipes salas remotamente com um arquivo de configuração XML](../../manage/skype-room-systems-v2/xml-config-file.md). 

Você pode usar o [PowerShell remoto](../../manage/skype-room-systems-v2/room-systems-v2-operations.md#remote-management-using-powershell) para receber a configuração de salas de equipes da Microsoft para fins de relatório. 
