...
Antes de implantar salas de equipes da Microsoft com o Exchange Online, certifique-se de que você cumpre os requisitos. Para obter mais informações, consulte [requisitos de salas de equipes da Microsoft](../../plan-your-deployment/clients-and-devices/requirements.md).
