...
> [!NOTE]
> As Salas do Microsoft Teams são um produto diferente com diferentes dependências e procedimentos de implantação. Para obter informações sobre salas do Microsoft Teams, consulte a visão geral de gerenciamento de [Salas](/microsoftteams/rooms/rooms-manage)do Microsoft Teams.
...
Se você precisar desabilitar uma conta existente do Sistema de Sala do Skype a partir dos serviços do Skype for Business em um pool do Skype for Business Server, use o seguinte comando para desabilitar a conta: 
...
Cada cliente do Sistema de Sala do Skype que ingressar no domínio pode ser totalmente gerenciado por um usuário de domínio com direitos de administrador local no computador de dispositivo do Sistema de Sala do Skype. Portanto, você pode criar um grupo de administradores dedicados no Active Directory e dar direitos administrativos a esse grupo durante a configuração da nova máquina do Sistema de Sala do Skype.
