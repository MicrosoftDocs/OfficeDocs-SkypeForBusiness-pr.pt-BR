...
|Habilitar o uso do BITS para baixar arquivos do Serviço de Agendamento de Endereços (EnableBitsForGalDownload)  <br/> |Permite que o Skype for Business use o BITS (Serviço de Transferência Inteligente em Segundo Plano) para baixar os arquivos dos Serviços de Agenda.  <br/> |
...
|Permitir armazenamento de senhas de usuário (SavePassword)  <br/> |Permite que o Skype for Business armazene senhas.  <br/> |
