...
**Resumo:** Leia este tópico para saber como configurar a integração entre o Office Web Apps Server e Skype para Business Server para habilitar as apresentações do PowerPoint para Webconferência.
  
Skype para Business Server emprega o Office Web Apps Server para lidar com apresentações do PowerPoint para Webconferência. Para obter informações sobre as vantagens para essa abordagem, consulte [Planejar a conferência em Skype para Business Server](../../plan-your-deployment/conferencing/conferencing.md).
...
Se você tiver configurado o acesso de usuários externos, você também verá algo semelhante a:
