...
<span data-ttu-id="59d49-p102">Todas as seções a seguir contêm as etapas que você já deve ter lido no tópico sobre planejamento. Se tiver dúvidas, consulte esse tópico.</span><span class="sxs-lookup"><span data-stu-id="59d49-p102">All the following sections contain steps that assume you've read the Planning topic. If anything's confusing you, feel free to check out the information there.</span></span>
...
10. <span data-ttu-id="59d49-170">Ao terminar, clique em **Concluído**.</span><span class="sxs-lookup"><span data-stu-id="59d49-170">When you're done, click **Done**.</span></span>
...
## <a name="modify-certificates"></a><span data-ttu-id="59d49-182">Modificar certificados</span><span class="sxs-lookup"><span data-stu-id="59d49-182">Modify certificates</span></span>
...
7. <span data-ttu-id="59d49-p123">Você também deverá verificar as entradas de **Nome Alternativo da Entidade**. Você encontrará uma ou mais das opções a seguir:</span><span class="sxs-lookup"><span data-stu-id="59d49-p123">You'll also need to check the **Subject Alternate Name** entries. You'll find one or more of the following:</span></span>
   ...
   - <span data-ttu-id="59d49-247">Caso já estejam atribuídos a lyncdiscover. \<sipdomain\> e lyncdiscoverinternal. \<sipdomain\> registros.</span><span class="sxs-lookup"><span data-stu-id="59d49-247">If already assigned, the lyncdiscover.\<sipdomain\> and lyncdiscoverinternal.\<sipdomain\> records.</span></span>
...
- <span data-ttu-id="59d49-259">Você fará sua solicitação inicial de Descoberta Automática por HTTPS (recomendável)?</span><span class="sxs-lookup"><span data-stu-id="59d49-259">Are you going to be doing your initial Autodiscover request over HTTPS (which we recommend)?</span></span>
  ...
  - <span data-ttu-id="59d49-260">Se você tiver uma regra de publicação na Web, deverá modificá-la.</span><span class="sxs-lookup"><span data-stu-id="59d49-260">If you have a web publishing rule, you need to modify it.</span></span>
...
3. <span data-ttu-id="59d49-285">Normalmente, você deverá inserir as seguintes informações:</span><span class="sxs-lookup"><span data-stu-id="59d49-285">Typically, you will need to enter the following information:</span></span>
   ...
   - <span data-ttu-id="59d49-299">Você deverá selecionar um **Ouvinte SSL** com o certificado público atualizado.</span><span class="sxs-lookup"><span data-stu-id="59d49-299">You'll need to select a **SSL Listener** with your up-to-date public certificate.</span></span>
...
3. <span data-ttu-id="59d49-312">Normalmente, você deverá inserir as seguintes informações:</span><span class="sxs-lookup"><span data-stu-id="59d49-312">Typically, you will need to enter the following information:</span></span>
...
1. <span data-ttu-id="59d49-339">Abra o Skype do Shell de gerenciamento do servidor de negócios.</span><span class="sxs-lookup"><span data-stu-id="59d49-339">Open Skype for Business Server Management Shell.</span></span>
...
3. <span data-ttu-id="59d49-382">Adicione um Skype para o provedor de hospedagem online Business Server.</span><span class="sxs-lookup"><span data-stu-id="59d49-382">Add a Skype for Business Server online hosting provider.</span></span>
...
### <a name="modify-global-mobility-policy"></a><span data-ttu-id="59d49-419">Modificar a política global de mobilidade</span><span class="sxs-lookup"><span data-stu-id="59d49-419">Modify global Mobility policy</span></span>

1. <span data-ttu-id="59d49-420">Faça logon, com uma conta que seja membro da função **CsAdministrator** , em um computador onde o **Skype do Shell de gerenciamento do servidor de negócios** e o **Ocscore** estão instalados.</span><span class="sxs-lookup"><span data-stu-id="59d49-420">Log on, with an account that's a member of the **CsAdministrator** role, to a computer where **Skype for Business Server Management Shell** and **Ocscore** are installed.</span></span>
    
2. <span data-ttu-id="59d49-421">Inicie o **Skype do Shell de gerenciamento do servidor de negócios**.</span><span class="sxs-lookup"><span data-stu-id="59d49-421">Start the **Skype for Business Server Management Shell**.</span></span>
    
3. <span data-ttu-id="59d49-422">Desative acesso a mobilidade e telefonar via trabalho globalmente, digitando:</span><span class="sxs-lookup"><span data-stu-id="59d49-422">Turn off access to Mobility and Call via Work globally by typing:</span></span>
   ...
   ```
    ...
    > [!NOTE]
    > <span data-ttu-id="59d49-423">Você pode desativar chamada via trabalho sem desativar acesso a mobilidade.</span><span class="sxs-lookup"><span data-stu-id="59d49-423">You can turn off Call via Work without turning off access to Mobility.</span></span> <span data-ttu-id="59d49-424">Mas você não pode desativar mobilidade sem também desativando a chamada via trabalho.</span><span class="sxs-lookup"><span data-stu-id="59d49-424">But you can't turn off Mobility without also turning off Call via Work.</span></span> 
  
    <span data-ttu-id="59d49-425">Para obter mais informações, consulte [Set-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/set-csmobilitypolicy?view=skype-ps).</span><span class="sxs-lookup"><span data-stu-id="59d49-425">For more info, check out [Set-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/set-csmobilitypolicy?view=skype-ps).</span></span>
    
### <a name="modify-mobility-policy-by-site"></a><span data-ttu-id="59d49-426">Modificar a política de mobilidade por site</span><span class="sxs-lookup"><span data-stu-id="59d49-426">Modify Mobility policy by site</span></span>

1. <span data-ttu-id="59d49-427">Faça logon, com uma conta que seja membro da função **CsAdministrator** , em um computador onde o **Skype do Shell de gerenciamento do servidor de negócios** e o **Ocscore** estão instalados.</span><span class="sxs-lookup"><span data-stu-id="59d49-427">Log on, with an account that's a member of the **CsAdministrator** role, to a computer where **Skype for Business Server Management Shell** and **Ocscore** are installed.</span></span>
    
2. <span data-ttu-id="59d49-428">Inicie o **Skype do Shell de gerenciamento do servidor de negócios**.</span><span class="sxs-lookup"><span data-stu-id="59d49-428">Start the **Skype for Business Server Management Shell**.</span></span>
    
3. <span data-ttu-id="59d49-p152">Você pode criar uma política no nível de site, desativar VoIP e vídeo, habilitar Exigir WiFi para Áudio IP e Exigir WiFi para Vídeo IP por site. Digite:</span><span class="sxs-lookup"><span data-stu-id="59d49-p152">You can create a site-level policy, turn off VoIP and video, enable Require WiFi for IP Audio, and Require WiFi for IP Video by site. Type:</span></span>
    
   ```
   New-CsMobilityPolicy -Identity site:<site identifier> -EnableIPAudioVideo $false -RequireWiFiForIPAudio $True -RequireWiFiforIPVideo $True
   ```

    <span data-ttu-id="59d49-431">Saiba mais em [New-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/new-csmobilitypolicy?view=skype-ps).</span><span class="sxs-lookup"><span data-stu-id="59d49-431">Learn more at [New-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/new-csmobilitypolicy?view=skype-ps).</span></span>
    
### <a name="modify-mobility-policy-by-user"></a><span data-ttu-id="59d49-432">Modificar a política de mobilidade por usuário</span><span class="sxs-lookup"><span data-stu-id="59d49-432">Modify Mobility policy by user</span></span>

1. <span data-ttu-id="59d49-433">Faça logon, com uma conta que seja membro da função **CsAdministrator** , em um computador onde o **Skype do Shell de gerenciamento do servidor de negócios** e o **Ocscore** estão instalados.</span><span class="sxs-lookup"><span data-stu-id="59d49-433">Log on, with an account that's a member of the **CsAdministrator** role, to a computer where **Skype for Business Server Management Shell** and **Ocscore** are installed.</span></span>
    
2. <span data-ttu-id="59d49-434">Inicie o **Skype do Shell de gerenciamento do servidor de negócios**.</span><span class="sxs-lookup"><span data-stu-id="59d49-434">Start the **Skype for Business Server Management Shell**.</span></span>
    
3. <span data-ttu-id="59d49-435">Criar políticas de mobilidade de nível de usuário e desativar a mobilidade e a chamada via trabalho por usuário.</span><span class="sxs-lookup"><span data-stu-id="59d49-435">Create user level Mobility policies and turn off Mobility and Call via Work by user.</span></span> <span data-ttu-id="59d49-436">Digite:</span><span class="sxs-lookup"><span data-stu-id="59d49-436">Type:</span></span>
   ...
   ```
    ...
    <span data-ttu-id="59d49-437">Mais um exemplo:</span><span class="sxs-lookup"><span data-stu-id="59d49-437">A further example with sample data:</span></span>
   ...
   ```
    ...
    > [!NOTE]
    > <span data-ttu-id="59d49-438">Você pode desativar chamada via trabalho sem desativar acesso a mobilidade.</span><span class="sxs-lookup"><span data-stu-id="59d49-438">You can turn off Call via Work without turning off access to Mobility.</span></span> <span data-ttu-id="59d49-439">Mas você não pode desativar mobilidade sem também desativando a chamada via trabalho.</span><span class="sxs-lookup"><span data-stu-id="59d49-439">But you can't turn off Mobility without also turning off Call via Work.</span></span> 
