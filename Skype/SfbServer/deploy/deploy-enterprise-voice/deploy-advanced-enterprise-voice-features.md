...
Implantar recursos avançados do Enterprise Voice no Skype for Business Server.
...
- [Implantar regiões de rede, sites e sub-redes no Skype for Business](deploy-network.md)
    
- [Implantar bypass de mídia no Skype for Business Server](deploy-media-bypass.md)
    
- [Implantar o controle de admissão de chamadas no Skype for Business Server](deploy-call-admission-control.md)
