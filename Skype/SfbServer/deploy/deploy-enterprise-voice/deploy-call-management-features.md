...
Implantando recursos de gerenciamento de chamada Skype for Business Server Enterprise Voice.
...
Esta seção descreve como configurar esses recursos de gerenciamento de chamada durante uma implantação Enterprise Voice de chamada.
  
## <a name="in-this-section"></a>Nesta seção

- [Processo de implantação para Estacionamento de Chamada Skype for Business](deployment-process-for-call-park.md)
    
- [Processo de implantação para coleta de chamada de grupo no Skype for Business](deployment-process-for-group-call-pickup.md)
    
- [Processo de implantação do Grupo de Resposta Skype for Business](deployment-process-for-response-group.md)
    
- [Processo de implantação para o aplicativo De comunicado no Skype for Business Server](deployment-process-for-the-announcement-application.md)
