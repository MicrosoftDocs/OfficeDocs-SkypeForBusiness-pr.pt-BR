...
> [!NOTE]
> Este tópico supõe que você tenha configurado um gateway PSTN e um tronco raiz com pelo menos um Servidor de Mediação ou pool localizado ou autônomo, conforme descrito em Definir um gateway no Construtor de [Topologias](define-a-gateway.md) Skype for Business Server na documentação de Implantação.
