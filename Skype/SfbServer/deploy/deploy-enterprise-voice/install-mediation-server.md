...
**Resumo:** Saiba como instalar os arquivos para o servidor de mediação em Skype para Business Server 2015.
...
> [!NOTE]
> Este tópico pressupõe que você já definiu e publicados de um pool do servidor de mediação autônomo em sua topologia, conforme descrito em [implantar um servidor de mediação no construtor de topologia no Skype para Business Server 2015](deploy-a-mediation-server.md). 
