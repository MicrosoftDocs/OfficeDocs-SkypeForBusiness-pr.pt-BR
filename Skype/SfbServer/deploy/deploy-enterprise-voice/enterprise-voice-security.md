...
- Ou comece a configurar configurações para rotear chamadas Enterprise Voice usuários, conforme descrito em [Configurar troncos em Skype for Business Server](configure-trunks.md).
