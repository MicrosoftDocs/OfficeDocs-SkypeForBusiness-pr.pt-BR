...
Conforme observado acima, muitas coisas entram em uma implantação do servidor de borda para o Skype for Business Server. Esta lista de verificação fornece uma visão geral das tarefas que você precisará executar e links para etapas mais detalhadas.
