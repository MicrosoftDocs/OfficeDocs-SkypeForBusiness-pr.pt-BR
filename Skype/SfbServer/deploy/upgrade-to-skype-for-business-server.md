...
> [!IMPORTANT]
>  Salve uma cópia do seu arquivo de topologia antes de fazer a atualização. Após a atualização, não será capaz de fazer um downgrade o topology.> se seus serviços estão nos mesmos servidores como seus bancos de dados, como o serviço está no mesmo servidor do banco de dados de Chat persistente de Chat persistente, ignore esta etapa e vá para a etapa 4. Depois de interromper os serviços, execute a atualização in-loco em cada servidor para atualizar os bancos de dados locais.
