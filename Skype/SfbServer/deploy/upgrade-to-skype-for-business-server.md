...
[Instalar os pré-requisitos para Skype para Business Server 2015](install/install-prerequisites.md)
  
[Instale o Skype para o servidor de negócios 2015](install/install.md)