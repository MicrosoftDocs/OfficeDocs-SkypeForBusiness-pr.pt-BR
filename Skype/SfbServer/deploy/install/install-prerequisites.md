...
1. Instale os recursos de software de pré-requisito listados em [requisitos de servidor para Skype para Business Server 2015](../../plan-your-deployment/requirements-for-your-environment/server-requirements.md). O software necessário deve ser no servidor que executará o Skype para Business Server 2015.
