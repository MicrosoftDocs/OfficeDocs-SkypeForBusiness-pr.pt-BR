...
|:-----|:-----|:-----|
|EnableCDR  <br/> |Indica se o CDR está habilitado ou não. Se for True, todos os registros de CDR serão coletados e gravados no banco de dados de monitoramento.  <br/> |Verdadeiro  <br/> |
...
|**Propriedade**|**Descrição**|**Valor padrão**|
|:-----|:-----|:-----|
|EnableQoE  <br/> |Indica se o monitoramento de QoE está habilitado ou não. Se for True, todos os registros de QoE serão coletados e gravados no banco de dados de monitoramento.  <br/> |Verdadeiro  <br/> |
