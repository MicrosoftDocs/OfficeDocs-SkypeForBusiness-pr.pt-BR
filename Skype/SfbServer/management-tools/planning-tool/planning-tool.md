...
- [Instalar a ferramenta de planejamento em Skype para Business Server 2015](install.md)
    
- [Optional Software](install.md#Optional_Software)
    
- [Navegue a ferramenta de planejamento no Skype para Business Server 2015](navigate.md)
    
- [Criar o design de topologia inicial para Skype for Business Server 2015](create-the-initial-design.md)
    
- [Editar a topologia no Skype para Business Server 2015](edit-the-topology.md)
    
- [Edit the network configuration diagram](edit-the-topology.md#Edit_Network_diagram)
    
- [Revise os relatórios de administrador no Skype para Business Server 2015](review-the-administrator-reports.md)
