...
Instalar o site na máquina host executando o StatsManWebSite.msi (incluído no [Skype para Business Server, gerente de estatísticas em tempo real (64-bit)](https://www.microsoft.com/en-in/download/details.aspx?id=57518)) e especificando o seguinte:
