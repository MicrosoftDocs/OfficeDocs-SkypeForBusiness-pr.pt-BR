...
1. **Data de início** Esta é a data de início da linha do tempo que o relatório deve ser gerado para; Por exemplo, 1 de agosto de 2010.
    
2. **Data de término** Esta é a data de término da linha do tempo que o relatório deve ser gerado para; Por exemplo, 30 de setembro de 2010.
...
- **Local de arquivos de log do servidor** O local da pasta onde os logs do servidor de política de largura de banda são armazenados. Esse é normalmente em \<servidor de arquivos\>\\< opção de FE\>\AppServerFiles\PDP.
...
|Windows PowerShell versão 3.0  <br/> |http://www.microsoft.com/en-us/download/details.aspx?id=34595  <br/> |
|Pacotes Redistribuíveis do Visual C++ 2010  <br/> |http://www.microsoft.com/en-us/download/details.aspx?id=5555  <br/> |
|Atualizações do Servidor de Informações da Internet  <br/> |http://www.microsoft.com/en-us/download/details.aspx?id=34869  <br/> |
