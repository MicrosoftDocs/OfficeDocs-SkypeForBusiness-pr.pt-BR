...
**Resumo:** Saiba como configurar seu Skype para Business Server 2015 infra-estrutura para funcionar com o System Center Operations Manager.
  
Em um mundo ideal, você nunca seria encontrar problemas com Skype para Business Server 2015. No entanto, Skype para Business Server pode ser afetado por fatores externos — por exemplo, falhas e falhas de hardware de rede. Usando Skype para pacotes de gerenciamento de 2015 Business Server, você pode identificar e abordar problemas potenciais de proativamente. Dessa forma, o Skype para pacotes de gerenciamento do Business Server 2015 estender os recursos do System Center Operations Manager.
  
Essas informações foi escritas com base na versão 9319.0 do pacote de monitoramento para Skype Business Server 2015 software de comunicações.
  
## <a name="configuration-overview"></a>Visão Geral da Configuração

 Para configurar sua Skype para Business Server 2015 infra-estrutura para funcionar com o System Center Operations Manager, você deve fazer três coisas:
...
|Funções do servidor associadas a um domínio  <br/> |Todos os Skype interno para funções de servidor de Business Server 2015 deve ser associado ao domínio.  <br/> |
|Funções autônomas do servidor  <br/> |Skype para os servidores de borda de 2015 Business Server não são necessários a ser associado ao domínio.  <br/> |
...
O pacote de monitoramento para Skype para Business Server 2015 inclui os seguintes arquivos:
...
Os seguintes recursos são novos no Skype para pacotes de gerenciamento do Business Server 2015.
  
- **Descoberta automática para logon do cliente** Aplicativos cliente que entrar no Skype para Business Server 2015 frequentemente automaticamente descubram o servidor para entrar no. As transações sintéticas agora oferecem suporte para verificar se a descoberta automática está configurada corretamente.
...
|14  <br/> |Conferência discada  <br/> |Novo no Skype para Business Server 2015  <br/> |
|15  <br/> |Conferência para Compartilhamento de Aplicativos  <br/> |Novo no Skype para Business Server 2015  <br/> |
|16  <br/> |Conferência de UCWA (participação de reunião na web)  <br/> |Novo no Skype para Business Server 2015  <br/> |
...
![Sondagem de pacote cumulativo de atualizações do SCOM consecutiva](../../media/655de542-cca7-4eda-8052-9a7703ecd0e9.png)
