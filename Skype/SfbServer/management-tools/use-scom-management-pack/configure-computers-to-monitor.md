...
**Resumo:** Instale os arquivos do agente do Operations Manager no computador do Skype for Business Server 2015 a ser monitorado e configure o computador para atuar como um proxy do System Center.
