...
> [!NOTE]
> Nem todas as CAs públicas estão em conformidade com os requisitos Skype for Business Server certificados. Recomendamos a consulta à lista de fornecedores certificados de CA pública para suas necessidades de certificado público. 
