...
|Windows Server 2012 sistema operacional do Datacenter R2 com todas as atualizações necessárias instaladas.   |Windows Server 2012 R2 Standard OS com todas as atualizações necessárias instaladas.   |
...
- Para Windows Server 2012, o artigo KB 2858668 deve ser instalado antes de uma atualização. [Obter isso aqui](https://support.microsoft.com/kb/2858668/).
    
- Se você tiver Windows Server 2012 R2, instale o artigo KB 2982006 antes de atualizar. [Ele foi encontrado aqui](https://support.microsoft.com/kb/2982006/).
...
Você pode usar SQL espelhamento ou SQL clustering com Skype for Business Server 2015, ele tem suporte. SQL espelhamento é criado por meio do Construtor Skype for Business Server Topologia. Se você tiver a intenção de configurar SQL clustering, isso é feito em SQL Server.
