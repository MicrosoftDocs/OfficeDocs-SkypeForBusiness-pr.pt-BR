...
3. Insira credenciais do Skype for Business na área de trabalho virtual.
...
- **Sem suporte: Sessões de Área de Trabalho Remota.** Nesse cenário, cada usuário faz o login em uma sessão de área de trabalho virtual genérica que não pode ser personalizada. Exemplos incluem o Microsoft Remote Desktop Sessions (RDSH) e o Citrix XenApp combinados com o Receptor Citrix.
...
- Ingressar em reuniões anonimamente (ou seja, ingressar em reuniões do Skype for Business hospedadas por uma organização que não se federa com sua organização).
