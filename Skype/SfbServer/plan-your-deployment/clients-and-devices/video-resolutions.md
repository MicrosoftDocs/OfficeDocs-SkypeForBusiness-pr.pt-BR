...
Os profissionais de TI acharão essas informações úteis para avaliar a adequação de laptops já em uso em sua organização ou em consideração para uso. Eles também podem pesquisar no [Catálogo de Soluções](https://partnersolutions.skypeforbusiness.com/solutionscatalog) para obter informações sobre dispositivos específicos.
