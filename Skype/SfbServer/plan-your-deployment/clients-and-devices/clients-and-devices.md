...
O [cliente Skype for Business para Mac](https://www.microsoft.com/download/details.aspx?id=54108) está disponível para download. Confira [os requisitos de cliente do Skype for Business](mac-requirements.md) para Mac para revisar os pré-requisitos.
...
O Complemento de Reunião Online do Skype for Business oferece suporte ao gerenciamento de reuniões de dentro do cliente de colaboração e mensagens do Microsoft Outlook no Windows. O software Desempresado de Reunião Online para Skype for Business é instalado automaticamente com o Skype for Business.
...
O Microsoft Surface Hub é um dispositivo de produtividade tudo em um destinado a brainstorming, colaboração e apresentações. Ele tem sua própria iteração do cliente Skype for Business, documentada no guia de administração do [Microsoft Surface Hub.](https://docs.microsoft.com/surface-hub/)
...
Os instaladores de cliente estão disponíveis para instaladores do tipo MSI e clique para executar. A estratégia de manutenção do cliente Skype for Business pode afetar suas escolhas, portanto, você deve entender os seguintes pontos:

- Em geral, o Skype for Business NÃO adiciona novos recursos a clientes lançados anteriormente

- Em geral, o Skype for Business NÃO planeja enviar novos recursos no Skype for Business MSI após seu lançamento inicial. As melhorias de MSI entre as versões serão basicamente qualidade/segurança em sua natureza.

- A melhor e mais recente experiência do cliente Skype for Business será encontrada no instalador clique para executar do Skype for Business 2019.
...
Talvez você queira usar a Ferramenta [de Implantação do Office](https://www.microsoft.com/download/details.aspx?id=49117) para esse tipo de instalador.

As versões cliente básica e completa (com a opção de versões de 32 e 64 bits) estão disponíveis usando um instalador clique para executar, seus usuários podem baixar em Baixar o [Skype for Business](https://products.office.com/skype-for-business/download-app?tab=tabs-3)em todos os seus dispositivos.

### <a name="msi"></a>MSI

O MSI é um método de instalação mais tradicional, usado nos clientes do Skype for Business 2015 e 2016. Ele permite que você instale manualmente atualizações e patches, use licenciamento por volume e ativação e é personalizável por meio da Ferramenta de [Personalização do Office.](https://www.microsoft.com/download/details.aspx?id=49030) Você pode distribuir clientes aplicando Políticas de Grupo, usando o Microsoft Endpoint Configuration Manager ou usando uma ferramenta de terceiros.
...
O Skype for Business Server 2019 e o Skype for Business Online suportam os seguintes clientes lançados anteriormente: Skype for Business 2016, Skype for Business 2015, Lync 2013.
...
Consulte os artigos a seguir para entender os recursos, plataformas, sistemas operacionais, navegadores e integração com os clientes do Skype for Business com suporte.
...
- [Requisitos de sistema do Skype for Business para Windows Phone](requirements-for-windows-phone.md)
