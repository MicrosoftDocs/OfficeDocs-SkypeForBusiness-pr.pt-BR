...
Além disso, você pode querer uma cópia do [SkypeRoomProvisioningScript.ps1](../../deploy/deploy-clients/room-systems-v2-scripts.md), usado para provisionar contas do Skype sala sistemas v2.
