...
---
# <a name="include-the-security-desk-in-skype-for-business-server"></a>Incluir a central de segurança no Skype for Business Server
 
Planejamento de como incluir a central de segurança da sua organização em uma implantação do E9-1-1, no Skype for Business Server Enterprise Voice.
