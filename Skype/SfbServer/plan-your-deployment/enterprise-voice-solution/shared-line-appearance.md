...
Para obter informações sobre como implantar o SLA, consulte [Implantar Shared aparência no Skype para Business Server 2015 da linha](../../deploy/deploy-enterprise-voice/deploy-shared-line-appearance.md).
