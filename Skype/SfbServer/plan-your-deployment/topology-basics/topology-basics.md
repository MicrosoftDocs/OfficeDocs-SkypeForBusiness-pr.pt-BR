...
|||||
|:-----|:-----|:-----|:-----|
|Firewalls  <br/> |Gateways PSTN (se você implantar Enterprise Voice  <br/> |Exchange UM Server (se você deseja integrar-se à UM do Exchange)  <br/> |Balanceamento de carga DNS  <br/> |
