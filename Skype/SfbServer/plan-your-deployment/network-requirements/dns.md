...
|A/AAAA   |FQDN de substituição de serviços Web internos do pool empresarial  <br/> *Web-int. <span></span> contoso <span></span> .com*   |VIP HLB para Serviços Web Internos do Servidor front-end  <br/> *192.168.21.120*   |Necessário para habilitar o tráfego web de cliente para servidor, como baixar o Skype for Business Web App. Também é necessário para clientes móveis.   |S   |
...
|A/AAAA   |FQDN dos serviços Web do pool de Front-End Externo  <br/>*Web-ext. <span></span> contoso <span></span> .com*  |Endereço IP público de proxy reverso, proxy para o VIP de Serviços Web Externos para seu pool de front-end &#x2776; <br/> 131.107.155.1 proxy para 192.168.21.120   |Interface externa do pool de front-end usada pelo Skype for Business Web App   |S   |
