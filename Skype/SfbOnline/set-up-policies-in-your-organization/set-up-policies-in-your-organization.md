---
title: Configurar políticas em sua organização
ms.reviewer: ''
ms.author: tonysmit
author: tonysmit
manager: serdars
...
- [Retenção de arquivos grandes anexados a uma reunião](retaining-large-files-attached-to-a-meeting.md)
- [Configurar políticas de conferência para sua organização](set-up-conferencing-policies-for-your-organization.md)
- [Configurar políticas móveis para sua organização](set-up-mobile-policies-for-your-organization.md)
