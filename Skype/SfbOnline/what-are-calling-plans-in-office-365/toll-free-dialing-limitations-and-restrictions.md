...
---
# <a name="toll-free-dialing-limitations-and-restrictions"></a><span data-ttu-id="eb1e1-105">Restrições e limitações de discagem gratuita</span><span class="sxs-lookup"><span data-stu-id="eb1e1-105">Toll-free dialing limitations and restrictions</span></span>

<span data-ttu-id="eb1e1-106">Isso ajudará você a descobrir como discar números de Chamada Tarifada gratuito em cada país ou região.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-106">This will help you find out how to dial toll free numbers in each country or region.</span></span> <span data-ttu-id="eb1e1-107">Depois de selecionar o país/região, ela levará a uma página que contém a onde o serviço de Chamada Tarifada gratuito está disponível incluindo detalhes específicos, restrições e limites.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-107">After you select the country/region, it will take you to a page that contains where toll free service is available including specific details, restrictions, and limits.</span></span> <span data-ttu-id="eb1e1-108">O formato de discagem ou formatos mostrará os códigos de acesso necessários dentro de cada país/região para discar o número de chamada gratuito.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-108">The dialing format or formats will show you the required access codes within each country/region to dial the toll-free number.</span></span>
  
<span data-ttu-id="eb1e1-109">Se você estiver pronto, selecione um país ou região:</span><span class="sxs-lookup"><span data-stu-id="eb1e1-109">If you're ready, select a country or region:</span></span>
  
## <a name="select-your-country-or-region-to-see-the-dialing-codes-limitations-and-restrictions"></a><span data-ttu-id="eb1e1-110">Selecione seu país ou região para ver os códigos de discagem, limitações e restrições.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-110">Select your country or region to see the dialing codes, limitations and restrictions.</span></span>
...
## <a name="here-are-some-important-things-for-you-to-remember-about-toll-free-numbers"></a><span data-ttu-id="eb1e1-172">Aqui estão algumas coisas importantes de lembrar sobre números de Chamada Tarifada livre:</span><span class="sxs-lookup"><span data-stu-id="eb1e1-172">Here are some important things for you to remember about toll free numbers:</span></span>

- <span data-ttu-id="eb1e1-173">**Números gratuitos tarifados só funcionam dentro de cada país/região.**</span><span class="sxs-lookup"><span data-stu-id="eb1e1-173">**Toll free numbers only operate within each country/region.**</span></span> <span data-ttu-id="eb1e1-174">Por exemplo, os usuários não conseguirá telefonar para um número de chamada gratuito australiano fora da Austrália.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-174">For example, your users won't be able to call an Australian toll-free number outside of Australia.</span></span>
    
- <span data-ttu-id="eb1e1-175">**Aquisição ou portando números de telefônico gratuito do Universal internacional (UIFN) não é suportado.**</span><span class="sxs-lookup"><span data-stu-id="eb1e1-175">**Acquiring or porting Universal International Freephone Numbers (UIFN) isn't supported.**</span></span>
    
- <span data-ttu-id="eb1e1-176">**Em muitos países/regiões, agência reguladores/telecomunicação no país/região requer cada número de chamada gratuita manter pelo menos 100 minutos de uso por mês para reter o número.**</span><span class="sxs-lookup"><span data-stu-id="eb1e1-176">**In many countries/regions, the regulator/telecommunication agency in the country/region requires each toll free phone number to maintain at least 100 minutes of usage per month in order to retain the number.**</span></span>
...
- <span data-ttu-id="eb1e1-178">**Modo de cabo telefônico, linha fixa e acesso à rede móvel para números para ligações gratuitas podem ser totalmente ou parcialmente restritos.**</span><span class="sxs-lookup"><span data-stu-id="eb1e1-178">**Wireline, fixed line, and mobile network access to toll-free numbers may be fully or partially restricted.**</span></span> <span data-ttu-id="eb1e1-179">O formato de discagem descreve os códigos de acesso necessários em cada país/região para fazer chamadas usando o número gratuito.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-179">The dialing format describes the required access codes within each country/region to place calls using the toll free number.</span></span>
    
- <span data-ttu-id="eb1e1-180">**Números gratuitos de chamada de plano de numeração da América do Norte:** Taxas de por minuto para o esquema de numeração da América do Norte os números são determinadas pelo país originador.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-180">**North America Numbering Plan Toll Free Numbers:** Per-minute rates for North America Numbering Plan toll free numbers are determined by the originating country.</span></span> <span data-ttu-id="eb1e1-181">A taxa por minuto livre de Chamada Tarifada para chamadas originadas no mapa dos Estados Unidos à taxa definida como "América do Norte".</span><span class="sxs-lookup"><span data-stu-id="eb1e1-181">The toll free per-minute rate for calls that originate from the United States map to the rate defined as "North America."</span></span> <span data-ttu-id="eb1e1-182">No entanto, chamadas originadas em outros países na América do Norte como Canadá, Porto Rico, etc. têm taxas de livre de Chamada Tarifada específico.</span><span class="sxs-lookup"><span data-stu-id="eb1e1-182">However, calls that originate from other North American countries such as Canada, Puerto Rico, etc. have specific toll free rates.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="eb1e1-184">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="eb1e1-184">Related topics</span></span>
[<span data-ttu-id="eb1e1-185">Obtendo números de telefone de serviço do Skype for Business e do Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="eb1e1-185">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md)
