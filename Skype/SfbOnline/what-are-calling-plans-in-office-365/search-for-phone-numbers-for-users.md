...
4. Na página **Adicionar novos números de usuário**, clique nas listas de**País** e **Estado** para selecionar o estado em que você deseja selecionar números e, em seguida, selecione o código de área da cidade na lista **Cidade**.
    
5.  Em **quantidade**, digite o número dos números de telefone que você deseja para a sua organização e clique em **Adicionar** para criar uma reserva. [!CUIDADO] Você tem 10 minutos para selecionar seus números de telefone. Se você demorar mais de 10 minutos, os números serão retornados ao pool de números de telefone.
