...
4. **Atribuir números de telefones** A última etapa é habilitar os usuários para fazerem e receberem ligações. Para isso, é necessário atribuir um número de telefone a cada usuário. Consulte [atribuir, alterar ou remover um número de telefone para um usuário](assign-change-or-remove-a-phone-number-for-a-user.md) para atribuir um número de telefone.
