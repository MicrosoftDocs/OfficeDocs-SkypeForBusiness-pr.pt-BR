...
O Sistema de Telefonia no Office 365 fornece um ID de chamada padrão que é o número de telefone atribuído ao usuário. Você pode alterar ou bloquear o ID de chamadas (também chamado de ID da linha de chamada) de um usuário. Você pode obter mais informações sobre como usar o ID de chamada em sua organização acessando [Como a identificação de chamadas pode ser usada em sua organização](how-can-caller-id-be-used-in-your-organization.md).
...
- **Bloquear o ID de chamadas de saída** Você pode bloquear o envio do ID em chamadas PSTN do usuário. Isso impede que o número de telefone seja exibido no telefone da pessoa que está sendo chamada.
    
- **Bloquear o ID de chamadas de entrada** Você pode impedir o usuário de receber o ID de chamada em quaisquer chamadas PSTN recebidas.
    
> [!IMPORTANT]
> As chamadas de emergência sempre enviarão o número de telefone do usuário (identificação de chamadas). 
...
- Para ver todas as políticas de configuração de identificação de chamadas em sua organização execute:

  ```
  Get-CsCallingLineIdentity |fl
  ```
Ver mais exemplos e detalhes de [Get-CsCallingLineIdentity](https://technet.microsoft.com/en-us/library/mt793856.aspx).
...
- Para criar uma nova política de identificação de chamadas que define o ID de chamadas como anônimo, execute:
  ...
  Ver mais exemplos e detalhes de [New-CsCallingLineIdentity](https://technet.microsoft.com/en-us/library/mt793855.aspx).
    
- Para aplicar a nova política que você criou para Amos Marble, execute:
...
Se você já criou uma política, pode usar o cmdlet [Set-CsCallingLineIdentity](https://technet.microsoft.com/en-us/library/mt793854.aspx) para fazer alterações na política existente, depois usar o cmdlet [Grant-CsCallingLineIdentity](https://technet.microsoft.com/en-us/library/mt793857.aspx) para aplicar as configurações a seus usuários.
...
- Para bloquear o ID de chamadas recebidas, execute:
    
  ```
  Set-CsCallingLineIdentity  -Identity "Block Incoming" -BlockIncomingPstnCallerID $true -EnableUserOverride $true
  ```
  Ver mais exemplos e detalhes de [Set-CsCallingLineIdentity](https://technet.microsoft.com/en-us/library/mt793854.aspx).
    
- Para aplicar a configuração de política criada para um usuário na sua organização, execute:
