...
A validação de endereço é uma parte importante da configuração de Planos de Chamada. Se, por algum motivo, um número de telefone não for ativado devido à validação de endereço, você precisará criar uma solicitação de serviço. A maneira de fazer isso depende do tamanho da sua organização.
