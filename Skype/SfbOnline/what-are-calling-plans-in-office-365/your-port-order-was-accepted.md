...
ms.locfileid: "54334403"
---
# <a name="your-port-order-was-accepted"></a>Seu pedido de portabilidade foi aceito

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]

Sua ordem de portabilidade foi aprovada! Procure seus números de telefone no centro de administração **Skype for Business voz**  >  **Telefone**  >  **números**.
