...
ms.custom:
- Phone System
description: 'Saiba como configurar e testar os atendedores automáticos de sistema telefônico para eficiente tratamento de chamadas para sua organização. '
...
[Exemplo de pequena empresa - Configurar um atendedor automático](tutorial-org-aa.yml)  
