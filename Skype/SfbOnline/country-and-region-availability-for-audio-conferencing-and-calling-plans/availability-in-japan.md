...
Eis os serviços do Office 365 para Skype para Teams da Microsoft e de negócios para japonês.
...
|Os números de telefone são atribuídos automaticamente para a Audioconferência?  <br/> |Sim, para Tokyo. Para obter números de telefone dedicados, consulte [Obtendo números de telefone de serviço do Skype for Business e do Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
