...
- Para ver a lista de idiomas com suporte para conferência de áudio, consulte [Serviços de audioconferência de idiomas com suporte](/MicrosoftTeams/audio-conferencing-supported-languages).
