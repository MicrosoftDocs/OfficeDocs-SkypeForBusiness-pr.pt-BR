...
> [!Note]
> Para obter informações sobre IDs de conferência do usuário no Microsoft Teams, consulte Exibir e redefinir uma [ID](/MicrosoftTeams/see-change-and-reset-a-conference-id-assigned-to-a-user-in-teams)de conferência atribuída a um usuário no Microsoft Teams .
...
Embora uma ID de conferência seja criada e atribuída automaticamente a um usuário, pode haver momentos em que um usuário não deseja usá-la e você deseja defini-la como um determinado número, ou quando seus usuários não puderem se lembrar ou perderem a ID da conferência. Você pode usar o Centro de administração do **Skype for Business** e Windows PowerShell para exibir, alterar e redefinir a ID da conferência.
...
3. No Centro de administração do **Skype for Business** Usuários de audioconferência , no painel Ação em ID da >    >  Conferência, clique em **Redefinir**. 
