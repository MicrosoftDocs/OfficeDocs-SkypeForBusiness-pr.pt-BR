...
Você deve ter permissões de administrador global para configurar o Skype for Business. Se você tiver um servidor proxy ou firewall que restringe o acesso a partes da Web, considere contratar um [parceiro da Microsoft](https://go.microsoft.com/fwlink/?linkid=391089) para configurar o Skype for Business para você.

## <a name="setting-up-skype"></a>Configurando o Skype

Parece que você precisa de ajuda para configurar o Skype com sua assinatura do Microsoft 365 ou do Office 365. Você pode seguir as etapas deste artigo para concluir sua configuração.

## <a name="1-plan-for-skype-for-business"></a>1. Planejar o Skype for Business

Se você tiver **[o Microsoft 365 Business Premium Standard ou o](https://products.office.com/business/office-365-business-premium)** **Business Essentials**, poderá usar o Skype for Business para fazer chamadas online para outras pessoas em sua empresa, que estão na sua assinatura. Por exemplo, se sua empresa tiver 10 pessoas, você poderá [começar a usar o Skype for Business para mensagens instantâneas e reuniões online](https://support.office.com/article/cc05afa6-1894-4a82-9dd9-6222061f50fd) entre si, além de [reuniões com o Skype for Business](https://support.office.com/article/2eed8424-581a-4497-b505-c08c152e5851) usando o Skype for Business depois de executar as etapas de 2 a 6 abaixo. E você também pode [configurar uma reunião do Skype for Business no Outlook](https://support.office.com/article/b8305620-d16e-4667-989d-4a977aad6556#bkmk_OWA) para reuniões online!
...
1. Localize sua identificação de usuário do Microsoft 365 ou do Office 365 (por exemplo, <em>Rob@fourthcoffee.com</em> ). Você recebeu um email da equipe de serviços online da Microsoft que contém a ID de usuário do Microsoft 365 ou do Office 365 que você criou quando comprou o Skype for Business online. O email tem a seguinte aparência:

    ![Um exemplo do email de boas-vindas que você recebeu depois de se inscrever no Skype for Business online. Ele contém a ID de usuário do Microsoft 365 ou do Office 365.](../images/977c5c96-29c5-40c0-a4c4-1ba66ba3a1fb.png)

2. Entre no centro de [Administração](https://admin.microsoft.com) e insira sua ID de usuário e senha do Microsoft 365 ou do Office 365. 
...
- [Instale o Skype for Business](https://support.office.com/article/8a0d4da8-9d58-44f9-9759-5c8f340cb3fb): instruções sobre como baixar o aplicativo no centro de administração do Microsoft 365 e instalá-lo no seu PC ou Mac.
...
## <a name="all-done-setting-up-getting-started-using-skype-for-business"></a>Já está tudo configurado? Introdução ao Skype for Business
<a name="bkmk_more"> </a>
