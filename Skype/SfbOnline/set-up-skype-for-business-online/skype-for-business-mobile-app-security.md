...
**Observação:** Consulte esta [documentação pública para imposição](/mem/intune/protect/device-compliance-get-started) de pino de dispositivo disponível em cada uma das plataformas Móveis acima.
