...
**Observação:** Consulte esta [documentação pública para](https://docs.microsoft.com/InTune/deploy-use/introduction-to-device-compliance-policies-in-microsoft-intune) a imposição de fixar dispositivos disponível em cada uma das plataformas móveis acima
