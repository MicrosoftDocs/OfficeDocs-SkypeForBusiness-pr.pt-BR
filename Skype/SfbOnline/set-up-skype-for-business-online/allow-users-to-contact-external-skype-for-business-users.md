...
Você deve ter [permissões de administrador](https://support.office.com/article/da585eea-f576-4f55-a1e0-87090b6aaa9d) no Microsoft 365 ou no Office 365 em ambas as organizações para fazer essa comunicação.
...
3. Na **central do teams**, escolha **Skype** > **portal herdado**do Skype 
...
10. **AGUARDE 24 HORAS PARA FAZER O TESTE**. Quando você altera as configurações de comunicações externas, pode levar até 24 horas para que as alterações sejam preenchidas em todos os centros de dados.
...
4. Outra maneira de testar se o problema é o seu firewall é acessar um local WiFi que não está protegido pelo firewall, como uma lanchonete. Use o Skype for Business para enviar uma solicitação ao seu contato para conversar. Se a mensagem for enviada de lá, mas não de seu trabalho, então você saberá que o problema é o firewall.
...
Depois de habilitar a comunicação externa com outros usuários do Skype for Business, os usuários podem encontrar usuários do Skype for Business federados procurando seus nomes de entrada. Um exemplo é Rob@contoso.com. Então, eles deverão adicionar a pessoa à lista de contatos.
...
2. No centro de administração, vá para usuários ativos do **usuários**  >  **Active users**.
