 ...
 **Observação**: as etapas a seguir consideram que você está usando o Microsoft Forefront Threat Management Gateway (TMG) 2010. Se você tiver uma solução de gateway web diferente, use as configurações descritas na etapa 4 abaixo.
