...
A Skype for Business configuração de presença online oferece às pessoas mais controle sobre quem pode ver se elas estão disponíveis, em uma reunião ou fora do escritório. Para obter detalhes sobre Skype for Business configurações de privacidade e presença, consulte [Configure presence in Skype for Business Online](configure-presence-in-skype-for-business-online.md). 
  
## <a name="choose-the-default-online-presence-setting-for-everyone-in-your-organization"></a>Escolha a configuração de presença online padrão para todos na sua organização
<a name="__top"> </a>

1. Vá para o centro de administração Skype for Business Online > **Organização > Geral**.
...
|**Exibir informações de presença somente para contatos de um usuário** <br/> |Qualquer pessoa na lista de contatos de um  usuário que não pertence ao **grupo de** privacidade Externo ou Bloqueado. <br/> Usuários individuais podem alterar essa configuração na caixa de Skype for Business **Opções.** <br/> |
