...
|Discagem format(s)  <br/> |0004 019 XXXX  <br/> |
|Código ISO de país/região  <br/> |UY  <br/> |
|Ilha/território abordado  <br/> |Não se aplica  <br/> |
|Ilha/território não coberto  <br/> |Não se aplica  <br/> |
|Disponibilidade de linha fixa/com fio  <br/> |Sim, com exceção da Claro.  <br/> |
|Disponibilidade de rede móvel  <br/> |Parcial. Veja os comentários.  <br/> |
|Comentários, restrições e problemas de acesso  <br/> |Acesso móvel: O horário da transmissão é cobrado. Acesso móvel: Disponível pela Ancel e pela Movistar.  <br/> |
