...
1. Vá para o centro de administração e, em seguida, na barra de navegação à esquerda, clique em **configurações** > de**Serviços &amp; e suplementos**e, em seguida, escolha **Skype for Business**.
