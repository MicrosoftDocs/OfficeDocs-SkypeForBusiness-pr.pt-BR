...
- [Erro de Módulo de Importação causado pela política de execução do Windows PowerShell](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKPowerShellExecutionPolicy)
    
- [Erro de Módulo de Importação causado pela versão incorreta do Windows PowerShell](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKIncorrectVersion)
...
- [Falha de logon para o usuário](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKLogonFailed)
