---
title: Bloqueando usando o Powershell para Skype para negócios Onlin de chamada de entrada
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.date: 05/07/2018
...
ms.custom:
- PowerShell
description: Use o PowerShell para gerenciar o bloqueio no Skype para o Business Online de chamada de entrada.
...
---
# <a name="inbound-pstn-call-blocking-for-calling-plans"></a>Chamada PSTN bloqueio de planos de chamada de entrada

Skype para negócios Online chamar planos agora oferece suporte a bloqueio de chamadas de entrada da rede telefônica pública comutada (PSTN). Este recurso permite que um locatário lista global de padrões de número a ser definida para que a ID de chamador de cada chamada PSTN de entrada para o inquilino pode ser verificada em relação à lista uma correspondência. Se for feita uma correspondência, uma chamada de entrada é rejeitada. 
...
Neste exemplo, o parâmetro identity, se for necessário (is?):`Remove-CsInboundBlockedNumberPattern -Identity “<identity>”`
