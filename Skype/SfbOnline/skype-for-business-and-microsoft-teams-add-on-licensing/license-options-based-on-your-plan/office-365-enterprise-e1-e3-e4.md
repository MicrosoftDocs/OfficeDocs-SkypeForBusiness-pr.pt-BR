...
3. Após comprar uma licença do **Sistema de Telefonia**, você verá o preço e a opção de comprar um Plano de Chamadas.
...
2. Entre no centro de administração e vá para **Cobrança** > **Assinaturas** > **Complementos**.
