...
## <a name="how-does-add-on-licensing-affect-cost"></a>Como o complemento licenciamento afetam custo?
...
Para obter informações de custo, consulte [como ver os preços e licenças de complemento de comprar](skype-for-business-and-microsoft-teams-add-on-licensing.md#bkmk_how) ou um destes procedimentos:
...
- [Preços de planos de chamada](https://products.office.com/en-us/skype-for-business/calling-plans)
...
Precisamos conversar com alguém sobre todas as opções de complementos? [Contatar o suporte do Office 365 para empresas - Ajuda para Administradores](http://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b).

## <a name="license-options-based-on-your-plan"></a>Opções de licença com base no seu plano

As opções de licenciamento de complemento disponíveis para você depende em seu Office 365 ou Skype para o plano de negócios. Consulte os tópicos a seguir para obter informações, recursos e opções que são específicas para o seu plano. 
...
Consulte seu plano de "Opções de licença com base no seu plano" para obter mais detalhes sobre qual licencia comprar e como ver os preços e licenças de complemento de compra. 
