...
Você pode habilitar seu Skype para os usuários corporativos usem o Skype interna para a ferramenta de comentários de aplicativo de negócios para permitir que usuários relatar problemas e fornecer comentários diretamente à Microsoft sobre sua experiência. 
...
> [!IMPORTANT]
> Os logs coletados pela ferramenta de comentários do aplicativo serão armazenados para até um máximo de 90 dias nos Estados Unidos enquanto o problema estiver sendo investigados. Dessa forma, não habilite essa ferramenta de comentários se isso viola a política de proteção de dados da sua organização. 
