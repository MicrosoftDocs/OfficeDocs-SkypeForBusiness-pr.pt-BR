...
## <a name="who-can-attend-an-audio-conferencing-meeting-and-who-can-i-hear"></a>Quem pode participar de uma reunião de conferência de áudio? E o que eu possa ouvir?

Qualquer pessoa que tenha a discagem número e conferência ID pode ingressar em uma Skype para reunião de negócios ou Teams da Microsoft, a menos que o organizador da reunião bloqueou a reunião.
  
Se você estiver chamando usando um telefone ou o Skype para aplicativos de negócios ou Teams da Microsoft, você conseguirá ouvir todas as outras pessoas na chamada e eles podem ouvi-lo. O organizador da reunião tem a capacidade de "Desativar" participantes da reunião se eles não desejam ouvi-los. 
...
Para obter uma lista atual de países/regiões, consulte [números de telefone de conferência de áudio](phone-numbers-for-audio-conferencing.md).
  
## <a name="can-i-set-up-local-numbers-for-audio-conferencing-from-additional-cities-in-the-country"></a>Pode configurar números locais para conferência de áudio de cidades adicionais no país?

Se os números de telefone para conferência de áudio não estão disponíveis na sua área ou não atenderem às necessidades da sua organização, por favor, envie seus comentários nos [fóruns de SkypeFeedback](http://www.skypefeedback.com/forums/299910--preview/category/119971-pstn-conferencing).
...
Adicionamos um novo recurso que permite a você, o [administrador](https://support.office.com/en-us/article/eac4d046-1afd-4f1a-85fc-8219c79e1504), para enviar e atualizar informações de conferência de áudio e o PIN em email. Para saber mais sobre ele, incluindo como desabilitá-lo, consulte [Habilitar ou desabilitar o envio de emails ao alteram as configurações de conferência de áudio](enable-or-disable-sending-emails-when-their-settings-change.md).
...
Não estamos lá. No entanto, você pode continuar a usar a conferência de áudio que está disponível no Skype para Business Server 2015 junto com um gateway PSTN para os usuários no local. 
...
## <a name="can-i-use-audio-conferencing-with-skype-meeting-broadcast"></a>Pode usar conferência de áudio com transmissão do Skype reunião?
...
> [!NOTE]
> Os usuários não poderão redefinir seu ID de conferência. A ID de conferência pode apenas ser redefinida por você, o [administrador](https://support.office.com/en-us/article/admin-eac4d046-1afd-4f1a-85fc-8219c79e1504), para a organização. 
...
> [!NOTE]
> Um Skype para negócios ou Microsoft Teams usuário não conseguirá redefinir seu PIN. O PIN pode apenas ser redefinido por você, o administrador. Quando um PIN é redefinido, um email é enviado ao usuário. 
...
## <a name="can-attendees-dial-out-to-international-phone-numbers-when-they-are-in-a-skype-for-business-or-microsoft-teams-meeting"></a>Podem participantes discar para números de telefone internacional quando estiverem em um Skype para reunião de negócios ou Teams da Microsoft?

Sim, os participantes podem discar internacionalmente e convidar outros chamadores em um Skype para reunião de negócios ou Teams da Microsoft. Consulte [discando check-out de uma reunião para que outras pessoas poderá ingressar nela](dialing-out-from-a-meeting-so-other-people-can-join-it.md).
  
## <a name="how-does-a-skype-for-business-or-microsoft-teams-user-schedule-a-meeting-with-audio-conferencing-meeting-details"></a>Como um Skype para negócios ou Microsoft Teams usuário agendar uma reunião com detalhes da reunião de conferência de áudio?
...
- **Opção 2**: se a configuração "Permitir não autenticado para os chamadores para ser as primeira pessoas em uma reunião" (desabilitada por padrão) está habilitada para um determinado organizador, então todas as reuniões agendadas por esse usuário poderá ser iniciado sem ter que o organizador de entrada é ou seu PIN de conferência áudio. Quando essa configuração estiver habilitada, a reunião será iniciado assim que o participante primeiro ingressa-lo por meio de um número de telefone de discagem e ele não será colocado no lobby. Para informações adicionais, consulte [conferência de áudio de gerenciar configurações para um usuário](manage-the-audio-conferencing-settings-for-a-user.md)
