...
4. No **Redefinir ID de conferência?** janela, clique em **Sim**. Uma conferência que ID será criado automaticamente e um email enviado ao usuário com a nova ID de conferência.
