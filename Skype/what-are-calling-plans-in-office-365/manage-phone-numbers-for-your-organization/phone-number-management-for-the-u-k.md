...
- Calling Plans
- Strat_SB_PSTN
description: "Use esta tabela para descobrir como obter e gerenciar números de telefone do Skype for Business Online no Reino Unido."
...
Use esta tabela para descobrir como obter e gerenciar números de telefone do Skype for Business Online no Reino Unido. 
...
|:-----|:-----|
|Você precisa obter números de usuário que não estejam listados no Centro de administração do Skype for Business.  <br/> |Baixe o formulário [Solicitação de novo número de telefone para o Reino Unido (números geográficos) (v.3.0)(en.us)](../../downloads/new-number-request-forms/new-phone-number-request-for-the-u.k.-(geographic-numbers)-(v.3.0)-(en.us).pdf), preencha-o e [o envie para nós](mailto:ptneu@microsoft.com).  <br/> |
|Você precisa obter números de telefone transferidos para nós.  <br/> |Baixe um destes formulários: <br/> [Carta de Autorização (LOA) para o Reino Unido (números geográficos) (v.2.0)(en.us)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-the-u.k.-(geographic-numbers)-(v.2.0)-(en.us).pdf) <br/> [Carta de Autorização (LOA) para o Reino Unido (números não geográficos) (v.2.1)(en.us)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-the-u.k.-(non-geographic-numbers)-(v.2.1)-(en.us).pdf) <br/>  Preencha o formulário e [o envie para nós](mailto:ptneu@microsoft.com).  <br/> |
