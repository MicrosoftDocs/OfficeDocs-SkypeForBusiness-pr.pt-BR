...
---
# <a name="transfer-phone-numbers-to-office-365"></a>Números de telefone de transferência para o Office 365
...
6. Na página **Números**, insira os números de telefone que você deseja transferir no formato E.164. Por exemplo, para um número da América do Norte, use o formato +1XXXYYYZZZZ. Separe vários números de telefone usando vírgulas.
...
9. Na página **carta de autorização** , verifique cada uma das seguintes caixas. Na caixa de **assinatura** , digite a pessoa que está autorizada a fazer alterações à conta. Este é o mesmo nome que é usado na página **Informações da conta** > **Authorizing pessoa**. Clique em **Avançar**.
...
Sua solicitação de pedido de porta será verificada e atualizada diariamente, e você será notificado de seu andamento e status no email. Se a sua solicitação será rejeitada, você deverá abrir um tíquete de suporte e no que suportam tíquete que solicitamos que você forneça a **Identificação do pedido de porta**. A ordem de porta ID pode ser encontrada no Skype para centro de administração de negócios em **voz** > **pedidos de porta** > coluna**Identificação do pedido** .
  
## <a name="what-if-i-have-problems"></a>E se eu tiver problemas?
<a name="bk_LNPcountries_1"> </a>
