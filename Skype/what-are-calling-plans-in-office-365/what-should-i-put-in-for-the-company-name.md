---
title: "O que devo colocar no nome da empresa?"
ms.author: tonysmit
author: tonysmit
manager: scotv
ms.date: 11/17/2017
...
# O que devo colocar no nome da empresa?

> [!IMPORTANT]
> Este artigo foi traduzido por um sistema de tradução automática, leia o aviso de isenção de responsabilidade.  
  
Este é o nome da sua empresa ou organização. O nome da empresa é limitado a 25 caracteres, que inclui espaços. O nome da empresa não é usado para processar a solicitação de ordem de porta; ele é usado no caso de uma controvérsia ou se algo está incorreto quando os números de telefone estão sendo migrados. Se você não couber o nome completo da empresa na caixa, ele não atrasar ou cancelar a ordem de porta.
