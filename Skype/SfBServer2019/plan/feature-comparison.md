...
&#x2779; Para Skype for Business aplicativos 2016, você deve estar usando Clique para Executar, build 16.0.4227 ou posterior.

&#x2780; Para Skype for Business aplicativos 2015, você deve ter a Atualização de setembro, build 15.0.4747 ou posterior.
...
Esta tabela aborda recursos relacionados ao suporte para funções de arquivamento e registro em log.
 ...
 | Recurso/funcionalidade | Skype for Business cliente 2015, 2016 ou 2019 | Skype for Business no Mac | Cliente Lync 2013 |  
|:-----|:-----|:-----|:-----|  
|Arquivamento de conversas de IM no Outlook Histórico de Conversas|&#x2714; &#x2776; |&#x2714; Se o histórico de conversas do lado do servidor estiver ligado  |&#x2714; &#x2776; | 
...
|Arquivamento do lado do cliente de transferências de arquivos, páginas de OneNote compartilhadas e PowerPoint anotações (indisponíveis no Skype for Business Online)  |&#x2714;||&#x2714;|
...
[Atualizações mais recentes para versões Skype for Business que usam Windows Installer (MSI)](../../SfbServer/sfb-client-updates.md)