...
description: Esta seção aborda as etapas necessárias para implantar um pool piloto do Skype for Business Server 2019. A implantação do Skype for Business Server 2019 requer o uso do Construtor de Topologias para definir sua topologia e os componentes que você deseja implantar, preparar seu ambiente para a implantação dos componentes do Skype for Business Server 2019, publicar seu design de topologia no primeiro Servidor Front-End e, em seguida, instalar e configurar o software do Skype for Business Server 2019 para os componentes da sua implantação. Quando concluída, a implantação do pool piloto do Skype for Business Server 2019 coexistiá com um pool herdado existente.
...
- [Preparar o Active Directory para o Skype for Business Server](prepare-active-directory.md)
    
- [Fazer o download da topologia da implantação existente](download-topology-from-existing-deployment.md)
    
- [Implantar o pool piloto do Skype for Business Server 2019](deploy-pilot-pool.md)
