...
### <a name="to-prepare-active-directory-for-skype-for-business-server-2019"></a>Para preparar o Active Directory para o Skype for Business Server 2019

1. No servidor front-end do Skype for Business Server 2019, execute o programa de instalação do Skype for Business Server 2019.
    
2. Selecione **preparar o Active Directory**.
  
3. Execute as etapas de 1 a 5 no assistente.
