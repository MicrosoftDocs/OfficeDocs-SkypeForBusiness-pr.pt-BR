...
description: Script auxiliar para configurar a autenticação do painel de controle SFB 2019 com o Microsoft 365 ou o Office 365 por meio do protocolo OAuth.
ms.openlocfilehash: 76f8444e78dfe31e008ea24be31c0e7b788b3130
ms.sourcegitcommit: da2a70a9b5e05d0fd7ecc150b451f5805667514c
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 03/12/2021
ms.locfileid: "50756217"
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="e56c6-103">Script de autenticação do painel de controle do Skype for Business Server 2019</span><span class="sxs-lookup"><span data-stu-id="e56c6-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="e56c6-104">A seguir estão os scripts auxiliares relacionados à autenticação para MacP (Painel de Controle de Administração Moderno).</span><span class="sxs-lookup"><span data-stu-id="e56c6-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="e56c6-105">Configurar a autenticação MACP com o Microsoft 365 ou o Office 365</span><span class="sxs-lookup"><span data-stu-id="e56c6-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="e56c6-106">Esse script deve ser executado após a instalação da Atualização Cumulativa 1 ou posterior do Skype for Business Server 2019, como parte da configuração do novo Painel de Controle.</span><span class="sxs-lookup"><span data-stu-id="e56c6-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="e56c6-107">Configurar o aplicativo MACP no Farm do ADFS</span><span class="sxs-lookup"><span data-stu-id="e56c6-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="e56c6-108">Esse script deve ser executado após a instalação da Atualização Cumulativa mais recente do Skype for Business Server 2019, como parte da configuração do novo Painel de Controle.</span><span class="sxs-lookup"><span data-stu-id="e56c6-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="e56c6-109">Configurar o OAuth para MACP</span><span class="sxs-lookup"><span data-stu-id="e56c6-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="e56c6-110">Esse script deve ser executado após a instalação da Atualização Cumulativa mais recente do Skype for Business Server 2019, como parte da configuração do novo Painel de Controle.</span><span class="sxs-lookup"><span data-stu-id="e56c6-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
