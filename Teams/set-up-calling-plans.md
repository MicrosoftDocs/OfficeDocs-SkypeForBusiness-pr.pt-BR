...
Chamadas para outros usuários do Skype for Business são grátis, mas se você quiser que os usuários possam fazer chamadas para telefones fora da sua empresa, adquira um plano de chamadas domésticas ou um plano de chamadas internacional no Office 365. É fácil configurá-lo para sua empresa. 

## <a name="step-1-find-out-if-calling-plans-are-available-in-your-countryregion"></a>Etapa 1: Descubra se os planos de chamadas estão disponíveis no seu país/região
Vá para a [disponibilidade de país e região para conferências de áudio e planos de chamadas](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md) e selecione seu país ou região para obter informações sobre a disponibilidade de planos de chamadas, além de informações sobre conferência de áudio, sistema telefônico, chamada tarifada e gratuita números e créditos de comunicações.
  
## <a name="step-2-buy-and-assign-licenses"></a>Etapa 2: comprar e atribuir licenças
1. Se o sistema telefônico no recurso do Office 365 não estiver incluído no seu plano, talvez seja necessário comprar licenças complementares do **sistema telefônico** . Depois de ter licenças do **sistema de telefonia** , compre [planos de chamadas para o Office 365](calling-plans-for-office-365.md). Consulte [Licenciamento de Complementos do Microsoft Teams](teams-add-on-licensing/microsoft-teams-add-on-licensing.md)e compre as licenças e o plano. 
...
- **Use o centro de administração do Skype for Business.** Em alguns países/regiões, você pode obter números para seus usuários usando o centro de administração do Skype for Business, consulte[Como obter números de telefone para seus usuários](/microsoftteams/getting-phone-numbers-for-your-users).
    
- **Fazer a portabilidade de seus números existentes.** Você pode fazer a portabilidade/transferência de números existentes do seu provedor de serviços ou operadora de telefonia atual para o Office 365. Consulte [transferir números de telefone para o Teams](phone-number-calling-plans/transfer-phone-numbers-to-teams.md) ou [gerenciar números de telefone de sua organização](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) para obter mais informações para ajudá-lo a fazer isso.  
...
<a name="bkmk_add_addresses"></a> Ao configurar planos de chamada no Office 365, você deve atribuir um número de telefone e um endereço de emergência para cada um dos seus usuários. O endereço de emergência deve ser criado antes de atribuir um número de telefone a um usuário. 
...
No centro de administração do Skype for Business,**** > vá para**usuários** > de voz de **voz** > **atribuir** > **local de alteração**de número. Para obter mais detalhes, consulte [atribuir ou alterar um endereço de emergência para um usuário](/skypeforbusiness/what-are-calling-plans-in-office-365/assign-or-change-an-emergency-address-for-a-user) .
   ...
   > [!NOTE]
   > Você também pode atribuir um endereço de emergência ao atribuir um número de telefone.
...
## <a name="step-6-tell-your-users-about-their-new-phone-numbers"></a>Etapa 6: Mostre aos usuários seus novos números de telefone
