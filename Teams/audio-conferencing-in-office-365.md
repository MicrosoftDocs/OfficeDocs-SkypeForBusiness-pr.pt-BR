...
- seo-marvel-apr2020
description: Saiba mais sobre como a Audioconferência no Microsoft 365 permite que os usuários liguem para reuniões de seus telefones.
ms.openlocfilehash: 1ac2842d219648c5a5deef0d687698cd7b5544dd
ms.sourcegitcommit: 5abfb6f1abe10b6d32cf6eb97a890cf3138ed0e6
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/10/2022
ms.locfileid: "67641922"
---
# <a name="audio-conferencing-in-microsoft-365"></a>Audioconferência no Microsoft 365

A Audioconferência no Microsoft 365 permite que os usuários liguem para reuniões de seus telefones. A Audioconferência permite até 1.000 participantes do telefone.

## <a name="what-is-audio-conferencing"></a>O que é audioconferência?

Ligar (discar) para reuniões é muito útil para usuários que estão em trânsito e não podem participar de uma reunião usando o aplicativo Microsoft Teams em seus laptops ou dispositivos móveis. Mas há outros cenários em que usar um telefone para participar de uma reunião do Teams pode ser uma opção melhor do que usar um aplicativo em um computador:
  
- Conectividade com a Internet é limitada.
- Uma reunião é apenas de áudio.
- A pessoa tentou ingressar em uma reunião do Teams e ela falhou.
...
Depois que os participantes tiverem ingressado na reunião, eles também poderão discar e convidar outros chamadores para uma reunião do Teams.
Consulte [Discagem de uma reunião do Teams para que outras pessoas possam ingressá-la](dialing-out-from-a-teams-meeting-so-other-people-can-join-it.md) para obter mais informações.
...
Ao configurar a Audioconferência para o Teams, você receberá uma ponte de audioconferência. Uma ponte de conferência pode conter um ou mais números de telefone. O número de telefone definido será incluído nos convites da reunião para aplicativos do Teams. Você pode [alterar os números de telefone em suas pontes de conferência](change-the-phone-numbers-on-your-audio-conferencing-bridge.md) e também [alterar outras configurações da ponte de audioconferência](change-the-settings-for-an-audio-conferencing-bridge.md).

A ponte de audioconferência atende uma chamada feita por um usuário que discou para a reunião utilizando um telefone. Ela atende o chamador com comandos de voz de um atendedor automático e, dependendo de suas configurações, pode reproduzir notificações e pedir para o chamador registrar o nome dele. **As configurações de ponte da Microsoft** permitem que você altere as configurações para notificações de reunião e a experiência de ingresso na reunião e defina a duração dos PINs usados pelos organizadores da reunião no [Microsoft Teams](set-the-pin-length-for-audio-conferencing-meetings-in-teams.md). Os organizadores da reunião usam PINs para iniciar reuniões se não puderem ingressar na reunião usando o aplicativo Teams.
 ...
 **Números de telefone compartilhados** são os números de telefone que podem ser compartilhados com outros Microsoft 365. Não é possível alterar os idiomas usados quando alguém liga para um desses números.
...
Para obter mais informações, consulte [Números de telefone para Audioconferência no Microsoft Teams](phone-numbers-for-audio-conferencing-in-teams.md) .
...
- **Use o centro de administração do Teams.** Para alguns países/regiões, você pode obter números para suas pontes de conferência usando o centro de administração do Teams. Consulte [Obter números dos telefones de serviço](./getting-service-phone-numbers.md).

- **Fazer a portabilidade de seus números existentes.** Você pode portar ou transferir números existentes de seu provedor de serviços ou operadora de telefonia atual para o Microsoft 365. Consulte [Transferir os números dos telefones ao Teams](phone-number-calling-plans/transfer-phone-numbers-to-teams.md) ou [Gerenciar números de telefone da sua organização](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) para obter mais informações.  
...
Depois de decidir configurar a Audioconferência para seus usuários, confira Configurar a [Audioconferência para o Microsoft Teams](set-up-audio-conferencing-in-teams.md) para as etapas que você precisa seguir.
