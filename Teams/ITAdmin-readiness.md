                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Jornada de migração do Skype for Business para o Microsoft Teams</h3>
                         <p>[Tutorial: Jornada de migração do Skype for Business para o Teams](tutorial-journey-skypeforbusiness-to-teams.yml)</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p>[Início rápido: equipes para os administradores de educação](teams-quick-start-edu.yml)</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Equipes e canais</h3>
                         ...
                         <p>[Tutorial: Criar uma equipe englobando toda a empresa usando o PowerShell](company-wide-team-creation-powershell.yml)</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                       ...
                       <p>[Vídeo: Noções básicas sobre descoberta eletrônica em equipes](https://www.youtube.com/watch?v=OF65_p_07cE)</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Reuniões</h3>
                        <p>[Tutorial: Reuniões no Teams](tutorial-meetings-in-teams.yml)</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Audioconferência</h3>
                         <p>[Tutorial: Serviços de audioconferência em equipes](tutorial-audio-conferencing.yml)</p>
                         <p>[Vídeo: Introdução à conferência de áudio](https://www.youtube.com/watch?v=AGPvaW4Vg0o)</p>
                         <p>[Vídeo: Planejar a conferência de áudio](https://www.youtube.com/watch?v=AWbuvcWcYIc)</p>
                         <p>[Vídeo: Número portando para audioconferências](https://www.youtube.com/watch?v=5k0C21KAsns)</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Planos de Chamadas</h3>
                         <p>[Início rápido: como configurar planos de chamar em equipes](configuring-teams-calling-quickstartguide.md)</p>
                         <p>[Tutorial: Entender as chamadas no Teams](tutorial-calling-in-teams.yml)</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p>[Vídeo: Direto de roteamento para equipes - Preview](https://www.youtube.com/watch?v=dVkc5Bs926Q)</p>
                    </div>
                </div>
            </div>
        </div>
