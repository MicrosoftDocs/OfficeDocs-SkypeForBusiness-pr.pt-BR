...
description: Saiba como gerenciar e usar modelos gerais de equipe no centro de administração do Teams para criar equipes de forma rápida e fácil.
f1.keywords:
- CSH
ms.custom:
...
Gerenciar tarefas, compartilhar documentos, realizar reuniões de projeto e documentar riscos e decisões com esse modelo para o gerenciamento geral de projetos.
...
Gerenciar tarefas, documentos e colaborar em tudo o que você precisa para fornecer um evento atraente. Convide os usuários convidados a ter uma colaboração segura dentro e fora da sua empresa.
...
> | Tipo de modelo | TemplateId| Propriedades que vêm com este modelo |
> | ------------------ |--|-----------------------------------------------------------|
> | Gerenciar um evento|`com.microsoft.teams.template.ManageAnEvent` | Canais: <ul><li>Geral</li> <li>Comunicados</li> <li>Orçamento</li> <li>Conteúdo</li><li>Logística</li> <li>Planejamento</li> <li> Marketing e PR</li></ul> Apps:<ul><li>Aprovações</li><li>Boletins</li> <li>Ideias dos funcionários</li> <li>Listas<ul><li>Agendador de conteúdo</li></ul><li>Marcos</li></li> <li>OneNote</li> <li>Power Automate</li> <li>Páginas do SharePoint<ul><li>Nosso site</li><li>Sobre nosso evento</li></ul><li>Tarefas por Planejador e Para Fazer</li><li>Wiki</li> |

## <a name="onboard-employees"></a>Integrar funcionários*

Aprimore sua cultura e agilize a integração de seus funcionários com essa equipe central para recursos, perguntas e um pouco de diversão.
...
Ajude a criar, crescer e sustentar sua distribuição da comunidade champions evangelizando e ajudando seus pares com a nova tecnologia.
...
## <a name="organize-help-desk"></a>Organizar o Help Desk*

Colabore na documentação, na política e nos processos que dão suporte ao seu help desk. Integre seu sistema de tíquetes existente ou use nosso modelo para gerenciar solicitações.
...
## <a name="crisis-communications"></a>Comunicações de crise*

Centralize a comunicação e os recursos críticos de crise para sua equipe de gerenciamento de crises ou resposta a incidentes. Use reuniões online para melhorar o fluxo de informações e a conscientização situacional.

> [!div class="mx-tdBreakAll"]
> | Tipo de modelo |TemplateId| Propriedades que vêm com este modelo |
> | ------------------ |--|----------------------------------------------------------|
> | Comunicações de crise |`com.microsoft.teams.template.CollaborateOnAGlobalCrisisOrEvent`| Canais: <ul><li>Geral<li>Comunicados</li><li>Atualização Executiva</li><li>Planejamento</li><li>Logística</li></ul>Apps: <ul><li>Aprovações</li><li>Emitir relatórios</li><li>Listas<ul><li>Agendador de conteúdo</li><li>Plano de projeto</li></ul></li><li>OneNote</li><li>Power Automate</li><li>Páginas do SharePoint<ul><li>Nosso site</li><li>Atualização mais recente</li></ul><li>Tarefas por Planejador e Para Fazer</li></ul>|
