...
> [!NOTE]
> Para usar o App Studio, confira Começar na plataforma Microsoft Teams com [o C#/.NET](/microsoftteams/platform/get-started/get-started-dotnet-app-studio) e o App Studio A última etapa ainda não está funcionando, portanto, você precisará baixar o zip e instalá-lo da maneira antiga em Carregar um pacote de aplicativos para o [Microsoft Teams.](/microsoftteams/platform/concepts/apps/apps-upload)
...
3. Ativar ou desativar **Carregar aplicativos personalizados.**
...
Os administradores e proprietários de equipe podem controlar se uma equipe permite que aplicativos personalizados sejam adicionados a ela. Esta configuração, **Permitir** que os membros carreguem aplicativos personalizados , juntamente com a política de aplicativo personalizada de um usuário determina quem pode adicionar aplicativos personalizados a uma determinada equipe.
...
Esta tabela resume as configurações e políticas de aplicativo personalizadas, como eles trabalham juntos e seu efeito combinado no controle de quem em sua organização pode carregar aplicativos personalizados para o Teams.
...
- Crie e atribua uma política de configuração de aplicativo personalizada no centro de administração do Microsoft Teams com a configuração **Carregar** aplicativos personalizados a ser a atribuição aos proprietários da equipe.
...
| Desabilitado    | Habilitado        | Desabilitado        |A interação com todos os aplicativos personalizados é bloqueada para sua organização. Os aplicativos personalizados não podem ser carregados por ninguém, exceto um Administrador de Serviço do Teams ou um administrador global. Você pode usar Windows PowerShell para excluir aplicativos personalizados.         |
