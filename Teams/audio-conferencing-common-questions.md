...
Qualquer pessoa que tenha o número de discagem e a ID da conferência pode ingressar em uma reunião do Skype for Business ou do Microsoft Teams, a menos que o organizador da reunião tenha bloqueado a reunião.
  
Se você estiver ligando usando um telefone ou os aplicativos do Skype for Business ou do Microsoft Teams, você poderá ouvir todos os outros na chamada e eles poderão ouvi-lo. O organizador da reunião tem a capacidade de "silenciar" os participantes da reunião se eles não quiserem ouvi-los. 
...
Há números de discagem locais que são atribuídos a você quando você compra as licenças para Audioconferência. Os números de discagem serão incluídos no convite da reunião. Esses números locais estarão disponíveis apenas para sua organização. O telefone atribuído à sua organização e esse número é compartilhado pelos usuários dentro dessa organização que estão habilitados para Audioconferência. Portanto, as reuniões do Skype for Business ou do Microsoft Teams agendadas pelo Usuário A e outro Usuário B terão o mesmo número de discagem.
...
|:-----|:-----|
|Os usuários ingressaram usando o aplicativo Skype for Business ou Microsoft Teams ou discados para a reunião.  <br/> |A reunião termina se não houver alterações na lista de participantes após 24 horas.  <br/> |
...
Para saber mais sobre os limites de reunião, consulte [Limites do Skype for Business Online.](/office365/servicedescriptions/skype-for-business-online-service-description/skype-for-business-online-limits#bkmk_Meeting_LyncOnlineLimits)
...
Com [reuniões primeiro,](meetings-first.md)os usuários do Skype for Business Server podem se beneficiar das reuniões do Teams e da Audioconferência do Teams. 
  
## <a name="can-a-user-get-a-personal-conference-id"></a>Um usuário pode obter uma ID de conferência pessoal?

Os usuários do Skype for Business e do Microsoft Teams receberão IDs de conferência aleatoriamente. Os usuários não podem reservar ou definir uma ID de conferência estática que só eles podem usar. 
  
## <a name="can-i-use-audio-conferencing-with-skype-meeting-broadcast"></a>Posso usar Audioconferência com Transmissão de Reunião do Skype?

Atualmente, não há suporte para usuários habilitados para Audioconferência ingressarem em uma Transmissão de Reunião do Skype.
...
Os usuários do Skype for Business ou do Microsoft Teams podem encontrar a ID da conferência atribuída a eles agendando uma reunião no Outlook e no Outlook na Web. Além disso, os usuários podem encontrar a ID da conferência no email que será enviado a eles após a configuração.
...
Os usuários do Skype for Business ou do Microsoft Teams podem encontrar o PIN em um email que será enviado a eles depois de serem definidos.
  
> [!NOTE]
> Os usuários do Teams podem alterar seu pin. Há um link na parte inferior do convite da reunião para redefinir o pino. 
...
## <a name="can-attendees-dial-out-to-international-phone-numbers-when-they-are-in-a-skype-for-business-or-microsoft-teams-meeting"></a>Os participantes podem discar para números de telefone internacionais quando estão em uma reunião do Skype for Business ou do Microsoft Teams?

Sim, os participantes podem discar internacionalmente e convidar outros chamadores para uma reunião do Skype for Business ou do Microsoft Teams. Consulte [Discagem de uma](dialing-out-from-a-teams-meeting-so-other-people-can-join-it.md) reunião do Microsoft Teams para que outras pessoas possam participar ou discar de uma reunião do Skype for Business Online para que outras pessoas possam participar [dela.](/SkypeForBusiness/audio-conferencing-in-office-365/dialing-out-from-a-meeting-so-other-people-can-join-it)
  
## <a name="how-does-a-skype-for-business-or-microsoft-teams-user-schedule-a-meeting-with-audio-conferencing-meeting-details"></a>Como um usuário do Skype for Business ou do Microsoft Teams agenda uma reunião com detalhes da reunião de Audioconferência?
