...
Você pode rotear chamadas para números não atribuídos para um usuário, para uma conta de recurso associada a um Atendedor Automático ou uma Fila de Chamadas ou para um serviço de anúncio que reproduzirá um arquivo de áudio personalizado para o chamador. O arquivo de áudio será reproduzindo repetidamente até o chamador ser travado.
