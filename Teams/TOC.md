...
## [Gerenciar o Teams](using-admin-roles.md)
...
### [Análises e relatórios do Teams no centro de administração do Microsoft Teams](teams-analytics-and-reports/teams-reporting-reference.md)
...
## [Audioconferência](deploy-audio-conferencing-teams-landing-page.md)
...
### [Gerenciar as configurações de audioconferência para usuários](manage-the-audio-conferencing-settings-for-a-user-in-teams.md)
...
##### [Bielorrússia ](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-belarus.md)
...
##### [Macedônia (ARIM)](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-macedonia.md)
...
### [Obter números de telefone para seus usuários](/SkypeForBusiness/what-are-calling-plans-in-office-365/getting-phone-numbers-for-your-users?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)
...
## [Fase 3 - Dimensionar](teams-adoption-phase3-enable.md)
...
## [Preparar seu ambiente para o Teams](upgrade-prepare-environment.md)
...
## [Preparar sua organização para o Teams](upgrade-prepare-organization.md)
...
## [Atualizar do Skype for Business Online para o Teams](upgrade-to-Teams-execute-SkypeforBusinessOnline.md)
## [Atualizar do Skype for Business híbrido ou local para o Teams](upgrade-to-Teams-execute-SkypeforBusinessHybridOnPrem.md)
...
## [Segurança e conformidade](security-compliance-overview.md)
...
### [Soluções de acessibilidade para o Skype for Business Online e o Microsoft Teams](/SkypeForBusiness/legal-and-regulatory/accessibility-solutions-in-france?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)
...
### [Gerenciar o aplicativo Turnos para sua organização no Teams](manage-the-shifts-app-for-your-organization-in-teams.md)
