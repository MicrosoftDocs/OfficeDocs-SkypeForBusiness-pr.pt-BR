...
### [Gerenciar o acesso baseado em turnos para funcionários iniciais](expand-teams-across-your-org/shifts/manage-shift-based-access-flw.md)
...
### [Experiências conectadas opcionais](teams-privacy-oce-overview.md)
...
#### [Usar regras de fluxo de email com o Exchange](https://docs.microsoft.com/microsoft-365/security/office-365-security/create-safe-sender-lists-in-office-365)
...
### [Telas do Teams](devices/teams-displays.md)
### [Atualizar telefones do Teams às telas do Teams](devices/upgrade-phones-to-displays.md)
### [Implantar telefones e telas do Teams usando o Intune](devices/phones-displays-deploy.md)
...
### [Move do Conector do Skype for Business Online para o módulo PowerShell do Teams](teams-powershell-move-from-sfbo.md)
...
## [Visualização pública no Microsoft Teams](public-preview-doc-updates.md)