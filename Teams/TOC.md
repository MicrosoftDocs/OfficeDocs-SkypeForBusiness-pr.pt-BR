...
# [Como distribuir as equipes](How-to-roll-out-teams.md)
...
## [Etapa 3: Monitorar o uso e comentários](get-started-with-teams-monitor-usage-and-feedback.md)
## [Etapa 4: Planejar sua distribuição de toda a organização](get-started-with-teams-resources-for-org-wide-rollout.md)
...
## [Aplicativos, bots, conectores &](deploy-apps-microsoft-teams-landing-page.md)
### [Considerações e permissões de aplicativos](app-permissions.md)
...
### [Análise de equipes e relatórios no Centro de administração do Microsoft Teams](teams-analytics-and-reports/teams-reporting-reference.md)
#### [Relatório de uso de equipes](teams-analytics-and-reports/teams-usage-report.md)
#### [Relatório de atividades do usuário de equipes](teams-analytics-and-reports/user-activity-report.md) 
#### [Relatório de uso do dispositivo de equipes](teams-analytics-and-reports/device-usage-report.md)
### [Relatórios de atividade de equipes no Centro de administração do Microsoft 365](teams-activity-reports.md)
...
#### [Ativar equipes em sua organização](Office-365-set-up.md)
...
#### [Atribuir licenças de equipes](assign-teams-licenses.md)
#### [Licenciamento de complemento de equipes](teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
##### Opções de licença com base no seu plano
###### [Office 365 Business Premium](teams-add-on-licensing/office-365-business-premium.md)
###### [O Office 365 ProPlus](teams-add-on-licensing/office-365-premium-pro-plus.md)
###### [E3 e o office 365 Enterprise E1](teams-add-on-licensing/office-365-enterprise-e1-e3.md)
###### [O Office 365 Enterprise E5](teams-add-on-licensing/office-365-enterprise-e5-with-audio-conferencing.md)
###### [E5 do Office 365 Enterprise sem serviços de audioconferência](teams-add-on-licensing/office-365-enterprise-e5-without-audio-conferencing.md)
###### [GOV, EDU e organizações sem fins lucrativos](teams-add-on-licensing/gov-edu-and-nonprofit-organizations.md)
...
## [Serviços de audioconferência](deploy-audio-conferencing-teams-landing-page.md)
...
### [Configure a conferência de áudio para Skype para negócios e Teams da Microsoft](/SkypeForBusiness/audio-conferencing-in-office-365/set-up-audio-conferencing?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)
...
### Gerenciar sua ponte de conferência de áudio
...
### [Gerenciar as configurações de conferência de áudio para usuários](manage-the-audio-conferencing-settings-for-a-user-in-teams.md)
...
### Gerenciar configurações de reuniões para serviços de audioconferência
...
##### [Bósnia e Herzegovina de &](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-bosniaherzegovina.md)
...
### [Qual é o sistema telefônico](what-is-phone-system-in-office-365.md)
### [Veja o você recebe com o Sistema de Telefonia](here-s-what-you-get-with-phone-system.md)
### [Configurar o sistema telefônico](setting-up-your-phone-system.md)
### [Configurar telefones de área comum](set-up-common-area-phones.md)
### Caixa postal
#### [Configurar a caixa postal do Sistema de Telefonia](set-up-phone-system-voicemail.md)
#### [Alterar o idioma padrão para a caixa postal](change-the-default-language-for-greetings-and-emails.md)
#### [Idiomas de mensagens e saudações da caixa postal](languages-for-voicemail-greetings-and-messages.md)
### ID do Chamador
#### [Como a ID de chamadas pode ser usada em sua organização](/SkypeForBusiness/what-are-calling-plans-in-office-365/how-can-caller-id-be-used-in-your-organization?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)
...
#### [Configurar o atendedor automático do Sistema de Telefonia](create-a-phone-system-auto-attendant.md)
...
#### [Criar uma fila de chamadas do Sistema de Telefonia](create-a-phone-system-call-queue.md)
...
### [Tipos de números de telefone usados para chamar planejar](different-kinds-of-phone-numbers-used-for-calling-plans.md)
...
### [Ver uma lista de números de telefone em sua organização](/SkypeForBusiness/what-are-calling-plans-in-office-365/see-a-list-of-phone-numbers-in-your-organization?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)
...
## Referência
### [Disponibilidade de país e região para chamar planejar](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
#### [Argentina](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-argentina.md)
#### [Austrália](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-australia.md)
#### [Áustria](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-austria.md)
#### [Bahrein](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-bahrain.md)
...
#### [Venezuela](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-venezuela.md)
#### [Vietnã](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-vietnam.md)
### Gerenciamento de número de telefone do país 
...
#### [Bósnia e Herzegovina de &](toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-bosnia-and-herzegovina.md)
...
### [Orientação de voz de nuvem](cloud-voice-landing-page.md)
#### [Definir meu sucesso](1-envision-define-my-success-cloud-voice.md)
#### [Decisões meu serviço - sistema telefônico com planos de chamada](calling-plan-landing-page.md)
#### [Decisões meu serviço - Roteamento direto de sistema do telefone](direct-routing-landing-page.md)
...
### [Telefones para equipes](phones-for-teams.md)
...
### [Telefones para Skype para negócios Online](/SkypeForBusiness/what-is-phone-system-in-office-365/getting-phones-for-skype-for-business-online/deploying-skype-for-business-online-phones?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)


## [Conformidade de & de segurança](security-compliance-overview.md)
...
##### [Conjunto de QoS nos clientes do Windows](QoS-in-Teams-clients.md)
...
### [Planejar Microsoft 365 governamental - DoD](plan-for-government-dod.md)
