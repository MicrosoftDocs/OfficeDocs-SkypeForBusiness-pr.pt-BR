...
1. A tela Conta de Usuário é exibida. Insira o endereço de entrada do Skype (no formato do usuário @ domínio) da conta da sala a ser usada com o console.
