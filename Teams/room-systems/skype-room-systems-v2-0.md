...
| Preparação de site             | Instalações / equipe AV / equipe de projeto de TI |             | [Preparação de site](room-systems-v2.md#site-readiness)                      |
| Prontidão de serviço          | IT equipe do projeto                        |             | [Prontidão de serviço](room-systems-v2.md#service-readiness)                      |
| Configuração              | IT equipe do projeto                        |             | [Configuração e implantação](room-systems-v2.md#configuration-and-deployment)                      |
| Implantação                 | Instalações / equipe AV / equipe de projeto de TI |             | [Lista de verificação da implantação](console.md#microsoft-teams-rooms-deployment-checklist)                      |
| Adoção                   | Instalações / equipe AV / equipe de projeto de TI |             | [Adoção](#plan-for-adoption-and-change-management)                      |
| Manutenção e operações | Equipe de AV / equipe de projeto de TI              |             | [Visão geral do gerenciamento](skype-room-systems-v2.md)                      |
