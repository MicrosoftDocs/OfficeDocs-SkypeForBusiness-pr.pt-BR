...
- **Mãos livres** com Cortana Os usuários podem interagir com Teams exibições usando sua voz para ingressar e apresentar sem esforço nas reuniões, ditar respostas a um chat Teams, verificar o que está no calendário e muito mais.
...
Teams licenças podem ser compradas como parte de assinaturas [Microsoft 365 e Office 365.](/office365/servicedescriptions/teams-service-description) Para saber mais sobre as licenças necessárias para usar Teams exibições, consulte [Voice and video calling with Microsoft Teams](https://products.office.com/microsoft-teams/voice-calling).
...
Para saber mais sobre como implantar Teams exibições usando o Intune, consulte [Deploy Teams phones and Teams displays](phones-displays-deploy.md).
