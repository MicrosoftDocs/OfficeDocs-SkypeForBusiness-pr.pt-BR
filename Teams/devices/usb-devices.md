...
O programa de certificação de periféricos garante que periféricos USB, como fones de ouvido com microfone, microfones, webcams e monitores, oferecem qualidade de áudio ou vídeo avançada. Os dispositivos certificados desfuncionaram (plug & Play) sem necessidade de configuração adicional e oferecem controle de chamada com o Microsoft Teams e o Skype for Business. Os produtos fornecem uma excelente experiência para usuários finais e administradores.
...
Para obter mais detalhes sobre o suporte do controle de chamadas com o Teams, leia [chamadas de controle usando um fone de ouvido](https://support.office.com/article/Control-calls-using-a-headset-in-Teams-65d6e104-444d-4013-b8c2-f11317dd69a8)com microfone.
...
- **Microfone Premium para Open Office** Todos os fones de ouvido com microfone são testados para fornecer áudio claro, mas o Open Office e outros ambientes com ruído atendem a um desafio maior: para atender claramente a voz do usuário de fone de ouvido, mas não transmitir o som de seus vizinhos.
- **Tamanho da sala de reunião** Dispositivos compartilhados, como viva-voz e câmeras, têm uma distância de uso compatível e as distâncias recomendadas podem ser reportadas de maneira diferente em diferentes fabricantes. Para dar aos clientes uma orientação clara, todos os dispositivos compartilhados são testados na certificação contra tamanhos de salas e ruídos bem definidos.
...
- Notificação do usuário de eventos e alertas do cliente da equipe (por exemplo, reunião iniciando, correio de voz ou chamada perdida).
...
- Os dispositivos de áudio (por exemplo, fones de ouvido com microfone e telefones viva-voz) oferecem:
  - Controle de chamada básica entre quando usado com um computador ou dispositivos Mac. Os controles básicos incluem a opção atender/desligar, ativar/desativar mudo e controle de volume.
...
*Tabela atualizada em julho de 2020*
...
|Jabra                |Envolver fone de ouvido com microfone de 75                                          |7/31/2020       |Skype for Business com atualização para o Microsoft Teams      |
|Jabra                |Envolver fone de ouvido com microfone de 65                                          |7/31/2020       |Skype for Business com atualização para o Microsoft Teams      |
