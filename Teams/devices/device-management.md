...
description: Gerenciar dispositivos usados com Microsoft Teams em sua organização.
...
ms.locfileid: "69245739"
---
# <a name="manage-devices-in-teams"></a>Gerenciar dispositivos no Teams 

Você pode gerenciar dispositivos usados com Microsoft Teams em sua organização no centro de administração do Microsoft Teams. Você pode exibir e gerenciar o inventário de dispositivos para sua organização e fazer tarefas como atualizar, reiniciar e monitorar o diagnóstico de dispositivos. Você também pode criar e atribuir perfis de configuração a um dispositivo ou grupos de dispositivos.

Para gerenciar dispositivos, como alterar a configuração do dispositivo, reiniciar dispositivos, gerenciar atualizações ou exibir o dispositivo e a integridade periférica, você precisa receber uma das seguintes funções de administrador Microsoft 365:

- Microsoft administrador global do 365
