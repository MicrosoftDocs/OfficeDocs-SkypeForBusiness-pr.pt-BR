---
title: Microsoft Teams alertas e monitoramento de dispositivos
author: cazawideh
ms.author: czawideh
manager: serdars
audience: Admin
...
ms.collection:
- M365-collaboration
description: Saiba como usar os recursos Teams monitoramento e alertas no centro de administração do Microsoft Teams para monitorar proativamente o estado de integridade de Teams dispositivos
appliesto:
- Microsoft Teams
ms.custom: ''
...
ms.locfileid: "64737605"
---
# <a name="microsoft-teams-device-health-monitoring"></a>Microsoft Teams de integridade do dispositivo

O monitoramento de integridade do dispositivo no centro de administração Microsoft Teams oferece a capacidade de monitorar proativamente a integridade de vários Teams dispositivos. Monitore o estado offline de um dispositivo e receba alertas em tempo real se o dispositivo monitorado em sua organização ficar offline.  
...
1. No painel de navegação à esquerda do Microsoft Teams de administração, selecione **Notificações & alertsRules** > .
...
3. Selecione o dispositivo para configurar a regra de estado para habilitar alertas.
    ...
    ![Teams regra de estado dos dispositivos.](../media/device-state-rule.png )
...
|Campo |Descrição  |
|--------|-------------|
|**Tipo de regra**   |A regra de estado do dispositivo ajuda você a gerenciar com eficiência. Teams e é classificado como um tipo de gerenciamento de dispositivo. No futuro, mais regras de tipo de gerenciamento de dispositivo estarão disponíveis para monitorar outros recursos relacionados (exemplos podem incluir: dispositivo não íntegro e o status de entrada do dispositivo).|
|**Condição**   |Você poderá monitorar a integridade dos dispositivos se eles estiverem offline. [Saiba mais sobre](../devices/device-management.md) o gerenciamento de dispositivos Teams centro de administração. |
...
|**Ações** >  **Alerta de canal**   |Na seção Ações, você pode especificar os canais das equipes para os quais deseja obter alertas. Atualmente, uma equipe padrão chamada **Alertas** e Notificações de Administrador e um canal chamado **MonitoringAlerts** será criado no qual as notificações serão entregues. <BR/> <BR/> Administradores globais e Teams administradores em seu locatário serão adicionados automaticamente a essa equipe padrão.|
...
As notificações são entregues no canal **MonitoringAlerts** criado automaticamente da Equipe **de Notificações e Alertas de** Administrador. Você receberá um alerta dentro de 15 minutos após o dispositivo ficar offline. 
