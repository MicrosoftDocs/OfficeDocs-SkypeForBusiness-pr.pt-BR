...
|Chamadas de vídeo e reuniões | Para uma experiência melhor com chamadas de vídeo e reuniões online, recomendamos o uso de um computador com um processador de 2 GHz e 4 GB de RAM (ou superior).  <ul><li>O efeito de vídeo opcional **desfocar tela de fundo** exige um processador compatível com Advanced Vector Extensions 2 (AVX2), compatível com a maioria de Mac 2013 ou posterior. Para obter uma lista de codificadores e decodificadores não compatíveis, confira [Recomendações do driver de decodificador e codificador de hardware](hardware-decoders-and-encoders.md).</li><li>Ingressar em uma reunião usando a detecção de proximidade em uma sala do Microsoft Teams não está disponível no Mac OS.</li></ul> |
