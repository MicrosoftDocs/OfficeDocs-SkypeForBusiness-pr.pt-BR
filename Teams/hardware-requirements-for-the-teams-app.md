...
Todos os requisitos nas seções a seguir se aplicam ao aplicativo da área de trabalho do Microsoft Teams e ao aplicativo Web Teams.
...
|Sistema operacional  |    Windows Server 2012 R2 +, Windows 10 ou Windows 8,1 em 32 bits e 64 bits. Para obter a melhor experiência, use a versão mais recente do seu sistema operacional.|
...
## <a name="hardware-requirements-for-teams-on-a-mac"></a>Requisitos de hardware para equipes em um Mac
...
## <a name="hardware-requirements-for-teams-in-a-virtual-desktop-infrastructure-vdi-environment"></a>Requisitos de hardware para Teams em um ambiente de infraestrutura de área de trabalho virtual (VDI)
...
- [Limites e especificações para o Microsoft Teams](limits-specifications-teams.md)
