...
|Chamadas de vídeo e reuniões | <ul><li>Requer processador de dois núcleos. Para maior resolução de compartilhamento de vídeo/tela e taxa de quadros, um processador de quatro núcleos ou melhor é recomendado. </li><li>Ingressar em uma reunião usando a detecção de proximidade em uma Sala do Microsoft Teams requer Bluetooth LE. O Bluetooth LE requer que o Bluetooth esteja habilitado no dispositivo cliente.</li></ul>
|
