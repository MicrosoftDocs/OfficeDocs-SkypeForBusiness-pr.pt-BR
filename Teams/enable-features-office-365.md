...
-   **Usar o Skype for Business para destinatários que não possuem o Microsoft Teams:** Quando essa configuração está ativada, ela permite que os usuários do Microsoft Teams entrem em contato com outros usuários da organização que não estão habilitados para o Microsoft Teams via Skype for Business.

-   **Permitir mensagens proativas de ajuda com T-bot:** Quando essa configuração está ativada, o T-bot iniciará uma sessão de bate-papo com os usuários para orientá-los sobre o uso do Microsoft Teams.
...
Ative esse recurso para que os usuários possam enviar um e-mail para um canal no Microsoft Teams usando o endereço de e-mail do canal. Os usuários podem fazer isso para qualquer canal pertencente a uma equipe que possuem. Os usuários também podem enviar e-mails para qualquer canal de uma equipe que tenha conectores adicionais habilitados para os membros da equipe. E, mesmo que um usuário não tenha permissão para criar um endereço de e-mail de canal, se alguém que tiver permissão criar esse endereço, o usuário poderá acessá-lo no menu do \<ícone de mais\> desse canal.
...
-   **Permitir que os usuários enviem e-mails aos canais:** Quando ativado, os ganchos de correio estão habilitados e os usuários podem enviar mensagens para um canal enviando um e-mail para o endereço de e-mail do canal do Microsoft Teams.
...
-   **Lista de remetentes restritos:** Os domínios dos remetentes podem ser ainda mais restritos para garantir que somente os domínios SMTP permitidos possam enviar e-mails para os canais do Microsoft Teams.

<a name="apps"></a>Aplicativos
----

Os aplicativos do Microsoft Teams são uma ótima maneira de integrar as ferramentas e os serviços importantes para a sua equipe diretamente de qualquer canal ou bate-papo.
...
No momento, as opções de armazenamento em nuvem do Microsoft Teams incluem Box, Dropbox, Google Drive e ShareFile. Os usuários podem carregar e compartilhar arquivos do serviços de armazenamento em nuvem aos canais e bate-papos do Microsoft Teams. Clique ou toque no botão de alternância ao lado dos provedores de armazenamento em nuvem que a sua organização deseja usar.
...
Você pode controlar quais usuários da sua organização podem criar equipes no Microsoft Teams. A mesma configuração de criação definida no Office 365 se aplica ao Microsoft Teams. Para obter mais informações sobre o gerenciamento de grupos do Office 365, veja [Criar grupos no Office 365](https://support.office.com/en-us/article/Create-Office-365-groups-74a1ef8b-3844-4d08-9980-9f8f7a36000f) e [Controlar quem pode criar Grupos no Office 365](https://support.office.com/en-us/article/Control-who-can-create-Office-365-Groups-4c46c8cb-17d0-44b5-9776-005fced8e618).

NOTA: Não é possível criar equipes a partir do painel de Grupos. As equipes devem ser criadas usando o cliente desktop ou o aplicativo web do Microsoft Teams.

Por padrão, qualquer usuário pode criar uma equipe ou um grupo. Os usuários podem criar equipes, escolhendo Equipes no lado esquerdo no cliente Microsoft Teams (cliente desktop ou aplicativo web) e, em seguida, selecionando Criar equipe na parte inferior do cliente, abaixo da lista de equipes.
