...
3. Quando você encontrar o aplicativo, clique em **Comprar agora** para acessar a guia **Planos** e preços da página de detalhes do aplicativo. Revise os planos e informações de preços da oferta SaaS para o aplicativo. Se precisar de mais informações, clique no link **saiba** mais para acessar a página do aplicativo no [AppSource](https://appsource.microsoft.com/).  
4. Para comprar um plano, clique **em Comprar agora**. Você será redirecionado para a experiência de compra da oferta associada ao Teams app. É aqui que você concluirá a compra do serviço ou da oferta saaS.
...
6. Selecione seu termo de cobrança **(mensal** ou anual **)** e insira o número de licenças de usuário que você deseja comprar.
7. Insira seu método de pagamento.
8. Quando estiver pronto, selecione **Colocar ordem**.
...
Selecione **Gerenciar licenças** para ir ao centro de administração Microsoft 365 para exibir e gerenciar as licenças que você comprou e gerenciar atribuições de licença para usuários.

Os administradores globais podem exibir as compras feitas por qualquer pessoa na organização, enquanto Teams administradores de serviço só podem exibir as compras feitas por si mesmos.  
