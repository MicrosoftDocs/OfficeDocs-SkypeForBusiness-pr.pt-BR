...
Você tem duas maneiras de obter números de serviço para poder usá-los com o Skype for Business e o Microsoft Teams:
  
- Obter novos números do Office 365.
    
- Portar ou transferir os números existentes de seu provedor de serviços ou operadora de telefone para o Office 365.
    
    > [!NOTE]
    > Ao transferir seus números de serviço, é altamente recomendável que você entre em contato com o [suporte da Microsoft](https://support.office.com/en-us/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b) para garantir que a maior capacidade de chamadas simultâneas seja considerada e configurada corretamente.
...
2. Vá para as equipes do **Centro** > de administração e o**administrador herdado**do**Skype** > Skype.
...
> [!NOTE]
> Se precisar de mais números de telefone, [entre em contato com o suporte para produtos de negócios-ajuda para administradores](https://support.office.com/en-us/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b). 
