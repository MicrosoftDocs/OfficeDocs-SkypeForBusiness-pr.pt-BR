...
- Portar ou transferir os números existentes de seu provedor de serviços ou operadora de telefone para o Office 365.
    ...
    > [!NOTE]
    > Ao transferir seus números de serviço, é altamente recomendável que você entre em contato com o [suporte da Microsoft](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b) para garantir que a maior capacidade de chamadas simultâneas seja considerada e configurada corretamente.
