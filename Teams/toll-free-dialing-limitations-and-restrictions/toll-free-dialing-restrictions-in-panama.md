...
|Discagem format(s)  <br/> | 00-800-XXX-XXXX <br/> |
...
|Comentários, restrições e problemas de acesso  <br/> |O cliente deve discar 011 (o internacional interurbano Panamá código) antes do número de chamada gratuito.  <br/> |
