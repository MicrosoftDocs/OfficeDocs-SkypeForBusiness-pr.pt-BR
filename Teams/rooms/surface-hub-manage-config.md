...
O Designer de Configuração do Windows é uma boa opção se você tiver apenas alguns dispositivos Surface Hub e puder accessá-los facilmente. Se você tiver muitos Surface Hubs ou se eles estiverem em locais remotos, use o Microsoft Intune no Microsoft Endpoint Manager se ele for implantado em sua organização. Independentemente do método escolhido, você precisa criar um arquivo de configuração XML para fazer alterações nas configurações do Teams no Surface Hub.
...
| `<CoordinatedMeetings>` | `<TrustedAccounts>`                       |           | Esta é uma lista separada por vírgulas de UPNs para cada dispositivo Salas do Teams ou Surface Hub do qual o dispositivo deve aceitar solicitações de junção de reunião ou para quais solicitações de ingresso na reunião devem ser enviadas.<br>Valores aceitos: cadeia de caracteres                                                                                                                                                                                                                                                                                                                         |
