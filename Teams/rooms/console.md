...
> [!NOTE]
> Salas do Microsoft Teams funcionará apenas em um ambiente de Microsoft Teams ou Skype for Business onde as contas de dispositivo são configuradas corretamente, conforme descrito em [Deploy Salas do Microsoft Teams](rooms-deploy.md).
