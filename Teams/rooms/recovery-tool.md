...
Baixe o pacote de [Salas do Microsoft Teams de](https://go.microsoft.com/fwlink/?linkid=851168) instalação mais recente e extraia-o para um pen drive ou compartilhamento de rede acessível ao Salas do Microsoft Teams dispositivo.
...
4) Para executar uma restauração de fábrica:
   ...
   2. Se BitLocker estiver, siga as instruções fornecidas no final da saída do script para desabilitá-lo.
