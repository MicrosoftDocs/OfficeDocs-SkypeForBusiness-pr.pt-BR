---
title: Salas do Microsoft Teams para segurança do Windows
ms.author: dstrome
author: dstrome
manager: serdars
audience: ITPro
...
- M365-collaboration
- Teams_ITAdmin_Rooms
description: Saiba como proteger seu Salas do Microsoft Teams para dispositivos Windows.
ms.openlocfilehash: b35d856afb7ca044388802aa514039bd9b8d40d3
ms.sourcegitcommit: 8dd36e1e30a47316c15c99e964d0464715bcd742
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 10/12/2022
ms.locfileid: "68532420"
---
# <a name="microsoft-teams-rooms-for-windows-security"></a>Salas do Microsoft Teams para segurança do Windows

A Microsoft trabalha com nossos parceiros para fornecer uma solução segura e não requer ações adicionais para proteger Salas do Microsoft Teams windows. Este artigo aborda muitos dos recursos de segurança encontrados no Salas do Teams para Windows.

Para obter informações sobre segurança Salas do Teams para dispositivos Android, [consulte Salas do Microsoft Teams para segurança do Android](security-android.md).
...
Embora os usuários finais não possam colocar arquivos em um disco Salas do Teams disco rígido, Microsoft Defender ainda está habilitado. Salas do Teams desempenho é testado com Microsoft Defender. Desabilitar isso ou adicionar software de segurança de ponto de extremidade pode levar a resultados imprevisíveis e potencial degradação do sistema.
