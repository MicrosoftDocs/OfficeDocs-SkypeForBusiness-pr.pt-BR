...
f1.keywords:
- NOCSH
description: Saiba como os Conectores mantêm sua equipe atualizada fornecendo frequentemente conteúdo e atualizações diretamente em um canal Teams para os serviços que você usa.
appliesto:
- Microsoft Teams
...
> [!IMPORTANT]
> Os conectores personalizados não estão disponíveis Nuvem da Comunidade Governamental (GCC), GCC Alta e Departamento de Defesa (DOD).

Para usar conectores em uma equipe ou canal, abra o menu Mais Opções no canto superior direito de um canal. No menu, selecione **Conectores** e localize ou pesquise o aplicativo do conector necessário. Configure o conector selecionado, se necessário.

:::image type="content" source="media/connectors-selection-ui.png" alt-text="Adicione conectores ao seu canal Teams das opções Mais no canto superior direito do canal.":::
