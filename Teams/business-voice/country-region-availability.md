...
Alguns recursos do Business Voice, especificamente os Planos de chamadas e o Assistente de Introdução, estão disponíveis apenas em determinados países e regiões. A disponibilidade desses recursos no local do locatário determina se você pode configurar o Business Voice por conta própria ou se precisa de ajuda de um parceiro ou revendedor da Microsoft.

Em países e regiões **com** suporte para Planos de Chamadas e o Assistente de Introdução, você pode comprar o Business Voice da Microsoft e configurar ou transferir seus números de telefone existentes para a Microsoft. Isso permitirá que você gerencie todos os seus números de telefone no Microsoft 365. Após concluir a mudança para o Business Voice:
...
Se o seu locatário estiver localizado em um país ou região que ofereça suporte aos Planos de Chamadas e Assistente de Introdução, confira [O que preciso comprar para usar o Microsoft 365 Business Voice com Plano de Chamadas?](what-to-buy.md).

Em países e regiões **sem** suporte para os Planos de Chamadas e Assistente de Introdução, é necessário adquirir o Business Voice de um parceiro ou revendedor da Microsoft. Após a compra do Business Voice, você precisará trabalhar com seu parceiro ou revendedor e sua operadora de telefonia de terceiros para configurar o Roteamento Direto entre o hardware de telefonia local e o Microsoft 365.

- A sua operadora de telefonia não muda. Todas as tarifas locais, de longa distância e gratuitas são cobradas pela operadora de telefonia de terceiros existente.
