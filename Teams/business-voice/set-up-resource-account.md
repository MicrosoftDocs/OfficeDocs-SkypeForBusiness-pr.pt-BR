---
title: Configurar uma conta de recurso Microsoft 365 Teams Telefone plano de chamada
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
description: Saiba como configurar uma conta de recurso Microsoft 365 Teams Telefone plano de chamada para uso com os atendentes automáticos.
appliesto:
- Microsoft Teams
...
ms.locfileid: "61766194"
---
# <a name="step-4-set-up-a-teams-phone-with-calling-plan-resource-account"></a>Etapa 4: Configurar uma conta de recurso Teams Telefone plano de chamada
...
> [!NOTE]
> Você só deve executar as etapas a seguir se tiver se inscreveu para um Teams Telefone período de avaliação do Plano de Chamada. Se você comprou Teams Telefone licenças do Plano de Chamada, as licenças virtuais já devem ser aplicadas à sua conta.
>
...
1. Abra o Centro de administração do Microsoft 365 e faça logoff com um usuário que seja um administrador global. Normalmente, essa é a conta que você usou para se inscrever Microsoft 365.
