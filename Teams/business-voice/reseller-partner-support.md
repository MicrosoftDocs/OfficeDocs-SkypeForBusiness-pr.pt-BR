...
- Obter as licenças corretas de voz para o seu locatário e seus usuários de telefone
- Ajudar a compreender os requisitos técnicos para a configuração do Business Voice
- Coordenar a ação com o seu provedor de telefonia para garantir que seus números de telefone sejam configurados corretamente para uso com o Business Voice
- Configurar a comunicação entre seu hardware de telefonia local e o Microsoft 365
- Ajudar você a configurar os recursos de voz para empresas, como filas de chamadas, atendente automático, caixa postal e muito mais

Ao contatar um parceiro da Microsoft ou revendedor para configurar o Business Voice sem plano de chamada, você precisará fornecer informações como:
...
- Detalhes da conexão entre o sistema de telefonia e o seu provedor PSTN
