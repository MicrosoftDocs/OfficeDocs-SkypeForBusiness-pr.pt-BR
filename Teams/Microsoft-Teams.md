...
ms.locfileid: "26510548"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Documentação e orientações práticas do Microsoft Teams</h1>
        <ul class="pivots">
            <li>
                <a href="#home"></a>
                <ul id="home">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introdução</h3>
                                                    <p>Encontre o planejamento, as instruções e as orientações práticas de que você precisa para tirar o máximo proveito do Teams na sua organização</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gerenciamento de adoção e alterações</h3>
                                                    <p>Obtenha ferramentar para dar suporte à implantação do Microsoft Teams e ajudá-lo a criar uma estratégia de gerenciamento de alterações para o Microsoft Teams</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Encontre treinamentos &amp; vídeos</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introdução à plataforma de desenvolvedor do Microsoft Teams</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Comunidade do Microsoft Teams tech</h3>
