...
- As setas e os valores numéricos dos caminhos estão de acordo com os [fluxos de chamadas do Microsoft Teams](https://docs.microsoft.com/microsoftteams/microsoft-teams-online-call-flows).
