...
No [Guia do Administrador de TI para o Insights](class-insights.md), você pode ler como o Insights funciona (incluindo locais de armazenamento) e [como desativar ou ativar o Insights](class-insights.md#turn-on-and-off-insights) quando quiser excluir os dados ou habilitar o serviço.
