---
title: Gerenciar o acesso a aplicativos do Teams no Microsoft 365
author: guptaashish
...
description: Gerencie o acesso aos aplicativos do Teams no Microsoft 365.
...
ms.locfileid: "65913519"
---
# <a name="manage-access-to-teams-apps-across-microsoft-365"></a>Gerenciar o acesso a aplicativos do Teams no Microsoft 365

Os desenvolvedores de aplicativos podem aprimorar seus aplicativos do Microsoft Teams para trabalhar no Outlook e no Office.com, além do aplicativo que está trabalhando no Teams. Os usuários finais podem usar os aplicativos aprimorados no Teams, no Microsoft Outlook e no Microsoft Office.com após o aprimoramento. Atualmente, somente os usuários finais na versão direcionada podem exibir e usar esses aplicativos específicos no Teams, outlook e Office.com. A experiência de administrador existente do Teams se aplica para controlar o acesso a esses aplicativos. Uma notificação sobre essa alteração está disponível no centro [de mensagens](https://admin.microsoft.com/AdminPortal/Home#/MessageCenter/:/messages/MC334280). Como administrador do Teams, você pode permitir que usuários finais específicos usem os aplicativos aprimorados ou gerenciem seu acesso aos aplicativos aprimorados no Teams, no Outlook e Office.com. Os administradores do Teams usam o centro de administração do Teams para gerenciar o acesso ao aplicativo.
...
| Opções para gerenciar o acesso |Portal|Administrador global|Administrador do Teams|
|--|---|---|--|
...
* [Aplicativos do Microsoft Teams projetados para o Microsoft 365 em versão prévia para o Outlook e Office.com](https://techcommunity.microsoft.com/t5/microsoft-365-blog/microsoft-teams-apps-designed-for-microsoft-365-coming-in/ba-p/3269538)
