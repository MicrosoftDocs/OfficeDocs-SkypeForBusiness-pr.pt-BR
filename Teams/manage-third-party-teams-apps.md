...
| Gerencie o acesso aos novos aplicativos para todos os usuários finais em sua organização. Consulte [Permitir ou bloquear aplicativos](manage-apps.md#allow-and-block-apps). | Teams de administração | Sim | Sim |
