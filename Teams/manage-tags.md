...
ms.locfileid: "50145848"
---
# <a name="manage-tags-in-microsoft-teams"></a>Gerenciar marcas no Microsoft Teams

> [!NOTE]
> Um dos recursos descritos neste artigo, **marcação por turno**, está em implementação. Se você for um administrador, poderá descobrir quando este recurso será lançado para a sua região no centro de mensagens (no [centro de administração do Microsoft 365](https://portal.office.com/adminportal/home)). Para manter-se atualizado sobre os recursos futuros do Teams, consulte o [mapa do Microsoft 365](https://www.microsoft.com/microsoft-365/roadmap?filters=&searchterms=microsoft%2Cteams).
...
Como administrador, você pode controlar como as marcas são usadas em toda a organização no centro de administração do Microsoft Teams. No momento, você não pode usar o PowerShell para gerenciar as marcas.
...
### <a name="set-up-tagging-by-shift"></a>Configurar marcação por turno
