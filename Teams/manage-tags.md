...
Como administrador, você pode controlar como as marcas são usadas em sua organização no centro de administração do Microsoft Teams. No momento, você não pode usar o PowerShell para gerenciar marcas.
...
A marcação por turno permite que os usuários alcancem as pessoas no turno em tempo real. O Teams atribui automaticamente usuários com marcas correspondentes ao nome do grupo de turnos e agendamento do aplicativo Shifts, permitindo mensagens dinâmicas baseadas em função. As notificações são enviadas somente para as pessoas que estão de turno no momento em que uma marca é usada para iniciar um chat ou em uma postagem de canal.

1. No Teams, acesse o [aplicativo Turnos](https://support.microsoft.com/office/get-started-in-shifts-5f3e30d8-1821-4904-be26-c3cd25a497d6#bkmk_openshiftsappdesktop).
