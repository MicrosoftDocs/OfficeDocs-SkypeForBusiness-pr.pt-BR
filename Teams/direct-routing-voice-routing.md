...
<span data-ttu-id="4043a-113">Para obter informações sobre todas as etapas necessárias para configurar o roteamento direto, consulte [Configurar o roteamento direto](direct-routing-configure.md).</span><span class="sxs-lookup"><span data-stu-id="4043a-113">For information on all the steps required for setting up Direct Routing, see [Configure Direct Routing](direct-routing-configure.md).</span></span>
...
## <a name="voice-routing-policy-considerations"></a><span data-ttu-id="4043a-125">Considerações sobre a política de roteamento de voz</span><span class="sxs-lookup"><span data-stu-id="4043a-125">Voice routing policy considerations</span></span>
...
<span data-ttu-id="4043a-145">No exemplo mostrado no diagrama a seguir, uma rota de voz é adicionada para enviar chamadas para todos os outros números canadenses e EUA (chamadas que vão para o padrão de número chamado + 1 XXX XXX XX XX).</span><span class="sxs-lookup"><span data-stu-id="4043a-145">In the example shown in the following diagram, a voice route is added to send calls to all other US and Canadian numbers (calls that go to called number pattern +1 XXX XXX XX XX).</span></span>
...
4. <span data-ttu-id="4043a-187">Atribua a política a um usuário chamado Spencer baixo.</span><span class="sxs-lookup"><span data-stu-id="4043a-187">Assign the policy to a user named Spencer Low.</span></span>
...
<span data-ttu-id="4043a-212">Para saber mais, consulte [gerenciar políticas de roteamento de voz](manage-voice-routing-policies.md).</span><span class="sxs-lookup"><span data-stu-id="4043a-212">To learn more, see [Manage voice routing policies](manage-voice-routing-policies.md).</span></span>
...
#### <a name="step-2-create-three-voice-routes-redmond-1-redmond-2-and-other-1"></a><span data-ttu-id="4043a-219">Etapa 2: criar três rotas de voz (Redmond, 1, Redmond 2 e outros + 1)</span><span class="sxs-lookup"><span data-stu-id="4043a-219">Step 2: Create three voice routes (Redmond 1, Redmond 2, and Other +1)</span></span>
...
<span data-ttu-id="4043a-227">Rotear todas as chamadas para o mesmo SBC.</span><span class="sxs-lookup"><span data-stu-id="4043a-227">Route all calls to the same SBC.</span></span>
...
<span data-ttu-id="4043a-232">Em uma sessão do PowerShell no Skype for Business Online, digite:</span><span class="sxs-lookup"><span data-stu-id="4043a-232">In a PowerShell session in Skype for Business Online, type:</span></span>
...
<span data-ttu-id="4043a-257">A tabela a seguir resume as designações de uso de política de roteamento "sem restrições" e rotas de voz.</span><span class="sxs-lookup"><span data-stu-id="4043a-257">The following table summarizes routing policy "No Restrictions" usage designations and voice routes.</span></span> 

|<span data-ttu-id="4043a-258">**Uso de PSTN**</span><span class="sxs-lookup"><span data-stu-id="4043a-258">**PSTN usage**</span></span>|<span data-ttu-id="4043a-259">**Rota de voz**</span><span class="sxs-lookup"><span data-stu-id="4043a-259">**Voice route**</span></span>|<span data-ttu-id="4043a-260">**Padrão de número**</span><span class="sxs-lookup"><span data-stu-id="4043a-260">**Number pattern**</span></span>|<span data-ttu-id="4043a-261">**Prioridade**</span><span class="sxs-lookup"><span data-stu-id="4043a-261">**Priority**</span></span>|<span data-ttu-id="4043a-262">**SBC**</span><span class="sxs-lookup"><span data-stu-id="4043a-262">**SBC**</span></span>|<span data-ttu-id="4043a-263">**Descrição**</span><span class="sxs-lookup"><span data-stu-id="4043a-263">**Description**</span></span>|
|:-----|:-----|:-----|:-----|:-----|:-----|
|<span data-ttu-id="4043a-264">EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="4043a-264">US and Canada</span></span>|<span data-ttu-id="4043a-265">"Redmond 1"</span><span class="sxs-lookup"><span data-stu-id="4043a-265">"Redmond 1"</span></span>|<span data-ttu-id="4043a-266">^\\+ 1 (425 \| 206) (\d {7} ) $</span><span class="sxs-lookup"><span data-stu-id="4043a-266">^\\+1(425\|206)(\d{7})$</span></span>|<span data-ttu-id="4043a-267">1</span><span class="sxs-lookup"><span data-stu-id="4043a-267">1</span></span>|<span data-ttu-id="4043a-268">sbc1.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-268">sbc1.contoso.biz</span></span><br/><span data-ttu-id="4043a-269">sbc2.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-269">sbc2.contoso.biz</span></span>|<span data-ttu-id="4043a-270">Roteiro ativo para números de chamada + 1 425 XXX XX XX ou + 1 206 XXX XX XX</span><span class="sxs-lookup"><span data-stu-id="4043a-270">Active route for callee numbers +1 425 XXX XX XX or +1 206 XXX XX XX</span></span>|
|<span data-ttu-id="4043a-271">EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="4043a-271">US and Canada</span></span>|<span data-ttu-id="4043a-272">"Redmond 2"</span><span class="sxs-lookup"><span data-stu-id="4043a-272">"Redmond 2"</span></span>|<span data-ttu-id="4043a-273">^\\+ 1 (425 \| 206) (\d {7} ) $</span><span class="sxs-lookup"><span data-stu-id="4043a-273">^\\+1(425\|206)(\d{7})$</span></span>|<span data-ttu-id="4043a-274">2</span><span class="sxs-lookup"><span data-stu-id="4043a-274">2</span></span>|<span data-ttu-id="4043a-275">sbc3.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-275">sbc3.contoso.biz</span></span><br/><span data-ttu-id="4043a-276">sbc4.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-276">sbc4.contoso.biz</span></span>|<span data-ttu-id="4043a-277">Rota de backup para números do chamado + 1 425 XXX XX XX ou + 1 206 XXX XX XX</span><span class="sxs-lookup"><span data-stu-id="4043a-277">Backup route for callee numbers +1 425 XXX XX XX or +1 206 XXX XX XX</span></span>|
|<span data-ttu-id="4043a-278">EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="4043a-278">US and Canada</span></span>|<span data-ttu-id="4043a-279">"Outro + 1"</span><span class="sxs-lookup"><span data-stu-id="4043a-279">"Other +1"</span></span>|<span data-ttu-id="4043a-280">^\\+ 1 (\d {10} ) $</span><span class="sxs-lookup"><span data-stu-id="4043a-280">^\\+1(\d{10})$</span></span>|<span data-ttu-id="4043a-281">3</span><span class="sxs-lookup"><span data-stu-id="4043a-281">3</span></span>|<span data-ttu-id="4043a-282">sbc5.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-282">sbc5.contoso.biz</span></span><br/><span data-ttu-id="4043a-283">sbc6.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-283">sbc6.contoso.biz</span></span>|<span data-ttu-id="4043a-284">Rota para números de chamada + 1 XXX XXX XX XX (exceto + 1 425 XXX XX XX ou + 1 206 XXX XX XX)</span><span class="sxs-lookup"><span data-stu-id="4043a-284">Route for callee numbers +1 XXX XXX XX XX (except +1 425 XXX XX XX or +1 206 XXX XX XX)</span></span>|
|<span data-ttu-id="4043a-285">International</span><span class="sxs-lookup"><span data-stu-id="4043a-285">International</span></span>|<span data-ttu-id="4043a-286">International</span><span class="sxs-lookup"><span data-stu-id="4043a-286">International</span></span>|<span data-ttu-id="4043a-287">\d +</span><span class="sxs-lookup"><span data-stu-id="4043a-287">\d+</span></span>|<span data-ttu-id="4043a-288">4</span><span class="sxs-lookup"><span data-stu-id="4043a-288">4</span></span>|<span data-ttu-id="4043a-289">sbc2.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-289">sbc2.contoso.biz</span></span><br/><span data-ttu-id="4043a-290">sbc5.contoso.biz</span><span class="sxs-lookup"><span data-stu-id="4043a-290">sbc5.contoso.biz</span></span>|<span data-ttu-id="4043a-291">Rota para qualquer padrão de número</span><span class="sxs-lookup"><span data-stu-id="4043a-291">Route for any number pattern</span></span> |
...
#### <a name="step-1-create-the-international-pstn-usage"></a><span data-ttu-id="4043a-307">Etapa 1: criar o uso de PSTN "internacional"</span><span class="sxs-lookup"><span data-stu-id="4043a-307">Step 1: Create the "International" PSTN usage</span></span>
...
1. <span data-ttu-id="4043a-330">Na barra de navegação à esquerda do centro de administração do Microsoft Teams, vá para **Usuários** e clique no usuário.</span><span class="sxs-lookup"><span data-stu-id="4043a-330">In the left navigation of the Microsoft Teams admin center, go to **Users**, and then click the user.</span></span>
...
#### <a name="step-3-create-a-voice-routing-policy-named-no-restrictions"></a><span data-ttu-id="4043a-339">Etapa 3: criar uma política de roteamento de voz chamada "sem restrições"</span><span class="sxs-lookup"><span data-stu-id="4043a-339">Step 3: Create a voice routing policy named "No Restrictions"</span></span>
