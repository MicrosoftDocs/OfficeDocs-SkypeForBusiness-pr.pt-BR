...
### <a name="to-buy-and-assign-user-audio-conferencing-licenses"></a>Para comprar e atribuir licenças de Audioconferência de usuário

1. Descubra se **a Audioconferência** está disponível em seu país/região. [Disponibilidade de países e regiões para Audioconferência e Planos de Chamadas](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md).
...
2. Obtenha suas licenças de **Audioconferência**. Se você quiser:
   ...
   - **Compre-o**: consulte [o licenciamento de complemento do Microsoft Teams](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md).

3. [Atribua licenças a usuários](/microsoft-365/admin/manage/assign-licenses-to-users) em sua organização que vão agendar ou liderar reuniões.
...
1. Descubra se **a Audioconferência** está disponível em seu país/região. [Disponibilidade de país e região para Audioconferência e Planos de Chamadas](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md).
...
3. [Configure créditos de comunicação para sua organização](set-up-communications-credits-for-your-organization.md) . Para configurar Créditos de Comunicação, confira [O que são Créditos de Comunicação?](what-are-communications-credits.md)
...
4. [Atribua licenças a usuários](/microsoft-365/admin/manage/assign-licenses-to-users) em sua organização que vão agendar ou liderar reuniões.
