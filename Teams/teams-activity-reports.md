...
|**6**   |Para filtrar a série apresentada no gráfico, clique no item da legenda. Por exemplo, no gráfico de **distribuição** , clique ou toque **em Windows**, **Mac**, **Linux**, **Web**, **Ios**ou **Android** para ver apenas as informações relacionadas a cada um. Alterar essa seleção não altera as informações na tabela de grade. |
