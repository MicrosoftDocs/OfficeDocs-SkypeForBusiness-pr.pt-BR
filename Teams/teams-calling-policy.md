---
title: 'Políticas de chamada em Microsoft Teams: recursos de encaminhamento de chamada e chamada'
author: SerdarSoysal
ms.author: tonysmit
manager: serdars
ms.topic: conceptual
...
No Microsoft Teams, as políticas de chamada controlam quais recursos de chamada e encaminhamento de chamada estão disponíveis para os usuários. As políticas de chamadas determinam se um usuário pode fazer chamadas privadas, usar encaminhamento de chamadas ou toque simultâneo para outros usuários ou números de telefone externos, rotear chamadas para caixa postal, enviar chamadas para grupos de chamadas, usar delegação para chamadas de entrada e saída e assim por diante.
...
4. Para controlar se os usuários podem encaminhar chamadas para a caixa postal, selecione **Habilitado para** ou **Usuário controlado por**. Para evitar o roteamento para a caixa postal, selecione **Desabilitado**.
5. Selecione **Salvar**.
...
Essa configuração controla todos os recursos de chamada Teams. Desativar esta funcionalidade para desativar todas as funcionalidades de chamada no Teams.
...
### <a name="call-forwarding-and-simultaneous-ringing-to-external-phone-numbers"></a>Encaminhamento de chamadas e toque simultâneo para números de telefone externo
...
### <a name="inbound-calls-can-be-routed-to-call-groups"></a>Chamadas de entrada podem ser roteada para grupos de chamadas
...
Essa configuração permite que as chamadas de entrada sejam roteados para representantes, permitindo que os representantes façam chamadas de saída em nome dos usuários para os quais eles têm permissões delegadas. Para obter mais informações, [consulte Share a phone line with a delegate](https://support.office.com/article/share-a-phone-line-with-a-delegate-16307929-a51f-43fc-8323-3b1bf115e5a8).

### <a name="prevent-toll-bypass-and-send-calls-through-the-pstn"></a>Evitar ignorar tarifas tarifadas e enviar chamadas por meio do PSTN 
...
Essa configuração controla se os convites de reunião de entrada são atendidos automaticamente. Ele está desligado por padrão. Lembre-se de que essa configuração se aplica somente a convites de reunião de entrada. Não se aplica a outros tipos de chamadas.
