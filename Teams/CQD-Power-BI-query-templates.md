...
Novidade em janeiro de 2020: [baixe modelos de consulta do Power BI para CQD](https://www.microsoft.com/download/details.aspx?id=102291). Modelos personalizáveis do Power BI que você pode usar para analisar e relatar seus dados CQD.
...
|CQD Mobile Device Report.pbit     | Fornece insights especificamente ajustados para usuários de dispositivos móveis, incluindo Qualidade de Chamada, Confiabilidade e Rate My Call. Exiba a rede móvel, a rede WiFi e os relatórios do sistema operacional móvel (Android, iOS). |
