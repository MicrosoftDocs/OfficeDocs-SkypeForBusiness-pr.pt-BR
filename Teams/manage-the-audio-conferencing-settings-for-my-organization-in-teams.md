...
### <a name="see-primary-and-secondary-languages-using-the-microsoft-teams-admin-center"></a>Consulte idiomas primários e secundários usando o Microsoft Teams de administração
...
## <a name="see-audio-conferencing-dial-in-numbers-using-the-microsoft-teams-admin-center"></a>Consulte números de discagem de audioconferência usando o Microsoft Teams de administração
