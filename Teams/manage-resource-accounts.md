...
Cada conta de recurso requer uma licença para trabalhar com atendimentos automáticos e filas de chamada. Você pode usar uma licença de *Microsoft 365 Sistema de Telefonia - Usuário Virtual*. Para obter essas licenças, consulte [Licença do Usuário Virtual](teams-add-on-licensing/virtual-user.md).
