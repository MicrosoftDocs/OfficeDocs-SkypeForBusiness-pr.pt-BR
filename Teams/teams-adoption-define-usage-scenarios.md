...
description: Saiba como escolher os melhores cenários de uso aplicáveis para a fase de experimento de sua Teams adoção.
f1.keywords:
- CSH
ms.custom:
- Adopt
...
ms.locfileid: "60766079"
---
# <a name="define-usage-scenarios-for-microsoft-teams"></a>Definir cenários de uso do Microsoft Teams

Certifique-se de entender os projetos de negócios (cenários) que estarão no escopo dessa fase da sua implementação. Confira esta lista de cenários de exemplo que são ótimos candidatos para um programa de adoção antecipado. Você pode começar com as vitórias fáceis, como:
...
- Trazer campanhas para o mercado mais rapidamente
...
## <a name="interview-business-stakeholders"></a>Entrevistar participantes de negócios

Para confirmar a seleção desses primeiros projetos, recomendamos uma reunião diretamente com as partes interessadas identificadas anteriormente neste processo. Seu objetivo neste ponto é ouvir e aprender informações adicionais sobre seus negócios. Considere as seguintes perguntas para conduzir a conversa:
...
- Quais são as iniciativas estratégicas da organização ou projetos de transformação atuais que Teams podem suportar?
- Quais métodos de comunicação e colaboração geralmente são melhor recebidos pela sua organização do que outros?
- Qual é o processo de elaboração, distribuição e compartilhamento de informações?
