...
<sup>1</sup> Para conceder e assumir o controle do conteúdo que está sendo compartilhado, ambas as partes devem estar usando o cliente da área de trabalho do Teams. Não há suporte para controle quando ambas as partes estiverem executando o Teams em um navegador. Isso ocorre devido a uma limitação técnica de que estamos planejando corrigir. Para saber mais, leia [Permitir que um participante conceda ou solicite o controle](../meeting-policies-in-teams.md#allow-a-participant-to-give-or-request-control).
