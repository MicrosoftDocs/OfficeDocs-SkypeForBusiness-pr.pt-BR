...
|Safari 13.1+     |Não há suporte para chamadas 1:1. Chamadas de grupo compatíveis com o suporte completo a áudio.<br><br>Vídeo: Somente entrada<br><br>Compartilhamento: Somente compartilhamento de entrada (sem saída)         |Reuniões são compatíveis com o suporte completo a áudio.<br><br>Vídeo: Somente entrada<br><br>Compartilhamento: somente compartilhamento de entrada (sem saída). Observe que apenas a tela inteira de um usuário pode ser compartilhada; o compartilhamento de janelas específicas em um monitor não está disponível.     |
