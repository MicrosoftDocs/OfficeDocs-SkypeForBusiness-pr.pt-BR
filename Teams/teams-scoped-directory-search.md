...
> [!IMPORTANT]
> As políticas do livro de endereços fornecem apenas uma separação virtual dos usuários da perspectiva do diretório. Também é importante observar que todos os dados do usuário que já tinham sido armazenados em cache, antes da aplicação de políticas novas ou atualizadas do livro de endereços, permanecerão disponíveis para os usuários por até 30 dias.
...
3. Em **Pesquisa,** ao lado da pesquisa de diretório escopo no Teams usando uma política de lista de endereços **(ABP)** do Exchange, a opção **ativar.**
