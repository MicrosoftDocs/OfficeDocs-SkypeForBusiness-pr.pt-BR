...
|ID do Chamador  <br/> |Chamadas de dentro da empresa exibem uma ID de chamada que obtém as informações do diretório corporativo, mostrando a foto e o cargo, em vez de apenas um número de telefone. Para chamadas de números de telefone externos, a identificação de chamadas fornecida pelo provedor de serviços de telefonia é exibida. Se os números de telefone externos forem números secundários em seu diretório corporativo, as informações do diretório corporativo serão exibidas.  <br/> |
...
- [Soluções de telefonia da Microsoft](https://docs.microsoft.com/SkypeForBusiness/hybrid/msft-telephony-solutions): Este artigo dispõe de todas as suas opções de implantação. Ele também tem informações sobre como planejar uma única solução completa de nuvem. 
...
- Música de espera
- Pesquisa de número reverso do AAD
