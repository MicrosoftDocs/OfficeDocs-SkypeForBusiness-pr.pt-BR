...
| 10 | Opcional: use o PowerShell para administrar Teams | Você pode usar cmdlets do PowerShell em vez do Microsoft 365 de administração para administrar e gerenciar Teams configurações. | | [Microsoft Teams PowerShell](/powershell/module/teams/?view=teams-ps) |