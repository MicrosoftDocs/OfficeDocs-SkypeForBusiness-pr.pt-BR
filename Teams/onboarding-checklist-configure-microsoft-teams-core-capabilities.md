...
| 254 | Opcional: usar o PowerShell para administrar equipes | Você pode usar cmdlets do PowerShell em vez do centro de administração do Office 365 para administrar e gerenciar as configurações do teams. | | [Microsoft Teams PowerShell](https://docs.microsoft.com/powershell/module/teams/?view=teams-ps) |
