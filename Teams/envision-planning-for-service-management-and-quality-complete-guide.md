...
---
# <a name="plan-for-service-management-and-quality"></a>Planejar o gerenciamento de serviço e qualidade

Este documento é sobre a fase de Envision for Microsoft Teams.
 
## <a name="introduction"></a>Introdução

Esse conteúdo fornecerá uma visão geral dos requisitos necessários entregar e manter uma implantação do Microsoft Teams de alta qualidade. Você pode ajudar a garantir uma implantação bem-sucedida pelo planejamento de gerenciamento de serviço e qualidade durante a fase de Envision, antes da sua implantação piloto ou de produção primeira.
...
-   Em segundo lugar, orientação é fornecida para o planejamento de um modelo de suporte para gerenciar o Microsoft Teams antes da implantação de produção ou piloto de usuário primeira. Esta seção descreve as tarefas que precisam ser executadas regularmente para manter uma implantação de equipes de qualidade. Além disso, esta seção apresenta orientação adicional que você pode usar para iniciar a compreensão e operacionalização essas tarefas.
...
Os principais componentes que afetam a experiência do usuário serão revisados nesta seção. Antes de examinar os principais componentes, é importante que você compreenda a experiência do usuário e sua importância na percebendo metas de negócios da sua organização. Vamos analisar como podemos definem a experiência do usuário pela primeira vez.

### <a name="user-experience-defined"></a>Experiência do usuário definida

Metas de negócios podem ser obtidas quando você implantar o Microsoft Teams e incorporar a comunicação em seus processos de negócios para aperfeiçoar seu fluxo de trabalho. Unidades de qualidade de adoção e uso: se sua organização oferece um serviço de alta qualidade que delights pessoas, então indivíduos e equipes ganhar confiança e encontrar novas e inovadores maneiras de usar o serviço que motivam benefícios comerciais.

No Centro de esta é a experiência do usuário com equipes — emoções e posturas em direção o serviço da pessoa. Portanto, o que contribui para a experiência do usuário? Ele varia dos usuários para saber como usar as equipes e incorporá-lo em seu fluxo de trabalho diário experimentando uma qualidade de chamada excepcionais e poder conectar confiável, independentemente de onde estejam. Experiência do usuário é muito ampla de natureza temporária; Este documento enfoca apenas aqueles elementos que podem ser controlados pela sua organização.
...
Uma organização ou um parceiro de suporte deve começar a planejar três componentes principais durante a fase de Envision de uma implantação de equipes: gerenciamento, rede e pontos de extremidade de serviço. A combinação de todos os três áreas é fundamental para a qualidade da experiência do usuário.
...
Para obter orientações detalhadas para o planejamento de gerenciamento de serviço, consulte [Planejando o gerenciamento de serviço](https://docs.microsoft.com/MicrosoftTeams/envision-planning-for-service-management-and-quality-complete-guide#Plan-for-service-management).
...
Para obter orientações detalhadas sobre o planejamento de rede, consulte [Planning for a qualidade da rede](https://docs.microsoft.com/MicrosoftTeams/envision-planning-for-service-management-and-quality-complete-guide#Plan-for-network-quality).
...
Para oferecer a melhor experiência de seus usuários possíveis, você precisa considerar estes aspectos importantes durante a fase de Envision: faça seus pontos de extremidade atendem aos requisitos de hardware e software de equipes? Você configurada e otimizada de pontos de extremidade para oferecer suporte a redes Wi-Fi? Os dispositivos que você usará para fazer e receber chamadas de voz? Esses dispositivos otimizados para equipes?

Para obter orientações detalhadas sobre o planejamento de ponto de extremidade, consulte [Planning for Quality do ponto de extremidade](https://docs.microsoft.com/MicrosoftTeams/envision-planning-for-service-management-and-quality-complete-guide#Plan-for-endpoint-quality).
...
![Diagrama que descreve os componentes de 3 de qualilty e como o gerenciamento de serviço se sobrepõe a todos os componentes de 3. Com foco no gerenciamento de serviço.](media/envision-planning-for-service-management-and-quality-complete-guide-image2.png)
...
Mapeamento funções operacionais logo no início da fase Envision habilita todas as equipes iniciar suas tarefas operacionais durante o piloto e conheça as operações e certifique-se de que tudo esteja pronto após a implantação é iniciado.
...
![Diagrama que descreve os componentes de qualidade e como o gerenciamento de serviço se sobrepõe a todos os componentes de 3 de 3. Com foco na rede.](media/envision-planning-for-service-management-and-quality-complete-guide-image4.png)

Conforme mencionado anteriormente, planejamento de qualidade da rede antes da inclusão a Microsoft Teams é crítica. Para obter mais orientações para a preparação da rede, consulte [preparar a rede da sua organização para equipes da Microsoft](https://docs.microsoft.com/MicrosoftTeams/prepare-network).
...
Para implementar o QoS em sua rede, as orientações a seguir podem ajudar a [Qualidade de serviço em equipes da Microsoft](https://docs.microsoft.com/MicrosoftTeams/qos-in-teams)
...
[Servidores proxy para Skype para negócios on-line e equipes](https://docs.microsoft.com/SkypeForBusiness/optimizing-your-network/proxy-servers-for-skype-for-business-online)
...
Depois que a firewall for aberto, você pode usar a [Ferramenta de avaliação de rede Microsoft](https://www.microsoft.com/en-us/download/details.aspx?id=53885) para validar a conectividade para os recursos de voz de nuvem.
...
A avaliação de rede poderá ser realizada por meio de um parceiro da Microsoft, ferramentas de terceiros ou a [ferramenta de avaliação de rede da Microsoft](https://www.microsoft.com/en-us/download/details.aspx?id=53885). Fornecemos também ainda mais diretrizes sobre como executar a avaliação usando a ferramenta de avaliação de rede da Microsoft como parte de nossa orientação de preparação [aqui](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Downloads?SelectedIDs=4_3_0_2,4_3_0_3,4_3_0_5,4_3_0_6,4_3_0_7,4_3_0_8,4_3_0_10,4_3_0_11)..

## <a name="plan-for-endpoint-quality"></a>Planejar a qualidade do ponto de extremidade

Como você pode ver do diagrama a seguir, os pontos de extremidade são um bloco de construção importante no fornecimento de uma experiência de qualidade para usuários finais.

![Diagrama que descreve os componentes de qualidade e como o gerenciamento de serviço se sobrepõe a todos os componentes de 3 de 3. Com o foco em pontos de extremidade.](media/envision-planning-for-service-management-and-quality-complete-guide-image5.png)

Pontos de extremidade do Microsoft Teams podem ser executado em vários dispositivos, incluindo PCs, Macs, tablets e dispositivos móveis. Parte da experiência abrange não apenas o dispositivo, mas como um usuário se conecta ao dispositivo — por exemplo, usando um headset otimizada, botões de ouvido ou microfone/alto-falante interno do dispositivo. Usar um fone de ouvido otimizada pode enriquecer a experiência geral do usuário.
...
A primeira parte do planejamento é garantir que todos os PCs e outros dispositivos em sua organização podem executar Teams da Microsoft. Isso envolve não só olhando os requisitos de hardware, mas também Noções básicas sobre o que mais PC está fazendo em segundo plano. Muitas organizações executarem outros softwares, incluindo os sistemas de detecção de invasão e o software de antimalware que pode afetar o desempenho de base de um dispositivo.

Microsoft Teams tem clientes disponíveis para a área de trabalho, web (Windows e Mac) e mobile (Android, iOS e Windows Mobile). Para obter informações sobre os requisitos de software para cada plataforma, consulte [Obter clientes para equipes da Microsoft](https://docs.microsoft.com/microsoftteams/get-clients).
...
|-----------------------------|----------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Planejar o gerenciamento de serviço | Conduzir um exercício de mapeamento de função operacionais <br/> Aprovação de equipes responsáveis <br/> Preparação de função | [Guia de operações](https://docs.microsoft.com/MicrosoftTeams/1-drive-value-operate-my-service) |
...
| | Implementar o QoS | [Qualidade de serviço em equipes da Microsoft](https://docs.microsoft.com/MicrosoftTeams/qos-in-teams) |
...
| | Otimizar redes Wi-Fi para a mídia em tempo real  | Consulte fornecedores participantes 3º |
...
| | | [Ferramenta de avaliação de rede](https://www.microsoft.com/en-us/download/details.aspx?id=53885) |
...
| | Validar os requisitos de software | [Obtenha os clientes para equipes da Microsoft](https://docs.microsoft.com/microsoftteams/get-clients) |
| | Implementar as recomendações de ponto de extremidade Wi-Fi | Consulte fornecedores participantes 3º |
