...
">PowerShell ‒ módulo do Skype for Business</a> ou <a href="https://docs.microsoft.com/microsoftteams/manage-teams-skypeforbusiness-admin-center">Microsoft Teams e Centro de administração do Skype for Business</a></td></tr>
<tr><td align="right"><sup>2</sup></td><td colspan="3"><a href="https://www.powershellgallery.com/packages/MicrosoftTeams/0.9.3">PowerShell ‒ módulo do Microsoft Teams</a> ou <a href="https://docs.microsoft.com/microsoftteams/manage-teams-skypeforbusiness-admin-center">Microsoft Teams e Centro de administração do Skype for Business</a></td></tr>
<tr><td align="right"><sup>3</sup></td><td colspan="3"><a href="https://docs.microsoft.com/microsoftteams/manage-teams-skypeforbusiness-admin-center">Microsoft Teams e Centro de administração do Skype for Business</a> apenas</td>
</tr>
</tfoot>
</table>
...
Para obter mais informações, confira [Gerenciar equipes no Microsoft Teams e no Centro de Administração do Skype for Business](manage-teams-in-modern-portal.md).
...
-   [Práticas recomendadas para organizar equipes no Microsoft Teams](best-practices-organizing.md)
-   [Visão geral de uma implantação do Microsoft Teams](deployment-overview.md)
...
| ![](media/audio_conferencing_image9.png)<br/>Próximos passos|<ul><li>Crie a equipe.</li><li>Planeje canais.</li></ul>|
...
| ![](media/audio_conferencing_image9.png)<br/>Próximos passos|<ul><li>Crie canais iniciais.</li><li>Poste uma mensagem de boas-vindas.</li><li>Comece a colaborar.</li></ul>|
...
| ![](media/audio_conferencing_image9.png)<br/>Próximo passo|<ul><li>Implemente um processo para monitorar a integridade de equipes individuais.</li></ul>|
...
| ![](media/audio_conferencing_image9.png)<br/>Próximos passos|<ul><li>Documente as práticas recomendadas e as lições aprendidas.</li><li>Arquive os dados, se necessário.</li></ul>|
