...
As políticas no Teams permitem controlar como o Teams se comporta em seu ambiente e quais recursos estão disponíveis para os usuários. Por exemplo, há políticas de chamada, políticas de reunião e políticas de mensagens, para nomear algumas, e cada área de política pode ser personalizada para atender às necessidades da sua organização.
...
Além disso, sempre que um novo recurso for adicionado ao Teams, o valor padrão relevante do EDU apropriado da política para esse recurso será adicionado automaticamente ao global (padrão de toda a organização) sem a necessidade de intervenção do administrador. Isso ajuda a garantir que as políticas corretas estejam em vigor para manter os alunos seguros e engajados.
...
1. Se você for novo no Teams, o assistente será iniciado automaticamente. Caso contrário, você pode iniciar o assistente a qualquer momento no painel. No painel de navegação esquerdo do Centro de administração do Microsoft Teams, vá para Página Inicial **e, em** seguida, na configuração de política Fácil para um bloco de ambiente de aprendizado seguro, selecione **Configuração rápida**.
...
> [!IMPORTANT]
> **Conclua esta etapa somente se você tiver políticas existentes atribuídas a alunos ou educadores e funcionários *antes* de executar o assistente**. Se você for novo no Teams e não tiver nenhuma política existente além das políticas criadas pelo assistente, ignore isso e vá para a etapa 2.
...
Consulte [Manter os alunos seguros ao usar o Teams para aprendizado à distância](https://support.microsoft.com/office/keeping-students-safe-while-using-teams-for-distance-learning-f00fa399-0473-4d31-ab72-644c137e11c8#ID0EBBAAA) para obter recomendações de segurança adicionais.
...
1. No painel de navegação esquerdo do Centro de administração do Microsoft Teams, vá para a Página Inicial **e, em** seguida, na configuração de política Fácil para um bloco de ambiente de aprendizado seguro, selecione **Alterar**.
...
Aqui estão as áreas de política e os nomes de política correspondentes cobertos pelo assistente. Para encontrar essas políticas, vá para o centro de administração do Microsoft Teams e, no painel de navegação esquerdo, vá para cada página da área de política.
...
|||Quem pode se registrar|Todos na organização|Todos na organização|
...
|||Compartilhamento do PowerPoint|Habilitado|Habilitado|
...
|||Aplicativos fixados|Atividade, Calendário, Teams|Atividade, chats, equipes, calendário, chamadas, arquivo
