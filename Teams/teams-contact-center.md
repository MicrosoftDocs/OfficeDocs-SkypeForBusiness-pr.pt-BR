...
Integrar soluções populares de central de contatos com o Microsoft Teams é uma necessidade comum para os clientes que implantam recursos de Chamada do Teams.  Este artigo fornece uma visão geral de como as soluções de contact center podem ser integradas ao Microsoft Teams e informações adicionais sobre os provedores de soluções participantes do Programa de Certificação do Centro de Contatos Conectados do Microsoft Teams.
...
Este modelo conecta provedores de soluções CCaaS à infraestrutura do sistema telefônico do Microsoft Teams, permitindo roteamento, configuração e percepções do sistema aprimorados. 

Os agentes que usam soluções criadas no modelo Connect podem coletar informações & informações e, se necessário, transferir chamadas para especialistas do assunto diretamente, usando a presença do SME no Teams para garantir sua disponibilidade.
...
Embora o seguinte não seja uma lista abrangente de recursos para esse modelo de integração, as áreas de foco incluem:
  ...
  - AuthN do Office 365 para agentes permitirem que os agentes se conectem ao locatário da Microsoft a partir do cliente CCaaS integrado 

  - Indicação de presença dos usuários do Teams 

  - Suporte a transferências e chamadas de grupo com usuários do Teams 
...
Embora o seguinte não seja uma lista abrangente de recursos para esse modelo de integração, ele realça as principais áreas de foco:
  ...
  - O aplicativo de experiência do agente também deve ser capaz de funcionar no Cliente Web e móvel do Teams
...
Embora o seguinte não seja uma lista abrangente de recursos para esse modelo de integração, essas áreas de destaque além das fornecidas pelo modelo Connect e Extend.
...
Consulte a tabela abaixo para ver uma visão geral dos modelos de integração compatíveis com o Microsoft Teams.
...
<tr class="even">
<td>Usuários com o Teams chamando?</td>
<td>Informal, SME</td>
<td>Informal, SME</td>
