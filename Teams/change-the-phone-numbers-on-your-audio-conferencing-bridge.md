...
3. Na página **Editar**, em **Atribuído a, expanda** a lista suspensa e selecione **Conference** **bridgeApply** > .
...
1. No painel de navegação esquerdo, vá para **pontes MeetingsConference** > .
