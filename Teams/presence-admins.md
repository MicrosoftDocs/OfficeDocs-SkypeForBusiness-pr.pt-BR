...
|![Círculo cinza com x, indica Offline](media/Presence_Offline.png) Aparecer offline|![Círculo cinza com x, indica Offline](media/Presence_Offline.png) Modo.  Quando os usuários não se conectarem em nenhum dos seus dispositivos por alguns minutos, eles aparecerão offline. | |
...
> [!NOTE]
> Um usuário também pode configurar manualmente uma duração para sua presença. Por exemplo, um usuário pode definir-se como aparece offline até a manhã amanhã.
...
A presença de equipes no Outlook é compatível com o aplicativo da área de trabalho do Outlook 2013 e posterior para contatos na mesma organização.
