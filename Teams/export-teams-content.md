...
- **Reações:** As APIs de exportação dão suporte a reações iniciadas por um usuário em uma mensagem do Teams. As reações atualmente suportadas são coração, raiva, tipo, triste, surpresa e risada.
