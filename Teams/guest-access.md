...
## <a name="guest-access-overview"></a>Visão geral do acesso de convidado
...
## <a name="how-does-guest-access-compare-to-external-access-federation"></a>Como o acesso de convidado se compara ao acesso externo (federação)?
