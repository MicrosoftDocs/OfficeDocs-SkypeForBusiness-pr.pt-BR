...
**Cada aluno tem experiências, habilidades e voz únicas.**<br/>
...
## <a name="who-uses-insights"></a>Quem usa o Insights?

### <a name="educators"></a>Educadores
...
Educadores são identificados pelas licenças do corpo docente. Os educadores devem ter uma licença do corpo docente e ser proprietário de uma equipe de classe para ver os dados apresentados no Insights.

### <a name="education-leaders"></a>Gestores escolares
...
Supondo que um supervisor também leciona, eles são considerados tanto um educador quanto um gestor escolar e podem acessar ambas as versões do Insights (para educadores e gestores escolares). Aqui, o Insights ajuda os gestores escolares a dar suporte a professores e alunos. No nível organizacional, o administrador de TI precisa conectar o sistema de informações dos alunos e atribuir permissões a cada função para acessar as escolas ou departamentos relevantes a eles.
...
>
> Os alunos são membros de uma equipe de classe dentro do Teams. Eles são identificados por sua licença e **não têm acesso** ao aplicativo ou à guia do Insights (mesmo que sejam proprietários da equipe).
>
> Os convidados *não podem* serem considerados alunos. 



## <a name="where-do-users-find-insights"></a>Onde os usuários encontram o Insights?
...
### <a name="education-leaders"></a>Gestores escolares
Os gestores escolares podem usar o Insights como um aplicativo pessoal disponível à esquerda na barra de aplicativos do Teams.
...
Por exemplo, um diretor vê apenas as classes na sua escola ou o chefe de um departamento vê apenas as classes do departamento. Os dados dos alunos são agregados em nível de classe, departamento, escola e distrito, e fornecemos Insights para cada nível (com base na permissão de cada usuário). Tanto educadores quanto gestores escolares podem ampliar e ver os dados individuais de alunos.

**Para adicionar o aplicativo Insights no Teams:**
* Clique em “**...**” na barra de aplicativos.
* Pesquise por **Insights** e selecione-o.
* Uma tela de descrição será aberta. Clique em **Adicionar**.

:::image type="content" source="media/insights-add-personal-app.png" alt-text="Adicionar Insights ao Teams":::

* Clique com o botão direito do mouse no ícone do Insights e selecione **Fixar**.
...
## <a name="how-insights-works"></a>Como o Insights funciona?
...
Antes de começar a implantar o Insights para sua instituição, por favor, dê uma rápida olhada como o Insights funciona, no nosso compromisso com a ética de dados, e no licenciamento necessário.

### <a name="data-collection"></a>Coleta de dados
Os dados são coletados para o Insights das atividades dos alunos e educadores no Teams. Dados de convidados não são coletados.
...
### <a name="using-data-ethically"></a>Usando dados de forma ética
...
A Microsoft compilou o Insights a partir do zero para garantir a proteção de dados. Estamos cientes da sensibilidade potencial de como esses dados podem ser utilizados, e nos preocupamos com seus dados e com a privacidade dos indivíduos. 

#### <a name="data-to-support-learning"></a>Dados de apoio à aprendizagem
...
O material para **gestores escolares** será publicado em breve.

## <a name="turn-insights-off-or-on"></a>Ativar ou desativar o Insights
...
### <a name="turn-off-insights-using-school-data-sync-sds"></a>Desativar o Insights usando o School Data Sync (SDS)
...
A utilização do Insights *não* requer o uso do SDS. No entanto, você pode optar por não participar do Insights a qualquer momento. Abra o [Centro de Administração do SDS](https://sds.microsoft.com) e vá para **Configurações** > **Gerenciar Insights para Educação**. Desativar '**Coletar dados para o Insights**' para desabilitar o Insights. 
...
### <a name="turn-on-insights"></a>Ativar o Insights
Se você desativou o Insights, você pode ativá-lo rapidamente. Abra o [Centro de Administração do SDS](https://sds.microsoft.com) e vá para **Configurações** > **Gerenciar Insights para Educação**. Ativar '**Coletar dados para o Insights**' para habilitar o Insights.
...
Se for um *novo* locatário e você *nunca* viu dados no Insights, verifique se o seu locatário foi **verificado como um locatário educacional** para acessar o Insights. Entre em contato com seu gerente da conta Microsoft e peça-lhe para verificar se o locatário está configurado corretamente.

Se você não tem um gerente de conta, abra um tíquete. Vá para o [Centro de administração do Office 365](https://admin.microsoft.com/AdminPortal/) > **Suporte** > **Nova Solicitação de Serviço**.  No título do tíquete, escreva: "Preciso de ajuda com a verificação educacional".
 
Além disso, verifique se a coleta de dados para Insights está ativada. Embora esteja ativado por padrão, o administrador de TI pode tê-lo desativado e, portanto, excluído todos os dados mantidos pelo Insights.

Para verificar isso, abra o [Centro de Administração do SDS](https://sds.microsoft.com) e vá para **Configurações** > **Gerenciar Insights para Educação**. Verifique o status de 'Coletar dados para insights'.

Se estiver desligado, ligue-o novamente.  O Insights começa a coletar dados, mas pode levar até 24 horas para vê-los nos relatórios. 
