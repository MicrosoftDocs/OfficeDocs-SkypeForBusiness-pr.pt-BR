...
description: Use estas diretrizes prescritivas para ajudá-lo a distribuir seus primeira algumas equipes para começar a usar o Microsoft Teams bate-papo, equipes, canais e reuniões.
layout: LandingPage
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Início rápido</h3>
                        <p>O orienta durante uma distribuição de equipes em pequena escala para que possa conhecer as equipes e planejar a implantação de toda a organização</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Crie seu primeiro equipes e canais</h3>
                        <p>Práticas recomendadas para configurar seu primeira equipes e canais</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Primeiros clientes a adotar onboard</h3>
                        <p>Obtenha os usuários primeiro para cima e em execução nas equipes novas que você acabou de criar</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Monitorar o uso e comentários</h3>
                        <p>Consulte como seus primeiros usuários estão usando equipes</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aonde ir próximo</h3>
                        <p>Quando você estiver pronto para distribuir as equipes para sua organização inteira, mostraremos como</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Obtenha ajuda</h3>
                        <p>Como localizar a assistência que necessária, enquanto você estiver usando o equipes</p>
                    </div>
                </div>
            </div>
        </div>
