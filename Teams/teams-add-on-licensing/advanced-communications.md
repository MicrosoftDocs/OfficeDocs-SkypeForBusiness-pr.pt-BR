...
description: Saiba mais sobre o SKU de complemento de Comunicações Avançadas para Microsoft Teams.
f1.keywords:
- NOCSH
ms.collection:
- M365-collaboration
...
Se sua organização estiver procurando aprimorar ainda mais sua experiência de comunicação, receba Comunicações Avançadas para personalização avançada de reuniões e ferramentas para gerenciar as políticas de comunicação da sua organização.

## <a name="what-is-advanced-communications"></a>O que é Comunicações Avançadas?

As Comunicações Avançadas incluem personalização avançada de reuniões, ferramentas para gerenciar as políticas de comunicação da sua organização, capacidade de gerenciamento premium com pacotes de política personalizados e lobby de reunião de marca personalizada para adaptar suas reuniões.
...
[Introdução Teams gravação baseada em política para & reuniões](../teams-recording-policy.md)
