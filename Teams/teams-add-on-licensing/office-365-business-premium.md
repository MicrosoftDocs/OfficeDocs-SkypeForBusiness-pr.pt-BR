...
- **Opção 1**. Use o [aplicativo Teams dentro de seu plano](https://products.office.com/microsoft-teams/free). Se você tiver uma pequena empresa (por exemplo, 1-2 pessoas), usar o aplicativo Teams é a melhor maneira de começar. É grátis e você pode comunicar o 1:1 por chat, fazer chamadas de áudio e vídeo em grupo e compartilhar sua área de trabalho para apresentações. [Compare os recursos, as taxas e as opções de pagamento](https://products.office.com/microsoft-teams/free).
