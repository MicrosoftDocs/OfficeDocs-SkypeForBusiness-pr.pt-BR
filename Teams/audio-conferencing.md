...
<span data-ttu-id="56ebc-120">Nessa etapa, as principais partes envolvidas no projeto definirão os casos de uso comercial que suportem a implementação de Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-120">In this step, core project stakeholders will define business use cases that support the implementation of Audio Conferencing.</span></span>
...
<td align="left"><ul><li><span data-ttu-id="56ebc-163">Responsável pela execução da estratégia de colaboração definida pelos executivos da empresa</span><span class="sxs-lookup"><span data-stu-id="56ebc-163">Responsible for execution on collaboration strategy defined by company executives</span></span></li>
...
<li><span data-ttu-id="56ebc-184">Desenvolvimento e responsabilidade pela estratégia de adoção</span><span class="sxs-lookup"><span data-stu-id="56ebc-184">Developing and responsible for adoption strategy</span></span></li>
...
<td align="left"><ul><li><span data-ttu-id="56ebc-205">Alimentar a fase de Descoberta em clientes e processos de atualização</span><span class="sxs-lookup"><span data-stu-id="56ebc-205">Providing input on Discovery phase into clients and update process</span></span></li>
...
<td align="left"><ul><li><span data-ttu-id="56ebc-225">Profissionais de TI responsáveis pela assistência no planejamento e execução de testes</span><span class="sxs-lookup"><span data-stu-id="56ebc-225">IT Pros responsible for assistance with test planning and execution</span></span></li></ul></td>
...
<li><span data-ttu-id="56ebc-253">Criar plano detalhado de implementação técnica</span><span class="sxs-lookup"><span data-stu-id="56ebc-253">Create detailed technical implementation plan</span></span></li></ul>
...
<td align="left"><span data-ttu-id="56ebc-296">Esquipe de Tecnologia da Informação</span><span class="sxs-lookup"><span data-stu-id="56ebc-296">Information Technology team</span></span></td>
</tr>
<tr class="odd">
...
<span data-ttu-id="56ebc-315">_Tabela 4 Exemplo de KSIs_</span><span class="sxs-lookup"><span data-stu-id="56ebc-315">_Table 4 Example of KSIs_</span></span>
...
<p><span data-ttu-id="56ebc-335">Comunicar o uso de novos números de conferência de discagem para os participantes externos</span><span class="sxs-lookup"><span data-stu-id="56ebc-335">Communicate the use of new dial-in conferencing numbers to external participants</span></span></p></td>
</tr>
<tr class="odd">
...
<span data-ttu-id="56ebc-349">A pesquisa do ambiente deve incluir avaliação da prontidão da rede para garantir que a rede esteja pronta para suportar a implementação do serviço de Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-349">Environmental discovery must include network readiness assessment to ensure the network is ready to support the implementation of the Audio Conferencing service.</span></span>
...
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-373">Operações de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-373">Audio Conferencing Operations</span></span></td>
...
<span data-ttu-id="56ebc-410">No geral, um plano de sucesso deve conter as seguintes seções principais:</span><span class="sxs-lookup"><span data-stu-id="56ebc-410">In general, a success plan will contain the following main sections:</span></span>
...
<span data-ttu-id="56ebc-460">[A licença para a Audioconferência](https://support.office.com/article/Skype-for-Business-add-on-licensing-3ed752b1-5983-43f9-bcfd-760619ab40a7?ui=en-US&rs=en-US&ad=US), anteriormente conhecida como licença de Conferência PSTN do Skype for Business, está disponível como parte dos planos de inscrição Office 365 E5 ou como um complemento aos parte dos planos de inscrição Office 365 E1 ou Office 365 E3.</span><span class="sxs-lookup"><span data-stu-id="56ebc-460">[Audio Conferencing license](https://support.office.com/article/Skype-for-Business-add-on-licensing-3ed752b1-5983-43f9-bcfd-760619ab40a7?ui=en-US&rs=en-US&ad=US), formerly known as Skype for Business PSTN Conferencing license, is available as part of Office 365 E5 subscription plans, or as an add-on to Office 365 E1 or Office 365 E3 subscription plans.</span></span>

> [!NOTE]
> <span data-ttu-id="56ebc-p120">A conferência PSTN ou por discagem no Teams não suporta Provedores de Audioconferência<sup></sup> de terceiros (ACPs). </span><span class="sxs-lookup"><span data-stu-id="56ebc-p120">PSTN or dial-in conferencing in Teams does not support 3<sup>rd</sup>-party Audio Conferencing Providers (ACPs). </span></span><br><span data-ttu-id="56ebc-462">Se você já usa a Conferência PSTN do Skype for Business hoje, você pode aproveitar a Audioconferência no Teams imediatamente.</span><span class="sxs-lookup"><span data-stu-id="56ebc-462">If you already use Skype for Business Online PSTN Conferencing today, you can immediately take advantage of Audio Conferencing in Teams.</span></span>

<span data-ttu-id="56ebc-463">Para fornecer números de telefone gratuitos de ponte de conferência e para suportar discagem de conferência para números de telefone internacionais, você precisa configurar [Créditos de Comunicação](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) para a sua organização.</span><span class="sxs-lookup"><span data-stu-id="56ebc-463">To provide toll-free conference bridge phone numbers and to support conferencing dial-out to International phone numbers, you need to setup [Communications Credits](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) for your organization.</span></span>


> [!IMPORTANT]
> <span data-ttu-id="56ebc-464">Alguns países são atendidos apenas por números de telefone gratuitos para ponte de conferência, e nesse caso, o uso de Créditos de Comunicação é um requisito obrigatório para ter suporte de acesso a esses países.</span><span class="sxs-lookup"><span data-stu-id="56ebc-464">Some countries are serviced by toll-free conference bridge phone numbers only, and in this case the use of Communications Credits is a mandatory requirement to support dial in for such countries.</span></span>

<span data-ttu-id="56ebc-465">A primeira consideração a fazer ao implementar os Créditos de Comunicação é decidir o valor inicial de fundos a serem comprados.</span><span class="sxs-lookup"><span data-stu-id="56ebc-465">The first consideration to make when implementing Communications Credits is to decide the initial amount of funds to be purchased.</span></span> <span data-ttu-id="56ebc-466">Os valores de fundos recomendados podem ser consultados na documentação dos [Créditos de Comunicação](https://support.office.com/en-us/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059).</span><span class="sxs-lookup"><span data-stu-id="56ebc-466">Recommended funding amounts can be referenced from the [Communications Credits](https://support.office.com/en-us/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) documentation.</span></span>

<span data-ttu-id="56ebc-467">Se a sua organização optar por usar recarga automática, uma recomendação sobre o gatilho (menor valor de fundos) também está incluída na documentação dos [Créditos de Comunicação](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059).</span><span class="sxs-lookup"><span data-stu-id="56ebc-467">If your organization chooses to use auto-recharge, a recommendation on the trigger (lowest amount of funds) is also included in the [Communications Credits](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) documentation.</span></span> <span data-ttu-id="56ebc-468">O valor da recarga automática deve ser determinado pelo uso real.</span><span class="sxs-lookup"><span data-stu-id="56ebc-468">Auto-recharge amount needs to be determined by the actual usage.</span></span> <span data-ttu-id="56ebc-469">O uso de Créditos de Comunicação deve ser monitorado ao longo do tempo e o valor da recarga precisa ser ajustado conforme a necessidade.</span><span class="sxs-lookup"><span data-stu-id="56ebc-469">Communications Credits usage should be monitored over time and the recharge amount needs to be adjusted as required.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="56ebc-470">Pontos de decisão</span><span class="sxs-lookup"><span data-stu-id="56ebc-470">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-471">Se a sua organização ainda não tiver adquirido a licença necessária para a Audioconferência, decida se as licenças da Audioconferência serão adquiridas ampliando as inscrições existentes do Office 365 ou adquirindo complementos de Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-471">If your organization has not already purchased the required Audio Conferencing licensing, decide whether Audio Conferencing licenses will be acquired by stepping up existing Office 365 subscriptions or by acquiring Audio Conferencing add-ons.</span></span></li>
<li><span data-ttu-id="56ebc-472">Decida se os Créditos de Comunicação serão obrigatórios para a implementação da Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-472">Decide if Communications Credits is required for Audio Conferencing implementation.</span></span> <span data-ttu-id="56ebc-473">Em caso positivo, decida o valor inicial de fundos a serem comprados.</span><span class="sxs-lookup"><span data-stu-id="56ebc-473">If so, decide the initial amount of funds to be purchased.</span></span> <span data-ttu-id="56ebc-474">Onde aplicável, decida o valor do gatilho e o valor da recarga automática.</span><span class="sxs-lookup"><span data-stu-id="56ebc-474">Where applicable, decide the trigger amount and auto-recharge amount.</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="56ebc-475">Próximos passos</span><span class="sxs-lookup"><span data-stu-id="56ebc-475">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-476">Documentar os usuários que receberão a licença da Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-476">Document the users that will be assigned Audio Conferencing license.</span></span></li>
<li><span data-ttu-id="56ebc-477">Documentar o plano de Créditos de Comunicação (valor inicial, valor do gatilho, valor da recarga automática).</span><span class="sxs-lookup"><span data-stu-id="56ebc-477">Document the Communications Credits plan (initial amount, trigger amount, auto-recharge amount).</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-478">Usuário</span><span class="sxs-lookup"><span data-stu-id="56ebc-478">User</span></span></th>
<th align="left"><span data-ttu-id="56ebc-479">Escritório</span><span class="sxs-lookup"><span data-stu-id="56ebc-479">Office</span></span></th>
<th align="left"><span data-ttu-id="56ebc-480">Licença do Office 365</span><span class="sxs-lookup"><span data-stu-id="56ebc-480">Office 365 License</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-481">Adele Vance</span><span class="sxs-lookup"><span data-stu-id="56ebc-481">Adele Vance</span></span></td>
<td align="left"><span data-ttu-id="56ebc-482">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-482">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-483">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="56ebc-483">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-484">Alex Wilber</span><span class="sxs-lookup"><span data-stu-id="56ebc-484">Alex Wilber</span></span></td>
<td align="left"><span data-ttu-id="56ebc-485">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-485">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-486">Office 365 E3, complemento de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-486">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-487">Ben Walters</span><span class="sxs-lookup"><span data-stu-id="56ebc-487">Ben Walters</span></span></td>
<td align="left"><span data-ttu-id="56ebc-488">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-488">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-489">Office 365 E3, complemento de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-489">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-490">Christie Cline</span><span class="sxs-lookup"><span data-stu-id="56ebc-490">Christie Cline</span></span></td>
<td align="left"><span data-ttu-id="56ebc-491">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-491">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-492">Office 365 E3, complemento de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-492">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-493">Debra Berger</span><span class="sxs-lookup"><span data-stu-id="56ebc-493">Debra Berger</span></span></td>
<td align="left"><span data-ttu-id="56ebc-494">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-494">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-495">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="56ebc-495">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-496">Lee Gu</span><span class="sxs-lookup"><span data-stu-id="56ebc-496">Lee Gu</span></span></td>
<td align="left"><span data-ttu-id="56ebc-497">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-497">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-498">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="56ebc-498">Office 365 E5</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-499">Emily Braun</span><span class="sxs-lookup"><span data-stu-id="56ebc-499">Emily Braun</span></span></td>
<td align="left"><span data-ttu-id="56ebc-500">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-500">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-501">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="56ebc-501">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-502">Lidia Holloway</span><span class="sxs-lookup"><span data-stu-id="56ebc-502">Lidia Holloway</span></span></td>
<td align="left"><span data-ttu-id="56ebc-503">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-503">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-504">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="56ebc-504">Office 365 E5</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-505">Pradeep Gupta</span><span class="sxs-lookup"><span data-stu-id="56ebc-505">Pradeep Gupta</span></span></td>
<td align="left"><span data-ttu-id="56ebc-506">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-506">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-507">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="56ebc-507">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-508">Marcel Beauchamp</span><span class="sxs-lookup"><span data-stu-id="56ebc-508">Marcel Beauchamp</span></span></td>
<td align="left"><span data-ttu-id="56ebc-509">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-509">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-510">Office 365 E3, complemento de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-510">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-511">Rachelle Cormier</span><span class="sxs-lookup"><span data-stu-id="56ebc-511">Rachelle Cormier</span></span></td>
<td align="left"><span data-ttu-id="56ebc-512">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-512">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-513">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="56ebc-513">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-514">Isabell Potvin</span><span class="sxs-lookup"><span data-stu-id="56ebc-514">Isabell Potvin</span></span></td>
<td align="left"><span data-ttu-id="56ebc-515">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-515">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-516">Office 365 E3, complemento de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-516">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-517">_Tabela 8 Exemplo de lista de atribuição de licenças para organizadores de reunião de Audioconferência_</span><span class="sxs-lookup"><span data-stu-id="56ebc-517">_Table 8 Example of license assignment list for Audio Conferencing meeting organizers_</span></span>

<table>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-518">Valor inicial</span><span class="sxs-lookup"><span data-stu-id="56ebc-518">Initial amount</span></span></th>
<td align="left"><span data-ttu-id="56ebc-519">US$ 1.000</span><span class="sxs-lookup"><span data-stu-id="56ebc-519">$ 1,000</span></span></td>
</tr>
</thead>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-520">Valor do gatilho</span><span class="sxs-lookup"><span data-stu-id="56ebc-520">Trigger amount</span></span></th>
<td align="left"><span data-ttu-id="56ebc-521">US$ 400</span><span class="sxs-lookup"><span data-stu-id="56ebc-521">$ 400</span></span></td>
</tr>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-522">Valor da recarga automática</span><span class="sxs-lookup"><span data-stu-id="56ebc-522">Auto-recharge amount</span></span></th>
<td align="left"><span data-ttu-id="56ebc-523">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-523">TBA</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-524">_Tabela 9 Exemplo de números de planejamento de Créditos de Comunicação_</span><span class="sxs-lookup"><span data-stu-id="56ebc-524">_Table 9 Example of Communications Credits planning numbers_</span></span>


## <a name="conference-bridge-phone-numbers"></a><span data-ttu-id="56ebc-525">Números de telefone de ponte de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-525">Conference bridge phone numbers</span></span>

<span data-ttu-id="56ebc-526">O serviço de Audioconferência do Office 365 inclui:</span><span class="sxs-lookup"><span data-stu-id="56ebc-526">The Audio Conferencing service in Office 365 includes:</span></span>

-   <span data-ttu-id="56ebc-527">Vários tipos de números de telefone de ponte de conferência (pagos e gratuitos)</span><span class="sxs-lookup"><span data-stu-id="56ebc-527">Multiple types of conference bridge phone numbers (Toll and Toll-Free)</span></span>

-   <span data-ttu-id="56ebc-528">Várias categorias de número de telefone (exclusivo e compartilhado)</span><span class="sxs-lookup"><span data-stu-id="56ebc-528">Multiple categories of the phone number (dedicated and shared)</span></span>

-   <span data-ttu-id="56ebc-529">Suporte de vários idiomas para a ponte de conferência (primária e secundária)</span><span class="sxs-lookup"><span data-stu-id="56ebc-529">Support for multiple languages for the conference bridge (primary and secondary)</span></span>

-   <span data-ttu-id="56ebc-530">Um número de telefone padrão para o locatário.</span><span class="sxs-lookup"><span data-stu-id="56ebc-530">A default phone number for the tenant.</span></span>

<span data-ttu-id="56ebc-531">A descrição completa dos recursos incluídos pode ser consultada em [Configurar conferência PSTN ou por discagem para o Skype for Business](https://support.office.com/article/Set-up-dial-in-or-PSTN-conferencing-for-Skype-for-Business-d01954f1-4f37-4cf5-a636-20039e5c59e9?ui=en-US&rs=en-US&ad=US) e [Números de telefone para conferência de discagem](https://support.office.com/article/Phone-numbers-for-dial-in-conferencing-95a08f84-04e5-4f72-88a8-d6472a7c89d7?ui=en-US&rs=en-US&ad=US)**.**</span><span class="sxs-lookup"><span data-stu-id="56ebc-531">Full description of the included capabilities can be referenced from [Set up dial-in or PSTN conferencing for Skype for Business](https://support.office.com/article/Set-up-dial-in-or-PSTN-conferencing-for-Skype-for-Business-d01954f1-4f37-4cf5-a636-20039e5c59e9?ui=en-US&rs=en-US&ad=US) and [Phone numbers for dial-in conferencing](https://support.office.com/article/Phone-numbers-for-dial-in-conferencing-95a08f84-04e5-4f72-88a8-d6472a7c89d7?ui=en-US&rs=en-US&ad=US)**.**</span></span>

> [!NOTE]
> <span data-ttu-id="56ebc-532">Os números de telefone exclusivos da ponte de conferência são contados em relação ao limite de números de telefone que podem ser adquiridos por locatário com base no número de licenças aplicáveis,conforme descrito em [Obter números de telefone para o serviço Skype for Business](https://support.office.com/article/Getting-Skype-for-Business-service-phone-numbers-e434aeb2-af99-40e7-981e-a474f0383734).</span><span class="sxs-lookup"><span data-stu-id="56ebc-532">Dedicated conference bridge phone numbers are counted towards the limit of phone numbers that can be acquired per tenant, based on the number of applicable licenses as described in [Getting Skype for Business service phone numbers](https://support.office.com/article/Getting-Skype-for-Business-service-phone-numbers-e434aeb2-af99-40e7-981e-a474f0383734).</span></span> <span data-ttu-id="56ebc-533">Os números de telefone gratuitos da ponte de conferência não precisam de Créditos de Comunicação.</span><span class="sxs-lookup"><span data-stu-id="56ebc-533">Toll-free conference bridge phone numbers require Communications Credits.</span></span>

<span data-ttu-id="56ebc-534">Se houver números de telefone existentes da ponte de conferência que precisem ser transferidos para o serviço de Audioconferência, presumindo que estejam cumprindo os requisitos específicos do país, os números de telefone da ponte de conferência existentes poderão ser transferidos para a Microsoft.</span><span class="sxs-lookup"><span data-stu-id="56ebc-534">If there are existing conference bridge phone numbers that must be transferred to the Audio Conferencing service, assuming they are meeting the country-specific requirements, then the existing conference bridge phone numbers can be transferred to Microsoft.</span></span>


> [!NOTE]
> <span data-ttu-id="56ebc-535">A complexidade da transferência de números de telefone para a Microsoft varia muito com base nos países ou regiões, operadoras, o número de circuitos envolvidos e vários outros fatores.</span><span class="sxs-lookup"><span data-stu-id="56ebc-535">Complexity of transferring phone numbers to Microsoft varies greatly based on the countries or regions, carriers, the number of circuits involved, and many other contributing factors.</span></span> <span data-ttu-id="56ebc-536">Para planejar a portabilidade dos números de telefone, consulte o [Guia de portabilidade de números](https://go.microsoft.com/fwlink/?linkid=859011).</span><span class="sxs-lookup"><span data-stu-id="56ebc-536">To plan for phone number porting, check out the [Number Porting Guide](https://go.microsoft.com/fwlink/?linkid=859011).</span></span>

|  |  |
|---------|---------|
| <iframe width="350" height="200" src="https://www.youtube.com/embed/5k0C21KAsns" frameborder="0" allowfullscreen></iframe>  |  |

<span data-ttu-id="56ebc-537">Detalhes adicionais sobre a transferência de números de telefone para o serviço de Audioconferência podem ser encontrados em [Transferir números de telefone para o Skype for Business Online](https://support.office.com/article/Transfer-phone-numbers-to-Skype-for-Business-Online-47b3af8e-4171-4dec-8333-c956f108664e).</span><span class="sxs-lookup"><span data-stu-id="56ebc-537">Additional details on transferring phone numbers to Audio Conferencing service can be found in [Transfer phone numbers to Skype for Business Online](https://support.office.com/article/Transfer-phone-numbers-to-Skype-for-Business-Online-47b3af8e-4171-4dec-8333-c956f108664e).</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="56ebc-538">Pontos de decisão</span><span class="sxs-lookup"><span data-stu-id="56ebc-538">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-539">Decidir se a organização exigirá números de telefone exclusivos da ponte de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-539">Decide whether the organization requires dedicated conference bridge phone numbers</span></span></li>
<li><span data-ttu-id="56ebc-540">Decidir como os números de telefone exclusivos da ponte da conferência serão obtidos para locais de usuários ou escritórios que estão no escopo de implementação da Audioconferência (obter da Microsoft ou transferir os números de telefone existentes)</span><span class="sxs-lookup"><span data-stu-id="56ebc-540">Decide how the dedicated conference bridge phone numbers will be obtained for user locations or offices in-scope for the Audio Conferencing implementation (obtain from Microsoft or transfer existing phone numbers)</span></span></li>
<li><span data-ttu-id="56ebc-541">Se você optar por obter da Microsoft, decidir o método para obter números de telefone (envio de formulários ou automatizado) para os locais de usuários ou escritórios que estão no escopo de implementação da Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-541">If you choose to obtain from Microsoft, decide the method to obtain phone numbers (form submission or automated) for user locations or offices in-scope for the Audio Conferencing implementation</span></span></li>
<li><span data-ttu-id="56ebc-542">Decidir as preferências de idioma a ser configuradas para naca números de telefone de ponte de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-542">Decide the language preferences to be set up for each dedicated conference bridge phone number</span></span></li>
<li><span data-ttu-id="56ebc-543">Decidir o número de telefone de ponte de conferência padrão do locatário</span><span class="sxs-lookup"><span data-stu-id="56ebc-543">Decide the tenant default conference bridge phone number</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="56ebc-544">Próximos passos</span><span class="sxs-lookup"><span data-stu-id="56ebc-544">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-545">Documentar o plano mestre para a aquisição de números de telefone, detalhando como os números de telefone serão obtidos para cada um dos locais de usuários ou escritórios que estão no escopo de implementação da Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-545">Document the master plan for phone numbers acquisition, detailing how phone numbers will be obtained for each user location or office in-scope for the Audio Conferencing implementation.</span></span></li>
<li><span data-ttu-id="56ebc-546">Se aplicável, preencha <a href="https://support.office.com/article/Get-phone-numbers-for-Skype-for-Business-Online-6b61cb3c-361c-48a8-a9ef-d81bddde27bb?ui=en-US&amp;rs=en-US&amp;ad=US">o formulário de solicitação de novo número de telefone</a>, um formulário para cada local ou escritório</span><span class="sxs-lookup"><span data-stu-id="56ebc-546">If applicable, complete <a href="https://support.office.com/article/Get-phone-numbers-for-Skype-for-Business-Online-6b61cb3c-361c-48a8-a9ef-d81bddde27bb?ui=en-US&amp;rs=en-US&amp;ad=US">the New Telephone Number Request form</a>, one form for each location or office</span></span></li>
<li><span data-ttu-id="56ebc-547">Se você optar por transferir números de telefone existentes confira o <a href="https://go.microsoft.com/fwlink/?linkid=859011">Guia de portabilidade de números</a> para planejar a ajustar o cronograma de implementação da Audioconferência de acordo.</span><span class="sxs-lookup"><span data-stu-id="56ebc-547">If you choose to transfer existing phone numbers, check out the <a href="https://go.microsoft.com/fwlink/?linkid=859011">Number Porting Guide</a> to plan it and adjust Audio Conferencing implementation timeline accordingly.</span></span></li>
<li><span data-ttu-id="56ebc-548">Documentar as configurações detalhadas do número de telefone da ponte de conferência (números de telefone exclusivos e compartilhados da ponte de conferência, preferências de idioma para cada número exclusivo de telefone da ponte de conferência, número de telefone da ponte de conferência padrão do locatário)</span><span class="sxs-lookup"><span data-stu-id="56ebc-548">Document the detailed conference bridge phone number configurations (shared and dedicated conference bridge phone numbers, language preferences for each dedicated conference bridge phone number, tenant default conference bridge phone number)</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-549">Escritório</span><span class="sxs-lookup"><span data-stu-id="56ebc-549">Office</span></span></th>
<th align="left"><span data-ttu-id="56ebc-550">Aquisição do número da ponte e Tipo da ponte</span><span class="sxs-lookup"><span data-stu-id="56ebc-550">Bridge Number Acquisition and Bridge Type</span></span></th>
<th align="left"><span data-ttu-id="56ebc-551">Número da ponte</span><span class="sxs-lookup"><span data-stu-id="56ebc-551">Bridge Number</span></span></th>
<th align="left"><span data-ttu-id="56ebc-552">Idioma da ponte</span><span class="sxs-lookup"><span data-stu-id="56ebc-552">Bridge Language</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-553">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-553">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-554">Adquirir novo, exclusivo</span><span class="sxs-lookup"><span data-stu-id="56ebc-554">Acquire new, dedicated</span></span></td>
<td align="left"><span data-ttu-id="56ebc-555">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-555">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-556">Inglês (Austrália)</span><span class="sxs-lookup"><span data-stu-id="56ebc-556">English (Australia)</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-557">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-557">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-558">Adquirir novo, compartilhado</span><span class="sxs-lookup"><span data-stu-id="56ebc-558">Acquire new, shared</span></span></td>
<td align="left"><span data-ttu-id="56ebc-559">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-559">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-560">Inglês (Estados Unidos); Chinês (Simplificado, PRC)</span><span class="sxs-lookup"><span data-stu-id="56ebc-560">English (United States), Chinese (Simplified, PRC)</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-561">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-561">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-562">Porta existente, exclusiva</span><span class="sxs-lookup"><span data-stu-id="56ebc-562">Port existing, dedicated</span></span></td>
<td align="left"><span data-ttu-id="56ebc-563">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="56ebc-563">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="56ebc-564">Inglês (Reino Unido)</span><span class="sxs-lookup"><span data-stu-id="56ebc-564">English (United Kingdom)</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-565">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-565">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-566">Adquirir novo, exclusivo</span><span class="sxs-lookup"><span data-stu-id="56ebc-566">Acquire new, dedicated</span></span></td>
<td align="left"><span data-ttu-id="56ebc-567">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-567">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-568">Francês (França), Inglês (Reino Unido)</span><span class="sxs-lookup"><span data-stu-id="56ebc-568">French (France), English (United Kingdom)</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-569">_Tabela 10 Exemplo de detalhes de ponte de conferência_</span><span class="sxs-lookup"><span data-stu-id="56ebc-569">_Table 10 Example of conference bridge details_</span></span>


> [!NOTE]
> <span data-ttu-id="56ebc-570">A tabela de exemplo acima e as tabelas subsequentes ao longo deste documento servem como modelo.</span><span class="sxs-lookup"><span data-stu-id="56ebc-570">The example table above and subsequent tables throughout this document serve as a template.</span></span> <span data-ttu-id="56ebc-571">Você verá “TBA” (a ser adicionado) para informações que você precisa inserir como parte do seu processo de planejamento.</span><span class="sxs-lookup"><span data-stu-id="56ebc-571">You'll see "TBA" (to be added) for information that you need to complete as part of your planning process.</span></span>

## <a name="conference-bridge-settings"></a><span data-ttu-id="56ebc-572">Configurações de ponte de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-572">Conference bridge settings</span></span>

<span data-ttu-id="56ebc-573">As opções de configuração da experiência de entrar em uma reunião de Audioconferência em toda a organização (notificação de entrada e saída e gravação de nome do chamador), o comprimento do PIN do organizador da reunião e a notificação por e-mail estão disponíveis para adaptar melhor a experiência do usuário final.</span><span class="sxs-lookup"><span data-stu-id="56ebc-573">Organization-wide configuration options around Audio Conferencing meeting join experience (meeting entry and exit notification and caller name recording), meeting organizer’s PIN length, and email notification are available to further tailor the end-user experience.</span></span>

-   <span data-ttu-id="56ebc-574">As notificações de entrada e saída de reuniões estão disponíveis na forma de nome, número de telefone e tons registrados.</span><span class="sxs-lookup"><span data-stu-id="56ebc-574">Meeting entry and exit notifications are available in the form of recorded name, phone number, and tones.</span></span>

-   <span data-ttu-id="56ebc-575">O comprimento do PIN pode ter de 4 a 12 dígitos, com um PIN de 5 dígitos como padrão.</span><span class="sxs-lookup"><span data-stu-id="56ebc-575">PIN length is configurable from 4 to 12 digits, with a 5-digit PIN as the default.</span></span>

-   <span data-ttu-id="56ebc-576">Os e-mails de notificação após a habilitação da licença de Audioconferência ou qualquer outra alteração conduzida pelo administrador estão habilitados por padrão.</span><span class="sxs-lookup"><span data-stu-id="56ebc-576">Notification emails upon enablement of Audio Conferencing license or any other admin-driven changes are enabled by default.</span></span> <span data-ttu-id="56ebc-577">Você pode desabilitar esse recurso e assumir o controle das comunicações dos usuários finais da sua organização.</span><span class="sxs-lookup"><span data-stu-id="56ebc-577">You can disable this feature and take control of your organization’s end-user communications.</span></span>

<span data-ttu-id="56ebc-578">Para os usuários aos quais tenha sido atribuída uma licença de Audioconferência, os números chamada pagos e gratuitos padrão, mostrados nas coordenadas de Audioconferência, podem ser configurados para uso:</span><span class="sxs-lookup"><span data-stu-id="56ebc-578">For users who are assigned an Audio Conferencing license, the default toll/toll-free numbers, shown in the Audio Conferencing coordinates, are configurable to use:</span></span>

-   <span data-ttu-id="56ebc-579">no padrão em nível de locatário ou</span><span class="sxs-lookup"><span data-stu-id="56ebc-579">the tenant-level default, or</span></span>

-   <span data-ttu-id="56ebc-580">em números de telefone de ponte de conferência atribuídos automaticamente ou</span><span class="sxs-lookup"><span data-stu-id="56ebc-580">the automatically-assigned conference bridge phone numbers, or</span></span>

-   <span data-ttu-id="56ebc-581">em números de telefone de ponte de conferência definidos manualmente para cada usuário.</span><span class="sxs-lookup"><span data-stu-id="56ebc-581">manually defined conference bridge phone numbers for each user.</span></span>

<span data-ttu-id="56ebc-582">Os números de telefone da ponte de conferência específicos do usuário costumam ser úteis em organizações nacionais ou internacionais, onde os usuários são distribuídos e precisam fornecer números locais como números de telefone da ponte de conferência padrão nos convites de reunião.</span><span class="sxs-lookup"><span data-stu-id="56ebc-582">User-specific conference bridge phone numbers are typically useful in global or nationwide organizations where users are distributed and must provide local numbers as the default conference bridge phone numbers in the meeting invites.</span></span>

<span data-ttu-id="56ebc-583">Os participantes que entram de diferentes cidades ou do exterior podem procurar números adicionais configurados no nível do locatário, mas esses números não aparecem diretamente nos convites de reunião.</span><span class="sxs-lookup"><span data-stu-id="56ebc-583">Participants joining from different cities or overseas can look up additional numbers configured at the tenant-level, but these numbers do not appear directly in the meeting invites.</span></span> <span data-ttu-id="56ebc-584">Os convites de reunião contêm um link que levará os participantes à página de números de discagem da conferência do Teams para que eles procurem os números de telefone da ponte de conferência mais próximos do seu local que estejam disponíveis.</span><span class="sxs-lookup"><span data-stu-id="56ebc-584">The meeting invites provide a link that will take participants to the Teams Conference Dial-in Numbers page for them to lookup the closest conference bridge phone numbers available from their location.</span></span>

<span data-ttu-id="56ebc-585">Você também pode configurar como os autores de chamada não autenticados são tratados por cada organizador de reunião individual para exigir que o organizador da reunião inicie a reunião antes que os autores de chamada não autenticados sejam admitidos ou para permitir que os autores de chamada não autenticados iniciem uma reunião.</span><span class="sxs-lookup"><span data-stu-id="56ebc-585">You can also configure how unauthenticated callers are handled by each individual meeting organizer, whether to require meeting organizer to start the meeting before unauthenticated callers are admitted, or to allow unauthenticated callers to start a meeting.</span></span>

<span data-ttu-id="56ebc-586">Estão disponíveis configurações adicionais que podem ser aplicadas para cada usuário para controlar o uso de números de telefone gratuitos de ponte de conferência e discagem de uma conferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-586">Additional configurations that can be applied for each user are available to control the use of toll-free conference bridge phone numbers and dial-out from a conference.</span></span>

> [!NOTE]
> <span data-ttu-id="56ebc-587">Esses controles relacionados a custo estão atualmente disponíveis somente para clientes da prévia.</span><span class="sxs-lookup"><span data-stu-id="56ebc-587">These cost-related controls are currently available for preview customers only.</span></span> <span data-ttu-id="56ebc-588">Você pode inscrever a sua organização no programa de prévia em [https://www.skypepreview.com](https://go.microsoft.com/fwlink/?linkid=859013).</span><span class="sxs-lookup"><span data-stu-id="56ebc-588">You can enroll your organization in the preview program from [https://www.skypepreview.com](https://go.microsoft.com/fwlink/?linkid=859013).</span></span>

<span data-ttu-id="56ebc-589">Com esses controles, você pode decidir se os organizadores da reunião podem fornecer números de telefone gratuitos de ponte de conferência para reuniões organizadas por eles, ou para controlar se os participantes podem discar das reuniões organizadas por eles.</span><span class="sxs-lookup"><span data-stu-id="56ebc-589">With these controls, you can decide whether meeting organizers can provide toll-free conference bridge phone numbers for meetings organized by them, and to control whether participants can dial out from the meetings organized by them.</span></span> <span data-ttu-id="56ebc-590">O nível de controle de discagem vai da exclusão da permissão de discagem, permitindo discar apenas para números domésticos, até a permissão de discagem para números domésticos e internacionais.</span><span class="sxs-lookup"><span data-stu-id="56ebc-590">The level of dial-out control spans from disallowing dial out, only allowing dial out to domestic numbers, to allowing dial out to both domestic and international numbers.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="56ebc-591">Pontos de decisão</span><span class="sxs-lookup"><span data-stu-id="56ebc-591">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-592">Decidir se a organização exigirá notificações de entrada e saída e, em caso afirmativo, o tipo de notificação a ser implementada (tons, número de telefone ou nome registrado).</span><span class="sxs-lookup"><span data-stu-id="56ebc-592">Decide whether the organization requires entry and exit notifications, and if yes, the type of notification to be implemented (tones, phone number, or recorded name).</span></span></li>
<li><span data-ttu-id="56ebc-593">Decidir o comprimento do PIN da Audioconferência que atenda às exigências de segurança da organização.</span><span class="sxs-lookup"><span data-stu-id="56ebc-593">Decide the Audio Conferencing PIN length that meets the organizational security requirements.</span></span></li>
<li><span data-ttu-id="56ebc-594">Decidir se a organização deseja assumir o controle das comunicações do usuário final relacionadas ao serviço de Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-594">Decide if the organization wants to take control of end-user communications related to Audio Conferencing service.</span></span></li>
<li><span data-ttu-id="56ebc-595">Decidir os números de telefone da ponte da conferência a serem atribuídos a cada organizador de reunião.</span><span class="sxs-lookup"><span data-stu-id="56ebc-595">Decide the conference bridge phone numbers to be assigned to each meeting organizer.</span></span></li>
<li><span data-ttu-id="56ebc-596">Decidir se alguns organizadores de reunião exigirão o recurso de usar números de telefone gratuitos de ponte de conferência para as suas reuniões</span><span class="sxs-lookup"><span data-stu-id="56ebc-596">Decide whether some meeting organizers require the ability to use toll-free conference bridge phone numbers for their meeings</span></span></li>
<li><span data-ttu-id="56ebc-597">Decidir se alguns organizadores de reunião exigirão o recurso de permitir que os autores da chamada não autenticados iniciem uma reunião.</span><span class="sxs-lookup"><span data-stu-id="56ebc-597">Decide whether some meeting organizers require the ability to allow unauthenticated callers to start a meeting.</span></span></li>
<li><span data-ttu-id="56ebc-598">Decidir se alguns organizadores de reunião exigirão que a discagem de saída da conferência seja controlada.</span><span class="sxs-lookup"><span data-stu-id="56ebc-598">Decide whether some meeting organizers require conference dial out to be controlled.</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="56ebc-599">Próximos passos</span><span class="sxs-lookup"><span data-stu-id="56ebc-599">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-600">Documentar detalhadamente as configurações de ponte de conferência (notificações de entrada e saída, comprimento do PIN, notificação por e-mail de alteração do configurações).</span><span class="sxs-lookup"><span data-stu-id="56ebc-600">Document the detailed conference bridge settings (entry and exit notifications, PIN length, configuration change email notification).</span></span></li>
<li><span data-ttu-id="56ebc-601">Documentar os números de telefone de ponte de conferência a serem atribuídos a cada organizador de reunião na configuração correspondente para controlar a política de autores de chamada não autenticados e os controles gratuitos e de discagem de saída.</span><span class="sxs-lookup"><span data-stu-id="56ebc-601">Document the conference bridge phone numbers to be assinged to each meeting organizer and the corresponding setting to control unauthenticated caller’s policy, and toll-free and dial out controls.</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<td align="left"><span data-ttu-id="56ebc-602"><strong>Habilitar notificações de entrada e saída de reuniões</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-602"><strong>Enable meeting entry and exit notifications</strong></span></span></td>
<td align="left"><span data-ttu-id="56ebc-603">Habilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-603">Enabled</span></span></td>
</tr>
</thead>
<thead>
<tr class="header">
<td align="left"><span data-ttu-id="56ebc-604"><strong>Tipo de anúncio de entrada/saída</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-604"><strong>Entry/exit announcement type</strong></span></span></td>
<td align="left"><span data-ttu-id="56ebc-605">Tons</span><span class="sxs-lookup"><span data-stu-id="56ebc-605">Tones</span></span></td>
</tr>
<tr class="header">
<td align="left"><span data-ttu-id="56ebc-606"><strong>Solicitar que os autores da chamada registrem seu nome antes de entrar na reunião</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-606"><strong>Ask callers to record their name before joining the meeting</strong></span></span></td>
<td align="left"><span data-ttu-id="56ebc-607">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-607">Disabled</span></span></td>
</tr>
<tr class="header">
<td align="left"><span data-ttu-id="56ebc-608"><strong>Tamanho mínimo do PIN</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-608"><strong>PIN length</strong></span></span></td>
<td align="left"><span data-ttu-id="56ebc-609">5</span><span class="sxs-lookup"><span data-stu-id="56ebc-609">5</span></span></td>
</tr>
<tr class="header">
<td align="left"><span data-ttu-id="56ebc-610"><strong>Enviar e-mails automaticamente aos usuários se suas configurações de discagem forem alteradas</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-610"><strong>Automatically send emails to users if their dial-in settings change</strong></span></span></td>
<td align="left"><span data-ttu-id="56ebc-611">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-611">Disabled</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-612">_Tabela 11 Exemplo de configurações de ponte de conferência_</span><span class="sxs-lookup"><span data-stu-id="56ebc-612">_Table 11 Example of conference bridge settings_</span></span>


<table>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-613">Usuário</span><span class="sxs-lookup"><span data-stu-id="56ebc-613">User</span></span></th>
<th align="left"><span data-ttu-id="56ebc-614">Escritório</span><span class="sxs-lookup"><span data-stu-id="56ebc-614">Office</span></span></th>
<th align="left"><span data-ttu-id="56ebc-615">Número de chamada padrão</span><span class="sxs-lookup"><span data-stu-id="56ebc-615">Default toll number</span></span></th>
<th align="left"><span data-ttu-id="56ebc-616">Número de chamada gratuita padrão</span><span class="sxs-lookup"><span data-stu-id="56ebc-616">Default toll-free number</span></span></th>
<th align="left"><span data-ttu-id="56ebc-617">Permitir chamada gratuita</span><span class="sxs-lookup"><span data-stu-id="56ebc-617">Allow toll-free</span></span></th>
<th align="left"><span data-ttu-id="56ebc-618">Autores de chamada não autenticados ignoram o lobby</span><span class="sxs-lookup"><span data-stu-id="56ebc-618">Unauthenticated callers bypass lobby</span></span></th>
<th align="left"><span data-ttu-id="56ebc-619">Discagem de saída de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-619">Conference dial out</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-620">Adele Vance</span><span class="sxs-lookup"><span data-stu-id="56ebc-620">Adele Vance</span></span></td>
<td align="left"><span data-ttu-id="56ebc-621">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-621">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-622">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-622">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-623">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-623">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-624">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-624">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-625">Habilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-625">Enabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-626">Doméstico e internacional</span><span class="sxs-lookup"><span data-stu-id="56ebc-626">International and domestic</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-627">Alex Wilber</span><span class="sxs-lookup"><span data-stu-id="56ebc-627">Alex Wilber</span></span></td>
<td align="left"><span data-ttu-id="56ebc-628">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-628">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-629">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-629">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-630">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-630">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-631">Não</span><span class="sxs-lookup"><span data-stu-id="56ebc-631">No</span></span></td>
<td align="left"><span data-ttu-id="56ebc-632">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-632">Disabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-633">Não permitido</span><span class="sxs-lookup"><span data-stu-id="56ebc-633">Not allowed</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-634">Ben Walters</span><span class="sxs-lookup"><span data-stu-id="56ebc-634">Ben Walters</span></span></td>
<td align="left"><span data-ttu-id="56ebc-635">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-635">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-636">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-636">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-637">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-637">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-638">Não</span><span class="sxs-lookup"><span data-stu-id="56ebc-638">No</span></span></td>
<td align="left"><span data-ttu-id="56ebc-639">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-639">Disabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-640">Não permitido</span><span class="sxs-lookup"><span data-stu-id="56ebc-640">Not allowed</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-641">Christie Cline</span><span class="sxs-lookup"><span data-stu-id="56ebc-641">Christie Cline</span></span></td>
<td align="left"><span data-ttu-id="56ebc-642">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-642">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-643">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-643">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-644">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-644">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-645">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-645">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-646">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-646">Disabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-647">Doméstico</span><span class="sxs-lookup"><span data-stu-id="56ebc-647">Domestic</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-648">Debra Berger</span><span class="sxs-lookup"><span data-stu-id="56ebc-648">Debra Berger</span></span></td>
<td align="left"><span data-ttu-id="56ebc-649">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-649">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-650">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-650">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-651">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-651">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-652">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-652">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-653">Habilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-653">Enabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-654">Doméstico</span><span class="sxs-lookup"><span data-stu-id="56ebc-654">Domestic</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-655">Lee Gu</span><span class="sxs-lookup"><span data-stu-id="56ebc-655">Lee Gu</span></span></td>
<td align="left"><span data-ttu-id="56ebc-656">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-656">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-657">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-657">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-658">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-658">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-659">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-659">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-660">Habilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-660">Enabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-661">Doméstico</span><span class="sxs-lookup"><span data-stu-id="56ebc-661">Domestic</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-662">Emily Braun</span><span class="sxs-lookup"><span data-stu-id="56ebc-662">Emily Braun</span></span></td>
<td align="left"><span data-ttu-id="56ebc-663">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-663">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-664">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="56ebc-664">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="56ebc-665">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-665">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-666">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-666">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-667">Habilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-667">Enabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-668">Não permitido</span><span class="sxs-lookup"><span data-stu-id="56ebc-668">Not allowed</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-669">Lidia Holloway</span><span class="sxs-lookup"><span data-stu-id="56ebc-669">Lidia Holloway</span></span></td>
<td align="left"><span data-ttu-id="56ebc-670">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-670">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-671">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="56ebc-671">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="56ebc-672">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-672">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-673">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-673">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-674">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-674">Disabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-675">Não permitido</span><span class="sxs-lookup"><span data-stu-id="56ebc-675">Not allowed</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-676">Pradeep Gupta</span><span class="sxs-lookup"><span data-stu-id="56ebc-676">Pradeep Gupta</span></span></td>
<td align="left"><span data-ttu-id="56ebc-677">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-677">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-678">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="56ebc-678">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="56ebc-679">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-679">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-680">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-680">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-681">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-681">Disabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-682">Não permitido</span><span class="sxs-lookup"><span data-stu-id="56ebc-682">Not allowed</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-683">Marcel Beauchamp</span><span class="sxs-lookup"><span data-stu-id="56ebc-683">Marcel Beauchamp</span></span></td>
<td align="left"><span data-ttu-id="56ebc-684">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-684">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-685">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-685">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-686">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-686">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-687">Não</span><span class="sxs-lookup"><span data-stu-id="56ebc-687">No</span></span></td>
<td align="left"><span data-ttu-id="56ebc-688">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-688">Disabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-689">Doméstico</span><span class="sxs-lookup"><span data-stu-id="56ebc-689">Domestic</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-690">Rachelle Cormier</span><span class="sxs-lookup"><span data-stu-id="56ebc-690">Rachelle Cormier</span></span></td>
<td align="left"><span data-ttu-id="56ebc-691">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-691">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-692">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-692">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-693">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-693">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-694">Sim</span><span class="sxs-lookup"><span data-stu-id="56ebc-694">Yes</span></span></td>
<td align="left"><span data-ttu-id="56ebc-695">Habilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-695">Enabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-696">Doméstico e internacional</span><span class="sxs-lookup"><span data-stu-id="56ebc-696">International and domestic</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-697">Isabell Potvin</span><span class="sxs-lookup"><span data-stu-id="56ebc-697">Isabell Potvin</span></span></td>
<td align="left"><span data-ttu-id="56ebc-698">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-698">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-699">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-699">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-700">TBA</span><span class="sxs-lookup"><span data-stu-id="56ebc-700">TBA</span></span></td>
<td align="left"><span data-ttu-id="56ebc-701">Não</span><span class="sxs-lookup"><span data-stu-id="56ebc-701">No</span></span></td>
<td align="left"><span data-ttu-id="56ebc-702">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-702">Disabled</span></span></td>
<td align="left"><span data-ttu-id="56ebc-703">Doméstico</span><span class="sxs-lookup"><span data-stu-id="56ebc-703">Domestic</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-704">_Tabela 12 Exemplo de atribuições de configurações de ponte de conferência_</span><span class="sxs-lookup"><span data-stu-id="56ebc-704">_Table 12 Example of conference bridge settings assignments_</span></span>


## <a name="dial-plans"></a><span data-ttu-id="56ebc-705">Planos de discagem</span><span class="sxs-lookup"><span data-stu-id="56ebc-705">Dial plans</span></span>

<span data-ttu-id="56ebc-706">O [Plano de discagem](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b), um Sistema de Telefonia do Office 365, é um conjunto de regras de normalização que converte números telefônicos discados em um formato alternativo (normalmente no formato[E.164](https://go.microsoft.com/fwlink/?linkid=859014)) para autorização de chamada e roteamento de chamada.</span><span class="sxs-lookup"><span data-stu-id="56ebc-706">A [Dial Plan](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b), a Phone System feature of Office 365, is a set of normalization rules that translates dialed phone numbers into an alternate format (typically [E.164](https://go.microsoft.com/fwlink/?linkid=859014) format) for call authorization and call routing.</span></span> <span data-ttu-id="56ebc-707">O serviço de Audioconferência aproveita os mesmos recursos usados pelo Sistema de Telefonia para converter números de telefone discados em cenários de discagem de saída de conferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-707">Audio Conferencing service leverages the same capabilities used by Phone System to translate dialed phone numbers in conference dial out scenarios.</span></span>

<span data-ttu-id="56ebc-708">Um plano de discagem permite que os usuários disquem números de telefone da forma como estão acostumados, como omitir o código de área para chamadas locais, omitir o código de país para chamadas domésticas ou mesmo usar atalhos de discagem ao fazer uma discagem de saída de conferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-708">A dial plan allows users to dial phone numbers the way they are accustomed to, such as omitting area code for local calls, omitting country code for domestic calls, or even using short digit dialing when performing conference dial out.</span></span>

<span data-ttu-id="56ebc-709">Dentro do recurso Sistema de Telefonia do Office 365, existem dois tipos de planos de discagem:</span><span class="sxs-lookup"><span data-stu-id="56ebc-709">Within the Phone System feature of Office 365, there are two types of dial plans:</span></span>

-   <span data-ttu-id="56ebc-710">**Plano de discagem para serviço**.</span><span class="sxs-lookup"><span data-stu-id="56ebc-710">**Service dial plan**.</span></span> <span data-ttu-id="56ebc-711">Esse é o plano de discagem padrão, é aplicado aos usuários com base no local de uso do Office 365 e não pode ser modificado.</span><span class="sxs-lookup"><span data-stu-id="56ebc-711">This is the default dial plan and applied to users based on Office 365 usage location, and it cannot be modified.</span></span>

<!-- -->

-   <span data-ttu-id="56ebc-712">**Plano de discagem para locatários**.</span><span class="sxs-lookup"><span data-stu-id="56ebc-712">**Tenant dial plan**.</span></span> <span data-ttu-id="56ebc-713">Esse é um plano de discagem personalizável em um locatário e é dividido em mais dois tipos:</span><span class="sxs-lookup"><span data-stu-id="56ebc-713">This is a customizable dial plan within a tenant, and further divided into two types:</span></span>

    -   <span data-ttu-id="56ebc-714">**Plano de discagem para locatário global** – o plano de discagem se aplica para todos os usuários do locatário.</span><span class="sxs-lookup"><span data-stu-id="56ebc-714">**Tenant-global dial plan**—the dial plan applies to all users within the tenant.</span></span>

    -   <span data-ttu-id="56ebc-715">**Plano de discagem para locatário usuário** – o plano de discagem se aplica apenas a usuários específicos.</span><span class="sxs-lookup"><span data-stu-id="56ebc-715">**Tenant-user dial plan**—the dial plan applies only to specific users.</span></span>


> [!NOTE]
> <span data-ttu-id="56ebc-716">Confira a documentação dos [planos de discagem do Plano de Chamadas do Office 365](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b) pata obter exemplos e mais detalhes.</span><span class="sxs-lookup"><span data-stu-id="56ebc-716">Check out the [Office 365 Calling Plan dial plans](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b) documentation for further details and examples.</span></span>

<span data-ttu-id="56ebc-717">O plano de discagem efetivo atribuído aos usuários é a combinação do plano de discagem para serviço (com base no local de uso do Office 365 do usuário) e do plano de discagem para locatários (que pode ser o plano de discagem para locatário global ou o plano de discagem para locatário usuário).</span><span class="sxs-lookup"><span data-stu-id="56ebc-717">The effective dial plan assigned to users is the combination of service dial plan (based on user’s Office 365 usage location) and tenant dial plan (can be either tenant-global dial plan or tenant-user dial plan).</span></span>

![A tabela mostra três combinações de planos de discagem para locatários e serviços.](media/audio_conferencing_image8.png)

<span data-ttu-id="56ebc-719">Há um máximo de 25 regras de normalização em cada plano de discagem para locatários e, portanto, a duplicação das regras de normalização já disponíveis como parte do plano de discagem para serviço precisa ser evitada.</span><span class="sxs-lookup"><span data-stu-id="56ebc-719">There is a maximum of 25 normalization rules in each tenant dial plan, and thus duplication with normalization rules already available as part of service dial plan needs to be avoided.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="56ebc-720">Pontos de decisão</span><span class="sxs-lookup"><span data-stu-id="56ebc-720">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-721">Decida se sua organização exigirá planos de discagem personalizados (requisitos de negócios, requisitos de adoção, etc.).</span><span class="sxs-lookup"><span data-stu-id="56ebc-721">Decide if your organization requires customized dial plans (business requirements, adoption requirements, etc.).</span></span></li>
<li><span data-ttu-id="56ebc-722">Se aplicável, decidir o escopo do plano de discagem para locatários (locatário global ou locatário usuário) para ter suporte para os requisitos dos planos de discagem personalizados.</span><span class="sxs-lookup"><span data-stu-id="56ebc-722">If applicable, decide the scope of tenant dial plan (tenant-global or tenant-user) to support the requirements for customized dial plans.</span></span></li>
<li><span data-ttu-id="56ebc-723">Se aplicável, decidir os planos de discagem para locatários que serão criados para oferecer suporte para locais de usuários ou escritórios que estejam no escopo de implementação da Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-723">If applicable, decide the tenant dial plans that will be created to support user locations or offices in-scope for the Audio Conferencing implementation.</span></span></li>
<li><span data-ttu-id="56ebc-724">Se aplicável, decidir qual usuário exigirá um plano de discagem personalizado e o plano de discagem para locatários a ser atribuído para cada usuário.</span><span class="sxs-lookup"><span data-stu-id="56ebc-724">If applicable, decide which user require customized dial plan and the tenant dial plan to be assigned for each user.</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="56ebc-725">Próximos passos</span><span class="sxs-lookup"><span data-stu-id="56ebc-725">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="56ebc-726">Documentar os planos de discagem personalizados e as regras de normalização associadas a serem configuradas como parte da implementação da Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-726">Document the customized dial plans and the associated normalization rules to be configured as part of Audio Conferencing implementation.</span></span></li>
<li><span data-ttu-id="56ebc-727">Documentar os usuários aos quais serão atribuídos um plano de discagem personalizado e o plano de discagem para locatários a ser atribuído para cada usuário.</span><span class="sxs-lookup"><span data-stu-id="56ebc-727">Document the users to be assigned with customized dial plan and the tenant dial plan to be assigned for each user.</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-728">Nome/descrição do plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-728">Tenant Dial Plan Name/Description</span></span></th>
<th align="left"><span data-ttu-id="56ebc-729">Nome/descrição das regras de normalização</span><span class="sxs-lookup"><span data-stu-id="56ebc-729">Normalization Rules Name/Description</span></span></th>
<th align="left"><span data-ttu-id="56ebc-730">Padrão</span><span class="sxs-lookup"><span data-stu-id="56ebc-730">Pattern</span></span></th>
<th align="left"><span data-ttu-id="56ebc-731">Conversão</span><span class="sxs-lookup"><span data-stu-id="56ebc-731">Translation</span></span></th>
<th align="left"><span data-ttu-id="56ebc-732">IsInternalExtension</span><span class="sxs-lookup"><span data-stu-id="56ebc-732">IsInternalExtension</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><p><span data-ttu-id="56ebc-733"><strong>AU-NSW-NorthRyde-OER</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-733"><strong>AU-NSW-NorthRyde-OER</strong></span></span></p>
<p><span data-ttu-id="56ebc-734"><em>One Epping Road North Ryde, NSW, AU Dial Plan</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-734"><em>One Epping Road North Ryde, NSW, AU Dial Plan</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="56ebc-735"><strong>AU-NSW-NorthRyde-OER-Internal</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-735"><strong>AU-NSW-NorthRyde-OER-Internal</strong></span></span></p>
<p><span data-ttu-id="56ebc-736"><em>Número interno (x7000 - x7999) para o escritório de One Epping Road, North Ryde, NSW, Austrália</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-736"><em>Internal number (x7000 - x7999) for One Epping Road office, North Ryde, NSW, Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-737">^(7\d{3})$</span><span class="sxs-lookup"><span data-stu-id="56ebc-737">^(7\d{3})$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-738">+6125550$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-738">+6125550$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-739">True</span><span class="sxs-lookup"><span data-stu-id="56ebc-739">True</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="56ebc-740"><strong>AU-NSW-Local</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-740"><strong>AU-NSW-Local</strong></span></span></p>
<p><span data-ttu-id="56ebc-741"><em>Normalização do número local para NSW, Austrália</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-741"><em>Local number normalization for NSW, Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-742">^([2-9]\d{7})$</span><span class="sxs-lookup"><span data-stu-id="56ebc-742">^([2-9]\d{7})$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-743">+612$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-743">+612$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-744">False</span><span class="sxs-lookup"><span data-stu-id="56ebc-744">False</span></span></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="56ebc-745"><strong>AU-TollFree</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-745"><strong>AU-TollFree</strong></span></span></p>
<p><span data-ttu-id="56ebc-746"><em>Normalização de número gratuito na Austrália</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-746"><em>Toll Free number normalization for Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-747">^(1[38]\d{4,8})\d*$</span><span class="sxs-lookup"><span data-stu-id="56ebc-747">^(1[38]\d{4,8})\d*$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-748">+61$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-748">+61$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-749">False</span><span class="sxs-lookup"><span data-stu-id="56ebc-749">False</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="56ebc-750"><strong>AU-Service</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-750"><strong>AU-Service</strong></span></span></p>
<p><span data-ttu-id="56ebc-751"><em>Normalização de número de serviço na Austrália</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-751"><em>Service number normalization for Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-752">^(000|1[0125]\d{1,8})$</span><span class="sxs-lookup"><span data-stu-id="56ebc-752">^(000|1[0125]\d{1,8})$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-753">$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-753">$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-754">False</span><span class="sxs-lookup"><span data-stu-id="56ebc-754">False</span></span></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="56ebc-755"><strong>SG-Singapore-OMB</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-755"><strong>SG-Singapore-OMB</strong></span></span></p>
<p><span data-ttu-id="56ebc-756"><em>OMB Singapore, SG Dial Plan</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-756"><em>OMB Singapore, SG Dial Plan</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="56ebc-757"><strong>SG-OMB-Internal</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-757"><strong>SG-OMB-Internal</strong></span></span></p>
<p><span data-ttu-id="56ebc-758"><em>Número interno (x8000 – x8999) para o escritório OMB, Cingapura</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-758"><em>Internal number (x8000 – x8999) for OMB office, Singapore</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-759">^(8\d{3})$</span><span class="sxs-lookup"><span data-stu-id="56ebc-759">^(8\d{3})$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-760">+656888$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-760">+656888$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-761">True</span><span class="sxs-lookup"><span data-stu-id="56ebc-761">True</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="56ebc-762"><strong>SG-TollFree</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-762"><strong>SG-TollFree</strong></span></span></p>
<p><span data-ttu-id="56ebc-763"><em>Normalização de número gratuito em Cingapura</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-763"><em>Toll Free number normalization for Singapore</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-764">^(1?800\d{7})\d*$</span><span class="sxs-lookup"><span data-stu-id="56ebc-764">^(1?800\d{7})\d*$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-765">+65$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-765">+65$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-766">False</span><span class="sxs-lookup"><span data-stu-id="56ebc-766">False</span></span></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="56ebc-767"><strong>SG-Service</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-767"><strong>SG-Service</strong></span></span></p>
<p><span data-ttu-id="56ebc-768"><em>Normalização de número de serviço em Cingapura</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-768"><em>Service number normalization for Singapore</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-769">^(1\d{3,4}|9\d{2})$</span><span class="sxs-lookup"><span data-stu-id="56ebc-769">^(1\d{3,4}|9\d{2})$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-770">$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-770">$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-771">False</span><span class="sxs-lookup"><span data-stu-id="56ebc-771">False</span></span></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="56ebc-772"><strong>FR-Paris-Issy-39qdPR</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-772"><strong>FR-Paris-Issy-39qdPR</strong></span></span></p>
<p><span data-ttu-id="56ebc-773"><em>39 quai du Président Roosevelt Issy-les-Moulineaux, France Dial Plan</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-773"><em>39 quai du Président Roosevelt Issy-les-Moulineaux, France Dial Plan</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="56ebc-774"><strong>FR-39qdPR-Internal</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-774"><strong>FR-39qdPR-Internal</strong></span></span></p>
<p><span data-ttu-id="56ebc-775"><em>Número interno (x7000 – x7999) para o escritório de 39 quai du Président Roosevelt, Issy-les-Moulineaux, França</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-775"><em>Internal number (x7000 – x7999) for 39 quai du Président Roosevelt office, Issy-les-Moulineaux, France</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-776">^(7\d{3})$</span><span class="sxs-lookup"><span data-stu-id="56ebc-776">^(7\d{3})$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-777">+3319999$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-777">+3319999$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-778">True</span><span class="sxs-lookup"><span data-stu-id="56ebc-778">True</span></span></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="56ebc-779"><strong>FR-TollFree</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-779"><strong>FR-TollFree</strong></span></span></p>
<p><span data-ttu-id="56ebc-780"><em>Normalização de número gratuito na França</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-780"><em>Toll Free number normalization for France</em></span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-781">^0?(80\d{7})\d*$</span><span class="sxs-lookup"><span data-stu-id="56ebc-781">^0?(80\d{7})\d*$</span></span></td>
<td align="left"><span data-ttu-id="56ebc-782">+33$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-782">+33$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-783">False</span><span class="sxs-lookup"><span data-stu-id="56ebc-783">False</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="56ebc-784"><strong>FR-Service</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-784"><strong>FR-Service</strong></span></span></p>
<p><span data-ttu-id="56ebc-785"><em>Normalização de número de serviço na França</em></span><span class="sxs-lookup"><span data-stu-id="56ebc-785"><em>Service number normalization for France</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="56ebc-786">^(1\d{1,2}|11[68]\d{3}|</span><span class="sxs-lookup"><span data-stu-id="56ebc-786">^(1\d{1,2}|11[68]\d{3}|</span></span></p>
<p><span data-ttu-id="56ebc-787">10\d{2}|3\d{3})$</span><span class="sxs-lookup"><span data-stu-id="56ebc-787">10\d{2}|3\d{3})$</span></span></p></td>
<td align="left"><span data-ttu-id="56ebc-788">$1</span><span class="sxs-lookup"><span data-stu-id="56ebc-788">$1</span></span></td>
<td align="left"><span data-ttu-id="56ebc-789">False</span><span class="sxs-lookup"><span data-stu-id="56ebc-789">False</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-790">_Tabela 13 Exemplo de planos de discagem para locatários_</span><span class="sxs-lookup"><span data-stu-id="56ebc-790">_Table 13 Example of tenant dial plans_</span></span>


<table>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="56ebc-791">Usuário</span><span class="sxs-lookup"><span data-stu-id="56ebc-791">User</span></span></th>
<th align="left"><span data-ttu-id="56ebc-792">Escritório</span><span class="sxs-lookup"><span data-stu-id="56ebc-792">Office</span></span></th>
<th align="left"><span data-ttu-id="56ebc-793">Tipo do plano de discagem</span><span class="sxs-lookup"><span data-stu-id="56ebc-793">Dial Plan Type</span></span></th>
<th align="left"><span data-ttu-id="56ebc-794">Nome do plano de discagem</span><span class="sxs-lookup"><span data-stu-id="56ebc-794">Dial Plan Name</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-795">Adele Vance</span><span class="sxs-lookup"><span data-stu-id="56ebc-795">Adele Vance</span></span></td>
<td align="left"><span data-ttu-id="56ebc-796">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-796">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-797">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-797">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-798">AU-NSW-NorthRyde-OER</span><span class="sxs-lookup"><span data-stu-id="56ebc-798">AU-NSW-NorthRyde-OER</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-799">Alex Wilber</span><span class="sxs-lookup"><span data-stu-id="56ebc-799">Alex Wilber</span></span></td>
<td align="left"><span data-ttu-id="56ebc-800">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-800">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-801">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-801">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-802">AU-NSW-NorthRyde-OER</span><span class="sxs-lookup"><span data-stu-id="56ebc-802">AU-NSW-NorthRyde-OER</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-803">Ben Walters</span><span class="sxs-lookup"><span data-stu-id="56ebc-803">Ben Walters</span></span></td>
<td align="left"><span data-ttu-id="56ebc-804">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="56ebc-804">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="56ebc-805">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-805">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-806">AU-NSW-NorthRyde-OER</span><span class="sxs-lookup"><span data-stu-id="56ebc-806">AU-NSW-NorthRyde-OER</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-807">Christie Cline</span><span class="sxs-lookup"><span data-stu-id="56ebc-807">Christie Cline</span></span></td>
<td align="left"><span data-ttu-id="56ebc-808">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-808">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-809">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-809">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-810">SG-Singapore-OMB</span><span class="sxs-lookup"><span data-stu-id="56ebc-810">SG-Singapore-OMB</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-811">Debra Berger</span><span class="sxs-lookup"><span data-stu-id="56ebc-811">Debra Berger</span></span></td>
<td align="left"><span data-ttu-id="56ebc-812">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-812">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-813">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-813">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-814">SG-Singapore-OMB</span><span class="sxs-lookup"><span data-stu-id="56ebc-814">SG-Singapore-OMB</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-815">Lee Gu</span><span class="sxs-lookup"><span data-stu-id="56ebc-815">Lee Gu</span></span></td>
<td align="left"><span data-ttu-id="56ebc-816">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="56ebc-816">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="56ebc-817">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-817">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-818">SG-Singapore-OMB</span><span class="sxs-lookup"><span data-stu-id="56ebc-818">SG-Singapore-OMB</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-819">Emily Braun</span><span class="sxs-lookup"><span data-stu-id="56ebc-819">Emily Braun</span></span></td>
<td align="left"><span data-ttu-id="56ebc-820">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-820">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-821">Plano de discagem para serviço</span><span class="sxs-lookup"><span data-stu-id="56ebc-821">Service dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-822">N/A</span><span class="sxs-lookup"><span data-stu-id="56ebc-822">N/A</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-823">Lidia Holloway</span><span class="sxs-lookup"><span data-stu-id="56ebc-823">Lidia Holloway</span></span></td>
<td align="left"><span data-ttu-id="56ebc-824">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-824">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-825">Plano de discagem para serviço</span><span class="sxs-lookup"><span data-stu-id="56ebc-825">Service dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-826">N/A</span><span class="sxs-lookup"><span data-stu-id="56ebc-826">N/A</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-827">Pradeep Gupta</span><span class="sxs-lookup"><span data-stu-id="56ebc-827">Pradeep Gupta</span></span></td>
<td align="left"><span data-ttu-id="56ebc-828">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="56ebc-828">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="56ebc-829">Plano de discagem para serviço</span><span class="sxs-lookup"><span data-stu-id="56ebc-829">Service dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-830">N/A</span><span class="sxs-lookup"><span data-stu-id="56ebc-830">N/A</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-831">Marcel Beauchamp</span><span class="sxs-lookup"><span data-stu-id="56ebc-831">Marcel Beauchamp</span></span></td>
<td align="left"><span data-ttu-id="56ebc-832">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-832">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-833">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-833">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-834">FR-Paris-Issy-39qdPR</span><span class="sxs-lookup"><span data-stu-id="56ebc-834">FR-Paris-Issy-39qdPR</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-835">Rachelle Cormier</span><span class="sxs-lookup"><span data-stu-id="56ebc-835">Rachelle Cormier</span></span></td>
<td align="left"><span data-ttu-id="56ebc-836">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-836">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-837">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-837">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-838">FR-Paris-Issy-39qdPR</span><span class="sxs-lookup"><span data-stu-id="56ebc-838">FR-Paris-Issy-39qdPR</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="56ebc-839">Isabell Potvin</span><span class="sxs-lookup"><span data-stu-id="56ebc-839">Isabell Potvin</span></span></td>
<td align="left"><span data-ttu-id="56ebc-840">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="56ebc-840">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="56ebc-841">Plano de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-841">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="56ebc-842">FR-Paris-Issy-39qdPR</span><span class="sxs-lookup"><span data-stu-id="56ebc-842">FR-Paris-Issy-39qdPR</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-843">_Tabela 14 Exemplo de atribuições de planos de discagem_</span><span class="sxs-lookup"><span data-stu-id="56ebc-843">_Table 14 Example of dial plan assignments_</span></span>


## <a name="microsoft-teams-configurations"></a><span data-ttu-id="56ebc-844">Configurações do Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="56ebc-844">Microsoft Teams configurations</span></span>

<span data-ttu-id="56ebc-845">Uma vez que a Audioconferência está disponível apenas para reuniões agendadas, as configurações de nível de locatário que regem o agendamento de reuniões (reuniões privadas e de canal) devem estar habilitadas.</span><span class="sxs-lookup"><span data-stu-id="56ebc-845">Since Audio Conferencing is only available for scheduled meetings, tenant-level configurations that govern meeting scheduling (private and channel meetings) must be enabled.</span></span>


> [!NOTE]
> <span data-ttu-id="56ebc-846">No momento, se sua organização tiver exigências de conformidade para garantir que todas as discussões nas reuniões sejam detectáveis, é necessário desabilitar as reuniões privadas se o organizador tiver uma caixa de correio no Exchange.</span><span class="sxs-lookup"><span data-stu-id="56ebc-846">Currently, if your organization has compliance requirements to ensure all meeting discussions are discoverable, you should disable private meetings if the organizer has an Exchange on-premises mailbox.</span></span><br><br>
> <span data-ttu-id="56ebc-847">Em outro caso de uso, se todas as reuniões da organização tiverem que permanecer visíveis apenas <strong>para as partes convidadas</strong>, recomendamos que você desabilite a possibilidade de agendar reuniões nos <strong>canais</strong> para evitar a divulgação das informações da reunião para as partes que não foram convidadas.</span><span class="sxs-lookup"><span data-stu-id="56ebc-847">In another use case, if all meetings in the organization must be visible <strong>to invited parties</strong> only, to avoid disclosing meeting information to uninvited parties, we recommend that you disable the ability to schedule meetings in <strong>channels</strong>.</span></span>

<span data-ttu-id="56ebc-848">As configurações, disponíveis como configurações em nível de locatário, são aplicáveis para todos os usuários da organização e afetarão todas as reuniões agendadas no Teams, não especificamente as reuniões Teams **com** Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-848">The settings, available as tenant-level configurations, are applicable to all users in the organization, and will impact all meeting scheduling in Teams, not specific to Teams meetings **with** Audio Conferencing.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="56ebc-849">Ponto de decisão</span><span class="sxs-lookup"><span data-stu-id="56ebc-849">Decision Point</span></span></td>
<td align="left"><p><span data-ttu-id="56ebc-850">Decidir se a organização exigirá ativar ou desativar o agendamento de reuniões privadas.</span><span class="sxs-lookup"><span data-stu-id="56ebc-850">Decide if the organization requires to enable or disable scheduling of private meetings.</span></span></p>
<p><span data-ttu-id="56ebc-851">Decidir se a organização exigirá ativar ou desativar o agendamento de reuniões de canal.</span><span class="sxs-lookup"><span data-stu-id="56ebc-851">Decide if the organization requires to enable or disable scheduling of channel meetings.</span></span></p></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="56ebc-852">Próximos passos</span><span class="sxs-lookup"><span data-stu-id="56ebc-852">Next Steps</span></span></td>
<td align="left"><p><span data-ttu-id="56ebc-853">Documentar as configurações de agendamento de reuniões para o Teams.</span><span class="sxs-lookup"><span data-stu-id="56ebc-853">Document the meeting scheduling configurations for Teams.</span></span></p></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<td align="left"><span data-ttu-id="56ebc-854"><strong>Permitir agendamento de reuniões privadas</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-854"><strong>Allow scheduling for private meetings</strong></span></span></td>
<td align="left"><span data-ttu-id="56ebc-855">Habilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-855">Enabled</span></span></td>
</tr>
</thead>
<thead>
<tr class="odd">
<td align="left"><span data-ttu-id="56ebc-856"><strong>Permitir agendamento de reuniões de canal</strong></span><span class="sxs-lookup"><span data-stu-id="56ebc-856"><strong>Allow scheduling for channel meetings</strong></span></span></td>
<td align="left"><span data-ttu-id="56ebc-857">Desabilitado</span><span class="sxs-lookup"><span data-stu-id="56ebc-857">Disabled</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="56ebc-858">_Tabela 15 Exemplo de configurações de reuniões Microsoft Teams_</span><span class="sxs-lookup"><span data-stu-id="56ebc-858">_Table 15 Example of Microsoft Teams meetings configurations_</span></span>


## <a name="document-technical-implementation-plan"></a><span data-ttu-id="56ebc-859">Documentar o plano de implementação técnica</span><span class="sxs-lookup"><span data-stu-id="56ebc-859">Document technical implementation plan</span></span>

<span data-ttu-id="56ebc-860">Utilizar os pontos de decisão acima para documentar o seu plano de implementação técnica.</span><span class="sxs-lookup"><span data-stu-id="56ebc-860">Use the decision points above to document your technical implementation plan.</span></span>

<span data-ttu-id="56ebc-861">Esse plano de implementação técnica fornecerá à equipe do projeto, que pode incluir o FastTrack ou um parceiro de implantação, as informações necessárias para executar a integração técnica para a implementação da Audioconferência.</span><span class="sxs-lookup"><span data-stu-id="56ebc-861">This technical implementation plan will provide the project team, which can include FastTrack or a deployment partner, with the information required to execute the technical onboarding for the implementation of Audio Conferencing.</span></span>

<span data-ttu-id="56ebc-862">No geral, um plano de implementação técnica deve conter as seguintes seções principais:</span><span class="sxs-lookup"><span data-stu-id="56ebc-862">In general, a technical implementation plan will contain the following main sections:</span></span>

-   <span data-ttu-id="56ebc-863">Lista de habilitação do site do serviço de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-863">Audio Conferencing service site enablement list</span></span>

-   <span data-ttu-id="56ebc-864">Lista de atribuição de licenças para organizadores de reunião de Audioconferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-864">License assignment list for Audio Conferencing meeting organizers</span></span>

-   <span data-ttu-id="56ebc-865">Número de planejamento de Créditos de Comunicação</span><span class="sxs-lookup"><span data-stu-id="56ebc-865">Communications Credits planning numbers</span></span>

-   <span data-ttu-id="56ebc-866">Detalhes de ponte de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-866">Conference bridge details</span></span>

-   <span data-ttu-id="56ebc-867">Configurações de ponte de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-867">Conference bridge settings</span></span>

-   <span data-ttu-id="56ebc-868">Atribuições das configurações de ponte de conferência</span><span class="sxs-lookup"><span data-stu-id="56ebc-868">Conference bridge settings assignments</span></span>

-   <span data-ttu-id="56ebc-869">Planos de discagem para locatários</span><span class="sxs-lookup"><span data-stu-id="56ebc-869">Tenant dial plans</span></span>

-   <span data-ttu-id="56ebc-870">Atribuições de planos de discagem</span><span class="sxs-lookup"><span data-stu-id="56ebc-870">Dial plan assignments</span></span>

-   <span data-ttu-id="56ebc-871">Configurações de reuniões Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="56ebc-871">Microsoft Teams meetings configurations</span></span>

<span data-ttu-id="56ebc-872">Com a conclusão do plano de sucesso e do plano de implementação técnica, agora você está pronto para conduzir a sua organização para as próximas etapas da jornada do cliente do Office 365.</span><span class="sxs-lookup"><span data-stu-id="56ebc-872">With the completion of success plan and technical implementation plan, you are now ready to take your organization to the next steps along the Office 365 customer journey.</span></span>

<a name="onboard"></a><span data-ttu-id="56ebc-873">Integração</span><span class="sxs-lookup"><span data-stu-id="56ebc-873">Onboard</span></span>
=======

<span data-ttu-id="56ebc-874">*Em breve.*</span><span class="sxs-lookup"><span data-stu-id="56ebc-874">*Coming soon.*</span></span>

<a name="drive-value"></a><span data-ttu-id="56ebc-875">Gerar valor</span><span class="sxs-lookup"><span data-stu-id="56ebc-875">Drive Value</span></span>
===========

<span data-ttu-id="56ebc-876">*Em breve.*</span><span class="sxs-lookup"><span data-stu-id="56ebc-876">*Coming soon.*</span></span>



### <a name="see-also"></a><span data-ttu-id="56ebc-877">Consulte também</span><span class="sxs-lookup"><span data-stu-id="56ebc-877">See also</span></span>
[<span data-ttu-id="56ebc-878">Configurar conferência PSTN ou de discagem para o Skype for Business</span><span class="sxs-lookup"><span data-stu-id="56ebc-878">Set up dial-in or PSTN conferencing for Skype for Business</span></span>](https://support.office.com/article/Set-up-audio-conferencing-for-Skype-for-Business-and-Microsoft-Teams-d01954f1-4f37-4cf5-a636-20039e5c59e9)
