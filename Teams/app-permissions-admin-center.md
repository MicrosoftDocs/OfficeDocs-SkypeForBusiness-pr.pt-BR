...
4. Na guia **Permissões,** revise as permissões solicitadas pelo aplicativo.
    ...
    :::image type="content" source="media/app-perm-admin-center-org-wide-permissions.png" alt-text="Captura de tela de permissões solicitadas por um aplicativo":::
...
Se os usuários em sua organização têm permissão para conceder consentimento e se um ou mais usuários concederem consentimento a um determinado aplicativo, você também verá a mesma mensagem para que você saiba que o consentimento foi concedido e o link do Active Directory do Azure para a página do aplicativo no portal do Azure AD.

> [!NOTE]
> Embora a  opção Revisar permissões e consentimento não está disponível para administradores de serviço do Teams e eles não podem conceder  consentimento de administrador em toda a organização a aplicativos, os administradores de serviço do Teams podem exibir o conteúdo na guia Permissões de um aplicativo. Por exemplo, um administrador de serviço do Teams pode clicar no link **do Azure Active Directory** para exibir detalhes de permissões do aplicativo no portal do Azure AD. 
...
- [Navegando o ciclo de vida do aplicativo do Teams](https://aka.ms/PR132) (sessão do Ignite 2020)