...
A Microsoft dá suporte a todos os codificadores e decodificadores, exceto aqueles listados neste artigo.

## <a name="hardware-decoder-driver-recommendations---intel"></a>Recomendações de driver de decodificador de hardware – Intel

As combinações de sistema operacional, modelo e driver a seguir não estão habilitadas para aceleração de hardware devido a vários problemas de driver.
...
Para sistemas operacionais herdados, somente os seguintes Device_ids estão habilitados para aceleração de hardware.
...
## <a name="hardware-encoder-driver-recommendations---intel"></a>Recomendações de driver do codificador de hardware – Intel
...
## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Recomendações de driver do codificador de hardware – Nvidia
...
## <a name="hardware-encoder-driver-recommendations---amd"></a>Recomendações de driver do codificador de hardware – AMD
