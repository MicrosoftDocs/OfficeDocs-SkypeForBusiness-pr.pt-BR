...
A Microsoft dá suporte a todos os decodificadores e codificadores, exceto os listados neste artigo.
...
|Sistema operacional           | Modelo (Device_id) | Driver/range |
|---------------------------|-------------------|--------------|
