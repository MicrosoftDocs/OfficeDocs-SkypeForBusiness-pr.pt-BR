...
## <a name="hardware-decoder-driver-recommendations---intel"></a>Recomendações de driver para decodificador de hardware-Intel
...
## <a name="hardware-decoder-driver-recommendations---nvidia"></a>Recomendações de driver do decodificador de hardware-Nvidia
...
## <a name="hardware-encoder-driver-recommendations---intel"></a>Recomendações de driver para codificador de hardware-Intel
...
## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Recomendações de driver para codificador de hardware-Nvidia
