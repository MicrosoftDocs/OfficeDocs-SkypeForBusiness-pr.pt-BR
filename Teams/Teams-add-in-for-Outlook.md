...
> - Se você estiver usando uma instalação do Office Outlook da Microsoft Store, não há suporte para o suplemento reuniões do teams. Os usuários que exigem este suplemento são aconselhados a instalar a versão do clique para executar do Office, conforme descrito no artigo do [Office no Windows 10 no modo S](https://support.office.com/article/faq-office-on-windows-10-in-s-mode-717193b5-ff9f-4388-84c0-277ddf07fe3f) . 
...
Consulte [agendar reuniões com o findtime](https://support.office.com/article/scheduling-meetings-with-findtime-4dc806ed-fde3-4ea7-8c5e-b5d1fddab4a6) para obter mais informações.
...
| Skype for Business com colaboração e reuniões do teams | Teams |
| Somente equipes | Teams |
...
Se o administrador configurou o Microsoft Exchange para [controlar o acesso ao servidor Web do Exchange (EWS)](https://docs.microsoft.com/en-us/exchange/client-developer/exchange-web-services/how-to-control-access-to-ews-in-exchange), um representante não poderá agendar uma reunião do teams em nome do chefe. A solução para essa configuração está em desenvolvimento e será lançada no futuro. 
