...
---
# <a name="sample-emails-and-surveys-for-upgrade-basic-communications"></a>Emails de amostra e pesquisas para comunicações atualizar básica
...
````
[Voltar para a etapa 1](upgrade-basic.md#step-1)
...
[Voltar para a etapa 4](upgrade-basic.md#step-4)

<a name="step-6-email"></a>

### <a name="remind-users-email-for-step-6"></a>Lembrar os usuários email, para a etapa 6

Linha de assunto: lembrete: Prepare-se para a atualização para equipes
...
[Voltar para a etapa 6.](upgrade-basic.md#step-6)
...
[Voltar para a etapa 7](upgrade-basic.md#step-7)
...
[Voltar para a etapa 10](upgrade-basic.md#step-10)

<!--ENDOFSECTION-->

<a name="step-9-surveys"></a>

## <a name="sample-surveys"></a>Pesquisas de amostra
...
|  &nbsp;  | Muita habilidade | Relativamente seu nível de habilidade | Habilidade não mudaram | Quer saber mais | N/D | Não tem certeza sobre/não familiar |   |   |   |    |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|--------------------|--------------------|-----|---------------------|---|---|---|----|
