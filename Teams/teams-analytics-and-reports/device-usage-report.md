...
1. Na navegação à esquerda do Centro de administração do Microsoft Teams, clique **em Análise & relatórios** de  >  **uso.** Na guia **Exibir relatórios,** em **Relatório**, selecione **Uso de dispositivo do Teams**.
2. Em **Intervalo de dados**, selecione intervalo e em seguida clique em **Executar relatório**.

    ![Captura de tela do relatório de uso de dispositivos do Teams no Centro de administração do Teams com callouts](../media/teams-reports-device-usage-with-callouts.png "Captura de tela do relatório de uso de dispositivos do Teams no Centro de administração do Teams com callouts")

## <a name="interpret-the-report"></a>Interpretar relatório

|Texto Explicativo |Descrição  |
|--------|-------------|
|**1**   |O relatório de uso de dispositivos do Teams pode ser exibido para tendências nos últimos 7 ou 30 dias.  |
