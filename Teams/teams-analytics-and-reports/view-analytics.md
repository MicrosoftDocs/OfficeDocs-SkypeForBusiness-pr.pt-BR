...
No Microsoft Teams, os usuários podem exibir análises para equipes e canais dos que fazem parte. Essas informações dão aos usuários informações sobre padrões de uso e atividades em suas equipes. Os usuários podem ver dados como o número de usuários ativos, postagens, respostas e muito mais em três níveis.

- **A análise entre equipes** fornece aos usuários uma visão geral ampla dos dados de uso de todas as equipes das que eles são membros ou proprietários em uma única exibição de lista.
...
Os usuários podem filtrar qualquer um desses exibições para ver dados por um período de tempo especificado.
...
3. Selecione um intervalo de datas para mostrar os dados de uso de todas as equipes das que você é membro ou proprietário.
    ...
    |--------|-------------|
    |**Nome**   |Nome da equipe. |
    |**Usuários ativos**   |Número de usuários ativos na equipe e linha de tendência da atividade da equipe durante o período de tempo especificado.
    ...
    |**Convidados**   |Número de convidados na equipe durante o período especificado. |
    |**Posts**   |Número de novas mensagens postadas no chat da equipe durante o período de tempo especificado. |
    |**Respostas**   |Número de respostas no chat da equipe durante o período especificado. |
    |**Tipo**   |Se a equipe é uma equipe privada ou uma equipe pública.|

## <a name="view-per-team-analytics"></a>Exibir análise por equipe

1. No Teams, vá para a equipe que você deseja, clique em Mais opções **(...)** e, em seguida, clique em **Gerenciar equipe.**
2. Clique na **guia** Análise.
4. Selecione um intervalo de datas para mostrar os dados de uso da equipe.  
    ...
    |**Gráfico de usuários** ativos  |Número de ativo diário. Passe o mouse sobre o ponto em uma determinada data para ver o número de usuários ativos nessa data.|
...
> [!TIP]
> Você também pode exibir a análise por equipe clicando em uma equipe na lista no exibição de análise entre [equipes.](#view-cross-team-analytics)

## <a name="view-per-channel-analytics"></a>Exibir análise por canal

1. No Teams, vá para o canal que você deseja, clique em Mais opções **(...)** e, em seguida, clique em **Gerenciar canal.**
2. Clique na **guia** Análise.
...
> [!NOTE]
> Definimos os usuários ativos como usuários que executam uma ação intencional no cliente da área de trabalho, no cliente móvel e no cliente Web. Exemplos de uma ação intencional incluem iniciar um chat, fazer uma chamada, compartilhar um arquivo, editar um documento dentro de equipes, participar de uma reunião e assim por diante. Eliminamos ações passivas, como inicialização automática, minimizar uma tela ou fechar o aplicativo. Também eliminamos todas as ações em uma única ID de usuário.
