...
Aqui está uma lista dos relatórios do teams disponíveis no centro de administração do Microsoft Teams e uma visão geral das informações que estão disponíveis em cada relatório.
