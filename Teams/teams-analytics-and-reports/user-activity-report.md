...
2. Em **Intervalo de datas,** selecione um intervalo e selecione **Executar relatório**.
    ...
    ![Captura de tela do relatório de Teams de atividades do usuário no centro de administração Teams com callouts](../media/teams-reports-user-activity-with-callouts.png "Captura de tela do relatório de Teams de atividades do usuário no centro de administração Teams com callouts")
