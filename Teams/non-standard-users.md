...
Os convidados não podem instalar, atualizar ou excluir aplicativos em um contexto compartilhado, como chat, canal ou reunião. Eles podem instalar, atualizar ou excluir aplicativos no escopo pessoal usando extensões de mensagem e links diretos. Os convidados não têm acesso à loja de aplicativos do Teams.
