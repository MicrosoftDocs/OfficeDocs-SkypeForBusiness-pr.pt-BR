...
Siga estas etapas para permitir que o aplicativo Pacientes no Microsoft Teams acesse uma api do Azure para instância FHIR. Este artigo pressuposição de que você tenha uma [API do Azure para instância FHIR](https://azure.microsoft.com/services/azure-api-for-fhir/) configurada e configurada em seu locatário.  Se você ainda não criou uma instância do Azure API para FHIR em seu locatário, consulte Início rápido: Implantar a API do Azure para FHIR usando o [portal do Azure.](https://docs.microsoft.com/azure/healthcare-apis/fhir-paas-portal-quickstart)

1. Clique [aqui](https://login.microsoftonline.com/common/adminConsent?client_id=4aee3506-b263-43e0-ba31-1468fa7b2806) para conceder autorização de administrador para o aplicativo Pacientes. Quando solicitado, entre usando as credenciais de administrador de locatário ou de administrador global e clique em Aceitar **para** conceder as permissões necessárias.

    ![Captura de tela da solicitação de permissão para o aplicativo Pacientes](../../media/patients-app-permissions-request.png)

    Depois de aceitar, feche a janela. Você verá uma página que pode ter esta aparência. Você pode ignorar a mensagem de erro na página. Ele é inofensivo e indica que o consentimento foi concedido. (Estamos trabalhando em uma página mais fácil de usar para esta URL. Fique atento!)
...
3. Na navegação à esquerda, selecione **Azure Active Directory** e, em seguida, selecione **Aplicativos Corporativos.**
    ...
    Procure uma linha chamada **Pacientes (desv)** e copie o valor na coluna **ID do** Objeto para a área de transferência.

    ![Captura de tela da linha Pacientes (desv) no portal do Azure](../../media/patients-app-azure-portal-object-id.png)

4. Vá para a instância de recurso da API do Azure para FHIR à qual você deseja conectar o aplicativo Pacientes (pesquisando-o ou navegando pelos recursos) e abra as configurações dessa instância.
...
8. No Teams, vá para a instância do aplicativo Pacientes carregada em sua equipe, clique em Configurações e, na caixa **Link,** insira a URL do ponto de extremidade do servidor FHIR. Em seguida, **clique em Conectar** para estabelecer uma conexão e pesquisar e adicionar pacientes à sua lista.  
    ...
    ![ Configurações do aplicativo Pacientes no Teams](../../media/patients-app-teams.png)
