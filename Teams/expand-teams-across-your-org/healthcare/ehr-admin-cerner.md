...
- Permitir que os pacientes participem de Teams virtuais de notificações por email ou SMS.
...
Para começar, o administrador Microsoft 365 inicia o portal de configuração do conector [EHR](https://ehrconnector.teams.microsoft.com) e faz logo em usar suas credenciais da Microsoft.
...
Você será apresentado com registros de integração para o início do paciente e do provedor. Esses registros são necessários para concluir a configuração de visita virtual no Cerner. Para obter mais informações, consulte o guia de integração Cerner-Microsoft Teams Telehealth.
...
Os provedores de saúde em sua organização podem participar de visitas virtuais usando Teams do portal PowerChart. O provedor deve navegar até o quadro de pacientes onde a opção Teams está disponível.

A partir daí, o provedor pode exibir informações de visita virtual, participar de visitas virtuais e enviar o link da reunião. Após a logon única, o provedor é levado diretamente para o compromisso virtual no Teams.
