...
A partir de 30 de junho de 2020, o Microsoft StaffHub foi desativado. Estamos criando recursos de StaffHub no Microsoft Teams. Hoje, o Teams inclui o aplicativo turnos para gerenciamento de agendamento e recursos adicionais se acumularão ao longo do tempo.

Essas mudanças fazem parte dos nossos esforços contínuos para capacitar todos os funcionários com o Microsoft 365. Com recursos para trabalhadores do Frontline agora no Teams, todos os funcionários de sua organização poderão usar o Teams para simplificar o trabalho de trabalho, colaborar com colegas de trabalho e acessar informações e experiências para ajudá-los a fazer o melhor trabalho.
...
O Microsoft StaffHub foi desativado, a partir de 30 de junho de 2020.

#### <a name="what-will-happen-once-staffhub-is-retired"></a>O que acontecerá quando o StaffHub for desativado?

StaffHub parou de funcionar para todos os usuários em 30 de junho de 2020. Qualquer pessoa que tentar abrir o aplicativo será exibida uma mensagem direcionando-o para o download de equipes.
...
Para acessar uma equipe do StaffHub a partir de turnos no Microsoft Teams, você precisava mover a equipe do StaffHub para o Microsoft Teams antes de 30 de junho de 2020, que é quando o StaffHub foi descontinuado.

#### <a name="what-happens-if-i-didnt-move-a-staffhub-team-to-shifts-in-teams"></a>O que acontece se eu não migrasse uma equipe do StaffHub para mudar para o Microsoft Teams?

As equipes que foram criadas usando StaffHub e não foram movidas para o Microsoft Teams não podem mais ser visualizadas ou movidas a partir de 30 de junho de 2020 quando StaffHub foi desativado. No entanto, você pode começar a usar o Microsoft Teams a qualquer momento e criar um cronograma de turnos no aplicativo turnos.

Se você tivesse uma equipe do StaffHub associada a um grupo do Office 365 que não se moveu para o Microsoft Teams e agora deseja criar um cronograma de turnos do Microsoft Teams associado a esse grupo do Office 365, entre em contato com o suporte.

### <a name="about-shifts"></a>Sobre turnos

#### <a name="what-is-shifts"></a>O que é turnos?

O aplicativo turnos no Teams é uma ferramenta de gerenciamento de agendamento que mantém os funcionários do Frontline conectados e em sincronização. Os gerentes criam, atualizam e gerenciam os cronogramas de turnos para equipes, e os membros da equipe podem ver seus cronogramas, ver quem mais está agendado para o dia, solicitar a troca ou oferecer um turno e solicitar folga, tudo em seus dispositivos móveis.  
...
Se já estiver em um plano que inclua turnos, você pode começar a usar turnos hoje como parte do teams. Dê uma olhada [na opção começar em turnos](https://support.office.com/article/get-started-in-shifts-5f3e30d8-1821-4904-be26-c3cd25a497d6).
...
Para obter informações sobre o produto, acesse [https://products.office.com/microsoft-teams/staff-scheduling-software](https://products.office.com/microsoft-teams/staff-scheduling-software) .
...
Para obter ajuda para o usuário final, vá para [ajuda de turnos para trabalhadores do Frontline](https://support.office.com/article/apps-and-services-cc1fba57-9900-4634-8306-2360a40c665b).

#### <a name="what-licenses-do-i-need-for-teams"></a>Quais são as licenças necessárias para o Teams?

Cada usuário deve ter uma licença ativa do Microsoft 365 ou do Office 365 de um plano elegível e deve receber uma licença do teams. 
...
#### <a name="does-each-user-need-to-have-a-microsoft-365-or-office-365-account-or-azure-active-directory-azure-ad-account"></a>Cada usuário precisa ter uma conta do Microsoft 365 ou do Office 365 ou da conta do Azure Active Directory (Azure AD)?

Sim, cada gerente e membro da equipe que usa o Microsoft Teams e turnos dentro do teams devem ter uma conta do Microsoft 365 ou do Office 365 (Azure AD) e deve ser atribuído a uma licença válida.
...
A capacidade de compartilhamento de arquivos, a capacidade de um gerente de distribuir arquivos para os membros da equipe, é ativada no back-end pelo SharePoint Online. Quando uma equipe é criada, um grupo do Microsoft 365 é automaticamente provisionado para essa equipe em segundo plano.
...
Os funcionários do Frontline podem ver toda a agenda de trabalho em um relance em turnos. Vamos dar suporte à integração nativa com o calendário do Outlook como parte do nosso roteiro. Nesse meio tempo, use o fluxo da Microsoft para configurar a integração com turnos no Teams e nos calendários do Outlook e do Google.
...
Você pode ativar ou desativar os turnos de toda a organização para todos os usuários da sua organização. No centro de administração do Microsoft Teams, você também pode usar a política de configuração do aplicativo de trabalho do Frontline para personalizar o Teams para sua força de trabalho do Frontline. A política é configurada com os aplicativos atividade, turnos, chat e chamadas. A atribuição da política fixa esses aplicativos à barra de aplicativos no Microsoft Teams para acesso rápido e fácil pelos usuários. 

Para saber mais, consulte [gerenciar o aplicativo turnos para sua organização no Microsoft Teams](manage-the-shifts-app-for-your-organization-in-teams.md).
