...
#### <a name="get-a-list-of-all-users-on-staffhub-teams-that-have-team-members-that-arent-provisioned-with-an-azure-ad-account"></a>Obter uma lista de todos os usuários em StaffHub Teams que têm membros da equipe que não são provisionados com uma conta do Azure AD
...
- Remova a conta não provisionada e adicione novamente a conta usando o UPN.
