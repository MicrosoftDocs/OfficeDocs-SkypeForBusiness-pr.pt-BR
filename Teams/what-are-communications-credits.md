...
> [!NOTE]
> Se sua organização estiver localizada em uma região diferente do endereço de cobrança do seu Enterprise Agreement (EA), talvez você não consiga comprar Créditos de Comunicação. Se você não conseguir adquirir Créditos de Comunicação, abra um incidente de suporte no portal e trabalharemos com você para atenuar esse problema até que uma solução permanente seja efetivada. 
  
## <a name="what-are-the-communications-credits-rates"></a>Quais são as taxas de Créditos de Comunicação?

Se você estiver se perguntando qual é o custo das chamadas para Planos de Chamadas, consulte [Cloud-Based Sistema de Telefonia for Voice Calling](https://go.microsoft.com/fwlink/p/?LinkId=799523) (role para baixo para "Ver taxas para onde você deseja chamar").
...
[Teams Relatório de uso de PSTN](teams-analytics-and-reports/pstn-usage-report.md)
