...
Para usar esse recurso, o Outlook na Web deve estar ligado para o usuário. Se o Outlook na Web estiver desligado, a opção Compartilhar com o **Outlook** não será exibida no Teams para o usuário. Para ver as etapas sobre como ativar e desativar o Outlook na Web, consulte Habilitar ou [desabilitar](/exchange/recipients-in-exchange-online/manage-user-mailboxes/enable-or-disable-outlook-web-app)o Outlook na Web para uma caixa de correio .
...
> [!NOTE]
> Esse recurso não é suportado no Outlook para Mac ou em algumas versões mais antigas do Outlook para Windows. Para obter mais informações, consulte Mensagens ativas nos Grupos do [Outlook e do Office 365.](/outlook/actionable-messages/)
...
Consulte também [Mensagens ativas nos Grupos do Outlook e do Office 365.](https://docs.microsoft.com/outlook/actionable-messages/)
