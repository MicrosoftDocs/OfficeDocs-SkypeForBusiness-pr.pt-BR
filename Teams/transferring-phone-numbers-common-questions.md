...
Veja a seguir as perguntas frequentes sobre a transferência de números de telefone para o Microsoft Teams. Depois de revisar as respostas, você deve estar pronto para criar um pedido de portabilidade e transferir seus números de telefone. Consulte [transferir números de telefone para o Office 365](transfer-phone-numbers-to-office-365.md) para obter instruções.
  
## <a name="what-countries-or-regions-support-number-porting"></a>Quais países ou regiões dão suporte à portabilidade numérica?

Você pode portar ou transferir números de telefone em todos os países ou regiões com suporte, mas a forma como você envia uma solicitação de pedido de portabilidade depende do país ou da região da qual os números de telefone vêm. Você pode ver uma lista dos países e regiões que são suportados pela [disponibilidade de países e regiões para conferências de áudio e planos de chamadas](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md). 

Quando estiver fazendo tarefas de gerenciamento de número de telefone, como transferir (portabilidade) ou obter números de telefone que não estão disponíveis no centro de administração do Skype for Business, consulte [gerenciar números de telefone de sua organização](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md).
...
- **Porta parcial** Isso ocorre quando você está apenas transferindo alguns números de telefone de seu provedor de serviços atual para o Microsoft Teams. Ao transferir alguns números relacionados ao mesmo número de telefone de cobrança, você ** *não deve incluir* ** o número de telefone de cobrança juntamente com todos os outros números de telefone na sua conta.
...
Para transferir ou *portar* números de telefone do teams para outro provedor de serviços telefônicos ou operadora, será necessário definir um PIN. Depois de definir o PIN, você precisa incluí-lo quando solicitar a portabilidade de um número de telefone. Para ver como configurar seu PIN, consulte [configurar seu PIN para transferir números para um novo provedor de serviços](/SkypeForBusiness/what-are-calling-plans-in-office-365/set-your-pin-for-transferring-numbers-to-a-new-service-provider).
