...
---
# <a name="phone-number-management-for-sweden"></a>Gerenciamento de números de telefone para a Suécia

Use esta tabela para encontrar informações sobre como obter e gerenciar números de telefone na Suécia para o Microsoft Teams.
...
|:-----|:-----|
|Obtenha novos números de telefone de usuário ou serviço que não estão listados no Centro de administração do Microsoft Teams.   <br/> |Baixe um desses formulários. <br/>  [Nova solicitação de número de telefone para a Suécia (v.5.0) (sv-se)](https://download.microsoft.com/download/5/e/3/5e3b17c3-9cc3-4098-8b03-4235dd42e724/new-phone-number-request-for-sweden-(v.5.0)-(sv-se).pdf) <br/>  [Nova solicitação de número de telefone para a Suécia (v.5.0) (en-us)](https://download.microsoft.com/download/a/3/0/a30b10be-42db-458d-bda2-adb320f2e2f3/new-phone-number-request-for-sweden-(v.5.0)-(en-us).pdf)<br/>  <br/>Preencha-o e [entre em contato com o Service Desk do TNS para obter instruções](contact-tns-service-desk.md).|
Obter números de telefone transferidos para nós.  <br/> |Baixe este formulário. <br/>[Carta de Autorização (LOA) para a Suécia (todos os números) (v.5.0) (sv-se)](https://download.microsoft.com/download/b/d/0/bd030c0c-67c5-40fb-a148-d12a4675aa79/letter-of-authorization-(loa)-for-sweden-(all-numbers)-(v.5.0)-(sv-se).pdf)<br/><br/> Preencha-o e [entre em contato com o Service Desk do TNS para obter instruções](contact-tns-service-desk.md). <br/> |
