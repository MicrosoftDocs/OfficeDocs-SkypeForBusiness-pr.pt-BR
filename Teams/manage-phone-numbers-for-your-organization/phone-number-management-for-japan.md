---
title: Telefone gerenciamento de números para o Japão
author: CarolynRowe
ms.author: crowe
manager: serdars
...
ms.locfileid: "58234976"
---
# <a name="phone-number-management-for-japan"></a>Telefone gerenciamento de números para o Japão

No Japão, fizemos uma parceria com o SoftBank para a compra e o provisionamento de Planos de Chamada para clientes com um endereço de cobrança no Japão. O SoftBank venderá seus Planos de Chamadas, fornecerá números de usuário para o Japão e fornecerá suporte para gerenciamento de números de telefone. No entanto, números de serviço e licenças para audioconferências, atendimentos automáticos e filas de chamada ainda serão vendidos e gerenciados por Microsoft 365 e Office 365.

Para obter mais informações sobre a [chamada do SoftBank](https://aka.ms/SoftBankVoicePlan).
