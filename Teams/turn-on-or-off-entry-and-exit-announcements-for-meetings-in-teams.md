...
3. No painel de **configurações de ponte** , habilitar ou desabilitar a **entrada de reunião e sair de notificações**. Esta opção é selecionada por padrão. Se você desmarcar a ele, os usuários que já tenham ingressado na reunião não serão notificados quando alguém entra ou sai da reunião.
    
4. Em **Tipo de anúncio de entrada/saída**, selecione **Nomes ou números de telefone** ou **Tons**.
    
5. Se você escolher **nomes ou números de telefone**, habilitar ou desabilitar **os chamadores Ask registrar seus nomes antes de ingressar na reunião**.
