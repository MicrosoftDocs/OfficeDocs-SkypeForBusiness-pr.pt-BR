...
- **Classificação de conteúdo gipsy**
...
- **Use Adesivos em conversas. Se você ativar isso, os usuários poderão incluir Adesivos em conversas de chat com outras pessoas.
...
- **Função de permissão de chat** Use essa configuração para definir a função de chat supervisionada do usuário.  Saiba mais sobre [o chat supervisionado.](supervise-chats-edu.md)
