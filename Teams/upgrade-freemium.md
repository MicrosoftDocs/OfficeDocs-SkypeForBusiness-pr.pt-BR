...
- 1:1 e chamada de áudio e vídeo online de grupo
- Reuniões de canal
- Compartilhamento de tela

A versão completa do Teams incluída com uma assinatura Microsoft 365 ou Office 365 oferece os seguintes recursos, além dos recursos que Teams oferece:

- Sem limite de usuário (com uma licença corporativa)
- Exchange de email e domínio de email personalizado
...
- Você é a pessoa que se inscreveu para a assinatura Teams assinatura gratuita existente.
- Se você estiver trazendo seu próprio domínio, ele ainda não está associado ao Azure Active Directory (por meio de avaliação ou assinatura Microsoft 365 ou Office 365 assinatura).

> [!NOTE]
> Para atualizar e transferir seus dados, você precisa comprar sua assinatura por meio do processo de atualização no Teams aplicativo. Se você comprou Microsoft 365 ou Office 365 com Teams sem passar pelo processo de atualização, não poderá transferir seus dados porque já terá um locatário separado.
...
Insira o endereço de email que você usa para entrar no Teams e, em seguida, compre um Microsoft 365 Business Standard plano. Se você quiser comprar uma Microsoft 365 Business Basic ou uma Enterprise de Office 365, [entre em contato com o suporte](https://portal.office.com/support/altusupport.aspx?app=teamsfreeupgrade).

## <a name="whats-next"></a>O que vem a seguir?

Depois que sua atualização [](get-started-with-teams-quick-start.md) for concluída, consulte Começar a [](adopt-microsoft-teams-landing-page.md) Microsoft Teams para obter as primeiras etapas e Adotar Microsoft Teams para uma abordagem em fases para Teams adoção em toda a sua organização.
