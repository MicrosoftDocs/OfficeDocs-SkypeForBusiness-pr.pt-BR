...
---
# <a name="availability-in-tunisia"></a>Disponibilidade na Tunísia
...
Aqui estão os serviços do Microsoft 365 e office 365 para Skype for Business e Microsoft Teams disponíveis para a Tunísia.
  
## <a name="audio-conferencing"></a>Audioconferência

|**Recurso**|**Detalhes**|
|:-----|:-----|
|A Audioconferência está disponível para compra?  <br/> |Sim, [somente pagamento por](../audio-conferencing-pay-per-minute.md) minuto <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Para quais capitais ou cidades importantes é possível obter números de chamadas tarifadas?   | Não geográfico. Os números de telefone não são vinculados a uma cidade ou local específico. <br/> |
