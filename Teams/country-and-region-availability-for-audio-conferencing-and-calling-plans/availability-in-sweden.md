...
ms.locfileid: "48320756"
---
# <a name="availability-in-sweden"></a>Disponibilidade na Suécia
...
Aqui estão os serviços do Microsoft 365 e do Office 365 para Skype for Business e Microsoft Teams disponíveis para a Suécia.
...
|Os números de telefone são atribuídos automaticamente para a Audioconferência?  <br/> |Sim, para: <br/><ul><li> Estocolmo</ul>Se quiser números de telefone dedicados, consulte [Obter números de telefone de serviço.](/microsoftteams/getting-service-phone-numbers)  <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Para quais capitais ou cidades importantes é possível obter números de chamadas tarifadas?  <br/> |<ul><li>Gotemburgo <li>  Helsingborg <li>  Vinculação <li>  Malmo <li>  Orebro <li>  Estocolmo <li>  Uppsala <li>  Vasteras </ul> |
