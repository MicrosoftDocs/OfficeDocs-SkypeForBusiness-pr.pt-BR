...
|Os números de telefone são atribuídos automaticamente para a Audioconferência?  <br/> |Sim, para: <br/><ul><li> Estocolmo</ul>Se você quiser números de telefone dedicados, consulte [Obter números de telefone de serviço](../getting-service-phone-numbers.md).  <br/> |
...
|**Recurso**|**Detalhes**|
|:-----|:-----|
|Para quais capitais ou cidades importantes é possível obter números de chamadas tarifadas?  <br/> |<ul><li>Gothburgo <li>  Helsingborg <li>  Linkoping <li>  Malmo <li>  Orebro <li>  Estocolmo <li>  Uppsala <li>  Vasteras </ul> |
