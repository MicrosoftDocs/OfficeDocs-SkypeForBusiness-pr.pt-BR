...
Este artigo oferece uma visão geral dos requisitos para a operação bem-sucedida de serviços de voz em nuvem para a sua organização. Ao operar corretamente seus serviços de voz em nuvem, você pode ter certeza de que está fornecendo uma experiência de alta qualidade e confiabilidade para sua organização.
...
O Microsoft Teams reúne tecnologias em todo o Microsoft 365 ou o Office 365 para fornecer um hub de trabalho em equipe. Os exemplos incluem:
...
É importante compreender a integridade geral do serviço Microsoft Teams para que você possa alertar proativamente outras pessoas em sua organização de qualquer evento que afete o serviço. Conforme descrito anteriormente, o Teams depende de outros serviços do Microsoft 365 ou do Office 365, como o Azure Active Directory, o Exchange Online, o SharePoint Online e o OneDrive for Business. Por isso, é igualmente importante monitorar a integridade dos serviços dependentes.
...
| Aplicativo de administração do Microsoft 365 ou do Office 365                  | Fornece notificações por push para o seu dispositivo móvel.  | Use quando você precisar ser notificado sobre incidentes de serviço enquanto estiver em trânsito.                  |
...
| API de comunicações do serviço do Microsoft 365 ou do Office 365 | Acesso programático à integridade do serviço do Microsoft 365 ou do Office 365.   | Use quando precisar de integração com uma ferramenta de monitoramento de terceiros ou se quiser criar sua própria solução. |
...
A primeira etapa no gerenciamento de alterações é monitorar as alterações planejadas para equipes. A melhor fonte para monitorar essas alterações é o [mapa do Office 365](https://products.office.com/business/office-365-roadmap), que lista recursos que estão em desenvolvimento, sendo implantados para clientes ou inicializados completamente. Você pode pesquisar recursos específicos do teams usando o filtro fornecido ou baixar o mapa para um arquivo do Excel para análise adicional. Para cada recurso, o mapa fornece uma breve descrição, juntamente com a data de lançamento prevista.
...
1.  Valide a qualidade executando uma análise da qualidade da experiência (consulte [melhorar e monitorar a qualidade da chamada para o Teams](monitor-call-quality-qos.md) para obter mais detalhes).
...
| Medir o uso (fase de valor da unidade)                           | Medir e avaliar o uso da equipe na fase valor da unidade (após a conclusão da implantação). Solucionar problemas de uso conforme necessário. | Newsletter  |               |
...
NPS é um índice, que varia de – 100 a 100, que mede a disposição do cliente para recomendar o produto ou serviço de uma empresa. O NPS é baseado em uma pesquisa anônima entregue aos usuários por e-mail ou por outros meios eletrônicos. O NPS mede a lealdade entre um provedor e um consumidor. Ele consiste apenas em uma pergunta, que solicita aos usuários que avaliem a experiência de 1 a 10, com a opção de fornecer comentários adicionais. Os usuários são classificados com base nas seguintes classificações:
...
O especialista em qualidade aproveita as ferramentas existentes e os processos documentados, como o painel de qualidade da chamada (CQD), para monitorar a experiência do usuário, identificar as tendências de qualidade e a correção de drives quando necessário.
O especialista em qualidade deve funcionar com as respectivas equipes para direcionar as ações de correção e denunciar a um Comitê de direcionamento sobre o progresso e quaisquer problemas de abertura.

Leia [melhorar e monitore a qualidade da chamada para o Teams](monitor-call-quality-qos.md), que descreve as atividades que avaliam e fornecem orientação de correção em áreas importantes que têm o maior impacto na melhoria da experiência do usuário. As diretrizes fornecidas neste artigo se concentram em usar o CQD como a principal ferramenta para denunciar e investigar cada área, com um foco no áudio para maximizar a adoção e o impacto. Todas as otimizações feitas à rede para melhorar a experiência de área também se converterão diretamente em aprimoramentos no vídeo e no compartilhamento da área de trabalho.

É altamente recomendável que você Innomine o especialista de qualidade em início. Depois de serem nomeados, eles devem começar a se familiarizar com o conteúdo [monitorar a qualidade da chamada](monitor-call-quality-qos.md) e os materiais de treinamento associados.
...
5.  **Entre em contato com o suporte da Microsoft:** Você pode entrar em contato com o suporte da Microsoft para obter problemas com o Teams online ou por telefone. Para obter informações, consulte [contatar o suporte para produtos empresariais](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products).
    Para clientes Premier, as solicitações de suporte podem ser iniciadas seguindo-se a orientação em [contatar o suporte para o Microsoft Teams (clientes Premier)](https://support.microsoft.com/premier/contacts).
...
#### <a name="common-tasks-for-phone-system"></a>Tarefas comuns do sistema telefônico
...
#### <a name="common-tasks-for-audio-conferencing"></a>Tarefas comuns para conferências de áudio
...
À medida que sua organização cresce ou contrai, é importante que você planeje o licenciamento de acordo com as necessidades atuais e futuras. Há uma licença base do Teams, além de licenciamento para recursos de voz na nuvem ([sistema telefônico](here-s-what-you-get-with-phone-system.md) e [conferência de áudio](https://products.office.com/skype-for-business/audio-conferencing)).

Para equipes, as licenças do sistema telefônico exigem licenças de [planos de chamada](calling-plan-landing-page.md) associados. O licenciamento do plano de chamada permite que você faça e receba chamadas telefônicas domésticas e/ou internacionais. Esses planos são baseados em uso e têm pools de minutos associados a eles. O provisionamento de [créditos de comunicações](what-are-communications-credits.md) garantirá que você nunca fique sem serviço.

A videoconferência permite uma conferência discada chamada e serviços de conferência discada nacionais. A conferência de discagem gratuita ou cenários de discagem não nacionais podem fazer com que você incorra em cobranças adicionais para as quais [créditos de comunicações](what-are-communications-credits.md) são necessários.

Os créditos de comunicações podem complementar as licenças do plano de chamada e do áudio de audioconferência. Ambas as licenças do plano de chamada e os créditos de comunicação são baseados em uso e, portanto, precisam ser monitorados e provisionados de acordo com isso.

Você pode aproveitar o [relatório de uso de PSTN](https://docs.microsoft.com/skypeforbusiness/skype-for-business-online-reporting/pstn-usage-report) para ajudar a monitorar o uso dos minutos do plano de chamada e dos créditos de comunicações. Com base nos resultados dessa atividade, você pode ajustar a licenciamento de acordo com isso. Em breve, oferecemos um relatório de [grupos de minutos PSTN](https://docs.microsoft.com/skypeforbusiness/skype-for-business-online-reporting/pstn-minute-pools-report) para auxiliá-lo com mais eficiência com essa tarefa.

### <a name="telephone-number-management"></a>Gerenciamento de número de telefone

Há dois métodos para adquirir números no Teams: você pode portar números de telefone de outro provedor ou pode provisionar os números diretamente do estoque de número da Microsoft. Os dois métodos são descritos em [obter números de telefone para seus usuários](getting-phone-numbers-for-your-users.md).

Há um limite para o número de números de telefone que você pode provisionar do inventário de número da Microsoft. Os limites são determinados por vários fatores detalhados em [quantos números de telefone você pode obter?](how-many-phone-numbers-can-you-get.md).
Os limites dependem do tipo de número: números de serviço de chamada gratuita, números de serviço de chamada e números de assinante (usuário). Cada um tem seus próprios limites e deve ser gerenciado independentemente. Se estiver aproximando o limite (ou se atingir o limite), você pode aplicar um incremento para o limite. Esse processo é descrito no artigo do parágrafo anterior.
