...
Este artigo apresenta uma visão geral dos requisitos para operar com êxito os serviços de voz na nuvem para sua organização. Ao operar corretamente seus serviços de voz na nuvem, você pode ter certeza de que está fornecendo uma experiência confiável e de alta qualidade para sua organização.
...
<tr><td><img src="media/audio_conferencing_image9.png" alt="An icon depicting the next steps"/><br/>Próximas etapas</td><td><ul><li>Revise o Guia de Operações na íntegra.</li><li>Implemente uma estratégia de operações que se alinhe às metas da sua organização para oferecer a qualidade e a confiabilidade das cargas de trabalho de voz na nuvem.</li><li>Revise [a qualidade da chamada do Monitor.](monitor-call-quality-qos.md)</li><li> Implemente uma estratégia de operações para executar avaliações regulares de Qualidade da Experiência para garantir que sua implantação de voz na nuvem está funcionando em seus recursos máximos.</li></ul></td></tr>
</table>
...
O Microsoft Teams reúne tecnologias no Microsoft 365 ou no Office 365 para fornecer um hub para o trabalho em equipe. Exemplos incluem:
...
É importante que você entenda a saúde geral do serviço microsoft teams para que possa alertar proativamente outras pessoas em sua organização sobre qualquer evento que afete o serviço. Conforme descrito anteriormente, o Teams depende de outros serviços do Microsoft 365 ou do Office 365, como o Azure Active Directory, o Exchange Online, o SharePoint Online e o OneDrive for Business. Por isso, é igualmente importante que você monitore a saúde dos serviços dependentes.
...
| Aplicativo de administração do Microsoft 365 ou do Office 365                  | Fornece notificações por push para seu dispositivo móvel.  | Use quando precisar ser notificado de incidentes de serviço enquanto estiver em qualquer lugar.                  |
...
| API de Comunicações de Serviço do Microsoft 365 ou do Office 365 | Acesso programático à saúde do serviço microsoft 365 ou office 365.   | Use quando precisar de integração com uma ferramenta de monitoramento de terceiros ou quiser criar sua própria solução. |
...
[Aplicativo móvel Office 365 Admin](https://support.office.com/article/Office-365-Admin-Mobile-App-e16f6421-2a1a-4142-bf9d-9846600a060a)

[Baixar o aplicativo móvel Office 365 Admin](https://products.office.com/business/manage-office-365-admin-app)

### <a name="monitoring-with-microsoft-system-center"></a>Monitoramento com o Microsoft System Center

O Microsoft System Center é uma plataforma de gerenciamento integrada que ajuda você a gerenciar datacenter, dispositivos cliente e ambientes de TI de nuvem híbrida. Os administradores do Office 365 que usam o System Center agora têm a opção de importar o Pacote de Gerenciamento do Office 365, que permite exibir todas as comunicações de serviço no Gerenciador de Operações no System Center. Usar esta ferramenta oferece acesso ao status dos serviços inscritos, a incidentes de serviço ativos e resolvidos e às comunicações do Centro de Mensagens (alterações futuras). Para obter mais informações, consulte a seguinte postagem [de blog.](https://blogs.office.com/2014/07/29/new-office-365-admin-tools/?eu=true)
...
1.  Valide a qualidade executando uma Revisão de Qualidade da Experiência (consulte [Melhorar e monitorar a qualidade](monitor-call-quality-qos.md) das chamada para o Teams para obter mais detalhes).
...
| Medir o uso (fase do valor da unidade)                           | Mede e avalie o uso do Teams na fase Valor da Unidade (após a conclusão da implantação). Resolver problemas de uso conforme necessário. | Quinzenal  |               |
...
O NPS (Net Promoter Score) é uma métrica de fidelização de clientes de todo o setor e uma boa abordagem a ser usada para avaliar os sentimentos dos usuários. O NPS pode ser calculado fazendo duas perguntas: "Qual é a probabilidade de você recomendar o Teams para um colega?", seguido da pergunta de forma livre, "Por quê?"
...
| Atividade                                                       | Descrição                                                                                                                                                                                                                                                                                                                                                                 | Cadência                | Equipe atribuída |
|----------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|---------------|
| Monitorar IPs e URLs do Office 365                                | Monitore quaisquer alterações nas URLs e intervalos de endereços IP do [Office 365](https://aka.ms/o365ips) usando o [RSS feed](https://go.microsoft.com/fwlink/p/?linkid=236301) fornecido e inicie uma solicitação de alteração para grupos de rede aplicáveis.                                                                                                                                | Diário                  |               |
| Atualizar a rede com base em alterações em IPs e URLs do Office 365 | Faça atualizações nos componentes de rede aplicáveis (firewalls, servidores proxy, VPNs, firewalls do lado do cliente e assim por diante) para refletir alterações nas URLs e intervalos de endereços IP do [Office 365.](https://aka.ms/o365ips)                                                                                                                                                              | Conforme necessário              |               |
...
O defensor da qualidade aproveita as ferramentas existentes e os processos documentados, como o CQD (Painel de Qualidade de Chamada), para monitorar a experiência do usuário, identificar tendências de qualidade e conduzir a correção quando necessário.
O campeão da qualidade deve trabalhar com as respectivas equipes para conduzir ações de correção e informar a um comitê de direção sobre o progresso e quaisquer problemas abertos.

Leia Melhorar e monitorar a qualidade da chamada para o [Teams,](monitor-call-quality-qos.md)que descreve as atividades que avaliam e fornecem orientações de correção em áreas principais que têm maior impacto na melhoria da experiência do usuário. As diretrizes fornecidas neste artigo se concentram no uso do CQD como a ferramenta principal para relatar e investigar cada área, com foco no áudio para maximizar a adoção e o impacto. Todas as otimizações feitas à rede para melhorar a experiência de área também se converterão diretamente em aprimoramentos no vídeo e no compartilhamento da área de trabalho.

Recomendamos que você nomeia o campeão de qualidade desde o início. Depois de indicados, eles devem começar a se familiarizar com [o conteúdo monitorar](monitor-call-quality-qos.md) a qualidade da chamada e materiais de treinamento associados.
...
5.  **Entre em contato com o Suporte da Microsoft:** Você pode entrar em contato com o Suporte da Microsoft para problemas com o Teams online ou por telefone. Para obter informações, consulte [Contatar o suporte para produtos de negócios.](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products)
    Para clientes Premier, as solicitações de suporte podem ser iniciadas seguindo as orientações em Contatar o suporte [do Microsoft Teams (clientes Premier).](https://support.microsoft.com/premier/contacts)
...
À medida que sua organização cresce ou contrai, é importante planejar o licenciamento para as necessidades atuais e futuras. Há uma licença base do Teams, além de licenciamento para recursos de voz na nuvem ([Sistema de Telefonia](here-s-what-you-get-with-phone-system.md) [e Audioconferência).](https://products.office.com/skype-for-business/audio-conferencing)

Para o Teams, as licenças do Sistema de Telefonia exigem licenças de Planos de [Chamada associadas.](calling-plan-landing-page.md) O licenciamento do Plano de Chamada permite que você faça e receba chamadas telefônicas domésticas e/ou internacionais. Esses planos são baseados em uso e têm pools de minutos associados a eles. Provisionar [Créditos de](what-are-communications-credits.md) Comunicação garantirá que você nunca ficará sem serviço.

A audioconferência permite conferência discada tarifada e serviços de conferência discada domésticas. A conferência discada gratuita ou cenários de discagem não doméstica podem fazer com que você incorrer em cobranças adicionais para as quais os [Créditos](what-are-communications-credits.md) de Comunicação são necessários.

Os Créditos de Comunicação podem complementar as licenças do Plano de Chamada e da Audioconferência. As licenças do Plano de Chamada e os Créditos de Comunicação são baseados em uso e, portanto, precisam ser monitorados e provisionados de acordo.

Você pode aproveitar o [relatório de uso de PSTN](https://docs.microsoft.com/skypeforbusiness/skype-for-business-online-reporting/pstn-usage-report) para ajudá-lo a monitorar o uso de minutos do Plano de Chamada e créditos de comunicação. Com base nos resultados dessa atividade, você pode ajustar seu licenciamento de acordo. Em breve, ofereceremos um relatório de pools de minutos [PSTN](https://docs.microsoft.com/skypeforbusiness/skype-for-business-online-reporting/pstn-minute-pools-report) para ajudar com mais eficiência nesta tarefa.

### <a name="telephone-number-management"></a>Gerenciamento de números de telefone

Há dois métodos para adquirir números no Teams: você pode fazer a portabilidade de números de telefone de outro provedor ou pode provisionar os números diretamente do inventário de números da Microsoft. Ambos os métodos são descritos em [Obter números de telefone para seus usuários.](getting-phone-numbers-for-your-users.md)
...
Os limites dependem do tipo de números : números de serviço de tarifa gratuita, números de serviço de tarifa tarifada e números de assinante (usuário). Cada um tem seus próprios limites e deve ser gerenciado independentemente. Se você estiver se aproximando do limite (ou tiver atingido o limite), poderá aplicar um incremento ao limite. Esse processo é descrito no artigo no parágrafo anterior.
...
![Diagrama de áreas a examinar durante uma Revisão de Qualidade da Experiência](media/plan-my-service-management-image2.png "As principais áreas a examinar durante uma Revisão de Qualidade da Experiência: áudio, confiabilidade e resultados da pesquisa do usuário.")
