...
ms.locfileid: "37925617"
---
# <a name="whats-the-status-of-your-port-orders"></a>Qual é o status dos seus pedidos de portabilidade?

Para ver o status do seu pedido de portabilidade, na navegação à esquerda do centro de administração do Microsoft Teams, vá para >**pedidos de porta**de **voz** > e clique em **histórico de pedidos**. Cada status de pedido de portabilidade é listado na coluna **status** .
