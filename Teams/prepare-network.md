...
Para testar os dois segmentos de rede, baixe a [ferramenta de avaliação de rede](https://go.microsoft.com/fwlink/?linkid=855799). Essa ferramenta pode ser implantada diretamente no computador cliente e em um computador conectado ao Customer Network Edge. A documentação da ferramenta é limitada, então não deixe de analisar a documentação abrangente incluída com o download. Ao executar a avaliação da prontidão da rede, você pode confirmar se sua rede está preparada para executar aplicativos de mídia em tempo real, como o Microsoft Teams.
...
Os cálculos de largura de banda do Microsoft Teams são complexos e, para ajudar, foi criada uma calculadora. Para ter acesso à calculadora, visite: <http://aka.ms/bwcalc>.
...
Ao planejar a implementação do Microsoft Teams na sua rede, você precisa garantir a largura de banda necessária, o acesso a todos os endereços IP necessários, as portas corretas abertas e os requisitos de desempenho de mídia em tempo real.
