...
- **Grupos do Microsoft 365**: controla a experiência dos convidados nos Grupos do Microsoft 365 e no Microsoft Teams.
- **SharePoint Online e OneDrive for Business**: controla a experiência dos convidados no SharePoint Online, no OneDrive for Business, nos Grupos do Microsoft 365 e no Microsoft Teams.
...
> [!NOTE]
> Você também pode gerenciar quais domínios podem receber convites para acessar seu locatário como convidados. Confira [Permitir/Bloquear o acesso de convidados aos Grupos do Microsoft 365](https://docs.microsoft.com/exchange/recipients-in-exchange-online/manage-group-access-to-office-365-groups).
...
## <a name="control-guest-access-in-microsoft-365-groups"></a>Controlar acesso de convidados aos Grupos do Microsoft 365

Nos Grupos do Microsoft 365, você pode controlar a adição de usuários convidados e o acesso de convidados para todos os Grupos do Microsoft 365 e para o Microsoft Teams em sua organização.

1. Entre com sua conta de administrador global em [https://portal.office.com/adminportal/home](https://portal.office.com/adminportal/home).

2. À esquerda, escolha **Configurações** e, em seguida, selecione **Serviços &amp; complementos**.

3. Selecione **Grupos do Microsoft 365**.

     ![Captura de tela dos Grupos do Microsoft 365 em configurações](media/authorize-guest-image2.png)
  
4. Na página de Grupos do Microsoft 365, alterne entre **Ativado** ou **Desativado**, conforme você desejar permitir que proprietários de equipes e grupos de fora da sua organização acessem aos Grupos do Microsoft 365. Clique ou toque no botão para defini-lo como **Ativado** ao lado de **Permitir que os proprietários do grupo adicionem pessoas fora da organização aos grupos**. Se esta opção for definida como **Ativado**, você verá outra opção para controlar se deseja permitir que os proprietários de grupos e equipes adicionem pessoas de fora da organização aos Grupos do Microsoft 365 e Microsoft Teams. Defina esta opção como **Ativado** se você quiser permitir que os proprietários de grupos e equipes adicionem usuários convidados. 
...
- Nos Grupos do Microsoft 365: ative o recurso **Permitir que os proprietários do grupo adicionem pessoas de fora da organização aos grupos**

    Para obter mais informações, confira [Controlar o acesso de convidados aos Grupos do Microsoft 365](#control-guest-access-in-microsoft-365-groups), acima.
  
Essas configurações se aplicam ao nível do locatário e controlam a experiência do convidado no SharePoint Online, OneDrive for Business, Grupos do Microsoft 365 e no Teams.
