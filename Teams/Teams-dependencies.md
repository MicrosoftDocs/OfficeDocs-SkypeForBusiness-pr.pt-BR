...
Para obter mais informações sobre como controlar quem pode enviar convites a convidados, consulte [Delegar convites para colaboração B2B do Active Directory do Azure](https://docs.microsoft.com/pt-BR/azure/active-directory/b2b/delegate-invitations)
