...
Aqui você encontrará as diretrizes que você precisa gerenciar para usar a API Graph para gerenciar Teams [canais](./private-channels.md) privados em sua organização.
