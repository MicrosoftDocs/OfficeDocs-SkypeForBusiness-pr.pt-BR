...
|---|---|---|---|---|
|**TeamsOnly <sup>2</sup>**</br>*Somente é possível se o usuário não tiver uma conta local no Skype for Business Server*|Teams|Teams|Sim|Estado final depois de atualizado. Será o padrão para novos locatários.|
...
|**SfBWithTeamsCollab**|Um usuário executa o Skype for Business e Teams lado a lado. Este usuário:</br><ul><li>Tem a funcionalidade de um usuário no modo SfBOnly.<li>Possui o Teams ativado somente para colaboração em grupo (Canais); chat/chamadas/agendamento de reunião estão desabilitados.</ul>|
