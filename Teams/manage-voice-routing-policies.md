...
description: Saiba como criar e gerenciar políticas de roteamento de chamadas para Microsoft Teams Roteamento Direto.
ms.openlocfilehash: 348eef9e33dba4f33868c94d72e21289b1a87690
ms.sourcegitcommit: 79dfda39db208cf943d0f7b4906883bb9d034281
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 02/09/2022
ms.locfileid: "62457391"
---
...
Se você implantou o [](direct-routing-landing-page.md) Roteamento Direto em sua organização, use políticas de roteamento de chamadas para permitir que os usuários Teams recebam e façam chamadas telefônicas para a PSTN (Rede Telefônica Pública Comucionada) usando sua infraestrutura de telefonia local.

Uma política de roteamento de chamadas (também chamada de política de roteamento de voz) é um contêiner para registros de uso PSTN. Crie e gerencie políticas de roteamento de voz indo para Políticas de roteamento **do** **VoiceVoice** >  no centro de administração Microsoft Teams ou usando Windows PowerShell.
...
É importante saber que atribuir uma política de roteamento de voz a um usuário não permite que ele faça chamadas PSTN em Teams. Você também precisará habilitar o usuário para Roteamento Direto e concluir outras etapas de configuração. Para saber mais, confira [Configurar Roteamento Direto](direct-routing-configure.md).
...
1. Na navegação à esquerda do centro de administração Microsoft Teams, vá para Políticas de roteamento **do** **VoiceVoice** >  e clique em **Adicionar**.<br>
...
1. Na navegação à esquerda do centro de administração Microsoft Teams, vá para Políticas de roteamento **do** **VoiceVoice** > .
