...
Uma política de roteamento de voz é um contêiner de registros de uso de PSTN. Crie e gerencie políticas de roteamento de voz indo para**políticas de roteamento de voz** de **voz** > no centro de administração do Microsoft Teams ou usando o Windows PowerShell.
...
1. Na navegação à esquerda do centro de administração do Microsoft Teams, vá para**políticas de roteamento de voz**de **voz** > e clique em **Adicionar**.<br>
