...
f1.keywords:
- NOCSH
description: Saiba como configurar e conectar seu SBC ao Teams Sistema de Telefonia Roteamento Direto.
ms.openlocfilehash: 7983fa176fec5e4921db169e1e92a6f6ebc2f2a7
ms.sourcegitcommit: 5e9b50cd1b513f06734be6c024ac06d293b27089
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 02/10/2022
ms.locfileid: "62518713"
---
...
3. Insira um FQDN para o SBC. <br><br>Certifique-se de que a parte do nome de domínio do FQDN corresponde a `*.onmicrosoft.com` um domínio registrado em seu locatário e tenha em mente que o nome de domínio não é suportado para o nome de domínio FQDN SBC. Por exemplo, se você tiver dois nomes de domínio `contoso.com` e `contoso.onmicrosoft.com`, use como `sbc.contoso.com` o nome SBC. Se estiver usando um subdomínio, certifique-se de que esse subdomínio também esteja registrado em seu locatário. Por exemplo, se você quiser usar `sbc.service.contoso.com`, então `service.contoso.com` precisa ser registrado.
...
|Necessário?|Teams configuração do centro de administração|Parâmetro do PowerShell|Descrição|Padrão|Valores possíveis|Tipo e restrições|
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
|Não|**Histórico de chamada de encaminhamento**|ForwardCallHistory |Indica se as informações do histórico de chamada são encaminhadas pelo tronco. Quando você ativar isso, o proxy Microsoft 365 enviará um header History-info e Referred-by. |Falso|Verdadeiro<br/>Falso|Boolean|
