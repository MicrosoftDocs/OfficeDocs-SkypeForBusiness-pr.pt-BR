...
Este artigo fornece uma visão geral dos requisitos para definir o sucesso da implantação do sistema telefônico com planos de chamada para sua organização. Ao definir apropriadamente qual será a aparência do sucesso, você pode medir seus resultados enquanto avança pela implantação e verifica se os resultados que você obtém são os que você deseja.

<!--ENDOFSECTION-->

## <a name="define-business-use-cases-for-phone-system-with-calling-plans"></a>Definir casos de uso empresarial para o sistema telefônico com planos de chamada

As organizações podem usar o sistema telefônico com planos de chamadas para modernizar seu local de trabalho, permitindo que os usuários façam chamadas telefônicas relacionadas a negócios em seus computadores e dispositivos móveis.

A modernização do local de trabalho pode fazer parte de qualquer número de cenários, uma implementação de trabalho baseada em atividades, uma grande mudança do Office, uma atualização para o Office em destaque, a desativação de uma solução de PBX (central privada de intercâmbio) herdada, a conclusão de um telefone comutado público contrato de provedor de serviços de rede (PSTN) e assim por diante.

Para começar, os principais participantes do projeto precisam definir casos de uso empresarial que dão suporte à implementação do sistema telefônico com planos de chamadas.

Os casos de uso comercial são destinados a definir e documentar resultados de negócios previstos e esperados, e inclui o seguinte:
...
-   **Escopo organizacional:** A implementação do sistema telefônico com planos de chamadas pode abranger toda a organização ou apenas unidades de negócios específicas.
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Pontos de decisão|<ul><li>Quais são os casos de uso empresarial do sistema telefônico com planos de chamada que você pode identificar em sua organização?</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Próximas etapas|<ul><li>Documentar todos os casos de uso de negócios do sistema telefônico com planos de chamada para sua organização.</li></ul>|

<!--ENDOFSECTION-->

## <a name="identify-key-stakeholders"></a>Identificar as principais partes envolvidas

Os casos de uso empresarial definidos na etapa anterior incluem um escopo organizacional para o sistema telefônico com implementação de planos de chamada. Com base nele, você pode preencher a matriz de participantes abrangentes para incluir as pessoas certas para envolver o projeto.
...
> |Proprietário do serviço|<ul><li>Seja responsável pela operação do sistema telefônico com serviço de planos de chamadas, tudo.</li><li>Possuir o sistema telefônico com serviço de planos de chamadas.</li></ul>|TBA|
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Pontos de decisão|<ul><li>Quem preencherá cada função importante do interessado em sua organização?</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Próximas etapas|<ul><li>Documente todos os principais participantes e comunique as responsabilidades e as expectativas da função para cada indivíduo atribuído.</li></ul>|
...
> [!TIP]
> Exemplo de OKRs relevante para o sistema telefônico com a implementação de planos de chamada pode ser referenciado abaixo:
> <br>
> 
...
> |---------|---------|---------|
> |Implantar o sistema telefônico com planos de chamadas em filiais européias pelo fim do ano fiscal 2018|FY18Q3: implantar o sistema telefônico com planos de chamada em Londres Office|Concepção<ul><li>Criar plano de sucesso</li><li>Criar plano detalhado de implementação técnica</li></ul><p>Integração<ul><li>Executar plano de sucesso</li><li>Executar plano de implementação técnica</li></ul>|
...
Como parte desse exercício, você precisa identificar os riscos de negócios e definir um plano de mitigação para cada um dos riscos identificados. Capture essas informações em um registro de riscos.
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Pontos de decisão|<ul><li>Quais são a sua organização&#39;s OKRs e KSIs?</li><li>Quais riscos você identificou relevantes para a implementação da conferência de áudio em sua organização? Quais são os planos de mitigação para os riscos identificados?</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Próximas etapas|<ul><li>Documente o OKRs, KSIs e estabeleça o registro de riscos.</li></ul>|
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Pontos de decisão|<ul><li>Decida se um Comitê de direcionamento é necessário para a sua organização.</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Próximas etapas|<ul><li>Identifique os membros do Comitê de direcionamento.</li><li>Agendar reuniões do Comitê de direcionamento.</li><li>Prepare-se para as reuniões do Comitê de direcionamento.</li><li>Mantenha as reuniões do Comitê de direcionamento.</li><li>Tome medidas com base na entrada de reunião do Comitê de direção.</li></ul>|

Orientações detalhadas adicionais sobre como operar um Comitê de direcionamento adequado podem ser encontradas no guia do Comitê de direcionamento disponível [aqui](https://docs.microsoft.com/MicrosoftTeams/envision-steering-committee-complete-guide).
