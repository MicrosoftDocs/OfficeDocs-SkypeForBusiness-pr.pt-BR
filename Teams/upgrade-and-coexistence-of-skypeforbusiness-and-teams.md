...
<sup>1</sup> Clientes mais antigos do Skype for Business que foram enviados antes de 2017 não fazem respeito ao TeamsUpgradePolicy. Verifique se você está usando o cliente do Skype for Business mais recente disponível no canal do Office.
...
- A comunicação iniciada a partir do cliente Skype for Business de outro usuário sempre irá para o cliente Skype for Business do Usuário A.

- As comunicações iniciadas a partir do cliente do Teams *de* um usuário na mesma organização sempre entrarão no cliente do Teams do Usuário A.

- As comunicações iniciadas *a* partir do cliente teams de um usuário em uma organização externa sempre entrarão no cliente Skype for Business do Usuário A.

Se você atribuiu uma licença do Microsoft 365 ou do Office 365 aos seus usuários, essa será a experiência de atualização padrão para sua organização. Quando você atribui uma licença do Microsoft 365 ou do Office 365, as licenças do Teams e do Skype for Business Online são atribuídas por padrão. <sup>2</sup>
...
Usando esse método de atualização, a presença também funcionará de maneira independente entre o Teams e o Skype for Business. Isso significa que outros usuários podem ver estados diferentes de presença para o Usuário A, dependendo do cliente usado. Para saber mais, confira [Presença](upgrade-to-Teams-on-prem-coexistence.md#presence).

- Outros usuários, ao usar o Teams, verão a presença com base na atividade do Usuário A no Teams.

- Outros usuários, ao usar o Skype for Business, verão a presença com base na atividade do Usuário A no Skype for Business.
...
Para novas conversas do ponto de vista do usuário do TeamsOnly, o chat ou a chamada sempre irá para o cliente de usuários do modo de ilhas do Teams. Isso ocorre porque o cliente do Teams mantém threads de conversas separadas para comunicações de Teams para Teams e de Teams para Skype for Business, mesmo que seja para o mesmo usuário. Para saber mais, confira [Conversas do Teams – Interoperabilidade versus threads nativos](upgrade-to-teams-on-prem-coexistence.md#teams-conversations---interop-versus-native-threads).
...
| Esforço administrativo mínimo para começar a usar o Teams. | Pode ser um desafio "sair das Ilhas" e ir para o modo TeamsOnly se os usuários e aqueles com quem eles se comunicam regularmente não estão usando ativamente o Teams.|
...
<sup>2</sup> Isso é verdadeiro mesmo se o usuário estiver instalado no Skype for Business Server. Se o usuário estiver hospedado no local ou online, deixe a licença do Skype for Business Online habilitada, pois atualmente ela é necessária para a funcionalidade completa do Teams.
...
Diferentemente do método de recursos sobrepostos, no método de recursos selecionados, os usuários do Skype for Business podem se comunicar com os usuários do TeamsOnly. A comunicação entre um usuário do Skype for Business e um usuário do Teams é conhecida como [interoperabilidade](upgrade-to-Teams-on-prem-coexistence.md#interoperability) ou "interop". A comunicação de interoperabilidade é possível bilateralmente para chats e chamadas entre um usuário no Skype for Business e outro usuário no Teams. Além disso, os usuários convidados sempre podem participar de uma reunião do Skype for Business ou do Teams; embora, devam usar um cliente que corresponda ao tipo de reunião. Para mais informações, confira [Reuniões](upgrade-to-Teams-on-prem-coexistence.md#meetings).
...
|Poderá reduzir as chances de um usuário final se confundir, devido a uma determinada funcionalidade está disponível apenas em um cliente. | Os usuários não têm acesso ao Teams para atividades comuns realizadas no Skype for Business, como chat e chamadas antes da atualização para o TeamsOnly.|
...
|---------|---------|
|Antes de serem atualizados para o TeamsOnly, os usuários devem executar ambos os clientes simultaneamente, pois os chats e chamadas recebidos podem chegar a qualquer cliente.     | Os chats e chamadas só são recebidos em um cliente, com base no modo do destinatário. Usuários não atualizados podem executar ambos os clientes, mas não há sobreposição funcional (chamadas e chats não estão disponíveis no Teams).         |
...
Depois de escolher a melhor jornada de atualização para sua organização, [execute a atualização para o Teams.](https://aka.ms/SkypeToTeams-Upgrade)
