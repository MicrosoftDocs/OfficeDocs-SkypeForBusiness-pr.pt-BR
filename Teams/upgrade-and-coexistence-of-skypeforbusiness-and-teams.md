...
- A comunicação iniciada pelo cliente do Teams de um *usuário na mesma organização* sempre chegará ao cliente do Teams do Usuário A.
- A comunicação iniciada pelo cliente do Teams de um *usuário em uma organização externa* sempre chegará ao cliente do Skype for Business do Usuário A.
...
Para novas conversas do ponto de vista do usuário do TeamsOnly, o chat ou a chamada sempre serão direcionados ao cliente do Teams dos usuários do modo de Uso Paralelo. Isso ocorre porque o cliente do Teams mantém threads de conversas separadas para comunicações de Teams para Teams e de Teams para Skype for Business, mesmo que seja para o mesmo usuário. Para saber mais, confira [Conversas do Teams – Interoperabilidade versus threads nativos](upgrade-to-Teams-on-prem-overview.md#teams-conversations---interop-versus-native-threads).
...
| Esforço administrativo mínimo para começar a usar o Teams. | Pode ser desafiador “sair do modo de Uso Paralelo” e mudar para o modo TeamsOnly se os usuários e aqueles com quem eles se comunicam regularmente não estiverem usando o Teams ativamente.|
...
> [!NOTE]
> Quando o Usuário A muda de Uso Paralelo para um dos modos do Skype for Business, o cliente do Teams de qualquer outro usuário que se comunica com o Usuário A precisa saber que o modo do Usuário A mudou para que ele possa rotear a comunicação para o cliente apropriado do Usuário A. Para qualquer usuário que já estabeleceu chats nativos de Teams para Teams com o Usuário A, poderá levar um tempo para que os clientes do Teams desses outros usuários estejam cientes da mudança do modo de Uso Paralelo para qualquer modo do Skype for Business. Quando os administradores estiverem prontos, eles poderão mudar o agendamento de chats, chamadas e reuniões de um determinado usuário para o Teams de uma só vez, atualizando o modo do usuário para TeamsOnly.
...
<tr><td><img src="media/audio_conferencing_image9.png" alt="An icon depicting the next step"/><br/>Próxima etapa</td><td><ul> Identificar o modelo de implantação atual, cenários de casos de uso e considerações importantes para a organização, informará a jornada para o Teams mais adequada à sua organização.<br><br></ul></td></tr>
</table>
