...
- **Abra a porta UDP.** Abra a porta UDP no intervalo de 49152 a 53247 para intervalos IP 52.112.0.0/14 a 52.120.0.0/14.
...
1. Vá para o centro [de Teams de administração](https://admin.teams.microsoft.com/)
...
5. A configuração para **dispositivos SIP pode ser usada para chamadas** e selecione **Salvar**.
...
3. No canto superior direito, selecione **Dispositivos** **ActionsProvision** >  e siga uma destas etapas:
  ...
  - **Para provisionar um dispositivo:**
     ...
     c. Em **Aguardando a ativação**, selecione o dispositivo que você acabou de adicionar e selecione **Gerar código de verificação**.
   ...
   - **Para provisionar muitos dispositivos:**
     ...
     e. À direita no painel Upload **endereços MAC**, selecione **Selecionar** um arquivo e selecione o arquivo **Template_Provisioning.csvque contém** seus dados.

     f. No painel **Provisionar dispositivos** , em Aguardando a ativação **, selecione** um dispositivo e selecione **Gerar** código de verificação para gerar um código de verificação único para cada dispositivo provisionado. Observe o código de verificação para cada dispositivo SIP.
...
7. Vá para [https://microsoft.com/devicelogin](https://microsoft.com/devicelogin), e em **Digite código**, insira o código de emparelhamento do dispositivo SIP e selecione **Next**.
...
2. Selecione **Teams** **dispositivosSIP** > . Todos os dispositivos SIP conectados estão listados à direita.
...
O Gateway SIP só dá suporte a IPv4. Microsoft Teams serviço e cliente suportam IPv4 e IPv6. Se você quiser controlar as comunicações Microsoft Teams, use os intervalos de endereços IP em Microsoft 365 [URLs e intervalos de endereços IP](/microsoft-365/enterprise/urls-and-ip-address-ranges).
