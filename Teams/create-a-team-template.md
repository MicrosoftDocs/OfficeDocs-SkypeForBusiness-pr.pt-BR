...
Um modelo de equipe personalizado é uma estrutura de equipe predefinida com um conjunto de canais, guias e aplicativos. Você pode desenvolver um modelo que ajude a criar rapidamente o espaço de colaboração certo. Seu modelo de equipe personalizado usa suas configurações preferenciais.  
