...
---
<a name="environmental-discovery-for-a-microsoft-teams-rollout"></a>Descobertas ambientais para uma adoção do Microsoft Teams
===================================================

A descoberta é uma das primeiras etapas fundamentais que você deve seguir ao planejar sua jornada para o Microsoft Teams.

Você executa uma descoberta detalhada do seu ambiente para entender melhor seu estado atual e revelar quaisquer dificuldades ou, ainda mais, possíveis bloqueadores para a execução da sua adoção do Teams.

## <a name="discovery-questionnaire"></a>Questionário de descoberta

O questionário de exemplo abaixo orienta você em um conjunto de perguntas para confirmar que sua organização está pronta para a aplicação bem-sucedida da Audioconferência e do Sistema de Telefonia com recursos de Planos de Chamada no Teams.

Todos os assuntos relacionados à sua infraestrutura de colaboração existente e à organização do Microsoft 365 ou office 365, rede, pontos de extremidade, operações, adoção e preparação são incluídos como parte do questionário de descoberta de questões ambientais.
...
<a name="project-team"></a>Equipe do Project
---

Capture informações detalhadas sobre os principais participantes do seu projeto de lançamento do Teams. Observe que uma pessoa pode desempenhar várias funções em todo o projeto.
...
> |---|---|---|
> | Observe a produção do Microsoft 365<br/>ou nome e ID da organização do Office 365<br/>na coluna Resposta. Se você tiver mais<br/>do que um locatário associado a<br/>sua organização, anote todas as IDs. | Nome do locatário: <br/>ID do locatário:| |
> | Em quais regiões os locatários são implantados?| | |
> | Observe o tipo destes Microsoft 365 ou <br/>Locatários do Office 365. Eles são Multitenente <br/>ou Dedicado? | <input type="checkbox"> Multitenante<br/> <input type="checkbox"> Dedicado | |
...
> | Se você atualmente mantém um Microsoft 365 ativo<br/>ou locatário do Office 365, é o domínio SMTP/SIP de <br/>seus usuários direcionados associados ao locatário? | <input type="checkbox"> N/A – Sem o Microsoft 365 ou<br/>&nbsp;&nbsp; &nbsp; Locatário do Office 365 no lugar <br/> <input type="checkbox"> Não, SMTP/SIP dos usuários <br/>&nbsp;&nbsp; &nbsp; domínio não está associado <br/>&nbsp;&nbsp; &nbsp; com locatários em <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 ou Office 365<br/> <input type="checkbox"> Sim, SMTP/SIP dos usuários <br/>&nbsp;&nbsp; &nbsp; domínio está associado <br/>&nbsp;&nbsp; &nbsp; com um locatário existente em <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 ou Office 365 | |
...
> | O Skype for Business está implantado? <br/>Para implantações híbridas e locais, certifique-se de <br/>você observa a versão e a atualização cumulativa (CU) <br/>detalhes na coluna Comentários. | <input type="checkbox"> Sim, Microsoft 365 ou <br/>&nbsp; &nbsp; &nbsp;Office 365 <br/> <input type="checkbox"> Sim, híbrido (com <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 ou <br/>&nbsp;&nbsp; &nbsp; Office 365) <br/> <input type="checkbox"> Sim, local <br/> <input type="checkbox"> Sim, online, dedicado <br/>&nbsp;&nbsp; &nbsp; (Microsoft) <br/> <input type="checkbox"> Sim, hospedado, dedicado <br/>&nbsp;&nbsp; &nbsp; (terceiros) <br/> <input type="checkbox"> Sim, hospedado, compartilhado <br/>&nbsp;&nbsp; &nbsp; (terceiros) <br/> <input type="checkbox"> Não, outros | |
> | O Exchange está implantado? <br/>Para implantações híbridas e locais, certifique-se de <br/>você anota os detalhes da versão e do CU nos Comentários <br/>Coluna. | <input type="checkbox"> Sim, Microsoft 365 <br/> <input type="checkbox"> Sim, híbrido (com <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 ou <br/>&nbsp;&nbsp; &nbsp; Office 365) <br/> <input type="checkbox"> Sim, local <br/> <input type="checkbox"> Sim, online, dedicado <br/>&nbsp;&nbsp; &nbsp; (Microsoft) <br/> <input type="checkbox"> Sim, hospedado, dedicado <br/>&nbsp;&nbsp; &nbsp; (terceiros) <br/> <input type="checkbox"> Sim, hospedado, compartilhado <br/>&nbsp;&nbsp; &nbsp; (terceiros) <br/> <input type="checkbox"> Não, outros | |
> | O SharePoint está implantado? <br/>Para implantações híbridas e locais, certifique-se de <br/>você anota os detalhes da versão e do CU nos Comentários <br/>Coluna. | <input type="checkbox"> Sim, Microsoft 365 <br/> <input type="checkbox"> Sim, híbrido (com <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 ou <br/>&nbsp;&nbsp; &nbsp; Office 365) <br/> <input type="checkbox"> Sim, local <br/> <input type="checkbox"> Sim, online, dedicado <br/>&nbsp;&nbsp; &nbsp; (Microsoft) <br/> <input type="checkbox"> Sim, hospedado, dedicado <br/>&nbsp;&nbsp; &nbsp; (terceiros) <br/> <input type="checkbox"> Sim, hospedado, compartilhado <br/>&nbsp;&nbsp; &nbsp; (terceiros) <br/> <input type="checkbox"> Não, outros | |
> | O OneDrive for Business está implantado? | <input type="checkbox"> Sim <br/> <input type="checkbox"> Não | |
> | Você tem outras plataformas de terceiros implantadas <br/>e em uso hoje? Em caso exato, observe o número de usuários de <br/>essas plataformas e os detalhes de uso na <br/>Coluna Comentários. | <input type="checkbox"> Cisco WebEx <br/> <input type="checkbox"> Folga <br/> <input type="checkbox"> Outro (Especificar na <br/>&nbsp;&nbsp; &nbsp; Coluna Comentários.) | Número de usuários: <br/>Detalhes:|
...
> | Você tem [SBCs que suportam Roteamento](https://docs.microsoft.com/microsoftteams/direct-routing-plan#supported-session-border-controllers-sbcs) Direto implantado <br/>para seus escritórios que estão no escopo desta iniciativa? Se Sim,<br/>observe os detalhes na coluna Comentários.| <input type="checkbox"> Sim <br/> <input type="checkbox"> Não ||
...
> | Pergunta | Resposta | Comentários |
> |---|---|---|
> | Quais tipos de usuários estão habilitados para o Skype <br/>para o Business Online? | <input type="checkbox"> Todos os usuários da organização <br/> <input type="checkbox"> Usuários/grupos de usuários específicos <br/>&nbsp;&nbsp; &nbsp; (Especifique na coluna Comentários.) | |
> | Quais são as modalidades e recursos atualmente <br/>em uso hoje? | <input type="checkbox"> Mensagens Instantâneas e Presença (IM/P)<br/> <input type="checkbox"> Conferência <br/> <input type="checkbox"> Federação <br/> <input type="checkbox"> Gravação de Reunião <br/> <input type="checkbox"> Audioconferência da Microsoft <br/> <input type="checkbox"> Audioconferência de terceiros (Observação<br/>&nbsp;&nbsp; &nbsp; os detalhes na coluna Comentários.) <br/> <input type="checkbox"> Planos de Chamada (anteriormente chamada PSTN) <br/> <input type="checkbox"> Assistentes Automáticos Organizacionais <br/> <input type="checkbox"> Filas de chamada | |
...
> | Selecione os serviços que sua função de Borda fornece hoje. | <input type="checkbox"> Acesso de usuário externo (usuários corporativos) <br/> <input type="checkbox"> Acesso remoto do usuário (anônimo) <br/>&nbsp;&nbsp; &nbsp; participantes externos da reunião) <br/> <input type="checkbox"> Federação <br/> <input type="checkbox"> Media relay | |
...
Use a tabela a seguir para capturar os detalhes de rede da sua organização e como seus usuários estão (ou serão) conectados ao Microsoft 365 e aos serviços do Office 365.

> | Pergunta | Resposta | Comentários |
> |---|---|---|
> | Como fazer (ou como) os usuários no escopo da migração <br/>acessar o Teams quando eles estão no escritório? <br/>Selecione todas as que se aplicam. | <input type="checkbox"> Conexão NAT roteada <br/> <input type="checkbox"> Servidor proxy <br/> <input type="checkbox"> Dados Wi-Fi <br/> <input type="checkbox"> Recursos gerenciados (não públicos) Wi-Fi <br/> <input type="checkbox"> Rota Expressa <br/>&nbsp;&nbsp; &nbsp; (Peering da Microsoft) ||
> | Se o acesso ao Microsoft 365 ou ao Office 365 for por meio de um<br/>servidor proxy, há alguma maneira de ignorar o proxy? | <input type="checkbox"> Sim <br/> <input type="checkbox"> Não | |
...
> | Se uma VPN for usada, o tráfego do Teams poderá ser excluído da <br/>VPN para acessar diretamente o Microsoft 365 e os Serviços do Office 365? | <input type="checkbox"> Sim <br/> <input type="checkbox"> Não | |
...
> | Todos os locais dentro de uma região têm saída de Internet, <br/>ou a saída da Internet está centralizada para toda a região? | <input type="checkbox"> Acesso regional à Internet <br/> <input type="checkbox"> Acesso centralizado à <br/>&nbsp;&nbsp; &nbsp; internet | |
...
> | Pergunta | Resposta | Comentários |
> |---|---|---|
> | Qual é o seu modelo de operações para o Lync Server, <br/>Skype for Business Server, implantação do Microsoft 365, <br/>ou implantação do Office 365 hoje? | | |
> | Você pode esboçar a organização de suporte atual para <br/>Lync Server, Skype for Business Server, Microsoft 365, <br/>ou o Office 365? | | |
...
> | Como monitorar seu Lync Server, Skype para <br/>Business Server, implantação do Microsoft 365 ou <br/>Implantação do Office 365? | | |
