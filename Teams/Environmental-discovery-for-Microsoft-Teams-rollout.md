...
---
<a name="environmental-discovery-for-a-microsoft-teams-rollout"></a>Descoberta ambiental para uma lançamento do Microsoft Teams
===================================================

A descoberta é uma das primeiras etapas principais que você toma ao planejar sua jornada para o Microsoft Teams.

Você executa uma descoberta detalhada do seu ambiente para entender melhor seu estado atual e revelar quaisquer dificuldades ou, ainda mais, possíveis bloqueadores para a execução da sua versão do Teams.

## <a name="discovery-questionnaire"></a>Questionário de descoberta

O questionário de exemplo abaixo orienta você por meio de um conjunto de perguntas para confirmar se sua organização está pronta para a lançamento bem-sucedido de Audioconferência e Sistema de Telefonia com recursos de Planos de Chamadas no Teams.

Todas as questões relacionadas à sua infraestrutura de colaboração existente e organização do Microsoft 365 ou Office 365, rede, pontos de extremidade, operações e adoção e preparação estão incluídos como parte do questionário de descoberta ambiental.
...
> [!TIP]
> Você pode começar copiando o questionário para um documento do Microsoft Word. Tente responder a todas as perguntas e capturar todos os detalhes à medida que você passar.

<a name="project-team"></a>Equipe do Project
---

Capture informações detalhadas sobre os principais participantes do projeto de lançamento do Teams. Observe que uma pessoa pode desempenhar várias funções em todo o projeto.
...
> |---|---|---|
> | Observe a produção do Microsoft 365<br/>ou nome da organização do Office 365 e ID<br/>na coluna Resposta. Se você tiver mais<br/>do que um locatário associado<br/>sua organização, anote todas as IDs. | Nome do locatário: <br/>ID do locatário:| |
> | Em quais regiões os locatários são implantados?| | |
> | Observe o tipo desses Microsoft 365 ou <br/>Locatários do Office 365. Eles são Multitenant <br/>ou Dedicado? | <input type="checkbox"> Multitenant<br/> <input type="checkbox"> Dedicado | |
...
> | Qual nível de licença está habilitado para o Skype <br/>Usuários do Business Online? | <input type="checkbox"> E1/G1 <br/> <input type="checkbox"> E2/G2 <br/> <input type="checkbox"> E3/G3 <br/> <input type="checkbox"> E4/G4 E5 | O número de usuários <br/>para cada SKU: |
...
Se aplicável, capture os detalhes da implantação do Teams usando a tabela de exemplo abaixo. Se você não tiver implantado o Teams, ignore esta seção.
...
Se aplicável, capture os detalhes da implantação do Skype for Business Online usando a tabela de exemplo abaixo. Se você ainda não implantou a implantação do Skype for Business Online, ignore esta seção.
...
Se aplicável, capture os detalhes da implantação do Skype for Business usando a tabela de exemplo abaixo. Se você não tiver implantado o Skype for Business local, ignore esta seção.
...
> | Quais modalidades e recursos estão em uso no momento <br/>hoje? | <input type="checkbox"> Mensagens Instantâneas e Presença (IM/P) <br/> <input type="checkbox"> Conferência <br/> <input type="checkbox"> Federação <br/> <input type="checkbox"> Gravação de reunião <br/> <input type="checkbox"> Chat Persistente / Chat de Grupo <br/> <input type="checkbox"> Conferência de Áudio da Microsoft <br/>&nbsp;&nbsp; &nbsp; (anteriormente Discar em Conferência) em seu <br/>&nbsp;&nbsp; &nbsp; Lync Server local ou <br/>&nbsp;&nbsp; &nbsp; Implantação do Skype for Business <br/> <input type="checkbox"> Audioconferência de terceiros <br/>&nbsp;&nbsp; &nbsp; (Observe os detalhes nos Comentários <br/>&nbsp;&nbsp; &nbsp; column.) <br/> <input type="checkbox"> Enterprise Voice usando local <br/>&nbsp; &nbsp; &nbsp;Conectividade PSTN <br/> <input type="checkbox"> Planos de chamada (anteriormente chamada PSTN) via <br/>&nbsp;&nbsp; &nbsp; Híbrido com Skype for Business Online | |
...
<a name="networking-and-access-to-microsoft-365-and-office-365-services"></a>Rede e acesso aos serviços do Microsoft 365 e office 365
---

Use a tabela a seguir para capturar os detalhes de rede da sua organização e como seus usuários estão (ou serão) conectados aos serviços do Microsoft 365 e do Office 365.
...
> | Se uma VPN for usada, o tráfego do Teams poderá ser excluído <br/>a VPN para acessar diretamente o Microsoft 365 e o Office 365 Services? | <input type="checkbox"> Sim <br/> <input type="checkbox"> Não | |
...
> | Pergunta | Resposta | Comentários |
> |---|---|---|
> | Qual é o seu modelo de operações para o Lync Server, <br/>Skype for Business Server, implantação do Microsoft 365, <br/>ou a implantação do Office 365 hoje? | | |
...
> | Como monitorar seu Lync Server, Skype for <br/>Business Server, implantação do Microsoft 365 ou <br/>Implantação do Office 365? | | |
...
> | Como medir o sucesso da tecnologia no momento <br/>lançamentos como o Skype for Business? | | |
