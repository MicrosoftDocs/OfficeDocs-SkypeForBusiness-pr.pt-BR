...
> [!NOTE]
> - Se você não vir a opção de **toda a organização** durante a criação de uma equipe e estiver um administrador global, o recurso ainda pode ser aplicação ou sua organização pode ter mais do que o limite de tamanho atual de 5.000 membros. Que queremos para aumentar esse limite no futuro.
...
### <a name="is-there-a-way-to-convert-an-existing-team-to-an-org-wide-team"></a>Há uma maneira de converter uma equipe existente para uma equipe de toda a organização?

Administradores globais podem converter uma equipe existente para editá-lo no cliente de equipes uma equipe de toda a organização.
Vá para o nome da equipe e clique em mais opções … equipe de Editar gt _ (reticências).
