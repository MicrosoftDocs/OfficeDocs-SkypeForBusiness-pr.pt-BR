...
## <a name="service-management-for-teams"></a>Gerenciamento de serviço para equipes
...
## <a name="plan-for-operational-role-mapping"></a>Plano para mapeamento de função operacionais
...
Mapeamento de funções operacionais logo no início da fase Envision permite todas as equipes iniciar suas tarefas operacionais durante o piloto e conheça as operações e certifique-se de que tudo esteja pronto após a implantação é iniciado.
...
>[!TIP]
>O exemplo a seguir é um exemplo de um modelo para documentar o resultado de funções operacionais mapeamento exercício executado para oferecer suporte a esse projeto.
...
|Central de atendimento|Interface para os usuários a obter suporte|TBA|TBA|
...
<table>
<tr><td>![](media/audio_conferencing_image7.png) <br/>Pontos de decisão</td><td><ul><li>Decida quem é responsável para operações de voz de nuvem em sua organização.</li></ol></td></tr>
<tr><td>![](media/audio_conferencing_image9.png)<br/>Próximos passos</td><td><ul><li>Baixe o Planning for guia completo de gerenciamento de serviço.</li><li>Baixe o guia de revisão de experiência de qualidade.</li><li>Revise o guia de operações por completo.</li><li>Forneça todas as guias para todos os membros da equipe de operações para examinar e estar familiarizado com os requisitos das operações.</li></ol></td></tr>
</table>
