...
ms.reviewer: rowille
audience: admin
description: Avalie regularmente oportunidades para aprimorar o serviço Teams, monitore o Teams para quaisquer aprimoramentos de recursos interessantes.
f1.keywords:
- NOCSH
...
Este artigo fornece uma visão geral dos requisitos para obter o máximo dos serviços de voz na nuvem para sua organização. Monitorando continuamente os recursos do serviço de voz na nuvem, você pode ter certeza de que está entregando o maior valor para sua organização.
...
Quando você vir oportunidades para aprimorar seu serviço, aproveite o tempo para fazer isso direito. Revisite [Implantar chat, equipes, canais](deploy-chat-teams-channels-microsoft-teams-landing-page.md) e aplicativos no Microsoft Teams e aplicar a mesma orientação de ponta a ponta. Ao fazer pequenas alterações incrementais, é improvável que você precise concluir todas as atividades e tarefas na íntegra, mas você deve avaliar cada atividade e tarefa ao longo do caminho para se dar a melhor chance de um resultado bem-sucedido.
