...
| [5](upgrade-basic.md#step-5) | Skype for Business Somente + Notificar o Skype for Business Usuário <br>(Use este comando se os usuários estão atualmente **no Skype for Business único** modo) | ```Grant-CsTeamsUpgradePolicy -PolicyName SfBOnlyWithNotify -Identity $SipAddress```  |
