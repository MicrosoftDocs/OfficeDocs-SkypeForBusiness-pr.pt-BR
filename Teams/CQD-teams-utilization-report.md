...
Na seção inferior esquerda da página, você encontrará uma tabela fornecendo valores totais para cada tipo de mídia no ano passado. 
    ![Captura de tela: Teams relatórios de utilização ](media/CQD-teams-utilization-report5.png) ![ Captura de tela: Teams relatórios de utilização](media/CQD-teams-utilization-report6.png)   
