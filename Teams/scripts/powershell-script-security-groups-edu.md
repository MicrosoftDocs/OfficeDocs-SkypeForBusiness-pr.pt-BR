...
ms.service: msteams
audience: admin
description: Use este script do PowerShell para criar os grupos de segurança que você precisa gerenciar Teams políticas para educadores e alunos em sua escola.
f1.keywords:
- NOCSH
...
---
# <a name="powershell-script-sample---create-security-groups-for-educators-and-students-in-your-school"></a><span data-ttu-id="d75a7-103">Exemplo de script do PowerShell - Criar grupos de segurança para educadores e alunos em sua escola</span><span class="sxs-lookup"><span data-stu-id="d75a7-103">PowerShell script sample - Create security groups for educators and students in your school</span></span>

<span data-ttu-id="d75a7-104">Use este script do PowerShell para criar os grupos de segurança que você precisa gerenciar Microsoft Teams políticas em sua escola.</span><span class="sxs-lookup"><span data-stu-id="d75a7-104">Use this PowerShell script to create the security groups that you need to manage Microsoft Teams policies in your school.</span></span> <span data-ttu-id="d75a7-105">O [recurso de atribuição](../assign-policies.md#assign-a-policy-to-a-group) de política a grupos Teams permite atribuir uma política a um grupo de usuários, como um grupo de segurança.</span><span class="sxs-lookup"><span data-stu-id="d75a7-105">The [policy assignment to groups](../assign-policies.md#assign-a-policy-to-a-group) feature in Teams lets you assign a policy to a group of users, such as a security group.</span></span> <span data-ttu-id="d75a7-106">As atribuições de política serão propagadas para os membros do grupo, de acordo com as regras de precedência.</span><span class="sxs-lookup"><span data-stu-id="d75a7-106">The policy assignment is propagated to members of the group according to precedence rules.</span></span> <span data-ttu-id="d75a7-107">À medida que os membros forem adicionados ou removidos de um grupo, as atribuições de política herdadas serão atualizadas.</span><span class="sxs-lookup"><span data-stu-id="d75a7-107">As members are added to or removed from a group, their inherited policy assignments are updated accordingly.</span></span>

<span data-ttu-id="d75a7-108">Esse script do PowerShell cria dois grupos de segurança, um para funcionários e educadores e outro para alunos em sua escola, com base no tipo de licença.</span><span class="sxs-lookup"><span data-stu-id="d75a7-108">This PowerShell script creates two security groups, one for staff and educators and another for students in your school, based on license type.</span></span> <span data-ttu-id="d75a7-109">Em seguida, você pode atribuir políticas aos grupos de segurança criados.</span><span class="sxs-lookup"><span data-stu-id="d75a7-109">You can then assign policies to the security groups that you created.</span></span> <span data-ttu-id="d75a7-110">Para obter mais informações sobre como usar esse script, consulte [Assign policies to large sets of users in your school](../batch-group-policy-assignment-edu.md).</span><span class="sxs-lookup"><span data-stu-id="d75a7-110">For more information about using this script, see [Assign policies to large sets of users in your school](../batch-group-policy-assignment-edu.md).</span></span>

<span data-ttu-id="d75a7-111">Este script faz o seguinte:</span><span class="sxs-lookup"><span data-stu-id="d75a7-111">This script does the following:</span></span>

- <span data-ttu-id="d75a7-112">Identifica funcionários e educadores que são atribuídos a um SKU docente, cria um grupo de segurança e adiciona funcionários e educadores ao grupo.</span><span class="sxs-lookup"><span data-stu-id="d75a7-112">Identifies staff and educators who are assigned a Faculty SKU, creates a security group, and then adds staff and educators  to the group.</span></span>
- <span data-ttu-id="d75a7-113">Identifica os alunos que são atribuídos a uma SKU de aluno, cria um grupo de segurança e adiciona os alunos ao grupo.</span><span class="sxs-lookup"><span data-stu-id="d75a7-113">Identifies students who are assigned a Student SKU, creates a security group, and then adds the students to the group.</span></span>
- <span data-ttu-id="d75a7-114">Atualiza a associação de cada grupo de segurança para adicionar ou remover funcionários, educadores e alunos com base em se eles têm uma licença.</span><span class="sxs-lookup"><span data-stu-id="d75a7-114">Updates the membership of each security group to add or remove staff, educators, and students based on whether they have a license.</span></span>

<span data-ttu-id="d75a7-115">Você precisará executar esse script regularmente para manter os grupos de segurança atualizados e atualizados.</span><span class="sxs-lookup"><span data-stu-id="d75a7-115">You'll need to run this script regularly to keep the security groups fresh and up to date.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="d75a7-116">É importante entender as regras [de precedência](../assign-policies.md#precedence-rules) e a classificação de atribuição de [grupo](../assign-policies.md#group-assignment-ranking) ao atribuir políticas a grupos.</span><span class="sxs-lookup"><span data-stu-id="d75a7-116">It's important to understand [precedence rules](../assign-policies.md#precedence-rules) and [group assignment ranking](../assign-policies.md#group-assignment-ranking) when assigning policies to groups.</span></span> <span data-ttu-id="d75a7-117">Leia e entenda os conceitos em O que você precisa saber sobre a atribuição de [política a grupos.](../assign-policies.md#what-you-need-to-know-about-policy-assignment-to-groups)</span><span class="sxs-lookup"><span data-stu-id="d75a7-117">Make sure that you read and understand the concepts in [What you need to know about policy assignment to groups](../assign-policies.md#what-you-need-to-know-about-policy-assignment-to-groups).</span></span>

## <a name="before-you-start"></a><span data-ttu-id="d75a7-118">Antes de começar</span><span class="sxs-lookup"><span data-stu-id="d75a7-118">Before you start</span></span>

<span data-ttu-id="d75a7-119">Baixe e instale o [módulo Skype for Business PowerShell Online](/microsoft-365/enterprise/manage-skype-for-business-online-with-microsoft-365-powershell)e reinicie o computador, se solicitado.</span><span class="sxs-lookup"><span data-stu-id="d75a7-119">Download and install the [Skype for Business Online PowerShell module](/microsoft-365/enterprise/manage-skype-for-business-online-with-microsoft-365-powershell), and then restart your computer if prompted.</span></span>

<span data-ttu-id="d75a7-120">Para se inclinar mais, consulte [Manage Skype for Business Online with Office 365 PowerShell](/office365/enterprise/powershell/manage-skype-for-business-online-with-office-365-powershell) and Teams [PowerShell overview](../teams-powershell-overview.md).</span><span class="sxs-lookup"><span data-stu-id="d75a7-120">To lean more, see [Manage Skype for Business Online with Office 365 PowerShell](/office365/enterprise/powershell/manage-skype-for-business-online-with-office-365-powershell) and [Teams PowerShell overview](../teams-powershell-overview.md).</span></span>


## <a name="sample-script"></a><span data-ttu-id="d75a7-121">Script de exemplo</span><span class="sxs-lookup"><span data-stu-id="d75a7-121">Sample script</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d75a7-122">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="d75a7-122">Related topics</span></span>

[<span data-ttu-id="d75a7-123">Atribua políticas a seus usuários no Teams</span><span class="sxs-lookup"><span data-stu-id="d75a7-123">Assign policies to your users in Teams</span></span>](../assign-policies.md)