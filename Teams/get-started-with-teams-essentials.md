...
O Microsoft Teams Essentials está disponível para compra no site direto da Microsoft e em Parceiros de Nuvem selecionados da Microsoft. As assinaturas diretas e por meio de parceiros diferem de algumas maneiras, pois usam sistemas de identidade diferentes. Visite a tabela mais adiante neste artigo para obter mais detalhes ou acesse:[ planos do Microsoft Teams Essentials](#how-does-microsoft-teams-essentials-compare-to-other-microsoft-teams-plans)

Uma assinatura comprada pelo site direto da Microsoft usa a identidade da conta Microsoft, que permite que você use seu endereço de email existente, como TomislavK@outlook.com, TomislavK@gmail.com ou TomislavK@ContosoLandscaping.com para se inscrever.
...
Se você comprou o Teams Essentials pelo site da Microsoft (direto), você possui o **Microsoft Teams Essentials**.
...
| **Chat e colaboração**     |         |         |         |         |
| Chat ilimitado (privado e em grupo) |     Sim    |   Sim      |   Sim      |    Sim      |
...
> [!IMPORTANT] 
> Para obter administração aprimorada e todo o conjunto completo de recursos do Teams, você precisará atualizar para a versão completa do Teams comprando um [plano de assinatura apropriado do Microsoft 365 ou do Office 365](https://www.microsoft.com/en-us/microsoft-teams/compare-microsoft-teams-options) para seus usuários. Recomendamos isso, pois você terá mais flexibilidade para gerenciar a forma como sua organização colabora.
...
1. **Compre a assinatura.** Acesse o [Microsoft Teams Essentials para pequenas empresas](https://www.microsoft.com/microsoft-teams/compare-microsoft-teams-options) e selecione **Comprar agora** em Microsoft Teams Essentials.
...
3. **Revise a descrição do serviço do Teams.** Visite a [ descrição do serviço Microsoft Teams](/office365/servicedescriptions/teams-service-description) para saber mais sobre o Microsoft Teams.
...
## <a name="upgrade-from-a-free-version-of-microsoft-teams-to-microsoft-teams-essentials"></a>Atualizar de uma versão gratuita do Microsoft Teams para o Microsoft Teams Essentials
...
Sim. Você pode manter seu sistema de email existente e aproveitar o Teams Essentials para conhecer, conversar e colaborar.  
...
Sim. Você pode sincronizar calendários existentes do Outlook.com e do Google com o Teams Essentials.
