...
5. Dependendo do País (Mercado) selecionado, agora você terá opções diferentes disponíveis para você usar para localizar os números de telefone necessários.  

6. Em **Quantidade,** insira o número de números de telefone que você deseja para sua organização e clique em **Próximo**. [!CUIDADO] Você tem 10 minutos para selecionar seus números de telefone. Se você demorar mais de 10 minutos, os números serão retornados ao pool de números de telefone.
