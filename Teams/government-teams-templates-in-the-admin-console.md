...
Centralize a comunicação e os recursos críticos para sua equipe de gerenciamento de crise ou resposta a incidentes. Dentro dessa equipe, você pode incluir vários tipos diferentes de arquivos para ajudar a criar um local central para todos os seus documentos. Use reuniões online para melhorar o fluxo de informações e a conscientização situação.
